...
public struct ActivatePipelineInput: Swift.Equatable {
    ...
    var parameterValues: [DataPipelineClientTypes.ParameterValue]?
    /// The ID of the pipeline.
    /// This member is required.
    var pipelineId: Swift.String?
    /// The date and time to resume the pipeline. By default, the pipeline resumes from the last completed execution.
    var startTimestamp: ClientRuntime.Date?
...
public struct AddTagsInput: Swift.Equatable {
    ...
    /// This member is required.
    var tags: [DataPipelineClientTypes.Tag]?
...
public struct DescribeObjectsOutputResponse: Swift.Equatable {
    ...
    var hasMoreResults: Swift.Bool
    /// The starting point for the next page of results. To view the next page of results, call DescribeObjects again with this marker value. If the value is null, there are no more results.
    var marker: Swift.String?
    /// An array of object definitions.
    /// This member is required.
    var pipelineObjects: [DataPipelineClientTypes.PipelineObject]?
...
public struct DescribePipelinesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var pipelineDescriptionList: [DataPipelineClientTypes.PipelineDescription]?
...
public struct EvaluateExpressionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var evaluatedExpression: Swift.String?
...
public struct GetPipelineDefinitionOutputResponse: Swift.Equatable {
    ...
    var parameterObjects: [DataPipelineClientTypes.ParameterObject]?
...
public struct ListPipelinesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var pipelineIdList: [DataPipelineClientTypes.PipelineIdName]?
...
extension DataPipelineClientTypes {
    ...
    public struct Operator: Swift.Equatable {
        ...
        var type: DataPipelineClientTypes.OperatorType?
...
extension DataPipelineClientTypes {
    ...
    public struct ParameterObject: Swift.Equatable {
        ...
        /// This member is required.
        var attributes: [DataPipelineClientTypes.ParameterAttribute]?
...
extension DataPipelineClientTypes {
    ...
    public struct PipelineDescription: Swift.Equatable {
        ...
        /// This member is required.
        var fields: [DataPipelineClientTypes.Field]?
...
public struct PollForTaskInput: Swift.Equatable {
    ...
    var instanceIdentity: DataPipelineClientTypes.InstanceIdentity?
    /// The type of task the task runner is configured to accept and process. The worker group is set as a field on objects in the pipeline when they are created. You can only specify a single value for workerGroup in the call to PollForTask. There are no wildcard values permitted in workerGroup; the string must be an exact, case-sensitive, match.
    /// This member is required.
    var workerGroup: Swift.String?
...
public struct PollForTaskOutputResponse: Swift.Equatable {
    ...
    var taskObject: DataPipelineClientTypes.TaskObject?
...
public struct PutPipelineDefinitionOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var errored: Swift.Bool
    /// The validation errors that are associated with the objects defined in pipelineObjects.
    var validationErrors: [DataPipelineClientTypes.ValidationError]?
    /// The validation warnings that are associated with the objects defined in pipelineObjects.
    var validationWarnings: [DataPipelineClientTypes.ValidationWarning]?
...
extension DataPipelineClientTypes {
    ...
    public struct Query: Swift.Equatable {
        ...
        var selectors: [DataPipelineClientTypes.Selector]?
...
public struct QueryObjectsInput: Swift.Equatable {
    ...
    var query: DataPipelineClientTypes.Query?
    /// Indicates whether the query applies to components or instances. The possible values are: COMPONENT, INSTANCE, and ATTEMPT.
    /// This member is required.
    var sphere: Swift.String?
...
extension DataPipelineClientTypes {
    ...
    public struct Selector: Swift.Equatable {
        /// Contains a logical operation for comparing the value of a field with a specified value.
        var `operator`: DataPipelineClientTypes.Operator?
        /// The name of the field that the operator will be applied to. The field name is the "key" portion of the field definition in the pipeline definition syntax that is used by the AWS Data Pipeline API. If the field is not set on the object, the condition fails.
        var fieldName: Swift.String?
...
public struct SetTaskStatusInput: Swift.Equatable {
    ...
    var errorStackTrace: Swift.String?
    /// The ID of the task assigned to the task runner. This value is provided in the response for [PollForTask].
    /// This member is required.
    var taskId: Swift.String?
    /// If FINISHED, the task successfully completed. If FAILED, the task ended unsuccessfully. Preconditions use false.
    /// This member is required.
    var taskStatus: DataPipelineClientTypes.TaskStatus?
...
extension DataPipelineClientTypes {
    ...
    public struct TaskObject: Swift.Equatable {
        ...
        var attemptId: Swift.String?
        /// Connection information for the location where the task runner will publish the output of the task.
        var objects: [Swift.String:DataPipelineClientTypes.PipelineObject]?
