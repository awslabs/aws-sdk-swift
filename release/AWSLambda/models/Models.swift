...
extension LambdaClientTypes {
    ...
    public struct AccountLimit: Swift.Equatable {
        ...
        var codeSizeUnzipped: Swift.Int
        /// The maximum size of a deployment package when it's uploaded directly to Lambda. Use Amazon S3 for larger files.
        var codeSizeZipped: Swift.Int
        /// The maximum number of simultaneous function executions.
        var concurrentExecutions: Swift.Int
        /// The amount of storage space that you can use for all deployment packages and layer archives.
        var totalCodeSize: Swift.Int
        /// The maximum number of simultaneous function executions, minus the capacity that's reserved for individual functions with [PutFunctionConcurrency].
        var unreservedConcurrentExecutions: Swift.Int?
...
public struct AddPermissionInput: Swift.Equatable {
    ...
    var eventSourceToken: Swift.String?
...
extension LambdaClientTypes {
    ...
    public struct AliasConfiguration: Swift.Equatable {
        ...
        var aliasArn: Swift.String?
        /// A description of the alias.
        var description: Swift.String?
        /// The function version that the alias invokes.
        var functionVersion: Swift.String?
        /// The name of the alias.
        var name: Swift.String?
        /// A unique identifier that changes when you update the alias.
        var revisionId: Swift.String?
        /// The [routing configuration](https://docs.aws.amazon.com/lambda/latest/dg/lambda-traffic-shifting-using-aliases.html) of the alias.
        var routingConfig: LambdaClientTypes.AliasRoutingConfiguration?
...
extension LambdaClientTypes {
    ...
    public struct AliasRoutingConfiguration: Swift.Equatable {
        ...
        var additionalVersionWeights: [Swift.String:Swift.Double]?
...
extension LambdaClientTypes {
    ...
    public struct AllowedPublishers: Swift.Equatable {
        ...
        /// This member is required.
        var signingProfileVersionArns: [Swift.String]?
...
extension LambdaClientTypes {
    ...
    public struct CodeSigningConfig: Swift.Equatable {
        ...
        /// This member is required.
        var allowedPublishers: LambdaClientTypes.AllowedPublishers?
        /// The Amazon Resource Name (ARN) of the Code signing configuration.
        /// This member is required.
        var codeSigningConfigArn: Swift.String?
        /// Unique identifer for the Code signing configuration.
        /// This member is required.
        var codeSigningConfigId: Swift.String?
        /// The code signing policy controls the validation failure action for signature mismatch or expiry.
        /// This member is required.
        var codeSigningPolicies: LambdaClientTypes.CodeSigningPolicies?
        /// Code signing configuration description.
        var description: Swift.String?
        /// The date and time that the Code signing configuration was last modified, in ISO-8601 format (YYYY-MM-DDThh:mm:ss.sTZD).
        /// This member is required.
        var lastModified: Swift.String?
...
extension LambdaClientTypes {
    ...
    public struct CodeSigningPolicies: Swift.Equatable {
        ...
        var untrustedArtifactOnDeployment: LambdaClientTypes.CodeSigningPolicy?
...
extension LambdaClientTypes {
    public struct Concurrency: Swift.Equatable {
        ...
        var reservedConcurrentExecutions: Swift.Int?
...
public struct CreateCodeSigningConfigOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var codeSigningConfig: LambdaClientTypes.CodeSigningConfig?
...
public struct CreateEventSourceMappingInput: Swift.Equatable {
    ...
    var bisectBatchOnFunctionError: Swift.Bool?
    /// (Streams only) An Amazon SQS queue or Amazon SNS topic destination for discarded records.
    var destinationConfig: LambdaClientTypes.DestinationConfig?
    ...
    var eventSourceArn: Swift.String?
    ...
    var filterCriteria: LambdaClientTypes.FilterCriteria?
    /// The name of the Lambda function. Name formats
    ///
    /// * Function name - MyFunction.
    ///
    ...
    var functionResponseTypes: [LambdaClientTypes.FunctionResponseType]?
    ...
    var maximumBatchingWindowInSeconds: Swift.Int?
    /// (Streams only) Discard records older than the specified age. The default value is infinite (-1).
    var maximumRecordAgeInSeconds: Swift.Int?
    ...
    var maximumRetryAttempts: Swift.Int?
    /// (Streams only) The number of batches to process from each shard concurrently.
    var parallelizationFactor: Swift.Int?
    /// (MQ) The name of the Amazon MQ broker destination queue to consume.
    var queues: [Swift.String]?
    /// The Self-Managed Apache Kafka cluster to send records.
    var selfManagedEventSource: LambdaClientTypes.SelfManagedEventSource?
    /// An array of authentication protocols or VPC components required to secure your event source.
    var sourceAccessConfigurations: [LambdaClientTypes.SourceAccessConfiguration]?
    /// The position in a stream from which to start reading. Required for Amazon Kinesis, Amazon DynamoDB, and Amazon MSK Streams sources. AT_TIMESTAMP is only supported for Amazon Kinesis streams.
    var startingPosition: LambdaClientTypes.EventSourcePosition?
    /// With StartingPosition set to AT_TIMESTAMP, the time from which to start reading.
    var startingPositionTimestamp: ClientRuntime.Date?
    /// The name of the Kafka topic.
    var topics: [Swift.String]?
    /// (Streams only) The duration in seconds of a processing window. The range is between 1 second up to 900 seconds.
    var tumblingWindowInSeconds: Swift.Int?
...
public struct CreateEventSourceMappingOutputResponse: Swift.Equatable {
    ...
    var lastProcessingResult: Swift.String?
    /// (Streams and Amazon SQS standard queues) The maximum amount of time, in seconds, that Lambda spends gathering records before invoking the function. Default: 0 Related setting: When you set BatchSize to a value greater than 10, you must set MaximumBatchingWindowInSeconds to at least 1.
    var maximumBatchingWindowInSeconds: Swift.Int?
    ...
    var stateTransitionReason: Swift.String?
    /// The name of the Kafka topic.
    var topics: [Swift.String]?
...
public struct CreateFunctionInput: Swift.Equatable {
    ...
    var architectures: [LambdaClientTypes.Architecture]?
    /// The code for the function.
    /// This member is required.
    var code: LambdaClientTypes.FunctionCode?
    ...
    var deadLetterConfig: LambdaClientTypes.DeadLetterConfig?
    /// A description of the function.
    var description: Swift.String?
    /// Environment variables that are accessible from function code during execution.
    var environment: LambdaClientTypes.Environment?
    /// Connection settings for an Amazon EFS file system.
    var fileSystemConfigs: [LambdaClientTypes.FileSystemConfig]?
    /// The name of the Lambda function. Name formats
    ///
    ...
    var imageConfig: LambdaClientTypes.ImageConfig?
    ...
    var packageType: LambdaClientTypes.PackageType?
    /// Set to true to publish the first version of the function during creation.
    var publish: Swift.Bool
    /// The Amazon Resource Name (ARN) of the function's execution role.
    /// This member is required.
    var role: Swift.String?
    /// The identifier of the function's [runtime](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html). Runtime is required if the deployment package is a .zip file archive.
    var runtime: LambdaClientTypes.Runtime?
    ...
    var tracingConfig: LambdaClientTypes.TracingConfig?
    ...
    var vpcConfig: LambdaClientTypes.VpcConfig?
...
public struct CreateFunctionOutputResponse: Swift.Equatable {
    ...
    var environment: LambdaClientTypes.EnvironmentResponse?
    ...
    var imageConfigResponse: LambdaClientTypes.ImageConfigResponse?
    ...
    var lastUpdateStatus: LambdaClientTypes.LastUpdateStatus?
    /// The reason for the last update that was performed on the function.
    var lastUpdateStatusReason: Swift.String?
    /// The reason code for the last update that was performed on the function.
    var lastUpdateStatusReasonCode: LambdaClientTypes.LastUpdateStatusReasonCode?
    /// The function's [ layers](https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html).
    var layers: [LambdaClientTypes.Layer]?
    /// For Lambda@Edge functions, the ARN of the main function.
    var masterArn: Swift.String?
    ...
    var signingJobArn: Swift.String?
    /// The ARN of the signing profile version.
    var signingProfileVersionArn: Swift.String?
    /// The current state of the function. When the state is Inactive, you can reactivate the function by invoking it.
    var state: LambdaClientTypes.State?
    /// The reason for the function's current state.
    var stateReason: Swift.String?
    /// The reason code for the function's current state. When the code is Creating, you can't invoke or modify the function.
    var stateReasonCode: LambdaClientTypes.StateReasonCode?
    /// The amount of time in seconds that Lambda allows a function to run before stopping it.
    var timeout: Swift.Int?
    /// The function's X-Ray tracing configuration.
    var tracingConfig: LambdaClientTypes.TracingConfigResponse?
    /// The version of the Lambda function.
    var version: Swift.String?
    /// The function's networking configuration.
    var vpcConfig: LambdaClientTypes.VpcConfigResponse?
...
extension LambdaClientTypes {
    ...
    public struct DestinationConfig: Swift.Equatable {
        ...
        var onFailure: LambdaClientTypes.OnFailure?
        /// The destination configuration for successful invocations.
        var onSuccess: LambdaClientTypes.OnSuccess?
...
extension LambdaClientTypes {
    ...
    public struct EnvironmentResponse: Swift.Equatable {
        /// Error messages for environment variables that couldn't be applied.
        var error: LambdaClientTypes.EnvironmentError?
...
extension LambdaClientTypes {
    ...
    public struct FileSystemConfig: Swift.Equatable {
        ...
        /// This member is required.
        var localMountPath: Swift.String?
...
extension LambdaClientTypes.Filter: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LambdaClientTypes.FilterCriteria: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension LambdaClientTypes {
    ...
    public struct FilterCriteria: Swift.Equatable {
        /// A list of filters.
        var filters: [LambdaClientTypes.Filter]?
...
extension LambdaClientTypes {
    ...
    public struct FunctionCodeLocation: Swift.Equatable {
        ...
        var resolvedImageUri: Swift.String?
...
extension LambdaClientTypes {
    public struct FunctionEventInvokeConfig: Swift.Equatable {
        ...
        var maximumEventAgeInSeconds: Swift.Int?
...
public struct GetAccountSettingsOutputResponse: Swift.Equatable {
    ...
    var accountLimit: LambdaClientTypes.AccountLimit?
    /// The number of functions and amount of storage in use.
    var accountUsage: LambdaClientTypes.AccountUsage?
...
public struct GetFunctionOutputResponse: Swift.Equatable {
    ...
    var code: LambdaClientTypes.FunctionCodeLocation?
    /// The function's [reserved concurrency](https://docs.aws.amazon.com/lambda/latest/dg/concurrent-executions.html).
    var concurrency: LambdaClientTypes.Concurrency?
    /// The configuration of the function or version.
    var configuration: LambdaClientTypes.FunctionConfiguration?
...
public struct GetLayerVersionByArnOutputResponse: Swift.Equatable {
    ...
    var compatibleArchitectures: [LambdaClientTypes.Architecture]?
    /// The layer's compatible runtimes.
    var compatibleRuntimes: [LambdaClientTypes.Runtime]?
    /// Details about the layer version.
    var content: LambdaClientTypes.LayerVersionContentOutput?
    ...
    var createdDate: Swift.String?
    /// The description of the version.
    var description: Swift.String?
    /// The ARN of the layer.
    var layerArn: Swift.String?
    /// The ARN of the layer version.
    var layerVersionArn: Swift.String?
    /// The layer's software license.
    var licenseInfo: Swift.String?
    /// The version number.
...
public struct GetProvisionedConcurrencyConfigOutputResponse: Swift.Equatable {
    ...
    var allocatedProvisionedConcurrentExecutions: Swift.Int?
    /// The amount of provisioned concurrency available.
    var availableProvisionedConcurrentExecutions: Swift.Int?
    ...
    var requestedProvisionedConcurrentExecutions: Swift.Int?
    /// The status of the allocation process.
    var status: LambdaClientTypes.ProvisionedConcurrencyStatusEnum?
...
extension LambdaClientTypes {
    ...
    public struct ImageConfigResponse: Swift.Equatable {
        /// Error response to GetFunctionConfiguration.
        var error: LambdaClientTypes.ImageConfigError?
...
public struct InvokeAsyncInput: Swift.Equatable {
    ...
    /// This member is required.
    var invokeArgs: ClientRuntime.ByteStream?
...
public struct InvokeInput: Swift.Equatable {
    ...
    var clientContext: Swift.String?
    /// The name of the Lambda function, version, or alias. Name formats
    ///
    /// * Function name - my-function (name-only), my-function:v1 (with alias).
    ///
    ...
    var invocationType: LambdaClientTypes.InvocationType?
    /// Set to Tail to include the execution log in the response. Applies to synchronously invoked functions only.
    var logType: LambdaClientTypes.LogType?
...
public struct InvokeOutputResponse: Swift.Equatable {
    ...
    var executedVersion: Swift.String?
    /// If present, indicates that an error occurred during function execution. Details about the error are included in the response payload.
    var functionError: Swift.String?
...
extension LambdaClientTypes {
    ...
    public struct LayersListItem: Swift.Equatable {
        ...
        var latestMatchingVersion: LambdaClientTypes.LayerVersionsListItem?
        /// The Amazon Resource Name (ARN) of the function layer.
        var layerArn: Swift.String?
...
public struct ListAliasesOutputResponse: Swift.Equatable {
    /// A list of aliases.
    var aliases: [LambdaClientTypes.AliasConfiguration]?
...
public struct ListCodeSigningConfigsOutputResponse: Swift.Equatable {
    ...
    var codeSigningConfigs: [LambdaClientTypes.CodeSigningConfig]?
    /// The pagination token that's included if more results are available.
    var nextMarker: Swift.String?
...
public struct ListEventSourceMappingsOutputResponse: Swift.Equatable {
    ...
    var eventSourceMappings: [LambdaClientTypes.EventSourceMappingConfiguration]?
...
public struct ListFunctionEventInvokeConfigsOutputResponse: Swift.Equatable {
    ...
    var functionEventInvokeConfigs: [LambdaClientTypes.FunctionEventInvokeConfig]?
    /// The pagination token that's included if more results are available.
    var nextMarker: Swift.String?
...
public struct ListFunctionsInput: Swift.Equatable {
    ...
    var functionVersion: LambdaClientTypes.FunctionVersion?
    /// Specify the pagination token that's returned by a previous request to retrieve the next page of results.
    var marker: Swift.String?
...
public struct ListFunctionsOutputResponse: Swift.Equatable {
    /// A list of Lambda functions.
    var functions: [LambdaClientTypes.FunctionConfiguration]?
    /// The pagination token that's included if more results are available.
    var nextMarker: Swift.String?
...
public struct ListLayerVersionsInput: Swift.Equatable {
    ...
    var compatibleArchitecture: LambdaClientTypes.Architecture?
    /// A runtime identifier. For example, go1.x.
    var compatibleRuntime: LambdaClientTypes.Runtime?
    /// The name or Amazon Resource Name (ARN) of the layer.
    /// This member is required.
    var layerName: Swift.String?
    /// A pagination token returned by a previous call.
...
public struct ListLayerVersionsOutputResponse: Swift.Equatable {
    /// A list of versions.
    var layerVersions: [LambdaClientTypes.LayerVersionsListItem]?
...
public struct ListLayersOutputResponse: Swift.Equatable {
    ...
    var layers: [LambdaClientTypes.LayersListItem]?
...
public struct ListProvisionedConcurrencyConfigsOutputResponse: Swift.Equatable {
    ...
    var provisionedConcurrencyConfigs: [LambdaClientTypes.ProvisionedConcurrencyConfigListItem]?
...
public struct ListVersionsByFunctionOutputResponse: Swift.Equatable {
    ...
    var versions: [LambdaClientTypes.FunctionConfiguration]?
...
public struct PublishLayerVersionInput: Swift.Equatable {
    ...
    /// This member is required.
    var content: LambdaClientTypes.LayerVersionContentInput?
    /// The description of the version.
    var description: Swift.String?
    /// The name or Amazon Resource Name (ARN) of the layer.
    /// This member is required.
...
public struct PutProvisionedConcurrencyConfigInput: Swift.Equatable {
    ...
    /// This member is required.
    var provisionedConcurrentExecutions: Swift.Int?
    /// The version number or alias name.
    /// This member is required.
    var qualifier: Swift.String?
...
extension LambdaClientTypes {
    ...
    public struct SelfManagedEventSource: Swift.Equatable {
        ...
        var endpoints: [Swift.String:[Swift.String]]?
...
extension LambdaClientTypes {
    ...
    public struct SourceAccessConfiguration: Swift.Equatable {
        ...
        var type: LambdaClientTypes.SourceAccessType?
...
extension LambdaClientTypes {
    ...
    public struct TracingConfig: Swift.Equatable {
        /// The tracing mode.
        var mode: LambdaClientTypes.TracingMode?
