...
public struct AddTagsInput: Swift.Equatable {
    ...
    var tagsList: [CloudTrailClientTypes.Tag]?
...
extension CloudTrailClientTypes {
    ...
    public struct AdvancedEventSelector: Swift.Equatable {
        ...
        /// This member is required.
        var fieldSelectors: [CloudTrailClientTypes.AdvancedFieldSelector]?
...
public struct CreateTrailInput: Swift.Equatable {
    ...
    var enableLogFileValidation: Swift.Bool?
    /// Specifies whether the trail is publishing events from global services such as IAM to the log files.
    var includeGlobalServiceEvents: Swift.Bool?
    /// Specifies whether the trail is created in the current region or in all regions. The default is false, which creates a trail only in the region where you are signed in. As a best practice, consider creating trails that log events in all regions.
    var isMultiRegionTrail: Swift.Bool?
    ...
    var isOrganizationTrail: Swift.Bool?
...
public struct CreateTrailOutputResponse: Swift.Equatable {
    ...
    var logFileValidationEnabled: Swift.Bool?
...
public struct DescribeTrailsInput: Swift.Equatable {
    ...
    var includeShadowTrails: Swift.Bool?
    ...
    var trailNameList: [Swift.String]?
...
public struct DescribeTrailsOutputResponse: Swift.Equatable {
    ...
    var trailList: [CloudTrailClientTypes.Trail]?
...
extension CloudTrailClientTypes {
    ...
    public struct EventSelector: Swift.Equatable {
        ...
        var dataResources: [CloudTrailClientTypes.DataResource]?
        ...
        var excludeManagementEventSources: [Swift.String]?
        ...
        var includeManagementEvents: Swift.Bool?
        ...
        var readWriteType: CloudTrailClientTypes.ReadWriteType?
...
public struct GetEventSelectorsOutputResponse: Swift.Equatable {
    ...
    var advancedEventSelectors: [CloudTrailClientTypes.AdvancedEventSelector]?
    /// The event selectors that are configured for the trail.
    var eventSelectors: [CloudTrailClientTypes.EventSelector]?
...
public struct GetInsightSelectorsOutputResponse: Swift.Equatable {
    ...
    var insightSelectors: [CloudTrailClientTypes.InsightSelector]?
...
public struct GetTrailOutputResponse: Swift.Equatable {
    ...
    var trail: CloudTrailClientTypes.Trail?
...
public struct GetTrailStatusOutputResponse: Swift.Equatable {
    ...
    var isLogging: Swift.Bool?
    /// Displays any CloudWatch Logs error that CloudTrail encountered when attempting to deliver logs to CloudWatch Logs.
    var latestCloudWatchLogsDeliveryError: Swift.String?
    /// Displays the most recent date and time when CloudTrail delivered logs to CloudWatch Logs.
    var latestCloudWatchLogsDeliveryTime: ClientRuntime.Date?
    /// This field is no longer in use.
    var latestDeliveryAttemptSucceeded: Swift.String?
    /// This field is no longer in use.
    var latestDeliveryAttemptTime: Swift.String?
    ...
    var latestDeliveryError: Swift.String?
    /// Specifies the date and time that CloudTrail last delivered log files to an account's Amazon S3 bucket.
    var latestDeliveryTime: ClientRuntime.Date?
    /// Displays any Amazon S3 error that CloudTrail encountered when attempting to deliver a digest file to the designated bucket. For more information, see [Error Responses](https://docs.aws.amazon.com/AmazonS3/latest/API/ErrorResponses.html) in the Amazon S3 API Reference. This error occurs only when there is a problem with the destination S3 bucket, and does not occur for requests that time out. To resolve the issue, create a new bucket, and then call UpdateTrail to specify the new bucket; or fix the existing objects so that CloudTrail can again write to the bucket.
    var latestDigestDeliveryError: Swift.String?
    /// Specifies the date and time that CloudTrail last delivered a digest file to an account's Amazon S3 bucket.
    var latestDigestDeliveryTime: ClientRuntime.Date?
    /// This field is no longer in use.
    var latestNotificationAttemptSucceeded: Swift.String?
    /// This field is no longer in use.
    var latestNotificationAttemptTime: Swift.String?
...
extension CloudTrailClientTypes {
    ...
    public struct InsightSelector: Swift.Equatable {
        ...
        var insightType: CloudTrailClientTypes.InsightType?
...
public struct ListPublicKeysOutputResponse: Swift.Equatable {
    ...
    var publicKeyList: [CloudTrailClientTypes.PublicKey]?
...
public struct ListTagsInput: Swift.Equatable {
    ...
    /// This member is required.
    var resourceIdList: [Swift.String]?
...
public struct ListTagsOutputResponse: Swift.Equatable {
    ...
    var resourceTagList: [CloudTrailClientTypes.ResourceTag]?
...
public struct ListTrailsOutputResponse: Swift.Equatable {
    ...
    var trails: [CloudTrailClientTypes.TrailInfo]?
...
extension CloudTrailClientTypes {
    ...
    public struct LookupAttribute: Swift.Equatable {
        ...
        /// This member is required.
        var attributeKey: CloudTrailClientTypes.LookupAttributeKey?
...
public struct LookupEventsInput: Swift.Equatable {
    ...
    var eventCategory: CloudTrailClientTypes.EventCategory?
    /// Contains a list of lookup attributes. Currently the list can contain only one item.
    var lookupAttributes: [CloudTrailClientTypes.LookupAttribute]?
...
public struct LookupEventsOutputResponse: Swift.Equatable {
    ...
    var events: [CloudTrailClientTypes.Event]?
    /// The token to use to get the next page of results after a previous API call. If the token does not appear, there are no more results to return. The token must be passed in with the same parameters as the previous call. For example, if the original call specified an AttributeKey of 'Username' with a value of 'root', the call with NextToken should include those same parameters.
    var nextToken: Swift.String?
...
extension CloudTrailClientTypes {
    ...
    public struct PublicKey: Swift.Equatable {
        ...
        var validityEndTime: ClientRuntime.Date?
        /// The starting time of validity of the public key.
        var validityStartTime: ClientRuntime.Date?
        /// The DER encoded public key value in PKCS#1 format.
        var value: ClientRuntime.Data?
...
extension CloudTrailClientTypes {
    ...
    public struct Trail: Swift.Equatable {
        ...
        var hasCustomEventSelectors: Swift.Bool?
        /// Specifies whether a trail has insight types specified in an InsightSelector list.
        var hasInsightSelectors: Swift.Bool?
