...
public struct DescribeBundleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBundleInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeBundleInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeBundleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeBundleOutputError>
}

public struct DescribeBundleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBundleInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let bundleId = input.bundleId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("bundleId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/bundles/\(bundleId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ExportBundleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportBundleInputURLHostMiddleware"
    ...
    public typealias MInput = ExportBundleInput
    public typealias MOutput = ClientRuntime.OperationOutput<ExportBundleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportBundleOutputError>
}

public struct ExportBundleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportBundleInputURLPathMiddleware"
...
public struct ExportProjectInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportProjectInputURLHostMiddleware"
    ...
    public typealias MInput = ExportProjectInput
    public typealias MOutput = ClientRuntime.OperationOutput<ExportProjectOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ExportProjectOutputError>
}

public struct ExportProjectInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ExportProjectInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/exports/\(projectId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListBundlesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBundlesInputURLHostMiddleware"
    ...
    public typealias MInput = ListBundlesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListBundlesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListBundlesOutputError>
}

public struct ListBundlesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBundlesInputURLPathMiddleware"
