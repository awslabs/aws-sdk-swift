...
public protocol HoneycodeClientProtocol {
    ...
    ///         </p>
    func batchCreateTableRows(input: BatchCreateTableRowsInput, completion: @escaping (SdkResult<BatchCreateTableRowsOutput, BatchCreateTableRowsOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func batchDeleteTableRows(input: BatchDeleteTableRowsInput, completion: @escaping (SdkResult<BatchDeleteTableRowsOutput, BatchDeleteTableRowsOutputError>) -> Void)
    /// <p>
    ...
    ///             ("").
    ///         </p>
    func batchUpdateTableRows(input: BatchUpdateTableRowsInput, completion: @escaping (SdkResult<BatchUpdateTableRowsOutput, BatchUpdateTableRowsOutputError>) -> Void)
    /// <p>
    ...
    ///             as an empty string ("").
    ///         </p>
    func batchUpsertTableRows(input: BatchUpsertTableRowsInput, completion: @escaping (SdkResult<BatchUpsertTableRowsOutput, BatchUpsertTableRowsOutputError>) -> Void)
    /// <p>
    ///             The DescribeTableDataImportJob API allows you to retrieve the status and details of a table data import job.
    ///         </p>
    func describeTableDataImportJob(input: DescribeTableDataImportJobInput, completion: @escaping (SdkResult<DescribeTableDataImportJobOutput, DescribeTableDataImportJobOutputError>) -> Void)
    /// <p>
    ///             The GetScreenData API allows retrieval of data from a screen in a Honeycode app.
    ///             The API allows setting local variables in the screen to filter, sort or otherwise affect what will be
    ///             displayed on the screen.
    ///         </p>
    func getScreenData(input: GetScreenDataInput, completion: @escaping (SdkResult<GetScreenDataOutput, GetScreenDataOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func invokeScreenAutomation(input: InvokeScreenAutomationInput, completion: @escaping (SdkResult<InvokeScreenAutomationOutput, InvokeScreenAutomationOutputError>) -> Void)
    /// <p>
    ///             The ListTableColumns API allows you to retrieve a list of all the columns in a table in a workbook.
    ///         </p>
    func listTableColumns(input: ListTableColumnsInput, completion: @escaping (SdkResult<ListTableColumnsOutput, ListTableColumnsOutputError>) -> Void)
    /// <p>
    ///             The ListTableRows API allows you to retrieve a list of all the rows in a table in a workbook.
    ///         </p>
    func listTableRows(input: ListTableRowsInput, completion: @escaping (SdkResult<ListTableRowsOutput, ListTableRowsOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func queryTableRows(input: QueryTableRowsInput, completion: @escaping (SdkResult<QueryTableRowsOutput, QueryTableRowsOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func startTableDataImportJob(input: StartTableDataImportJobInput, completion: @escaping (SdkResult<StartTableDataImportJobOutput, StartTableDataImportJobOutputError>) -> Void)
}
