...
/// Your request has the same name as another active human loop but has different input data. You cannot start two
///     human loops with the same name and different input data.
...
public struct DeleteHumanLoopInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteHumanLoopInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteHumanLoopInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteHumanLoopOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteHumanLoopOutputError>
}

public struct DeleteHumanLoopInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteHumanLoopInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let humanLoopName = input.humanLoopName else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("humanLoopName is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/human-loops/\(humanLoopName.urlPercentEncoding())"
...
public struct DescribeHumanLoopInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeHumanLoopInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeHumanLoopInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeHumanLoopOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeHumanLoopOutputError>
}

public struct DescribeHumanLoopInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeHumanLoopInputURLPathMiddleware"
...
public struct ListHumanLoopsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListHumanLoopsInputURLHostMiddleware"
    ...
    public typealias MInput = ListHumanLoopsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListHumanLoopsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListHumanLoopsOutputError>
}

public struct ListHumanLoopsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListHumanLoopsInputURLPathMiddleware"
...
/// We couldn't find the requested resource. Check that your resources exists and were created
///       in the same AWS Region as your request, and try your request again.
...
///       Amazon A2I service quotes, see <a href="https://docs.aws.amazon.com/general/latest/gr/a2i.html">Amazon Augmented AI Service Quotes. Delete some resources or request an increase in your
///       service quota. You can request a quota increase using Service Quotas or the AWS Support
///       Center. To request an increase, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html">AWS Service Quotas in the
...
public struct StartHumanLoopInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartHumanLoopInputURLHostMiddleware"
    ...
    public typealias MInput = StartHumanLoopInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartHumanLoopOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartHumanLoopOutputError>
}

public struct StartHumanLoopInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartHumanLoopInputURLPathMiddleware"
...
public struct StopHumanLoopInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopHumanLoopInputURLHostMiddleware"
    ...
    public typealias MInput = StopHumanLoopInput
    public typealias MOutput = ClientRuntime.OperationOutput<StopHumanLoopOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopHumanLoopOutputError>
}

public struct StopHumanLoopInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopHumanLoopInputURLPathMiddleware"
...
/// The
///       request isn't valid. Check the syntax and try again.
