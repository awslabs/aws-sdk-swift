...
public protocol SecretsManagerClientProtocol {
    ...
    func removeRegionsFromReplication(input: RemoveRegionsFromReplicationInput, completion: @escaping (SdkResult<RemoveRegionsFromReplicationOutput, RemoveRegionsFromReplicationOutputError>) -> Void)
    /// <p>Converts an existing secret to a multi-Region secret and begins replication the secret to a
    ///       list of new regions. </p>
    func replicateSecretToRegions(input: ReplicateSecretToRegionsInput, completion: @escaping (SdkResult<ReplicateSecretToRegionsOutput, ReplicateSecretToRegionsOutputError>) -> Void)
    ...
    func stopReplicationToReplica(input: StopReplicationToReplicaInput, completion: @escaping (SdkResult<StopReplicationToReplicaOutput, StopReplicationToReplicaOutputError>) -> Void)
