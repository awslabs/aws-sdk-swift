...
public class SecretsManagerClient {
    ...
    public convenience init(region: Swift.String? = nil) throws {
        ...
        let config = try SecretsManagerClientConfiguration(region: unwrappedRegion)
...
extension SecretsManagerClient: SecretsManagerClientProtocol {
    ...
    public func createSecret(input: CreateSecretInput, completion: @escaping (ClientRuntime.SdkResult<CreateSecretOutputResponse, CreateSecretOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<CreateSecretOutputResponse>, ClientRuntime.SdkError<CreateSecretOutputError>> in
    ...
    public func putSecretValue(input: PutSecretValueInput, completion: @escaping (ClientRuntime.SdkResult<PutSecretValueOutputResponse, PutSecretValueOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<PutSecretValueOutputResponse>, ClientRuntime.SdkError<PutSecretValueOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
    ...
    public func rotateSecret(input: RotateSecretInput, completion: @escaping (ClientRuntime.SdkResult<RotateSecretOutputResponse, RotateSecretOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<RotateSecretOutputResponse>, ClientRuntime.SdkError<RotateSecretOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
    ...
    public func updateSecret(input: UpdateSecretInput, completion: @escaping (ClientRuntime.SdkResult<UpdateSecretOutputResponse, UpdateSecretOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Swift.Result<ClientRuntime.OperationOutput<UpdateSecretOutputResponse>, ClientRuntime.SdkError<UpdateSecretOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
