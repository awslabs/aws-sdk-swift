...
extension SecretsManagerClient: SecretsManagerClientProtocol {
    ...
    public func createSecret(input: CreateSecretInput, completion: @escaping (SdkResult<CreateSecretOutput, CreateSecretOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateSecretOutput>, SdkError<CreateSecretOutputError>> in
    ...
    public func putSecretValue(input: PutSecretValueInput, completion: @escaping (SdkResult<PutSecretValueOutput, PutSecretValueOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<PutSecretValueOutput>, SdkError<PutSecretValueOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
    ...
    public func removeRegionsFromReplication(input: RemoveRegionsFromReplicationInput, completion: @escaping (SdkResult<RemoveRegionsFromReplicationOutput, RemoveRegionsFromReplicationOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RemoveRegionsFromReplicationInput, RemoveRegionsFromReplicationOutput, RemoveRegionsFromReplicationOutputError>(id: "removeRegionsFromReplication")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RemoveRegionsFromReplicationInput, RemoveRegionsFromReplicationOutput, RemoveRegionsFromReplicationOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RemoveRegionsFromReplicationInput, RemoveRegionsFromReplicationOutput, RemoveRegionsFromReplicationOutputError>(xAmzTarget: "secretsmanager.RemoveRegionsFromReplication"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func replicateSecretToRegions(input: ReplicateSecretToRegionsInput, completion: @escaping (SdkResult<ReplicateSecretToRegionsOutput, ReplicateSecretToRegionsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ReplicateSecretToRegionsInput, ReplicateSecretToRegionsOutput, ReplicateSecretToRegionsOutputError>(id: "replicateSecretToRegions")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ReplicateSecretToRegionsInput, ReplicateSecretToRegionsOutput, ReplicateSecretToRegionsOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ReplicateSecretToRegionsInput, ReplicateSecretToRegionsOutput, ReplicateSecretToRegionsOutputError>(xAmzTarget: "secretsmanager.ReplicateSecretToRegions"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func rotateSecret(input: RotateSecretInput, completion: @escaping (SdkResult<RotateSecretOutput, RotateSecretOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<RotateSecretOutput>, SdkError<RotateSecretOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
    ...
    public func stopReplicationToReplica(input: StopReplicationToReplicaInput, completion: @escaping (SdkResult<StopReplicationToReplicaOutput, StopReplicationToReplicaOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StopReplicationToReplicaInput, StopReplicationToReplicaOutput, StopReplicationToReplicaOutputError>(id: "stopReplicationToReplica")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StopReplicationToReplicaInput, StopReplicationToReplicaOutput, StopReplicationToReplicaOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<StopReplicationToReplicaInput, StopReplicationToReplicaOutput, StopReplicationToReplicaOutputError>(xAmzTarget: "secretsmanager.StopReplicationToReplica"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func updateSecret(input: UpdateSecretInput, completion: @escaping (SdkResult<UpdateSecretOutput, UpdateSecretOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateSecretOutput>, SdkError<UpdateSecretOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
