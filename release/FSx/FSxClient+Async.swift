...
public extension FSxClient {
    ...
    {
        typealias associateFileSystemAliasesContinuation = CheckedContinuation<AssociateFileSystemAliasesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: associateFileSystemAliasesContinuation) in
            associateFileSystemAliases(input: input) { result in
                switch result {
    ...
    {
        typealias cancelDataRepositoryTaskContinuation = CheckedContinuation<CancelDataRepositoryTaskOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: cancelDataRepositoryTaskContinuation) in
            cancelDataRepositoryTask(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias copyBackupContinuation = CheckedContinuation<CopyBackupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: copyBackupContinuation) in
            copyBackup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createDataRepositoryTaskContinuation = CheckedContinuation<CreateDataRepositoryTaskOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createDataRepositoryTaskContinuation) in
            createDataRepositoryTask(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createFileSystemFromBackupContinuation = CheckedContinuation<CreateFileSystemFromBackupOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createFileSystemFromBackupContinuation) in
            createFileSystemFromBackup(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeDataRepositoryTasksContinuation = CheckedContinuation<DescribeDataRepositoryTasksOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeDataRepositoryTasksContinuation) in
            describeDataRepositoryTasks(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeFileSystemAliasesContinuation = CheckedContinuation<DescribeFileSystemAliasesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFileSystemAliasesContinuation) in
            describeFileSystemAliases(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias disassociateFileSystemAliasesContinuation = CheckedContinuation<DisassociateFileSystemAliasesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: disassociateFileSystemAliasesContinuation) in
            disassociateFileSystemAliases(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
