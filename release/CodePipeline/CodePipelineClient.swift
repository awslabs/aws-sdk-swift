...
public class CodePipelineClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CodePipelineClientConfiguration(region: unwrappedRegion)
    ...
    public class CodePipelineClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CodePipelineClient")
