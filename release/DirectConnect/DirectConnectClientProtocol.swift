...
public protocol DirectConnectClientProtocol {
    ...
    func acceptDirectConnectGatewayAssociationProposal(input: AcceptDirectConnectGatewayAssociationProposalInput, completion: @escaping (SdkResult<AcceptDirectConnectGatewayAssociationProposalOutput, AcceptDirectConnectGatewayAssociationProposalOutputError>) -> Void)
    ...
    func allocateConnectionOnInterconnect(input: AllocateConnectionOnInterconnectInput, completion: @escaping (SdkResult<AllocateConnectionOnInterconnectOutput, AllocateConnectionOnInterconnectOutputError>) -> Void)
    ...
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func allocateHostedConnection(input: AllocateHostedConnectionInput, completion: @escaping (SdkResult<AllocateHostedConnectionOutput, AllocateHostedConnectionOutputError>) -> Void)
    ...
    func allocatePrivateVirtualInterface(input: AllocatePrivateVirtualInterfaceInput, completion: @escaping (SdkResult<AllocatePrivateVirtualInterfaceOutput, AllocatePrivateVirtualInterfaceOutputError>) -> Void)
    ...
    func allocatePublicVirtualInterface(input: AllocatePublicVirtualInterfaceInput, completion: @escaping (SdkResult<AllocatePublicVirtualInterfaceOutput, AllocatePublicVirtualInterfaceOutputError>) -> Void)
    ...
    func allocateTransitVirtualInterface(input: AllocateTransitVirtualInterfaceInput, completion: @escaping (SdkResult<AllocateTransitVirtualInterfaceOutput, AllocateTransitVirtualInterfaceOutputError>) -> Void)
    ...
    func associateConnectionWithLag(input: AssociateConnectionWithLagInput, completion: @escaping (SdkResult<AssociateConnectionWithLagOutput, AssociateConnectionWithLagOutputError>) -> Void)
    ...
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func associateHostedConnection(input: AssociateHostedConnectionInput, completion: @escaping (SdkResult<AssociateHostedConnectionOutput, AssociateHostedConnectionOutputError>) -> Void)
    ...
    func associateMacSecKey(input: AssociateMacSecKeyInput, completion: @escaping (SdkResult<AssociateMacSecKeyOutput, AssociateMacSecKeyOutputError>) -> Void)
    ...
    func associateVirtualInterface(input: AssociateVirtualInterfaceInput, completion: @escaping (SdkResult<AssociateVirtualInterfaceOutput, AssociateVirtualInterfaceOutputError>) -> Void)
    ...
    func confirmConnection(input: ConfirmConnectionInput, completion: @escaping (SdkResult<ConfirmConnectionOutput, ConfirmConnectionOutputError>) -> Void)
    ...
    func confirmPrivateVirtualInterface(input: ConfirmPrivateVirtualInterfaceInput, completion: @escaping (SdkResult<ConfirmPrivateVirtualInterfaceOutput, ConfirmPrivateVirtualInterfaceOutputError>) -> Void)
    ...
    func confirmPublicVirtualInterface(input: ConfirmPublicVirtualInterfaceInput, completion: @escaping (SdkResult<ConfirmPublicVirtualInterfaceOutput, ConfirmPublicVirtualInterfaceOutputError>) -> Void)
    ...
    func confirmTransitVirtualInterface(input: ConfirmTransitVirtualInterfaceInput, completion: @escaping (SdkResult<ConfirmTransitVirtualInterfaceOutput, ConfirmTransitVirtualInterfaceOutputError>) -> Void)
    ...
    func createBGPPeer(input: CreateBGPPeerInput, completion: @escaping (SdkResult<CreateBGPPeerOutput, CreateBGPPeerOutputError>) -> Void)
    ...
    func createDirectConnectGateway(input: CreateDirectConnectGatewayInput, completion: @escaping (SdkResult<CreateDirectConnectGatewayOutput, CreateDirectConnectGatewayOutputError>) -> Void)
    ...
    func createDirectConnectGatewayAssociation(input: CreateDirectConnectGatewayAssociationInput, completion: @escaping (SdkResult<CreateDirectConnectGatewayAssociationOutput, CreateDirectConnectGatewayAssociationOutputError>) -> Void)
    ...
    func createDirectConnectGatewayAssociationProposal(input: CreateDirectConnectGatewayAssociationProposalInput, completion: @escaping (SdkResult<CreateDirectConnectGatewayAssociationProposalOutput, CreateDirectConnectGatewayAssociationProposalOutputError>) -> Void)
    ...
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func createInterconnect(input: CreateInterconnectInput, completion: @escaping (SdkResult<CreateInterconnectOutput, CreateInterconnectOutputError>) -> Void)
    ...
    func createLag(input: CreateLagInput, completion: @escaping (SdkResult<CreateLagOutput, CreateLagOutputError>) -> Void)
    ...
    func createPrivateVirtualInterface(input: CreatePrivateVirtualInterfaceInput, completion: @escaping (SdkResult<CreatePrivateVirtualInterfaceOutput, CreatePrivateVirtualInterfaceOutputError>) -> Void)
    ...
    func createPublicVirtualInterface(input: CreatePublicVirtualInterfaceInput, completion: @escaping (SdkResult<CreatePublicVirtualInterfaceOutput, CreatePublicVirtualInterfaceOutputError>) -> Void)
    ...
    ///       frames, call <a>DescribeConnections</a>. To check whether your virtual
    ///       interface supports jumbo frames, call <a>DescribeVirtualInterfaces</a>.</p>
    func createTransitVirtualInterface(input: CreateTransitVirtualInterfaceInput, completion: @escaping (SdkResult<CreateTransitVirtualInterfaceOutput, CreateTransitVirtualInterfaceOutputError>) -> Void)
    ...
    func deleteBGPPeer(input: DeleteBGPPeerInput, completion: @escaping (SdkResult<DeleteBGPPeerOutput, DeleteBGPPeerOutputError>) -> Void)
    ...
    func deleteDirectConnectGateway(input: DeleteDirectConnectGatewayInput, completion: @escaping (SdkResult<DeleteDirectConnectGatewayOutput, DeleteDirectConnectGatewayOutputError>) -> Void)
    ...
    func deleteDirectConnectGatewayAssociation(input: DeleteDirectConnectGatewayAssociationInput, completion: @escaping (SdkResult<DeleteDirectConnectGatewayAssociationOutput, DeleteDirectConnectGatewayAssociationOutputError>) -> Void)
    ...
    func deleteDirectConnectGatewayAssociationProposal(input: DeleteDirectConnectGatewayAssociationProposalInput, completion: @escaping (SdkResult<DeleteDirectConnectGatewayAssociationProposalOutput, DeleteDirectConnectGatewayAssociationProposalOutputError>) -> Void)
    /// <p>Deletes the specified interconnect.</p>
    ///          <note>
    ///             <p>Intended for use
    ///         by AWS Direct Connect Partners only.</p>
    ///          </note>
    func deleteInterconnect(input: DeleteInterconnectInput, completion: @escaping (SdkResult<DeleteInterconnectOutput, DeleteInterconnectOutputError>) -> Void)
    ...
    func deleteLag(input: DeleteLagInput, completion: @escaping (SdkResult<DeleteLagOutput, DeleteLagOutputError>) -> Void)
    /// <p>Deletes a virtual interface.</p>
    func deleteVirtualInterface(input: DeleteVirtualInterfaceInput, completion: @escaping (SdkResult<DeleteVirtualInterfaceOutput, DeleteVirtualInterfaceOutputError>) -> Void)
    ...
    @available(*, deprecated)
    func describeConnectionLoa(input: DescribeConnectionLoaInput, completion: @escaping (SdkResult<DescribeConnectionLoaOutput, DescribeConnectionLoaOutputError>) -> Void)
    ...
    ///          </note>
    @available(*, deprecated)
    func describeConnectionsOnInterconnect(input: DescribeConnectionsOnInterconnectInput, completion: @escaping (SdkResult<DescribeConnectionsOnInterconnectOutput, DescribeConnectionsOnInterconnectOutputError>) -> Void)
    ...
    func describeDirectConnectGatewayAssociationProposals(input: DescribeDirectConnectGatewayAssociationProposalsInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewayAssociationProposalsOutput, DescribeDirectConnectGatewayAssociationProposalsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeDirectConnectGatewayAssociations(input: DescribeDirectConnectGatewayAssociationsInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewayAssociationsOutput, DescribeDirectConnectGatewayAssociationsOutputError>) -> Void)
    ...
    func describeDirectConnectGatewayAttachments(input: DescribeDirectConnectGatewayAttachmentsInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewayAttachmentsOutput, DescribeDirectConnectGatewayAttachmentsOutputError>) -> Void)
    ...
    func describeDirectConnectGateways(input: DescribeDirectConnectGatewaysInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewaysOutput, DescribeDirectConnectGatewaysOutputError>) -> Void)
    /// <p>Lists the hosted connections that have been provisioned on the specified
    ///       interconnect or link aggregation group (LAG).</p>
    ///          <note>
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func describeHostedConnections(input: DescribeHostedConnectionsInput, completion: @escaping (SdkResult<DescribeHostedConnectionsOutput, DescribeHostedConnectionsOutputError>) -> Void)
    /// <p>Deprecated. Use <a>DescribeLoa</a> instead.</p>
    ...
    @available(*, deprecated)
    func describeInterconnectLoa(input: DescribeInterconnectLoaInput, completion: @escaping (SdkResult<DescribeInterconnectLoaOutput, DescribeInterconnectLoaOutputError>) -> Void)
    /// <p>Lists the interconnects owned by the AWS account or only the specified interconnect.</p>
    func describeInterconnects(input: DescribeInterconnectsInput, completion: @escaping (SdkResult<DescribeInterconnectsOutput, DescribeInterconnectsOutputError>) -> Void)
    /// <p>Describes all your link aggregation groups (LAG) or the specified LAG.</p>
    func describeLags(input: DescribeLagsInput, completion: @escaping (SdkResult<DescribeLagsOutput, DescribeLagsOutputError>) -> Void)
    ...
    ///       in the <i>AWS Direct Connect User Guide</i>.</p>
    func describeLoa(input: DescribeLoaInput, completion: @escaping (SdkResult<DescribeLoaOutput, DescribeLoaOutputError>) -> Void)
    ...
    func describeLocations(input: DescribeLocationsInput, completion: @escaping (SdkResult<DescribeLocationsOutput, DescribeLocationsOutputError>) -> Void)
    ...
    func describeVirtualGateways(input: DescribeVirtualGatewaysInput, completion: @escaping (SdkResult<DescribeVirtualGatewaysOutput, DescribeVirtualGatewaysOutputError>) -> Void)
    ...
    func describeVirtualInterfaces(input: DescribeVirtualInterfacesInput, completion: @escaping (SdkResult<DescribeVirtualInterfacesOutput, DescribeVirtualInterfacesOutputError>) -> Void)
    ...
    func disassociateConnectionFromLag(input: DisassociateConnectionFromLagInput, completion: @escaping (SdkResult<DisassociateConnectionFromLagOutput, DisassociateConnectionFromLagOutputError>) -> Void)
    /// <p>Removes the association between a MAC Security (MACsec) security key and an AWS Direct Connect dedicated connection.</p>
    func disassociateMacSecKey(input: DisassociateMacSecKeyInput, completion: @escaping (SdkResult<DisassociateMacSecKeyOutput, DisassociateMacSecKeyOutputError>) -> Void)
    /// <p>Lists the virtual interface failover test history.</p>
    func listVirtualInterfaceTestHistory(input: ListVirtualInterfaceTestHistoryInput, completion: @escaping (SdkResult<ListVirtualInterfaceTestHistoryOutput, ListVirtualInterfaceTestHistoryOutputError>) -> Void)
    ...
    func startBgpFailoverTest(input: StartBgpFailoverTestInput, completion: @escaping (SdkResult<StartBgpFailoverTestOutput, StartBgpFailoverTestOutputError>) -> Void)
    /// <p>Stops the virtual interface failover test.</p>
    func stopBgpFailoverTest(input: StopBgpFailoverTestInput, completion: @escaping (SdkResult<StopBgpFailoverTestOutput, StopBgpFailoverTestOutputError>) -> Void)
    ...
    func updateDirectConnectGatewayAssociation(input: UpdateDirectConnectGatewayAssociationInput, completion: @escaping (SdkResult<UpdateDirectConnectGatewayAssociationOutput, UpdateDirectConnectGatewayAssociationOutputError>) -> Void)
    ...
    ///       non-operational.</p>
    ///          </note>
    func updateLag(input: UpdateLagInput, completion: @escaping (SdkResult<UpdateLagOutput, UpdateLagOutputError>) -> Void)
    ...
    ///       interface supports jumbo frames, call <a>DescribeVirtualInterfaces</a>.</p>
    func updateVirtualInterfaceAttributes(input: UpdateVirtualInterfaceAttributesInput, completion: @escaping (SdkResult<UpdateVirtualInterfaceAttributesOutput, UpdateVirtualInterfaceAttributesOutputError>) -> Void)
}
