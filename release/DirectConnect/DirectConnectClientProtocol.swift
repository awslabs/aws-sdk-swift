...
public protocol DirectConnectClientProtocol {
    ...
    func acceptDirectConnectGatewayAssociationProposal(input: AcceptDirectConnectGatewayAssociationProposalInput, completion: @escaping (SdkResult<AcceptDirectConnectGatewayAssociationProposalOutputResponse, AcceptDirectConnectGatewayAssociationProposalOutputError>) -> Void)
    ...
    func allocateConnectionOnInterconnect(input: AllocateConnectionOnInterconnectInput, completion: @escaping (SdkResult<AllocateConnectionOnInterconnectOutputResponse, AllocateConnectionOnInterconnectOutputError>) -> Void)
    ...
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func allocateHostedConnection(input: AllocateHostedConnectionInput, completion: @escaping (SdkResult<AllocateHostedConnectionOutputResponse, AllocateHostedConnectionOutputError>) -> Void)
    ...
    func allocatePrivateVirtualInterface(input: AllocatePrivateVirtualInterfaceInput, completion: @escaping (SdkResult<AllocatePrivateVirtualInterfaceOutputResponse, AllocatePrivateVirtualInterfaceOutputError>) -> Void)
    ...
    func allocatePublicVirtualInterface(input: AllocatePublicVirtualInterfaceInput, completion: @escaping (SdkResult<AllocatePublicVirtualInterfaceOutputResponse, AllocatePublicVirtualInterfaceOutputError>) -> Void)
    ...
    func allocateTransitVirtualInterface(input: AllocateTransitVirtualInterfaceInput, completion: @escaping (SdkResult<AllocateTransitVirtualInterfaceOutputResponse, AllocateTransitVirtualInterfaceOutputError>) -> Void)
    ...
    func associateConnectionWithLag(input: AssociateConnectionWithLagInput, completion: @escaping (SdkResult<AssociateConnectionWithLagOutputResponse, AssociateConnectionWithLagOutputError>) -> Void)
    ...
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func associateHostedConnection(input: AssociateHostedConnectionInput, completion: @escaping (SdkResult<AssociateHostedConnectionOutputResponse, AssociateHostedConnectionOutputError>) -> Void)
    ...
    func associateMacSecKey(input: AssociateMacSecKeyInput, completion: @escaping (SdkResult<AssociateMacSecKeyOutputResponse, AssociateMacSecKeyOutputError>) -> Void)
    ...
    func associateVirtualInterface(input: AssociateVirtualInterfaceInput, completion: @escaping (SdkResult<AssociateVirtualInterfaceOutputResponse, AssociateVirtualInterfaceOutputError>) -> Void)
    ...
    func confirmConnection(input: ConfirmConnectionInput, completion: @escaping (SdkResult<ConfirmConnectionOutputResponse, ConfirmConnectionOutputError>) -> Void)
    ...
    func confirmPrivateVirtualInterface(input: ConfirmPrivateVirtualInterfaceInput, completion: @escaping (SdkResult<ConfirmPrivateVirtualInterfaceOutputResponse, ConfirmPrivateVirtualInterfaceOutputError>) -> Void)
    ...
    func confirmPublicVirtualInterface(input: ConfirmPublicVirtualInterfaceInput, completion: @escaping (SdkResult<ConfirmPublicVirtualInterfaceOutputResponse, ConfirmPublicVirtualInterfaceOutputError>) -> Void)
    ...
    func confirmTransitVirtualInterface(input: ConfirmTransitVirtualInterfaceInput, completion: @escaping (SdkResult<ConfirmTransitVirtualInterfaceOutputResponse, ConfirmTransitVirtualInterfaceOutputError>) -> Void)
    ...
    func createBGPPeer(input: CreateBGPPeerInput, completion: @escaping (SdkResult<CreateBGPPeerOutputResponse, CreateBGPPeerOutputError>) -> Void)
    ...
    func createDirectConnectGateway(input: CreateDirectConnectGatewayInput, completion: @escaping (SdkResult<CreateDirectConnectGatewayOutputResponse, CreateDirectConnectGatewayOutputError>) -> Void)
    ...
    func createDirectConnectGatewayAssociation(input: CreateDirectConnectGatewayAssociationInput, completion: @escaping (SdkResult<CreateDirectConnectGatewayAssociationOutputResponse, CreateDirectConnectGatewayAssociationOutputError>) -> Void)
    ...
    func createDirectConnectGatewayAssociationProposal(input: CreateDirectConnectGatewayAssociationProposalInput, completion: @escaping (SdkResult<CreateDirectConnectGatewayAssociationProposalOutputResponse, CreateDirectConnectGatewayAssociationProposalOutputError>) -> Void)
    ...
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func createInterconnect(input: CreateInterconnectInput, completion: @escaping (SdkResult<CreateInterconnectOutputResponse, CreateInterconnectOutputError>) -> Void)
    ...
    func createLag(input: CreateLagInput, completion: @escaping (SdkResult<CreateLagOutputResponse, CreateLagOutputError>) -> Void)
    ...
    func createPrivateVirtualInterface(input: CreatePrivateVirtualInterfaceInput, completion: @escaping (SdkResult<CreatePrivateVirtualInterfaceOutputResponse, CreatePrivateVirtualInterfaceOutputError>) -> Void)
    ...
    func createPublicVirtualInterface(input: CreatePublicVirtualInterfaceInput, completion: @escaping (SdkResult<CreatePublicVirtualInterfaceOutputResponse, CreatePublicVirtualInterfaceOutputError>) -> Void)
    ...
    ///       frames, call <a>DescribeConnections</a>. To check whether your virtual
    ///       interface supports jumbo frames, call <a>DescribeVirtualInterfaces</a>.</p>
    func createTransitVirtualInterface(input: CreateTransitVirtualInterfaceInput, completion: @escaping (SdkResult<CreateTransitVirtualInterfaceOutputResponse, CreateTransitVirtualInterfaceOutputError>) -> Void)
    ...
    func deleteBGPPeer(input: DeleteBGPPeerInput, completion: @escaping (SdkResult<DeleteBGPPeerOutputResponse, DeleteBGPPeerOutputError>) -> Void)
    ...
    func deleteDirectConnectGateway(input: DeleteDirectConnectGatewayInput, completion: @escaping (SdkResult<DeleteDirectConnectGatewayOutputResponse, DeleteDirectConnectGatewayOutputError>) -> Void)
    ...
    func deleteDirectConnectGatewayAssociation(input: DeleteDirectConnectGatewayAssociationInput, completion: @escaping (SdkResult<DeleteDirectConnectGatewayAssociationOutputResponse, DeleteDirectConnectGatewayAssociationOutputError>) -> Void)
    ...
    func deleteDirectConnectGatewayAssociationProposal(input: DeleteDirectConnectGatewayAssociationProposalInput, completion: @escaping (SdkResult<DeleteDirectConnectGatewayAssociationProposalOutputResponse, DeleteDirectConnectGatewayAssociationProposalOutputError>) -> Void)
    /// <p>Deletes the specified interconnect.</p>
    ///          <note>
    ///             <p>Intended for use
    ///         by AWS Direct Connect Partners only.</p>
    ///          </note>
    func deleteInterconnect(input: DeleteInterconnectInput, completion: @escaping (SdkResult<DeleteInterconnectOutputResponse, DeleteInterconnectOutputError>) -> Void)
    ...
    func deleteLag(input: DeleteLagInput, completion: @escaping (SdkResult<DeleteLagOutputResponse, DeleteLagOutputError>) -> Void)
    /// <p>Deletes a virtual interface.</p>
    func deleteVirtualInterface(input: DeleteVirtualInterfaceInput, completion: @escaping (SdkResult<DeleteVirtualInterfaceOutputResponse, DeleteVirtualInterfaceOutputError>) -> Void)
    ...
    @available(*, deprecated)
    func describeConnectionLoa(input: DescribeConnectionLoaInput, completion: @escaping (SdkResult<DescribeConnectionLoaOutputResponse, DescribeConnectionLoaOutputError>) -> Void)
    ...
    ///          </note>
    @available(*, deprecated)
    func describeConnectionsOnInterconnect(input: DescribeConnectionsOnInterconnectInput, completion: @escaping (SdkResult<DescribeConnectionsOnInterconnectOutputResponse, DescribeConnectionsOnInterconnectOutputError>) -> Void)
    ...
    func describeDirectConnectGatewayAssociationProposals(input: DescribeDirectConnectGatewayAssociationProposalsInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewayAssociationProposalsOutputResponse, DescribeDirectConnectGatewayAssociationProposalsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeDirectConnectGatewayAssociations(input: DescribeDirectConnectGatewayAssociationsInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewayAssociationsOutputResponse, DescribeDirectConnectGatewayAssociationsOutputError>) -> Void)
    ...
    func describeDirectConnectGatewayAttachments(input: DescribeDirectConnectGatewayAttachmentsInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewayAttachmentsOutputResponse, DescribeDirectConnectGatewayAttachmentsOutputError>) -> Void)
    ...
    func describeDirectConnectGateways(input: DescribeDirectConnectGatewaysInput, completion: @escaping (SdkResult<DescribeDirectConnectGatewaysOutputResponse, DescribeDirectConnectGatewaysOutputError>) -> Void)
    /// <p>Lists the hosted connections that have been provisioned on the specified
    ///       interconnect or link aggregation group (LAG).</p>
    ///          <note>
    ///             <p>Intended for use by AWS Direct Connect Partners only.</p>
    ///          </note>
    func describeHostedConnections(input: DescribeHostedConnectionsInput, completion: @escaping (SdkResult<DescribeHostedConnectionsOutputResponse, DescribeHostedConnectionsOutputError>) -> Void)
    /// <p>Deprecated. Use <a>DescribeLoa</a> instead.</p>
    ...
    @available(*, deprecated)
    func describeInterconnectLoa(input: DescribeInterconnectLoaInput, completion: @escaping (SdkResult<DescribeInterconnectLoaOutputResponse, DescribeInterconnectLoaOutputError>) -> Void)
    /// <p>Lists the interconnects owned by the AWS account or only the specified interconnect.</p>
    func describeInterconnects(input: DescribeInterconnectsInput, completion: @escaping (SdkResult<DescribeInterconnectsOutputResponse, DescribeInterconnectsOutputError>) -> Void)
    /// <p>Describes all your link aggregation groups (LAG) or the specified LAG.</p>
    func describeLags(input: DescribeLagsInput, completion: @escaping (SdkResult<DescribeLagsOutputResponse, DescribeLagsOutputError>) -> Void)
    ...
    ///       in the <i>AWS Direct Connect User Guide</i>.</p>
    func describeLoa(input: DescribeLoaInput, completion: @escaping (SdkResult<DescribeLoaOutputResponse, DescribeLoaOutputError>) -> Void)
    ...
    func describeLocations(input: DescribeLocationsInput, completion: @escaping (SdkResult<DescribeLocationsOutputResponse, DescribeLocationsOutputError>) -> Void)
    ...
    func describeVirtualGateways(input: DescribeVirtualGatewaysInput, completion: @escaping (SdkResult<DescribeVirtualGatewaysOutputResponse, DescribeVirtualGatewaysOutputError>) -> Void)
    ...
    func describeVirtualInterfaces(input: DescribeVirtualInterfacesInput, completion: @escaping (SdkResult<DescribeVirtualInterfacesOutputResponse, DescribeVirtualInterfacesOutputError>) -> Void)
    ...
    func disassociateConnectionFromLag(input: DisassociateConnectionFromLagInput, completion: @escaping (SdkResult<DisassociateConnectionFromLagOutputResponse, DisassociateConnectionFromLagOutputError>) -> Void)
    /// <p>Removes the association between a MAC Security (MACsec) security key and an AWS Direct Connect dedicated connection.</p>
    func disassociateMacSecKey(input: DisassociateMacSecKeyInput, completion: @escaping (SdkResult<DisassociateMacSecKeyOutputResponse, DisassociateMacSecKeyOutputError>) -> Void)
    /// <p>Lists the virtual interface failover test history.</p>
    func listVirtualInterfaceTestHistory(input: ListVirtualInterfaceTestHistoryInput, completion: @escaping (SdkResult<ListVirtualInterfaceTestHistoryOutputResponse, ListVirtualInterfaceTestHistoryOutputError>) -> Void)
    ...
    func startBgpFailoverTest(input: StartBgpFailoverTestInput, completion: @escaping (SdkResult<StartBgpFailoverTestOutputResponse, StartBgpFailoverTestOutputError>) -> Void)
    /// <p>Stops the virtual interface failover test.</p>
    func stopBgpFailoverTest(input: StopBgpFailoverTestInput, completion: @escaping (SdkResult<StopBgpFailoverTestOutputResponse, StopBgpFailoverTestOutputError>) -> Void)
    ...
    func updateDirectConnectGatewayAssociation(input: UpdateDirectConnectGatewayAssociationInput, completion: @escaping (SdkResult<UpdateDirectConnectGatewayAssociationOutputResponse, UpdateDirectConnectGatewayAssociationOutputError>) -> Void)
    ...
    ///       non-operational.</p>
    ///          </note>
    func updateLag(input: UpdateLagInput, completion: @escaping (SdkResult<UpdateLagOutputResponse, UpdateLagOutputError>) -> Void)
    ...
    ///       interface supports jumbo frames, call <a>DescribeVirtualInterfaces</a>.</p>
    func updateVirtualInterfaceAttributes(input: UpdateVirtualInterfaceAttributesInput, completion: @escaping (SdkResult<UpdateVirtualInterfaceAttributesOutputResponse, UpdateVirtualInterfaceAttributesOutputError>) -> Void)
}
