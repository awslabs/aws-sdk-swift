...
extension EcrPublicClientTypes {
    ...
    public struct AuthorizationData: Swift.Equatable {
        ...
        var authorizationToken: Swift.String?
...
public struct BatchCheckLayerAvailabilityInput: Swift.Equatable {
    ...
    var registryId: Swift.String?
    /// The name of the repository that is associated with the image layers to check.
    /// This member is required.
    var repositoryName: Swift.String?
...
public struct BatchCheckLayerAvailabilityOutputResponse: Swift.Equatable {
    ...
    var failures: [EcrPublicClientTypes.LayerFailure]?
    /// A list of image layer objects corresponding to the image layer references in the request.
    var layers: [EcrPublicClientTypes.Layer]?
...
public struct BatchDeleteImageInput: Swift.Equatable {
    ...
    /// This member is required.
    var imageIds: [EcrPublicClientTypes.ImageIdentifier]?
...
public struct BatchDeleteImageOutputResponse: Swift.Equatable {
    /// Any failures associated with the call.
    var failures: [EcrPublicClientTypes.ImageFailure]?
...
public struct CreateRepositoryInput: Swift.Equatable {
    ...
    var catalogData: EcrPublicClientTypes.RepositoryCatalogDataInput?
    ...
    var tags: [EcrPublicClientTypes.Tag]?
...
public struct CreateRepositoryOutputResponse: Swift.Equatable {
    ...
    var catalogData: EcrPublicClientTypes.RepositoryCatalogData?
    /// The repository that was created.
    var repository: EcrPublicClientTypes.Repository?
...
public struct DescribeImageTagsOutputResponse: Swift.Equatable {
    ...
    var imageTagDetails: [EcrPublicClientTypes.ImageTagDetail]?
...
public struct DescribeImagesOutputResponse: Swift.Equatable {
    ...
    var imageDetails: [EcrPublicClientTypes.ImageDetail]?
...
public struct DescribeRegistriesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var registries: [EcrPublicClientTypes.Registry]?
...
public struct DescribeRepositoriesInput: Swift.Equatable {
    ...
    var repositoryNames: [Swift.String]?
...
public struct DescribeRepositoriesOutputResponse: Swift.Equatable {
    ...
    var repositories: [EcrPublicClientTypes.Repository]?
...
public struct GetAuthorizationTokenOutputResponse: Swift.Equatable {
    /// An authorization token data object that corresponds to a public registry.
    var authorizationData: EcrPublicClientTypes.AuthorizationData?
...
public struct GetRegistryCatalogDataOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var registryCatalogData: EcrPublicClientTypes.RegistryCatalogData?
...
extension EcrPublicClientTypes {
    ...
    public struct Image: Swift.Equatable {
        ...
        var imageId: EcrPublicClientTypes.ImageIdentifier?
        /// The image manifest associated with the image.
        var imageManifest: Swift.String?
        /// The manifest media type of the image.
        var imageManifestMediaType: Swift.String?
...
extension EcrPublicClientTypes {
    ...
    public struct ImageDetail: Swift.Equatable {
        ...
        var artifactMediaType: Swift.String?
        /// The sha256 digest of the image manifest.
        var imageDigest: Swift.String?
        /// The media type of the image manifest.
        var imageManifestMediaType: Swift.String?
        /// The date and time, expressed in standard JavaScript date format, at which the current image was pushed to the repository.
        var imagePushedAt: ClientRuntime.Date?
        ...
        var imageSizeInBytes: Swift.Int?
        /// The list of tags associated with this image.
        var imageTags: [Swift.String]?
...
extension EcrPublicClientTypes {
    ...
    public struct ImageFailure: Swift.Equatable {
        ...
        var failureCode: EcrPublicClientTypes.ImageFailureCode?
...
extension EcrPublicClientTypes {
    ...
    public struct ImageTagDetail: Swift.Equatable {
        ...
        var imageDetail: EcrPublicClientTypes.ReferencedImageDetail?
...
extension EcrPublicClientTypes {
    ...
    public struct Layer: Swift.Equatable {
        ...
        var layerAvailability: EcrPublicClientTypes.LayerAvailability?
        /// The sha256 digest of the image layer.
        var layerDigest: Swift.String?
        /// The size, in bytes, of the image layer.
        var layerSize: Swift.Int?
...
extension EcrPublicClientTypes {
    ...
    public struct LayerFailure: Swift.Equatable {
        ...
        var failureCode: EcrPublicClientTypes.LayerFailureCode?
        /// The reason for the failure.
        var failureReason: Swift.String?
...
public struct PutImageOutputResponse: Swift.Equatable {
    ...
    var image: EcrPublicClientTypes.Image?
...
extension EcrPublicClientTypes {
    ...
    public struct Registry: Swift.Equatable {
        ...
        /// This member is required.
        var aliases: [EcrPublicClientTypes.RegistryAlias]?
...
extension EcrPublicClientTypes {
    ...
    public struct RegistryAlias: Swift.Equatable {
        ...
        /// This member is required.
        var defaultRegistryAlias: Swift.Bool
        ...
        /// This member is required.
        var primaryRegistryAlias: Swift.Bool
        /// The status of the registry alias.
        /// This member is required.
        var status: EcrPublicClientTypes.RegistryAliasStatus?
...
extension EcrPublicClientTypes {
    ...
    public struct Repository: Swift.Equatable {
        ...
        var repositoryArn: Swift.String?
        /// The name of the repository.
        var repositoryName: Swift.String?
        /// The URI for the repository. You can use this URI for container image push and pull operations.
        var repositoryUri: Swift.String?
...
extension EcrPublicClientTypes {
    ...
    public struct RepositoryCatalogData: Swift.Equatable {
        ...
        var architectures: [Swift.String]?
        /// The short description of the repository.
        var description: Swift.String?
        /// The URL containing the logo associated with the repository.
        var logoUrl: Swift.String?
        /// Whether or not the repository is certified by AWS Marketplace.
        var marketplaceCertified: Swift.Bool?
        ...
        var operatingSystems: [Swift.String]?
        /// The longform usage details of the contents of the repository. The usage text provides context for users of the repository.
        var usageText: Swift.String?
...
extension EcrPublicClientTypes {
    ...
    public struct RepositoryCatalogDataInput: Swift.Equatable {
        ...
        var logoImageBlob: ClientRuntime.Data?
...
public struct UploadLayerPartInput: Swift.Equatable {
    ...
    /// This member is required.
    var layerPartBlob: ClientRuntime.Data?
    /// The position of the first byte of the layer part witin the overall image layer.
    /// This member is required.
    var partFirstByte: Swift.Int?
    /// The position of the last byte of the layer part within the overall image layer.
    /// This member is required.
    var partLastByte: Swift.Int?
...
public struct UploadLayerPartOutputResponse: Swift.Equatable {
    ...
    var lastByteReceived: Swift.Int?
    /// The registry ID associated with the request.
    var registryId: Swift.String?
    /// The repository name associated with the request.
    var repositoryName: Swift.String?
