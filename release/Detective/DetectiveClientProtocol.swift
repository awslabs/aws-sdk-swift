...
public protocol DetectiveClientProtocol {
    ...
    func createGraph(input: CreateGraphInput, completion: @escaping (SdkResult<CreateGraphOutput, CreateGraphOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func createMembers(input: CreateMembersInput, completion: @escaping (SdkResult<CreateMembersOutput, CreateMembersOutputError>) -> Void)
    ...
    ///          graph.</p>
    func deleteGraph(input: DeleteGraphInput, completion: @escaping (SdkResult<DeleteGraphOutput, DeleteGraphOutputError>) -> Void)
    ...
    ///          method.</p>
    func deleteMembers(input: DeleteMembersInput, completion: @escaping (SdkResult<DeleteMembersOutput, DeleteMembersOutputError>) -> Void)
    ...
    func disassociateMembership(input: DisassociateMembershipInput, completion: @escaping (SdkResult<DisassociateMembershipOutput, DisassociateMembershipOutputError>) -> Void)
    /// <p>Returns the membership details for specified member accounts for a behavior
    ///          graph.</p>
    func getMembers(input: GetMembersInput, completion: @escaping (SdkResult<GetMembersOutput, GetMembersOutputError>) -> Void)
    ...
    func listGraphs(input: ListGraphsInput, completion: @escaping (SdkResult<ListGraphsOutput, ListGraphsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func startMonitoringMember(input: StartMonitoringMemberInput, completion: @escaping (SdkResult<StartMonitoringMemberOutput, StartMonitoringMemberOutputError>) -> Void)
