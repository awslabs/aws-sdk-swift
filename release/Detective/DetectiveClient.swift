...
extension DetectiveClient: DetectiveClientProtocol {
    ...
    public func createGraph(input: CreateGraphInput, completion: @escaping (SdkResult<CreateGraphOutput, CreateGraphOutputError>) -> Void)
    {
        let urlPath = "/graph"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "detective")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateGraphInput, CreateGraphOutput, CreateGraphOutputError>(id: "createGraph")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateGraphInput, CreateGraphOutput, CreateGraphOutputError>(contentType: "application/json"))
    ...
    ///          graph.</p>
    public func deleteGraph(input: DeleteGraphInput, completion: @escaping (SdkResult<DeleteGraphOutput, DeleteGraphOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "detective")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteGraphInput, DeleteGraphOutput, DeleteGraphOutputError>(id: "deleteGraph")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteGraphInput, DeleteGraphOutput, DeleteGraphOutputError>(contentType: "application/json"))
    ...
    public func disassociateMembership(input: DisassociateMembershipInput, completion: @escaping (SdkResult<DisassociateMembershipOutput, DisassociateMembershipOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "detective")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisassociateMembershipInput, DisassociateMembershipOutput, DisassociateMembershipOutputError>(id: "disassociateMembership")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisassociateMembershipInput, DisassociateMembershipOutput, DisassociateMembershipOutputError>(contentType: "application/json"))
    ...
    public func listGraphs(input: ListGraphsInput, completion: @escaping (SdkResult<ListGraphsOutput, ListGraphsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "detective")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListGraphsInput, ListGraphsOutput, ListGraphsOutputError>(id: "listGraphs")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListGraphsInput, ListGraphsOutput, ListGraphsOutputError>(contentType: "application/json"))
    ...
    ///             </li>
    ///          </ul>
    public func startMonitoringMember(input: StartMonitoringMemberInput, completion: @escaping (SdkResult<StartMonitoringMemberOutput, StartMonitoringMemberOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "detective")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartMonitoringMemberInput, StartMonitoringMemberOutput, StartMonitoringMemberOutputError>(id: "startMonitoringMember")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartMonitoringMemberInput, StartMonitoringMemberOutput, StartMonitoringMemberOutputError>(contentType: "application/json"))
