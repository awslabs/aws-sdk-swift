...
public class DetectiveClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try DetectiveClientConfiguration(region: unwrappedRegion)
    ...
    public class DetectiveClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("DetectiveClient")
...
public struct DetectiveClientLogHandlerFactory: SDKLogHandlerFactory {
