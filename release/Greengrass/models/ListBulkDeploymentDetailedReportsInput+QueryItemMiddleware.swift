...
public struct ListBulkDeploymentDetailedReportsInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<ListBulkDeploymentDetailedReportsOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListBulkDeploymentDetailedReportsOutput>
