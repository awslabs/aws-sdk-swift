...
public struct ListFunctionDefinitionVersionsInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<ListFunctionDefinitionVersionsOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListFunctionDefinitionVersionsOutput>
