...
extension TranscribeStreamingClient: TranscribeStreamingClientProtocol {
    ...
    public func startMedicalStreamTranscription(input: StartMedicalStreamTranscriptionInput, streamSource: StreamSource, completion: @escaping (SdkResult<StartMedicalStreamTranscriptionOutputResponse, StartMedicalStreamTranscriptionOutputError>) -> Void)
    {
    ...
    ///             </li>
    ///          </ul>
    public func startStreamTranscription(input: StartStreamTranscriptionInput, streamSource: StreamSource, completion: @escaping (SdkResult<StartStreamTranscriptionOutputResponse, StartStreamTranscriptionOutputError>) -> Void)
    {
