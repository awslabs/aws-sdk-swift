...
public protocol TranscribeStreamingClientProtocol {
    ...
    func startMedicalStreamTranscription(input: StartMedicalStreamTranscriptionInput, streamSource: StreamSource, completion: @escaping (SdkResult<StartMedicalStreamTranscriptionOutput, StartMedicalStreamTranscriptionOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func startStreamTranscription(input: StartStreamTranscriptionInput, streamSource: StreamSource, completion: @escaping (SdkResult<StartStreamTranscriptionOutput, StartStreamTranscriptionOutputError>) -> Void)
}
