...
public struct DescribeDimensionKeysInput: Swift.Equatable {
    ...
    /// This member is required.
    var groupBy: PiClientTypes.DimensionGroup?
    ...
    var partitionBy: PiClientTypes.DimensionGroup?
    ...
    /// This member is required.
    var serviceType: PiClientTypes.ServiceType?
...
public struct DescribeDimensionKeysOutputResponse: Swift.Equatable {
    ...
    var alignedEndTime: ClientRuntime.Date?
    /// The start time for the returned dimension keys, after alignment to a granular boundary (as specified by PeriodInSeconds). AlignedStartTime will be less than or equal to the value of the user-specified StartTime.
    var alignedStartTime: ClientRuntime.Date?
    /// The dimension keys that were requested.
    var keys: [PiClientTypes.DimensionKeyDescription]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the token, up to the value specified by MaxRecords.
    var nextToken: Swift.String?
    /// If PartitionBy was present in the request, PartitionKeys contains the breakdown of dimension keys by the specified partitions.
    var partitionKeys: [PiClientTypes.ResponsePartitionKey]?
...
extension PiClientTypes {
    ...
    public struct DimensionKeyDetail: Swift.Equatable {
        ...
        var status: PiClientTypes.DetailStatus?
...
public struct GetDimensionKeyDetailsInput: Swift.Equatable {
    ...
    /// This member is required.
    var groupIdentifier: Swift.String?
    ...
    var requestedDimensions: [Swift.String]?
...
public struct GetDimensionKeyDetailsOutputResponse: Swift.Equatable {
    ...
    var dimensions: [PiClientTypes.DimensionKeyDetail]?
...
public struct GetResourceMetricsInput: Swift.Equatable {
    ...
    /// This member is required.
    var metricQueries: [PiClientTypes.MetricQuery]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the token, up to the value specified by MaxRecords.
    var nextToken: Swift.String?
    /// The granularity, in seconds, of the data points returned from Performance Insights. A period can be as short as one second, or as long as one day (86400 seconds). Valid values are:
    ///
...
public struct GetResourceMetricsOutputResponse: Swift.Equatable {
    ...
    var metricList: [PiClientTypes.MetricKeyDataPoints]?
    /// An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the token, up to the value specified by MaxRecords.
    var nextToken: Swift.String?
...
extension PiClientTypes {
    ...
    public struct MetricKeyDataPoints: Swift.Equatable {
        ...
        var dataPoints: [PiClientTypes.DataPoint]?
        /// The dimension(s) to which the data points apply.
        var key: PiClientTypes.ResponseResourceMetricKey?
