...
public class RdsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try RdsClientConfiguration(region: unwrappedRegion)
    ...
    public class RdsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("RdsClient")
