...
public struct AuthorizeDBSecurityGroupIngressInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<AuthorizeDBSecurityGroupIngressOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AuthorizeDBSecurityGroupIngressOutput>
