...
public struct RevokeDBSecurityGroupIngressInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<RevokeDBSecurityGroupIngressOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<RevokeDBSecurityGroupIngressOutput>
