...
public protocol RdsClientProtocol {
    ...
    ///         </note>
    func addRoleToDBCluster(input: AddRoleToDBClusterInput, completion: @escaping (SdkResult<AddRoleToDBClusterOutputResponse, AddRoleToDBClusterOutputError>) -> Void)
    ...
    ///         </note>
    func addRoleToDBInstance(input: AddRoleToDBInstanceInput, completion: @escaping (SdkResult<AddRoleToDBInstanceOutputResponse, AddRoleToDBInstanceOutputError>) -> Void)
    ...
    ///         </p>
    func authorizeDBSecurityGroupIngress(input: AuthorizeDBSecurityGroupIngressInput, completion: @escaping (SdkResult<AuthorizeDBSecurityGroupIngressOutputResponse, AuthorizeDBSecurityGroupIngressOutputError>) -> Void)
    ...
    ///         </note>
    func backtrackDBCluster(input: BacktrackDBClusterInput, completion: @escaping (SdkResult<BacktrackDBClusterOutputResponse, BacktrackDBClusterOutputError>) -> Void)
    ...
    func copyDBParameterGroup(input: CopyDBParameterGroupInput, completion: @escaping (SdkResult<CopyDBParameterGroupOutputResponse, CopyDBParameterGroupOutputError>) -> Void)
    ...
    ///         </p>
    func copyDBSnapshot(input: CopyDBSnapshotInput, completion: @escaping (SdkResult<CopyDBSnapshotOutputResponse, CopyDBSnapshotOutputError>) -> Void)
    /// <p>Copies the specified option group.</p>
    func copyOptionGroup(input: CopyOptionGroupInput, completion: @escaping (SdkResult<CopyOptionGroupOutputResponse, CopyOptionGroupOutputError>) -> Void)
    ...
    ///          </p>
    func createCustomAvailabilityZone(input: CreateCustomAvailabilityZoneInput, completion: @escaping (SdkResult<CreateCustomAvailabilityZoneOutputResponse, CreateCustomAvailabilityZoneOutputError>) -> Void)
    ...
    ///            <p>This action only applies to Aurora DB clusters.</p>
    ///          </note>
    func createDBClusterEndpoint(input: CreateDBClusterEndpointInput, completion: @escaping (SdkResult<CreateDBClusterEndpointOutputResponse, CreateDBClusterEndpointOutputError>) -> Void)
    ...
    ///          </p>
    ///          </important>
    func createDBInstanceReadReplica(input: CreateDBInstanceReadReplicaInput, completion: @escaping (SdkResult<CreateDBInstanceReadReplicaOutputResponse, CreateDBInstanceReadReplicaOutputError>) -> Void)
    ...
    ///          </important>
    func createDBParameterGroup(input: CreateDBParameterGroupInput, completion: @escaping (SdkResult<CreateDBParameterGroupOutputResponse, CreateDBParameterGroupOutputError>) -> Void)
    /// <p>Creates a new DB proxy.</p>
    func createDBProxy(input: CreateDBProxyInput, completion: @escaping (SdkResult<CreateDBProxyOutputResponse, CreateDBProxyOutputError>) -> Void)
    /// <p>
    ...
    ///       </p>
    func createDBProxyEndpoint(input: CreateDBProxyEndpointInput, completion: @escaping (SdkResult<CreateDBProxyEndpointOutputResponse, CreateDBProxyEndpointOutputError>) -> Void)
    ...
    ///          </note>
    func createDBSecurityGroup(input: CreateDBSecurityGroupInput, completion: @escaping (SdkResult<CreateDBSecurityGroupOutputResponse, CreateDBSecurityGroupOutputError>) -> Void)
    ...
    func createDBSnapshot(input: CreateDBSnapshotInput, completion: @escaping (SdkResult<CreateDBSnapshotOutputResponse, CreateDBSnapshotOutputError>) -> Void)
    ...
    func createOptionGroup(input: CreateOptionGroupInput, completion: @escaping (SdkResult<CreateOptionGroupOutputResponse, CreateOptionGroupOutputError>) -> Void)
    ...
    ///                 RDS on VMware User Guide.</a>
    ///          </p>
    func deleteCustomAvailabilityZone(input: DeleteCustomAvailabilityZoneInput, completion: @escaping (SdkResult<DeleteCustomAvailabilityZoneOutputResponse, DeleteCustomAvailabilityZoneOutputError>) -> Void)
    ...
    ///            <p>This action only applies to Aurora DB clusters.</p>
    ///          </note>
    func deleteDBClusterEndpoint(input: DeleteDBClusterEndpointInput, completion: @escaping (SdkResult<DeleteDBClusterEndpointOutputResponse, DeleteDBClusterEndpointOutputError>) -> Void)
    ...
    func deleteDBInstanceAutomatedBackup(input: DeleteDBInstanceAutomatedBackupInput, completion: @escaping (SdkResult<DeleteDBInstanceAutomatedBackupOutputResponse, DeleteDBInstanceAutomatedBackupOutputError>) -> Void)
    ...
    func deleteDBParameterGroup(input: DeleteDBParameterGroupInput, completion: @escaping (SdkResult<DeleteDBParameterGroupOutputResponse, DeleteDBParameterGroupOutputError>) -> Void)
    /// <p>Deletes an existing DB proxy.</p>
    func deleteDBProxy(input: DeleteDBProxyInput, completion: @escaping (SdkResult<DeleteDBProxyOutputResponse, DeleteDBProxyOutputError>) -> Void)
    ...
    func deleteDBProxyEndpoint(input: DeleteDBProxyEndpointInput, completion: @escaping (SdkResult<DeleteDBProxyEndpointOutputResponse, DeleteDBProxyEndpointOutputError>) -> Void)
    /// <p>Deletes a DB security group.</p>
    ///          <note>
    ///             <p>The specified DB security group must not be associated with any DB instances.</p>
    ///          </note>
    func deleteDBSecurityGroup(input: DeleteDBSecurityGroupInput, completion: @escaping (SdkResult<DeleteDBSecurityGroupOutputResponse, DeleteDBSecurityGroupOutputError>) -> Void)
    ...
    ///          </note>
    func deleteDBSnapshot(input: DeleteDBSnapshotInput, completion: @escaping (SdkResult<DeleteDBSnapshotOutputResponse, DeleteDBSnapshotOutputError>) -> Void)
    ...
    func deleteInstallationMedia(input: DeleteInstallationMediaInput, completion: @escaping (SdkResult<DeleteInstallationMediaOutputResponse, DeleteInstallationMediaOutputError>) -> Void)
    /// <p>Deletes an existing option group.</p>
    func deleteOptionGroup(input: DeleteOptionGroupInput, completion: @escaping (SdkResult<DeleteOptionGroupOutputResponse, DeleteOptionGroupOutputError>) -> Void)
    ...
    func deregisterDBProxyTargets(input: DeregisterDBProxyTargetsInput, completion: @escaping (SdkResult<DeregisterDBProxyTargetsOutputResponse, DeregisterDBProxyTargetsOutputError>) -> Void)
    ...
    ///                 RDS on VMware User Guide.</a>
    ///          </p>
    func describeCustomAvailabilityZones(input: DescribeCustomAvailabilityZonesInput, completion: @escaping (SdkResult<DescribeCustomAvailabilityZonesOutputResponse, DescribeCustomAvailabilityZonesOutputError>) -> Void)
    ...
    ///             <p>This action only applies to Aurora MySQL DB clusters.</p>
    ///         </note>
    func describeDBClusterBacktracks(input: DescribeDBClusterBacktracksInput, completion: @escaping (SdkResult<DescribeDBClusterBacktracksOutputResponse, DescribeDBClusterBacktracksOutputError>) -> Void)
    /// <p>Returns information about endpoints for an Amazon Aurora DB cluster.</p>
    ///          <note>
    ///            <p>This action only applies to Aurora DB clusters.</p>
    ///          </note>
    func describeDBClusterEndpoints(input: DescribeDBClusterEndpointsInput, completion: @escaping (SdkResult<DescribeDBClusterEndpointsOutputResponse, DescribeDBClusterEndpointsOutputError>) -> Void)
    /// <p>
    ...
    func describeDBInstanceAutomatedBackups(input: DescribeDBInstanceAutomatedBackupsInput, completion: @escaping (SdkResult<DescribeDBInstanceAutomatedBackupsOutputResponse, DescribeDBInstanceAutomatedBackupsOutputError>) -> Void)
    ...
    func describeDBLogFiles(input: DescribeDBLogFilesInput, completion: @escaping (SdkResult<DescribeDBLogFilesOutputResponse, DescribeDBLogFilesOutputError>) -> Void)
    /// <p>
    ...
    ///         </p>
    func describeDBParameterGroups(input: DescribeDBParameterGroupsInput, completion: @escaping (SdkResult<DescribeDBParameterGroupsOutputResponse, DescribeDBParameterGroupsOutputError>) -> Void)
    /// <p>Returns the detailed parameter list for a particular DB parameter group.</p>
    func describeDBParameters(input: DescribeDBParametersInput, completion: @escaping (SdkResult<DescribeDBParametersOutputResponse, DescribeDBParametersOutputError>) -> Void)
    /// <p>Returns information about DB proxies.</p>
    func describeDBProxies(input: DescribeDBProxiesInput, completion: @escaping (SdkResult<DescribeDBProxiesOutputResponse, DescribeDBProxiesOutputError>) -> Void)
    /// <p>Returns information about DB proxy endpoints.</p>
    func describeDBProxyEndpoints(input: DescribeDBProxyEndpointsInput, completion: @escaping (SdkResult<DescribeDBProxyEndpointsOutputResponse, DescribeDBProxyEndpointsOutputError>) -> Void)
    /// <p>Returns information about DB proxy target groups, represented by <code>DBProxyTargetGroup</code> data structures.</p>
    func describeDBProxyTargetGroups(input: DescribeDBProxyTargetGroupsInput, completion: @escaping (SdkResult<DescribeDBProxyTargetGroupsOutputResponse, DescribeDBProxyTargetGroupsOutputError>) -> Void)
    /// <p>Returns information about <code>DBProxyTarget</code> objects. This API supports pagination.</p>
    func describeDBProxyTargets(input: DescribeDBProxyTargetsInput, completion: @escaping (SdkResult<DescribeDBProxyTargetsOutputResponse, DescribeDBProxyTargetsOutputError>) -> Void)
    /// <p>
    ///         Returns a list of <code>DBSecurityGroup</code> descriptions. If a <code>DBSecurityGroupName</code> is specified,
    ///             the list will contain only the descriptions of the specified DB security group.
    ///         </p>
    func describeDBSecurityGroups(input: DescribeDBSecurityGroupsInput, completion: @escaping (SdkResult<DescribeDBSecurityGroupsOutputResponse, DescribeDBSecurityGroupsOutputError>) -> Void)
    ...
    func describeDBSnapshotAttributes(input: DescribeDBSnapshotAttributesInput, completion: @escaping (SdkResult<DescribeDBSnapshotAttributesOutputResponse, DescribeDBSnapshotAttributesOutputError>) -> Void)
    /// <p>Returns information about DB snapshots. This API action supports pagination.</p>
    func describeDBSnapshots(input: DescribeDBSnapshotsInput, completion: @escaping (SdkResult<DescribeDBSnapshotsOutputResponse, DescribeDBSnapshotsOutputError>) -> Void)
    ...
    func describeInstallationMedia(input: DescribeInstallationMediaInput, completion: @escaping (SdkResult<DescribeInstallationMediaOutputResponse, DescribeInstallationMediaOutputError>) -> Void)
    /// <p>Describes all available options.</p>
    func describeOptionGroupOptions(input: DescribeOptionGroupOptionsInput, completion: @escaping (SdkResult<DescribeOptionGroupOptionsOutputResponse, DescribeOptionGroupOptionsOutputError>) -> Void)
    /// <p>Describes the available option groups.</p>
    func describeOptionGroups(input: DescribeOptionGroupsInput, completion: @escaping (SdkResult<DescribeOptionGroupsOutputResponse, DescribeOptionGroupsOutputError>) -> Void)
    ...
    func describeReservedDBInstances(input: DescribeReservedDBInstancesInput, completion: @escaping (SdkResult<DescribeReservedDBInstancesOutputResponse, DescribeReservedDBInstancesOutputError>) -> Void)
    /// <p>Lists available reserved DB instance offerings.</p>
    func describeReservedDBInstancesOfferings(input: DescribeReservedDBInstancesOfferingsInput, completion: @escaping (SdkResult<DescribeReservedDBInstancesOfferingsOutputResponse, DescribeReservedDBInstancesOfferingsOutputError>) -> Void)
    ...
    func describeSourceRegions(input: DescribeSourceRegionsInput, completion: @escaping (SdkResult<DescribeSourceRegionsOutputResponse, DescribeSourceRegionsOutputError>) -> Void)
    /// <p>You can call <code>DescribeValidDBInstanceModifications</code>
    ///             to learn what modifications you can make to your DB instance.
    ///             You can use this information when you call
    ///             <code>ModifyDBInstance</code>.
    ///         </p>
    func describeValidDBInstanceModifications(input: DescribeValidDBInstanceModificationsInput, completion: @escaping (SdkResult<DescribeValidDBInstanceModificationsOutputResponse, DescribeValidDBInstanceModificationsOutputError>) -> Void)
    /// <p>Downloads all or a portion of the specified log file, up to 1 MB in size.</p>
    func downloadDBLogFilePortion(input: DownloadDBLogFilePortionInput, completion: @escaping (SdkResult<DownloadDBLogFilePortionOutputResponse, DownloadDBLogFilePortionOutputError>) -> Void)
    ...
    ///        </p>
    ///          </note>
    func failoverGlobalCluster(input: FailoverGlobalClusterInput, completion: @escaping (SdkResult<FailoverGlobalClusterOutputResponse, FailoverGlobalClusterOutputError>) -> Void)
    ...
    func importInstallationMedia(input: ImportInstallationMediaInput, completion: @escaping (SdkResult<ImportInstallationMediaOutputResponse, ImportInstallationMediaOutputError>) -> Void)
    ...
    func modifyCertificates(input: ModifyCertificatesInput, completion: @escaping (SdkResult<ModifyCertificatesOutputResponse, ModifyCertificatesOutputError>) -> Void)
    ...
    ///             <p>This action only applies to Aurora DB clusters.</p>
    ///          </note>
    func modifyCurrentDBClusterCapacity(input: ModifyCurrentDBClusterCapacityInput, completion: @escaping (SdkResult<ModifyCurrentDBClusterCapacityOutputResponse, ModifyCurrentDBClusterCapacityOutputError>) -> Void)
    ...
    ///            <p>This action only applies to Aurora DB clusters.</p>
    ///          </note>
    func modifyDBClusterEndpoint(input: ModifyDBClusterEndpointInput, completion: @escaping (SdkResult<ModifyDBClusterEndpointOutputResponse, ModifyDBClusterEndpointOutputError>) -> Void)
    /// <p>
    ...
    ///             that your DB parameter group has been created or modified.</p>
    ///          </important>
    func modifyDBParameterGroup(input: ModifyDBParameterGroupInput, completion: @escaping (SdkResult<ModifyDBParameterGroupOutputResponse, ModifyDBParameterGroupOutputError>) -> Void)
    /// <p>Changes the settings for an existing DB proxy.</p>
    func modifyDBProxy(input: ModifyDBProxyInput, completion: @escaping (SdkResult<ModifyDBProxyOutputResponse, ModifyDBProxyOutputError>) -> Void)
    /// <p>Changes the settings for an existing DB proxy endpoint.</p>
    func modifyDBProxyEndpoint(input: ModifyDBProxyEndpointInput, completion: @escaping (SdkResult<ModifyDBProxyEndpointOutputResponse, ModifyDBProxyEndpointOutputError>) -> Void)
    /// <p>Modifies the properties of a <code>DBProxyTargetGroup</code>.</p>
    func modifyDBProxyTargetGroup(input: ModifyDBProxyTargetGroupInput, completion: @escaping (SdkResult<ModifyDBProxyTargetGroupOutputResponse, ModifyDBProxyTargetGroupOutputError>) -> Void)
    ...
    ///       </p>
    func modifyDBSnapshot(input: ModifyDBSnapshotInput, completion: @escaping (SdkResult<ModifyDBSnapshotOutputResponse, ModifyDBSnapshotOutputError>) -> Void)
    ...
    func modifyDBSnapshotAttribute(input: ModifyDBSnapshotAttributeInput, completion: @escaping (SdkResult<ModifyDBSnapshotAttributeOutputResponse, ModifyDBSnapshotAttributeOutputError>) -> Void)
    ...
    func modifyOptionGroup(input: ModifyOptionGroupInput, completion: @escaping (SdkResult<ModifyOptionGroupOutputResponse, ModifyOptionGroupOutputError>) -> Void)
    ...
    ///
    ///          </note>
    func promoteReadReplica(input: PromoteReadReplicaInput, completion: @escaping (SdkResult<PromoteReadReplicaOutputResponse, PromoteReadReplicaOutputError>) -> Void)
    /// <p>Promotes a read replica DB cluster to a standalone DB cluster.</p>
    ///          <note>
    ///             <p>This action only applies to Aurora DB clusters.</p>
    ///          </note>
    func promoteReadReplicaDBCluster(input: PromoteReadReplicaDBClusterInput, completion: @escaping (SdkResult<PromoteReadReplicaDBClusterOutputResponse, PromoteReadReplicaDBClusterOutputError>) -> Void)
    /// <p>Purchases a reserved DB instance offering.</p>
    func purchaseReservedDBInstancesOffering(input: PurchaseReservedDBInstancesOfferingInput, completion: @escaping (SdkResult<PurchaseReservedDBInstancesOfferingOutputResponse, PurchaseReservedDBInstancesOfferingOutputError>) -> Void)
    ...
    func registerDBProxyTargets(input: RegisterDBProxyTargetsInput, completion: @escaping (SdkResult<RegisterDBProxyTargetsOutputResponse, RegisterDBProxyTargetsOutputError>) -> Void)
    /// <p>
    ...
    ///             <p>This action only applies to Aurora DB clusters.</p>
    ///         </note>
    func removeRoleFromDBCluster(input: RemoveRoleFromDBClusterInput, completion: @escaping (SdkResult<RemoveRoleFromDBClusterOutputResponse, RemoveRoleFromDBClusterOutputError>) -> Void)
    /// <p>Disassociates an AWS Identity and Access Management (IAM) role from a DB instance.</p>
    func removeRoleFromDBInstance(input: RemoveRoleFromDBInstanceInput, completion: @escaping (SdkResult<RemoveRoleFromDBInstanceOutputResponse, RemoveRoleFromDBInstanceOutputError>) -> Void)
    ...
    func resetDBParameterGroup(input: ResetDBParameterGroupInput, completion: @escaping (SdkResult<ResetDBParameterGroupOutputResponse, ResetDBParameterGroupOutputError>) -> Void)
    ...
    ///                 MySQL.</p>
    ///         </note>
    func restoreDBClusterFromS3(input: RestoreDBClusterFromS3Input, completion: @escaping (SdkResult<RestoreDBClusterFromS3OutputResponse, RestoreDBClusterFromS3OutputError>) -> Void)
    ...
    ///          </note>
    func restoreDBInstanceFromDBSnapshot(input: RestoreDBInstanceFromDBSnapshotInput, completion: @escaping (SdkResult<RestoreDBInstanceFromDBSnapshotOutputResponse, RestoreDBInstanceFromDBSnapshotOutputError>) -> Void)
    ...
    ///             in the <i>Amazon RDS User Guide.</i>
    ///         </p>
    func restoreDBInstanceFromS3(input: RestoreDBInstanceFromS3Input, completion: @escaping (SdkResult<RestoreDBInstanceFromS3OutputResponse, RestoreDBInstanceFromS3OutputError>) -> Void)
    ...
    ///          </note>
    func restoreDBInstanceToPointInTime(input: RestoreDBInstanceToPointInTimeInput, completion: @escaping (SdkResult<RestoreDBInstanceToPointInTimeOutputResponse, RestoreDBInstanceToPointInTimeOutputError>) -> Void)
    ...
    func revokeDBSecurityGroupIngress(input: RevokeDBSecurityGroupIngressInput, completion: @escaping (SdkResult<RevokeDBSecurityGroupIngressOutputResponse, RevokeDBSecurityGroupIngressOutputError>) -> Void)
    ...
    func startActivityStream(input: StartActivityStreamInput, completion: @escaping (SdkResult<StartActivityStreamOutputResponse, StartActivityStreamOutputError>) -> Void)
    ...
    ///           </p>
    ///         </note>
    func startDBInstance(input: StartDBInstanceInput, completion: @escaping (SdkResult<StartDBInstanceOutputResponse, StartDBInstanceOutputError>) -> Void)
    ...
    ///          </p>
    func startDBInstanceAutomatedBackupsReplication(input: StartDBInstanceAutomatedBackupsReplicationInput, completion: @escaping (SdkResult<StartDBInstanceAutomatedBackupsReplicationOutputResponse, StartDBInstanceAutomatedBackupsReplicationOutputError>) -> Void)
    ...
    ///             in the <i>Amazon Aurora User Guide</i>.</p>
    func stopActivityStream(input: StopActivityStreamInput, completion: @escaping (SdkResult<StopActivityStreamOutputResponse, StopActivityStreamOutputError>) -> Void)
    /// <p>
    ...
    ///           </p>
    ///         </note>
    func stopDBInstance(input: StopDBInstanceInput, completion: @escaping (SdkResult<StopDBInstanceOutputResponse, StopDBInstanceOutputError>) -> Void)
    /// <p>Stops automated backup replication for a DB instance.</p>
    ///         <p>For more information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReplicateBackups.html">
    ///             Replicating Automated Backups to Another AWS Region</a> in the <i>Amazon RDS User Guide.</i>
    ///          </p>
    func stopDBInstanceAutomatedBackupsReplication(input: StopDBInstanceAutomatedBackupsReplicationInput, completion: @escaping (SdkResult<StopDBInstanceAutomatedBackupsReplicationOutputResponse, StopDBInstanceAutomatedBackupsReplicationOutputError>) -> Void)
}
