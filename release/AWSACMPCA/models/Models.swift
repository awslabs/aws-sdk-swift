...
extension AcmPcaClientTypes {
    ...
    public struct AccessDescription: Swift.Equatable {
        ...
        var accessLocation: AcmPcaClientTypes.GeneralName?
        /// The type and format of AccessDescription information.
        /// This member is required.
        var accessMethod: AcmPcaClientTypes.AccessMethod?
...
extension AcmPcaClientTypes {
    ...
    public struct AccessMethod: Swift.Equatable {
        ...
        var accessMethodType: AcmPcaClientTypes.AccessMethodType?
        ...
        var customObjectIdentifier: Swift.String?
...
extension AcmPcaClientTypes {
    ...
    public struct ApiPassthrough: Swift.Equatable {
        ...
        var extensions: AcmPcaClientTypes.Extensions?
        /// Contains information about the certificate subject. The Subject field in the certificate identifies the entity that owns or controls the public key in the certificate. The entity can be a user, computer, device, or service. The Subject must contain an X.500 distinguished name (DN). A DN is a sequence of relative distinguished names (RDNs). The RDNs are separated by commas in the certificate.
        var subject: AcmPcaClientTypes.ASN1Subject?
...
extension AcmPcaClientTypes {
    ...
    public struct CertificateAuthority: Swift.Equatable {
        ...
        var certificateAuthorityConfiguration: AcmPcaClientTypes.CertificateAuthorityConfiguration?
        /// Date and time at which your private CA was created.
        var createdAt: ClientRuntime.Date?
        /// Reason the request to create your private CA failed.
        var failureReason: AcmPcaClientTypes.FailureReason?
        ...
        var keyStorageSecurityStandard: AcmPcaClientTypes.KeyStorageSecurityStandard?
        /// Date and time at which your private CA was last updated.
        var lastStateChangeAt: ClientRuntime.Date?
        ...
        var restorableUntil: ClientRuntime.Date?
        /// Information about the Online Certificate Status Protocol (OCSP) configuration or certificate revocation list (CRL) created and maintained by your private CA.
        var revocationConfiguration: AcmPcaClientTypes.RevocationConfiguration?
        /// Serial number of your private CA.
        var serial: Swift.String?
        /// Status of your private CA.
        var status: AcmPcaClientTypes.CertificateAuthorityStatus?
        /// Type of your private CA.
        var type: AcmPcaClientTypes.CertificateAuthorityType?
...
extension AcmPcaClientTypes {
    ...
    public struct CertificateAuthorityConfiguration: Swift.Equatable {
        ...
        var csrExtensions: AcmPcaClientTypes.CsrExtensions?
        /// Type of the public key algorithm and size, in bits, of the key pair that your CA creates when it issues a certificate. When you create a subordinate CA, you must use a key algorithm supported by the parent CA.
        /// This member is required.
        var keyAlgorithm: AcmPcaClientTypes.KeyAlgorithm?
        ...
        /// This member is required.
        var signingAlgorithm: AcmPcaClientTypes.SigningAlgorithm?
...
public struct CreateCertificateAuthorityAuditReportInput: Swift.Equatable {
    ...
    /// This member is required.
    var auditReportResponseFormat: AcmPcaClientTypes.AuditReportResponseFormat?
...
public struct CreateCertificateAuthorityAuditReportOutputResponse: Swift.Equatable {
    ...
    var auditReportId: Swift.String?
...
public struct CreateCertificateAuthorityInput: Swift.Equatable {
    ...
    /// This member is required.
    var certificateAuthorityType: AcmPcaClientTypes.CertificateAuthorityType?
    ...
    var tags: [AcmPcaClientTypes.Tag]?
...
public struct CreatePermissionInput: Swift.Equatable {
    ...
    /// This member is required.
    var actions: [AcmPcaClientTypes.ActionType]?
...
extension AcmPcaClientTypes {
    ...
    public struct CrlConfiguration: Swift.Equatable {
        ...
        var s3ObjectAcl: AcmPcaClientTypes.S3ObjectAcl?
...
extension AcmPcaClientTypes {
    ...
    public struct CsrExtensions: Swift.Equatable {
        ...
        var keyUsage: AcmPcaClientTypes.KeyUsage?
        ...
        var subjectInformationAccess: [AcmPcaClientTypes.AccessDescription]?
...
public struct DeleteCertificateAuthorityInput: Swift.Equatable {
    ...
    var permanentDeletionTimeInDays: Swift.Int?
...
public struct DescribeCertificateAuthorityAuditReportOutputResponse: Swift.Equatable {
    ...
    var auditReportStatus: AcmPcaClientTypes.AuditReportStatus?
...
public struct DescribeCertificateAuthorityOutputResponse: Swift.Equatable {
    ...
    var certificateAuthority: AcmPcaClientTypes.CertificateAuthority?
...
extension AcmPcaClientTypes {
    ...
    public struct EdiPartyName: Swift.Equatable {
        ...
        var nameAssigner: Swift.String?
        /// Specifies the party name.
        /// This member is required.
        var partyName: Swift.String?
...
extension AcmPcaClientTypes {
    ...
    public struct Extensions: Swift.Equatable {
        ...
        var certificatePolicies: [AcmPcaClientTypes.PolicyInformation]?
        /// Specifies additional purposes for which the certified public key may be used other than basic purposes indicated in the KeyUsage extension.
        var extendedKeyUsage: [AcmPcaClientTypes.ExtendedKeyUsage]?
        /// Defines one or more purposes for which the key contained in the certificate can be used. Default value for each option is false.
        var keyUsage: AcmPcaClientTypes.KeyUsage?
        /// The subject alternative name extension allows identities to be bound to the subject of the certificate. These identities may be included in addition to or in place of the identity in the subject field of the certificate.
        var subjectAlternativeNames: [AcmPcaClientTypes.GeneralName]?
...
extension AcmPcaClientTypes {
    ...
    public struct GeneralName: Swift.Equatable {
        /// Contains information about the certificate subject. The Subject field in the certificate identifies the entity that owns or controls the public key in the certificate. The entity can be a user, computer, device, or service. The Subject must contain an X.500 distinguished name (DN). A DN is a sequence of relative distinguished names (RDNs). The RDNs are separated by commas in the certificate.
        var directoryName: AcmPcaClientTypes.ASN1Subject?
        /// Represents GeneralName as a DNS name.
        var dnsName: Swift.String?
        /// Represents GeneralName as an EdiPartyName object.
        var ediPartyName: AcmPcaClientTypes.EdiPartyName?
        /// Represents GeneralName as an IPv4 or IPv6 address.
        var ipAddress: Swift.String?
        /// Represents GeneralName using an OtherName object.
        var otherName: AcmPcaClientTypes.OtherName?
        /// Represents GeneralName as an object identifier (OID).
        var registeredId: Swift.String?
        /// Represents GeneralName as an [RFC 822](https://tools.ietf.org/html/rfc822) email address.
        var rfc822Name: Swift.String?
        /// Represents GeneralName as a URI.
        var uniformResourceIdentifier: Swift.String?
...
public struct IssueCertificateInput: Swift.Equatable {
    ...
    var apiPassthrough: AcmPcaClientTypes.ApiPassthrough?
    /// The Amazon Resource Name (ARN) that was returned when you called [CreateCertificateAuthority](https://docs.aws.amazon.com/acm-pca/latest/APIReference/API_CreateCertificateAuthority.html). This must be of the form: arn:aws:acm-pca:region:account:certificate-authority/12345678-1234-1234-1234-123456789012
    /// This member is required.
    var certificateAuthorityArn: Swift.String?
    ...
    /// This member is required.
    var validity: AcmPcaClientTypes.Validity?
    ...
    var validityNotBefore: AcmPcaClientTypes.Validity?
...
extension AcmPcaClientTypes {
    ...
    public struct KeyUsage: Swift.Equatable {
        ...
        var cRLSign: Swift.Bool
        /// Key can be used to decipher data.
        var dataEncipherment: Swift.Bool
        /// Key can be used only to decipher data.
        var decipherOnly: Swift.Bool
        /// Key can be used for digital signing.
        var digitalSignature: Swift.Bool
        /// Key can be used only to encipher data.
        var encipherOnly: Swift.Bool
        /// Key can be used in a key-agreement protocol.
        var keyAgreement: Swift.Bool
        /// Key can be used to sign certificates.
        var keyCertSign: Swift.Bool
        /// Key can be used to encipher data.
        var keyEncipherment: Swift.Bool
        /// Key can be used for non-repudiation.
        var nonRepudiation: Swift.Bool
...
public struct ListCertificateAuthoritiesInput: Swift.Equatable {
    ...
    var resourceOwner: AcmPcaClientTypes.ResourceOwner?
...
public struct ListCertificateAuthoritiesOutputResponse: Swift.Equatable {
    ...
    var certificateAuthorities: [AcmPcaClientTypes.CertificateAuthority]?
...
public struct ListPermissionsOutputResponse: Swift.Equatable {
    ...
    var permissions: [AcmPcaClientTypes.Permission]?
...
extension AcmPcaClientTypes {
    ...
    public struct OcspConfiguration: Swift.Equatable {
        ...
        var ocspCustomCname: Swift.String?
...
extension AcmPcaClientTypes {
    ...
    public struct PolicyInformation: Swift.Equatable {
        ...
        var policyQualifiers: [AcmPcaClientTypes.PolicyQualifierInfo]?
...
extension AcmPcaClientTypes {
    ...
    public struct RevocationConfiguration: Swift.Equatable {
        ...
        var crlConfiguration: AcmPcaClientTypes.CrlConfiguration?
        ...
        var ocspConfiguration: AcmPcaClientTypes.OcspConfiguration?
...
public struct RevokeCertificateInput: Swift.Equatable {
    ...
    /// This member is required.
    var certificateSerial: Swift.String?
    /// Specifies why you revoked the certificate.
    /// This member is required.
    var revocationReason: AcmPcaClientTypes.RevocationReason?
...
extension AcmPcaClientTypes {
    ...
    public struct Validity: Swift.Equatable {
        ...
        /// This member is required.
        var type: AcmPcaClientTypes.ValidityPeriodType?
