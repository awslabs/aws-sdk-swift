...
public class CustomerProfilesClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try CustomerProfilesClientConfiguration(region: unwrappedRegion)
    ...
    public class CustomerProfilesClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("CustomerProfilesClient")
...
public struct CustomerProfilesClientLogHandlerFactory: SDKLogHandlerFactory {
