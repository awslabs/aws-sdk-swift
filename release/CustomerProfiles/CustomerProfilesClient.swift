...
extension CustomerProfilesClient: CustomerProfilesClientProtocol {
    ...
    public func addProfileKey(input: AddProfileKeyInput, completion: @escaping (SdkResult<AddProfileKeyOutput, AddProfileKeyOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<AddProfileKeyInput, AddProfileKeyOutput, AddProfileKeyOutputError>(id: "addProfileKey")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AddProfileKeyInput, AddProfileKeyOutput, AddProfileKeyOutputError>(contentType: "application/json"))
    ...
    public func createProfile(input: CreateProfileInput, completion: @escaping (SdkResult<CreateProfileOutput, CreateProfileOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateProfileInput, CreateProfileOutput, CreateProfileOutputError>(contentType: "application/json"))
    ...
    public func deleteIntegration(input: DeleteIntegrationInput, completion: @escaping (SdkResult<DeleteIntegrationOutput, DeleteIntegrationOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteIntegrationInput, DeleteIntegrationOutput, DeleteIntegrationOutputError>(id: "deleteIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteIntegrationInput, DeleteIntegrationOutput, DeleteIntegrationOutputError>(contentType: "application/json"))
    ...
    public func deleteProfile(input: DeleteProfileInput, completion: @escaping (SdkResult<DeleteProfileOutput, DeleteProfileOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteProfileInput, DeleteProfileOutput, DeleteProfileOutputError>(contentType: "application/json"))
    ...
    public func deleteProfileKey(input: DeleteProfileKeyInput, completion: @escaping (SdkResult<DeleteProfileKeyOutput, DeleteProfileKeyOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteProfileKeyInput, DeleteProfileKeyOutput, DeleteProfileKeyOutputError>(id: "deleteProfileKey")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteProfileKeyInput, DeleteProfileKeyOutput, DeleteProfileKeyOutputError>(contentType: "application/json"))
    ...
    public func deleteProfileObject(input: DeleteProfileObjectInput, completion: @escaping (SdkResult<DeleteProfileObjectOutput, DeleteProfileObjectOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteProfileObjectInput, DeleteProfileObjectOutput, DeleteProfileObjectOutputError>(id: "deleteProfileObject")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteProfileObjectInput, DeleteProfileObjectOutput, DeleteProfileObjectOutputError>(contentType: "application/json"))
    ...
    public func deleteProfileObjectType(input: DeleteProfileObjectTypeInput, completion: @escaping (SdkResult<DeleteProfileObjectTypeOutput, DeleteProfileObjectTypeOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteProfileObjectTypeInput, DeleteProfileObjectTypeOutput, DeleteProfileObjectTypeOutputError>(id: "deleteProfileObjectType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteProfileObjectTypeInput, DeleteProfileObjectTypeOutput, DeleteProfileObjectTypeOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getDomain(input: GetDomainInput, completion: @escaping (SdkResult<GetDomainOutput, GetDomainOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetDomainInput, GetDomainOutput, GetDomainOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getIntegration(input: GetIntegrationInput, completion: @escaping (SdkResult<GetIntegrationOutput, GetIntegrationOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetIntegrationInput, GetIntegrationOutput, GetIntegrationOutputError>(id: "getIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetIntegrationInput, GetIntegrationOutput, GetIntegrationOutputError>(contentType: "application/json"))
    ...
    ///             </li>
    ///          </ul>
    public func getMatches(input: GetMatchesInput, completion: @escaping (SdkResult<GetMatchesOutput, GetMatchesOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetMatchesInput, GetMatchesOutput, GetMatchesOutputError>(id: "getMatches")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetMatchesInput, GetMatchesOutput, GetMatchesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func getProfileObjectType(input: GetProfileObjectTypeInput, completion: @escaping (SdkResult<GetProfileObjectTypeOutput, GetProfileObjectTypeOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetProfileObjectTypeInput, GetProfileObjectTypeOutput, GetProfileObjectTypeOutputError>(id: "getProfileObjectType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetProfileObjectTypeInput, GetProfileObjectTypeOutput, GetProfileObjectTypeOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///          template.</p>
    public func getProfileObjectTypeTemplate(input: GetProfileObjectTypeTemplateInput, completion: @escaping (SdkResult<GetProfileObjectTypeTemplateOutput, GetProfileObjectTypeTemplateOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetProfileObjectTypeTemplateInput, GetProfileObjectTypeTemplateOutput, GetProfileObjectTypeTemplateOutputError>(id: "getProfileObjectTypeTemplate")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetProfileObjectTypeTemplateInput, GetProfileObjectTypeTemplateOutput, GetProfileObjectTypeTemplateOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listAccountIntegrations(input: ListAccountIntegrationsInput, completion: @escaping (SdkResult<ListAccountIntegrationsOutput, ListAccountIntegrationsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAccountIntegrationsInput, ListAccountIntegrationsOutput, ListAccountIntegrationsOutputError>(id: "listAccountIntegrations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccountIntegrationsInput, ListAccountIntegrationsOutput, ListAccountIntegrationsOutputError>(contentType: "application/json"))
    ...
    public func listIntegrations(input: ListIntegrationsInput, completion: @escaping (SdkResult<ListIntegrationsOutput, ListIntegrationsOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListIntegrationsInput, ListIntegrationsOutput, ListIntegrationsOutputError>(id: "listIntegrations")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListIntegrationsInput, ListIntegrationsOutput, ListIntegrationsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listProfileObjectTypeTemplates(input: ListProfileObjectTypeTemplatesInput, completion: @escaping (SdkResult<ListProfileObjectTypeTemplatesOutput, ListProfileObjectTypeTemplatesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListProfileObjectTypeTemplatesInput, ListProfileObjectTypeTemplatesOutput, ListProfileObjectTypeTemplatesOutputError>(id: "listProfileObjectTypeTemplates")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListProfileObjectTypeTemplatesInput, ListProfileObjectTypeTemplatesOutput, ListProfileObjectTypeTemplatesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listProfileObjectTypes(input: ListProfileObjectTypesInput, completion: @escaping (SdkResult<ListProfileObjectTypesOutput, ListProfileObjectTypesOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListProfileObjectTypesInput, ListProfileObjectTypesOutput, ListProfileObjectTypesOutputError>(id: "listProfileObjectTypes")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListProfileObjectTypesInput, ListProfileObjectTypesOutput, ListProfileObjectTypesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listProfileObjects(input: ListProfileObjectsInput, completion: @escaping (SdkResult<ListProfileObjectsOutput, ListProfileObjectsOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListProfileObjectsInput, ListProfileObjectsOutput, ListProfileObjectsOutputError>(id: "listProfileObjects")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListProfileObjectsInput, ListProfileObjectsOutput, ListProfileObjectsOutputError>(contentType: "application/json"))
    ...
    public func mergeProfiles(input: MergeProfilesInput, completion: @escaping (SdkResult<MergeProfilesOutput, MergeProfilesOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<MergeProfilesInput, MergeProfilesOutput, MergeProfilesOutputError>(id: "mergeProfiles")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<MergeProfilesInput, MergeProfilesOutput, MergeProfilesOutputError>(contentType: "application/json"))
    ...
    public func putIntegration(input: PutIntegrationInput, completion: @escaping (SdkResult<PutIntegrationOutput, PutIntegrationOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutIntegrationInput, PutIntegrationOutput, PutIntegrationOutputError>(id: "putIntegration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutIntegrationInput, PutIntegrationOutput, PutIntegrationOutputError>(contentType: "application/json"))
    ...
    public func putProfileObject(input: PutProfileObjectInput, completion: @escaping (SdkResult<PutProfileObjectOutput, PutProfileObjectOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutProfileObjectInput, PutProfileObjectOutput, PutProfileObjectOutputError>(id: "putProfileObject")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutProfileObjectInput, PutProfileObjectOutput, PutProfileObjectOutputError>(contentType: "application/json"))
    ...
    public func putProfileObjectType(input: PutProfileObjectTypeInput, completion: @escaping (SdkResult<PutProfileObjectTypeOutput, PutProfileObjectTypeOutputError>) -> Void)
    {
        guard let domainName = input.domainName else {
            completion(.failure(.client(ClientError.serializationFailed("uri component domainName unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "profile")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutProfileObjectTypeInput, PutProfileObjectTypeOutput, PutProfileObjectTypeOutputError>(id: "putProfileObjectType")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutProfileObjectTypeInput, PutProfileObjectTypeOutput, PutProfileObjectTypeOutputError>(contentType: "application/json"))
    ...
    public func searchProfiles(input: SearchProfilesInput, completion: @escaping (SdkResult<SearchProfilesOutput, SearchProfilesOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SearchProfilesInput, SearchProfilesOutput, SearchProfilesOutputError>(contentType: "application/json"))
    ...
    public func updateDomain(input: UpdateDomainInput, completion: @escaping (SdkResult<UpdateDomainOutput, UpdateDomainOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateDomainInput, UpdateDomainOutput, UpdateDomainOutputError>(contentType: "application/json"))
    ...
    public func updateProfile(input: UpdateProfileInput, completion: @escaping (SdkResult<UpdateProfileOutput, UpdateProfileOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateProfileInput, UpdateProfileOutput, UpdateProfileOutputError>(contentType: "application/json"))
