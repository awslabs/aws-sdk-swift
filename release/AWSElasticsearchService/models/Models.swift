...
public struct AcceptInboundCrossClusterSearchConnectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AcceptInboundCrossClusterSearchConnectionInputURLHostMiddleware"
    ...
    public typealias MInput = AcceptInboundCrossClusterSearchConnectionInput
    public typealias MOutput = ClientRuntime.OperationOutput<AcceptInboundCrossClusterSearchConnectionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<AcceptInboundCrossClusterSearchConnectionOutputError>
}

public struct AcceptInboundCrossClusterSearchConnectionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AcceptInboundCrossClusterSearchConnectionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let crossClusterSearchConnectionId = input.crossClusterSearchConnectionId else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("crossClusterSearchConnectionId is nil and needs a value for the path of this operation"))))
        }
        var urlPath = "/2015-01-01/es/ccs/inboundConnection/\(crossClusterSearchConnectionId.urlPercentEncoding())/accept"
...
public struct AssociatePackageInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/packages/associate/\(packageID.urlPercentEncoding())/\(domainName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CancelElasticsearchServiceSoftwareUpdateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelElasticsearchServiceSoftwareUpdateInputURLHostMiddleware"
    ...
    public typealias MInput = CancelElasticsearchServiceSoftwareUpdateInput
    public typealias MOutput = ClientRuntime.OperationOutput<CancelElasticsearchServiceSoftwareUpdateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CancelElasticsearchServiceSoftwareUpdateOutputError>
}

public struct CancelElasticsearchServiceSoftwareUpdateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CancelElasticsearchServiceSoftwareUpdateInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/serviceSoftwareUpdate/cancel"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateElasticsearchDomainInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateElasticsearchDomainInputURLHostMiddleware"
    ...
    public typealias MInput = CreateElasticsearchDomainInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateElasticsearchDomainOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateElasticsearchDomainOutputError>
}

public struct CreateElasticsearchDomainInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateElasticsearchDomainInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/domain"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreateOutboundCrossClusterSearchConnectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateOutboundCrossClusterSearchConnectionInputURLHostMiddleware"
    ...
    public typealias MInput = CreateOutboundCrossClusterSearchConnectionInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateOutboundCrossClusterSearchConnectionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateOutboundCrossClusterSearchConnectionOutputError>
}

public struct CreateOutboundCrossClusterSearchConnectionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateOutboundCrossClusterSearchConnectionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/ccs/outboundConnection"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct CreatePackageInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/packages"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteElasticsearchDomainInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteElasticsearchDomainInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteElasticsearchDomainInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteElasticsearchDomainOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteElasticsearchDomainOutputError>
}

public struct DeleteElasticsearchDomainInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteElasticsearchDomainInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/domain/\(domainName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteElasticsearchServiceRoleInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteElasticsearchServiceRoleInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteElasticsearchServiceRoleInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteElasticsearchServiceRoleOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteElasticsearchServiceRoleOutputError>
}

public struct DeleteElasticsearchServiceRoleInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteElasticsearchServiceRoleInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/role"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteInboundCrossClusterSearchConnectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteInboundCrossClusterSearchConnectionInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteInboundCrossClusterSearchConnectionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteInboundCrossClusterSearchConnectionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteInboundCrossClusterSearchConnectionOutputError>
}

public struct DeleteInboundCrossClusterSearchConnectionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteInboundCrossClusterSearchConnectionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/ccs/inboundConnection/\(crossClusterSearchConnectionId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeleteOutboundCrossClusterSearchConnectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteOutboundCrossClusterSearchConnectionInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteOutboundCrossClusterSearchConnectionInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteOutboundCrossClusterSearchConnectionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteOutboundCrossClusterSearchConnectionOutputError>
}

public struct DeleteOutboundCrossClusterSearchConnectionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteOutboundCrossClusterSearchConnectionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/ccs/outboundConnection/\(crossClusterSearchConnectionId.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DeletePackageInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/packages/\(packageID.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeDomainAutoTunesInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/domain/\(domainName.urlPercentEncoding())/autoTunes"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeElasticsearchDomainConfigInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchDomainConfigInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeElasticsearchDomainConfigInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeElasticsearchDomainConfigOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeElasticsearchDomainConfigOutputError>
}

public struct DescribeElasticsearchDomainConfigInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchDomainConfigInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/domain/\(domainName.urlPercentEncoding())/config"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeElasticsearchDomainInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchDomainInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeElasticsearchDomainInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeElasticsearchDomainOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeElasticsearchDomainOutputError>
}

public struct DescribeElasticsearchDomainInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchDomainInputURLPathMiddleware"
...
public struct DescribeElasticsearchDomainsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchDomainsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeElasticsearchDomainsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeElasticsearchDomainsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeElasticsearchDomainsOutputError>
}

public struct DescribeElasticsearchDomainsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchDomainsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/domain-info"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeElasticsearchInstanceTypeLimitsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchInstanceTypeLimitsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeElasticsearchInstanceTypeLimitsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeElasticsearchInstanceTypeLimitsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeElasticsearchInstanceTypeLimitsOutputError>
}

public struct DescribeElasticsearchInstanceTypeLimitsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeElasticsearchInstanceTypeLimitsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        guard let elasticsearchVersion = input.elasticsearchVersion else {
            return .failure(.client(ClientRuntime.ClientError.pathCreationFailed(("elasticsearchVersion is nil and needs a value for the path of this operation"))))
        }
        ...
        var urlPath = "/2015-01-01/es/instanceTypeLimits/\(elasticsearchVersion.urlPercentEncoding())/\(instanceType.rawValue.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeInboundCrossClusterSearchConnectionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInboundCrossClusterSearchConnectionsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeInboundCrossClusterSearchConnectionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeInboundCrossClusterSearchConnectionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeInboundCrossClusterSearchConnectionsOutputError>
}

public struct DescribeInboundCrossClusterSearchConnectionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeInboundCrossClusterSearchConnectionsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/ccs/inboundConnection/search"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeOutboundCrossClusterSearchConnectionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOutboundCrossClusterSearchConnectionsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeOutboundCrossClusterSearchConnectionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeOutboundCrossClusterSearchConnectionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeOutboundCrossClusterSearchConnectionsOutputError>
}

public struct DescribeOutboundCrossClusterSearchConnectionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeOutboundCrossClusterSearchConnectionsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/ccs/outboundConnection/search"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribePackagesInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/packages/describe"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeReservedElasticsearchInstanceOfferingsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeReservedElasticsearchInstanceOfferingsInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeReservedElasticsearchInstanceOfferingsInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeReservedElasticsearchInstanceOfferingsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeReservedElasticsearchInstanceOfferingsOutputError>
}

public struct DescribeReservedElasticsearchInstanceOfferingsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeReservedElasticsearchInstanceOfferingsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/reservedInstanceOfferings"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DescribeReservedElasticsearchInstancesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeReservedElasticsearchInstancesInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeReservedElasticsearchInstancesInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeReservedElasticsearchInstancesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeReservedElasticsearchInstancesOutputError>
}

public struct DescribeReservedElasticsearchInstancesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeReservedElasticsearchInstancesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/reservedInstances"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct DissociatePackageInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/packages/dissociate/\(packageID.urlPercentEncoding())/\(domainName.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension ElasticsearchClientTypes.DryRunResults: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension ElasticsearchClientTypes.DryRunResults: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
public struct GetCompatibleElasticsearchVersionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetCompatibleElasticsearchVersionsInputURLHostMiddleware"
    ...
    public typealias MInput = GetCompatibleElasticsearchVersionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetCompatibleElasticsearchVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetCompatibleElasticsearchVersionsOutputError>
}

public struct GetCompatibleElasticsearchVersionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetCompatibleElasticsearchVersionsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/compatibleVersions"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetPackageVersionHistoryInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/packages/\(packageID.urlPercentEncoding())/history"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetUpgradeHistoryInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/upgradeDomain/\(domainName.urlPercentEncoding())/history"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct GetUpgradeStatusInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/upgradeDomain/\(domainName.urlPercentEncoding())/status"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListDomainsForPackageInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/packages/\(packageID.urlPercentEncoding())/domains"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListElasticsearchInstanceTypesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListElasticsearchInstanceTypesInputURLHostMiddleware"
    ...
    public typealias MInput = ListElasticsearchInstanceTypesInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListElasticsearchInstanceTypesOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListElasticsearchInstanceTypesOutputError>
}

public struct ListElasticsearchInstanceTypesInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListElasticsearchInstanceTypesInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/instanceTypes/\(elasticsearchVersion.urlPercentEncoding())"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListElasticsearchVersionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListElasticsearchVersionsInputURLHostMiddleware"
    ...
    public typealias MInput = ListElasticsearchVersionsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListElasticsearchVersionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListElasticsearchVersionsOutputError>
}

public struct ListElasticsearchVersionsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListElasticsearchVersionsInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/versions"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct ListPackagesForDomainInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/domain/\(domainName.urlPercentEncoding())/packages"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct PurchaseReservedElasticsearchInstanceOfferingInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PurchaseReservedElasticsearchInstanceOfferingInputURLHostMiddleware"
    ...
    public typealias MInput = PurchaseReservedElasticsearchInstanceOfferingInput
    public typealias MOutput = ClientRuntime.OperationOutput<PurchaseReservedElasticsearchInstanceOfferingOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PurchaseReservedElasticsearchInstanceOfferingOutputError>
}

public struct PurchaseReservedElasticsearchInstanceOfferingInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PurchaseReservedElasticsearchInstanceOfferingInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/purchaseReservedInstanceOffering"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct RejectInboundCrossClusterSearchConnectionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RejectInboundCrossClusterSearchConnectionInputURLHostMiddleware"
    ...
    public typealias MInput = RejectInboundCrossClusterSearchConnectionInput
    public typealias MOutput = ClientRuntime.OperationOutput<RejectInboundCrossClusterSearchConnectionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<RejectInboundCrossClusterSearchConnectionOutputError>
}

public struct RejectInboundCrossClusterSearchConnectionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "RejectInboundCrossClusterSearchConnectionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2015-01-01/es/ccs/inboundConnection/\(crossClusterSearchConnectionId.urlPercentEncoding())/reject"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct RemoveTagsInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/tags-removal"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct StartElasticsearchServiceSoftwareUpdateInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartElasticsearchServiceSoftwareUpdateInputURLHostMiddleware"
    ...
    public typealias MInput = StartElasticsearchServiceSoftwareUpdateInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartElasticsearchServiceSoftwareUpdateOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartElasticsearchServiceSoftwareUpdateOutputError>
}

public struct StartElasticsearchServiceSoftwareUpdateInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartElasticsearchServiceSoftwareUpdateInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/serviceSoftwareUpdate/start"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpdateElasticsearchDomainConfigInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateElasticsearchDomainConfigInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateElasticsearchDomainConfigInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateElasticsearchDomainConfigOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateElasticsearchDomainConfigOutputError>
}

public struct UpdateElasticsearchDomainConfigInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateElasticsearchDomainConfigInputURLPathMiddleware"
...
extension UpdateElasticsearchDomainConfigOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateElasticsearchDomainConfigOutputResponse(domainConfig: \(Swift.String(describing: domainConfig)), dryRunResults: \(Swift.String(describing: dryRunResults)))"}
}
...
struct UpdateElasticsearchDomainConfigOutputResponseBody: Swift.Equatable {
    public let domainConfig: ElasticsearchClientTypes.ElasticsearchDomainConfig?
    public let dryRunResults: ElasticsearchClientTypes.DryRunResults?
}
...
public struct UpdatePackageInputURLPathMiddleware: ClientRuntime.Middleware {
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/packages/update"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
public struct UpgradeElasticsearchDomainInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpgradeElasticsearchDomainInputURLHostMiddleware"
    ...
    public typealias MInput = UpgradeElasticsearchDomainInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpgradeElasticsearchDomainOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpgradeElasticsearchDomainOutputError>
}

public struct UpgradeElasticsearchDomainInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpgradeElasticsearchDomainInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/2015-01-01/es/upgradeDomain"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
