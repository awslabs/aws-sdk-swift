...
extension AppConfigDataClientTypes.BadRequestDetails: Swift.Codable, ClientRuntime.Reflection {
...
struct BadRequestExceptionBody: Swift.Equatable {
    ...
    public let reason: AppConfigDataClientTypes.BadRequestReason?
    public let details: AppConfigDataClientTypes.BadRequestDetails?
}
...
extension GetLatestConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "GetLatestConfigurationInput(configurationToken: \(Swift.String(describing: configurationToken)))"}
}

extension GetLatestConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct GetLatestConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLatestConfigurationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<GetLatestConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<GetLatestConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<GetLatestConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<GetLatestConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetLatestConfigurationOutputError>
}

public struct GetLatestConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLatestConfigurationInputQueryItemMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        if let configurationToken = input.operationInput.configurationToken {
            ...
            input.builder.withQueryItem(configurationTokenQueryItem)
        }
        return next.handle(context: context, input: input)
    }
...
public struct GetLatestConfigurationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLatestConfigurationInputURLHostMiddleware"
    ...
    public typealias MInput = GetLatestConfigurationInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetLatestConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetLatestConfigurationOutputError>
}

public struct GetLatestConfigurationInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLatestConfigurationInputURLPathMiddleware"
...
struct GetLatestConfigurationOutputResponseBody: Swift.Equatable {
    public let configuration: ClientRuntime.Data?
}
...
extension AppConfigDataClientTypes.InvalidParameterDetail: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension AppConfigDataClientTypes.InvalidParameterDetail: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "InvalidParameterDetail(problem: \(Swift.String(describing: problem)))"}
}
...
extension ResourceNotFoundException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ResourceNotFoundException(message: \(Swift.String(describing: message)), referencedBy: \(Swift.String(describing: referencedBy)), resourceType: \(Swift.String(describing: resourceType)))"}
}
...
struct ResourceNotFoundExceptionBody: Swift.Equatable {
    public let message: Swift.String?
    public let resourceType: AppConfigDataClientTypes.ResourceType?
    public let referencedBy: [Swift.String:Swift.String]?
}
...
public struct StartConfigurationSessionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartConfigurationSessionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartConfigurationSessionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartConfigurationSessionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartConfigurationSessionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartConfigurationSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartConfigurationSessionOutputError>
}

extension StartConfigurationSessionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartConfigurationSessionInput(applicationIdentifier: \(Swift.String(describing: applicationIdentifier)), configurationProfileIdentifier: \(Swift.String(describing: configurationProfileIdentifier)), environmentIdentifier: \(Swift.String(describing: environmentIdentifier)), requiredMinimumPollIntervalInSeconds: \(Swift.String(describing: requiredMinimumPollIntervalInSeconds)))"}
}

extension StartConfigurationSessionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct StartConfigurationSessionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartConfigurationSessionInputHeadersMiddleware"
...
public struct StartConfigurationSessionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartConfigurationSessionInputQueryItemMiddleware"
...
public struct StartConfigurationSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartConfigurationSessionInputURLHostMiddleware"
    ...
    public typealias MInput = StartConfigurationSessionInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartConfigurationSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartConfigurationSessionOutputError>
}

public struct StartConfigurationSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartConfigurationSessionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        var urlPath = "/configurationsessions"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
struct StartConfigurationSessionInputBody: Swift.Equatable {
    ...
    public let environmentIdentifier: Swift.String?
    public let configurationProfileIdentifier: Swift.String?
    public let requiredMinimumPollIntervalInSeconds: Swift.Int?
}
...
extension StartConfigurationSessionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartConfigurationSessionOutputResponse(initialConfigurationToken: \(Swift.String(describing: initialConfigurationToken)))"}
}
...
struct StartConfigurationSessionOutputResponseBody: Swift.Equatable {
    public let initialConfigurationToken: Swift.String?
}
