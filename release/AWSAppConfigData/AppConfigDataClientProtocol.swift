...
public protocol AppConfigDataClientProtocol {
    ...
    func getLatestConfiguration(input: GetLatestConfigurationInput, completion: @escaping (ClientRuntime.SdkResult<GetLatestConfigurationOutputResponse, GetLatestConfigurationOutputError>) -> Void)
    ...
    func startConfigurationSession(input: StartConfigurationSessionInput, completion: @escaping (ClientRuntime.SdkResult<StartConfigurationSessionOutputResponse, StartConfigurationSessionOutputError>) -> Void)
}
