...
public protocol QuickSightClientProtocol {
    ...
    func cancelIngestion(input: CancelIngestionInput, completion: @escaping (SdkResult<CancelIngestionOutput, CancelIngestionOutputError>) -> Void)
    ...
    func createAccountCustomization(input: CreateAccountCustomizationInput, completion: @escaping (SdkResult<CreateAccountCustomizationOutput, CreateAccountCustomizationOutputError>) -> Void)
    /// <p>Creates an analysis in Amazon QuickSight.</p>
    func createAnalysis(input: CreateAnalysisInput, completion: @escaping (SdkResult<CreateAnalysisOutput, CreateAnalysisOutputError>) -> Void)
    ...
    func createDashboard(input: CreateDashboardInput, completion: @escaping (SdkResult<CreateDashboardOutput, CreateDashboardOutputError>) -> Void)
    ...
    func createGroupMembership(input: CreateGroupMembershipInput, completion: @escaping (SdkResult<CreateGroupMembershipOutput, CreateGroupMembershipOutputError>) -> Void)
    ...
    func createIAMPolicyAssignment(input: CreateIAMPolicyAssignmentInput, completion: @escaping (SdkResult<CreateIAMPolicyAssignmentOutput, CreateIAMPolicyAssignmentOutputError>) -> Void)
    ...
    func createIngestion(input: CreateIngestionInput, completion: @escaping (SdkResult<CreateIngestionOutput, CreateIngestionOutputError>) -> Void)
    ...
    ///             AWS Support. </p>
    func createNamespace(input: CreateNamespaceInput, completion: @escaping (SdkResult<CreateNamespaceOutput, CreateNamespaceOutputError>) -> Void)
    ...
    /// 			and template.</p>
    func createTemplate(input: CreateTemplateInput, completion: @escaping (SdkResult<CreateTemplateOutput, CreateTemplateOutputError>) -> Void)
    /// <p>Creates a template alias for a template.</p>
    func createTemplateAlias(input: CreateTemplateAliasInput, completion: @escaping (SdkResult<CreateTemplateAliasOutput, CreateTemplateAliasOutputError>) -> Void)
    /// <p>Creates a theme.</p>
    ...
    func createTheme(input: CreateThemeInput, completion: @escaping (SdkResult<CreateThemeOutput, CreateThemeOutputError>) -> Void)
    /// <p>Creates a theme alias for a theme.</p>
    func createThemeAlias(input: CreateThemeAliasInput, completion: @escaping (SdkResult<CreateThemeAliasOutput, CreateThemeAliasOutputError>) -> Void)
    ...
    func deleteAccountCustomization(input: DeleteAccountCustomizationInput, completion: @escaping (SdkResult<DeleteAccountCustomizationOutput, DeleteAccountCustomizationOutputError>) -> Void)
    ...
    func deleteAnalysis(input: DeleteAnalysisInput, completion: @escaping (SdkResult<DeleteAnalysisOutput, DeleteAnalysisOutputError>) -> Void)
    /// <p>Deletes a dashboard.</p>
    func deleteDashboard(input: DeleteDashboardInput, completion: @escaping (SdkResult<DeleteDashboardOutput, DeleteDashboardOutputError>) -> Void)
    ...
    func deleteGroupMembership(input: DeleteGroupMembershipInput, completion: @escaping (SdkResult<DeleteGroupMembershipOutput, DeleteGroupMembershipOutputError>) -> Void)
    /// <p>Deletes an existing IAM policy assignment.</p>
    func deleteIAMPolicyAssignment(input: DeleteIAMPolicyAssignmentInput, completion: @escaping (SdkResult<DeleteIAMPolicyAssignmentOutput, DeleteIAMPolicyAssignmentOutputError>) -> Void)
    ...
    func deleteTemplate(input: DeleteTemplateInput, completion: @escaping (SdkResult<DeleteTemplateOutput, DeleteTemplateOutputError>) -> Void)
    ...
    func deleteTemplateAlias(input: DeleteTemplateAliasInput, completion: @escaping (SdkResult<DeleteTemplateAliasOutput, DeleteTemplateAliasOutputError>) -> Void)
    /// <p>Deletes a theme.</p>
    func deleteTheme(input: DeleteThemeInput, completion: @escaping (SdkResult<DeleteThemeOutput, DeleteThemeOutputError>) -> Void)
    /// <p>Deletes the version of the theme that the specified theme alias points to.
    /// 			If you provide a specific alias, you delete the version of the theme
    /// 			that the alias points to.</p>
    func deleteThemeAlias(input: DeleteThemeAliasInput, completion: @escaping (SdkResult<DeleteThemeAliasOutput, DeleteThemeAliasOutputError>) -> Void)
    ...
    func deleteUserByPrincipalId(input: DeleteUserByPrincipalIdInput, completion: @escaping (SdkResult<DeleteUserByPrincipalIdOutput, DeleteUserByPrincipalIdOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func describeAccountCustomization(input: DescribeAccountCustomizationInput, completion: @escaping (SdkResult<DescribeAccountCustomizationOutput, DescribeAccountCustomizationOutputError>) -> Void)
    /// <p>Describes the settings that were used when your QuickSight subscription was first
    ///             created in this AWS account.</p>
    func describeAccountSettings(input: DescribeAccountSettingsInput, completion: @escaping (SdkResult<DescribeAccountSettingsOutput, DescribeAccountSettingsOutputError>) -> Void)
    /// <p>Provides a summary of the metadata for an analysis.</p>
    func describeAnalysis(input: DescribeAnalysisInput, completion: @escaping (SdkResult<DescribeAnalysisOutput, DescribeAnalysisOutputError>) -> Void)
    /// <p>Provides the read and write permissions for an analysis.</p>
    func describeAnalysisPermissions(input: DescribeAnalysisPermissionsInput, completion: @escaping (SdkResult<DescribeAnalysisPermissionsOutput, DescribeAnalysisPermissionsOutputError>) -> Void)
    /// <p>Provides a summary for a dashboard.</p>
    func describeDashboard(input: DescribeDashboardInput, completion: @escaping (SdkResult<DescribeDashboardOutput, DescribeDashboardOutputError>) -> Void)
    /// <p>Describes read and write permissions for a dashboard.</p>
    func describeDashboardPermissions(input: DescribeDashboardPermissionsInput, completion: @escaping (SdkResult<DescribeDashboardPermissionsOutput, DescribeDashboardPermissionsOutputError>) -> Void)
    ...
    func describeDataSetPermissions(input: DescribeDataSetPermissionsInput, completion: @escaping (SdkResult<DescribeDataSetPermissionsOutput, DescribeDataSetPermissionsOutputError>) -> Void)
    ...
    func describeDataSourcePermissions(input: DescribeDataSourcePermissionsInput, completion: @escaping (SdkResult<DescribeDataSourcePermissionsOutput, DescribeDataSourcePermissionsOutputError>) -> Void)
    /// <p>Returns an Amazon QuickSight group's description and Amazon Resource Name (ARN). </p>
    func describeGroup(input: DescribeGroupInput, completion: @escaping (SdkResult<DescribeGroupOutput, DescribeGroupOutputError>) -> Void)
    /// <p>Describes an existing IAM policy assignment, as specified by the assignment name.</p>
    func describeIAMPolicyAssignment(input: DescribeIAMPolicyAssignmentInput, completion: @escaping (SdkResult<DescribeIAMPolicyAssignmentOutput, DescribeIAMPolicyAssignmentOutputError>) -> Void)
    /// <p>Describes a SPICE ingestion.</p>
    func describeIngestion(input: DescribeIngestionInput, completion: @escaping (SdkResult<DescribeIngestionOutput, DescribeIngestionOutputError>) -> Void)
    /// <p>Describes the current namespace.</p>
    func describeNamespace(input: DescribeNamespaceInput, completion: @escaping (SdkResult<DescribeNamespaceOutput, DescribeNamespaceOutputError>) -> Void)
    /// <p>Describes a template's metadata.</p>
    func describeTemplate(input: DescribeTemplateInput, completion: @escaping (SdkResult<DescribeTemplateOutput, DescribeTemplateOutputError>) -> Void)
    /// <p>Describes the template alias for a template.</p>
    func describeTemplateAlias(input: DescribeTemplateAliasInput, completion: @escaping (SdkResult<DescribeTemplateAliasOutput, DescribeTemplateAliasOutputError>) -> Void)
    /// <p>Describes read and write permissions on a template.</p>
    func describeTemplatePermissions(input: DescribeTemplatePermissionsInput, completion: @escaping (SdkResult<DescribeTemplatePermissionsOutput, DescribeTemplatePermissionsOutputError>) -> Void)
    /// <p>Describes a theme.</p>
    func describeTheme(input: DescribeThemeInput, completion: @escaping (SdkResult<DescribeThemeOutput, DescribeThemeOutputError>) -> Void)
    /// <p>Describes the alias for a theme.</p>
    func describeThemeAlias(input: DescribeThemeAliasInput, completion: @escaping (SdkResult<DescribeThemeAliasOutput, DescribeThemeAliasOutputError>) -> Void)
    /// <p>Describes the read and write permissions for a theme.</p>
    func describeThemePermissions(input: DescribeThemePermissionsInput, completion: @escaping (SdkResult<DescribeThemePermissionsOutput, DescribeThemePermissionsOutputError>) -> Void)
    ...
    ///             Guide</i>.</p>
    func getDashboardEmbedUrl(input: GetDashboardEmbedUrlInput, completion: @escaping (SdkResult<GetDashboardEmbedUrlOutput, GetDashboardEmbedUrlOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func getSessionEmbedUrl(input: GetSessionEmbedUrlInput, completion: @escaping (SdkResult<GetSessionEmbedUrlOutput, GetSessionEmbedUrlOutputError>) -> Void)
    /// <p>Lists Amazon QuickSight analyses that exist in the specified AWS account.</p>
    func listAnalyses(input: ListAnalysesInput, completion: @escaping (SdkResult<ListAnalysesOutput, ListAnalysesOutputError>) -> Void)
    /// <p>Lists dashboards in an AWS account.</p>
    func listDashboards(input: ListDashboardsInput, completion: @escaping (SdkResult<ListDashboardsOutput, ListDashboardsOutputError>) -> Void)
    /// <p>Lists all the versions of the dashboards in the QuickSight subscription.</p>
    func listDashboardVersions(input: ListDashboardVersionsInput, completion: @escaping (SdkResult<ListDashboardVersionsOutput, ListDashboardVersionsOutputError>) -> Void)
    ...
    func listGroupMemberships(input: ListGroupMembershipsInput, completion: @escaping (SdkResult<ListGroupMembershipsOutput, ListGroupMembershipsOutputError>) -> Void)
    ...
    func listIAMPolicyAssignments(input: ListIAMPolicyAssignmentsInput, completion: @escaping (SdkResult<ListIAMPolicyAssignmentsOutput, ListIAMPolicyAssignmentsOutputError>) -> Void)
    ...
    /// 			to.</p>
    func listIAMPolicyAssignmentsForUser(input: ListIAMPolicyAssignmentsForUserInput, completion: @escaping (SdkResult<ListIAMPolicyAssignmentsForUserOutput, ListIAMPolicyAssignmentsForUserOutputError>) -> Void)
    /// <p>Lists the history of SPICE ingestions for a dataset.</p>
    func listIngestions(input: ListIngestionsInput, completion: @escaping (SdkResult<ListIngestionsOutput, ListIngestionsOutputError>) -> Void)
    ...
    func listTemplateAliases(input: ListTemplateAliasesInput, completion: @escaping (SdkResult<ListTemplateAliasesOutput, ListTemplateAliasesOutputError>) -> Void)
    ...
    func listThemeAliases(input: ListThemeAliasesInput, completion: @escaping (SdkResult<ListThemeAliasesOutput, ListThemeAliasesOutputError>) -> Void)
    /// <p>Lists all the themes in the current AWS account.</p>
    func listThemes(input: ListThemesInput, completion: @escaping (SdkResult<ListThemesOutput, ListThemesOutputError>) -> Void)
    /// <p>Lists all the versions of the themes in the current AWS account.</p>
    func listThemeVersions(input: ListThemeVersionsInput, completion: @escaping (SdkResult<ListThemeVersionsOutput, ListThemeVersionsOutputError>) -> Void)
    /// <p>Lists the Amazon QuickSight groups that an Amazon QuickSight user is a member of.</p>
    func listUserGroups(input: ListUserGroupsInput, completion: @escaping (SdkResult<ListUserGroupsOutput, ListUserGroupsOutputError>) -> Void)
    ...
    func registerUser(input: RegisterUserInput, completion: @escaping (SdkResult<RegisterUserOutput, RegisterUserOutputError>) -> Void)
    /// <p>Restores an analysis.</p>
    func restoreAnalysis(input: RestoreAnalysisInput, completion: @escaping (SdkResult<RestoreAnalysisOutput, RestoreAnalysisOutputError>) -> Void)
    /// <p>Searches for analyses that belong to the user specified in the filter.</p>
    func searchAnalyses(input: SearchAnalysesInput, completion: @escaping (SdkResult<SearchAnalysesOutput, SearchAnalysesOutputError>) -> Void)
    /// <p>Searches for dashboards that belong to a user. </p>
    func searchDashboards(input: SearchDashboardsInput, completion: @escaping (SdkResult<SearchDashboardsOutput, SearchDashboardsOutputError>) -> Void)
    ...
    ///             customizations that apply to an AWS account. To find out which customizations apply, use
    ///             the <code>DescribeAccountCustomization</code> API operation. </p>
    func updateAccountCustomization(input: UpdateAccountCustomizationInput, completion: @escaping (SdkResult<UpdateAccountCustomizationOutput, UpdateAccountCustomizationOutputError>) -> Void)
    /// <p>Updates the Amazon QuickSight settings in your AWS account.</p>
    func updateAccountSettings(input: UpdateAccountSettingsInput, completion: @escaping (SdkResult<UpdateAccountSettingsOutput, UpdateAccountSettingsOutputError>) -> Void)
    /// <p>Updates an analysis in Amazon QuickSight</p>
    func updateAnalysis(input: UpdateAnalysisInput, completion: @escaping (SdkResult<UpdateAnalysisOutput, UpdateAnalysisOutputError>) -> Void)
    /// <p>Updates the read and write permissions for an analysis.</p>
    func updateAnalysisPermissions(input: UpdateAnalysisPermissionsInput, completion: @escaping (SdkResult<UpdateAnalysisPermissionsOutput, UpdateAnalysisPermissionsOutputError>) -> Void)
    /// <p>Updates a dashboard in an AWS account.</p>
    func updateDashboard(input: UpdateDashboardInput, completion: @escaping (SdkResult<UpdateDashboardOutput, UpdateDashboardOutputError>) -> Void)
    /// <p>Updates read and write permissions on a dashboard.</p>
    func updateDashboardPermissions(input: UpdateDashboardPermissionsInput, completion: @escaping (SdkResult<UpdateDashboardPermissionsOutput, UpdateDashboardPermissionsOutputError>) -> Void)
    /// <p>Updates the published version of a dashboard.</p>
    func updateDashboardPublishedVersion(input: UpdateDashboardPublishedVersionInput, completion: @escaping (SdkResult<UpdateDashboardPublishedVersionOutput, UpdateDashboardPublishedVersionOutputError>) -> Void)
    ...
    /// 		       <p>The permissions resource is <code>arn:aws:quicksight:region:aws-account-id:dataset/data-set-id</code>.</p>
    func updateDataSetPermissions(input: UpdateDataSetPermissionsInput, completion: @escaping (SdkResult<UpdateDataSetPermissionsOutput, UpdateDataSetPermissionsOutputError>) -> Void)
    ...
    func updateDataSourcePermissions(input: UpdateDataSourcePermissionsInput, completion: @escaping (SdkResult<UpdateDataSourcePermissionsOutput, UpdateDataSourcePermissionsOutputError>) -> Void)
    ...
    /// 		</p>
    func updateIAMPolicyAssignment(input: UpdateIAMPolicyAssignmentInput, completion: @escaping (SdkResult<UpdateIAMPolicyAssignmentOutput, UpdateIAMPolicyAssignmentOutputError>) -> Void)
    /// <p>Updates a template from an existing Amazon QuickSight analysis or another template.</p>
    func updateTemplate(input: UpdateTemplateInput, completion: @escaping (SdkResult<UpdateTemplateOutput, UpdateTemplateOutputError>) -> Void)
    /// <p>Updates the template alias of a template.</p>
    func updateTemplateAlias(input: UpdateTemplateAliasInput, completion: @escaping (SdkResult<UpdateTemplateAliasOutput, UpdateTemplateAliasOutputError>) -> Void)
    /// <p>Updates the resource permissions for a template.</p>
    func updateTemplatePermissions(input: UpdateTemplatePermissionsInput, completion: @escaping (SdkResult<UpdateTemplatePermissionsOutput, UpdateTemplatePermissionsOutputError>) -> Void)
    /// <p>Updates a theme.</p>
    func updateTheme(input: UpdateThemeInput, completion: @escaping (SdkResult<UpdateThemeOutput, UpdateThemeOutputError>) -> Void)
    /// <p>Updates an alias of a theme.</p>
    func updateThemeAlias(input: UpdateThemeAliasInput, completion: @escaping (SdkResult<UpdateThemeAliasOutput, UpdateThemeAliasOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func updateThemePermissions(input: UpdateThemePermissionsInput, completion: @escaping (SdkResult<UpdateThemePermissionsOutput, UpdateThemePermissionsOutputError>) -> Void)
