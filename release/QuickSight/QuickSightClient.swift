...
public class QuickSightClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try QuickSightClientConfiguration(region: unwrappedRegion)
    ...
    public class QuickSightClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("QuickSightClient")
