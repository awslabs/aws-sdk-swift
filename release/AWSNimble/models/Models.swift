...
public struct AcceptEulasInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "AcceptEulasInputURLHostMiddleware"
...
public struct CreateLaunchProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateLaunchProfileInputURLHostMiddleware"
...
public struct CreateStreamingImageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStreamingImageInputURLHostMiddleware"
...
public struct CreateStreamingSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStreamingSessionInputURLHostMiddleware"
...
public struct CreateStreamingSessionStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStreamingSessionStreamInputURLHostMiddleware"
...
public struct CreateStudioComponentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStudioComponentInputURLHostMiddleware"
...
public struct CreateStudioInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateStudioInputURLHostMiddleware"
...
public struct DeleteLaunchProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteLaunchProfileInputURLHostMiddleware"
...
public struct DeleteLaunchProfileMemberInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteLaunchProfileMemberInputURLHostMiddleware"
...
public struct DeleteStreamingImageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStreamingImageInputURLHostMiddleware"
...
public struct DeleteStreamingSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStreamingSessionInputURLHostMiddleware"
...
public struct DeleteStudioComponentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStudioComponentInputURLHostMiddleware"
...
public struct DeleteStudioInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStudioInputURLHostMiddleware"
...
public struct DeleteStudioMemberInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteStudioMemberInputURLHostMiddleware"
...
public struct GetEulaInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetEulaInputURLHostMiddleware"
...
public struct GetLaunchProfileDetailsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLaunchProfileDetailsInputURLHostMiddleware"
...
public struct GetLaunchProfileInitializationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLaunchProfileInitializationInputURLHostMiddleware"
...
public struct GetLaunchProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLaunchProfileInputURLHostMiddleware"
...
public struct GetLaunchProfileMemberInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetLaunchProfileMemberInputURLHostMiddleware"
...
public struct GetStreamingImageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamingImageInputURLHostMiddleware"
...
public struct GetStreamingSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamingSessionInputURLHostMiddleware"
...
public struct GetStreamingSessionStreamInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStreamingSessionStreamInputURLHostMiddleware"
...
public struct GetStudioComponentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStudioComponentInputURLHostMiddleware"
...
public struct GetStudioInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStudioInputURLHostMiddleware"
...
public struct GetStudioMemberInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetStudioMemberInputURLHostMiddleware"
...
extension NimbleClientTypes.LaunchProfileMembership: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "LaunchProfileMembership(identityStoreId: \(Swift.String(describing: identityStoreId)), persona: \(Swift.String(describing: persona)), principalId: \(Swift.String(describing: principalId)), sid: \(Swift.String(describing: sid)))"}
}
...
public struct ListEulaAcceptancesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListEulaAcceptancesInputURLHostMiddleware"
...
public struct ListEulasInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListEulasInputURLHostMiddleware"
...
public struct ListLaunchProfileMembersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListLaunchProfileMembersInputURLHostMiddleware"
...
public struct ListLaunchProfilesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListLaunchProfilesInputURLHostMiddleware"
...
public struct ListStreamingImagesInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamingImagesInputURLHostMiddleware"
...
public struct ListStreamingSessionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStreamingSessionsInputURLHostMiddleware"
...
public struct ListStudioComponentsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStudioComponentsInputURLHostMiddleware"
...
public struct ListStudioMembersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStudioMembersInputURLHostMiddleware"
...
public struct ListStudiosInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListStudiosInputURLHostMiddleware"
...
public struct PutLaunchProfileMembersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutLaunchProfileMembersInputURLHostMiddleware"
...
public struct PutStudioMembersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutStudioMembersInputURLHostMiddleware"
...
extension StartStreamingSessionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartStreamingSessionInput(clientToken: \(Swift.String(describing: clientToken)), sessionId: \(Swift.String(describing: sessionId)), studioId: \(Swift.String(describing: studioId)))"}
}

extension StartStreamingSessionInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct StartStreamingSessionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartStreamingSessionInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StartStreamingSessionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StartStreamingSessionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StartStreamingSessionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StartStreamingSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartStreamingSessionOutputError>
}

public struct StartStreamingSessionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartStreamingSessionInputQueryItemMiddleware"
...
public struct StartStreamingSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartStreamingSessionInputURLHostMiddleware"
    ...
    public typealias MInput = StartStreamingSessionInput
    public typealias MOutput = ClientRuntime.OperationOutput<StartStreamingSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StartStreamingSessionOutputError>
}

public struct StartStreamingSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartStreamingSessionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-08-01/studios/\(studioId.urlPercentEncoding())/streaming-sessions/\(sessionId.urlPercentEncoding())/start"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension StartStreamingSessionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StartStreamingSessionOutputResponse(session: \(Swift.String(describing: session)))"}
}
...
public struct StartStudioSSOConfigurationRepairInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StartStudioSSOConfigurationRepairInputURLHostMiddleware"
...
extension StopStreamingSessionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopStreamingSessionInput(clientToken: \(Swift.String(describing: clientToken)), sessionId: \(Swift.String(describing: sessionId)), studioId: \(Swift.String(describing: studioId)))"}
}

extension StopStreamingSessionInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct StopStreamingSessionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopStreamingSessionInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<StopStreamingSessionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<StopStreamingSessionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<StopStreamingSessionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<StopStreamingSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopStreamingSessionOutputError>
}

public struct StopStreamingSessionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopStreamingSessionInputQueryItemMiddleware"
...
public struct StopStreamingSessionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopStreamingSessionInputURLHostMiddleware"
    ...
    public typealias MInput = StopStreamingSessionInput
    public typealias MOutput = ClientRuntime.OperationOutput<StopStreamingSessionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<StopStreamingSessionOutputError>
}

public struct StopStreamingSessionInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopStreamingSessionInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/2020-08-01/studios/\(studioId.urlPercentEncoding())/streaming-sessions/\(sessionId.urlPercentEncoding())/stop"
        if let urlPrefix = urlPrefix, !urlPrefix.isEmpty {
            urlPath = "\(urlPrefix)\(urlPath)"
        }
        var copiedContext = context
...
extension StopStreamingSessionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StopStreamingSessionOutputResponse(session: \(Swift.String(describing: session)))"}
}
...
extension NimbleClientTypes.StreamConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamConfiguration(clipboardMode: \(Swift.String(describing: clipboardMode)), ec2InstanceTypes: \(Swift.String(describing: ec2InstanceTypes)), maxSessionLengthInMinutes: \(Swift.String(describing: maxSessionLengthInMinutes)), maxStoppedSessionLengthInMinutes: \(Swift.String(describing: maxStoppedSessionLengthInMinutes)), streamingImageIds: \(Swift.String(describing: streamingImageIds)))"}
}
...
extension NimbleClientTypes.StreamConfigurationCreate: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamConfigurationCreate(clipboardMode: \(Swift.String(describing: clipboardMode)), ec2InstanceTypes: \(Swift.String(describing: ec2InstanceTypes)), maxSessionLengthInMinutes: \(Swift.String(describing: maxSessionLengthInMinutes)), maxStoppedSessionLengthInMinutes: \(Swift.String(describing: maxStoppedSessionLengthInMinutes)), streamingImageIds: \(Swift.String(describing: streamingImageIds)))"}
}
...
extension NimbleClientTypes.StreamingSession: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StreamingSession(arn: \(Swift.String(describing: arn)), createdAt: \(Swift.String(describing: createdAt)), createdBy: \(Swift.String(describing: createdBy)), ec2InstanceType: \(Swift.String(describing: ec2InstanceType)), launchProfileId: \(Swift.String(describing: launchProfileId)), ownedBy: \(Swift.String(describing: ownedBy)), sessionId: \(Swift.String(describing: sessionId)), startedAt: \(Swift.String(describing: startedAt)), startedBy: \(Swift.String(describing: startedBy)), state: \(Swift.String(describing: state)), statusCode: \(Swift.String(describing: statusCode)), statusMessage: \(Swift.String(describing: statusMessage)), stopAt: \(Swift.String(describing: stopAt)), stoppedAt: \(Swift.String(describing: stoppedAt)), stoppedBy: \(Swift.String(describing: stoppedBy)), streamingImageId: \(Swift.String(describing: streamingImageId)), tags: \(Swift.String(describing: tags)), terminateAt: \(Swift.String(describing: terminateAt)), updatedAt: \(Swift.String(describing: updatedAt)), updatedBy: \(Swift.String(describing: updatedBy)))"}
}
...
extension NimbleClientTypes.StudioMembership: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "StudioMembership(identityStoreId: \(Swift.String(describing: identityStoreId)), persona: \(Swift.String(describing: persona)), principalId: \(Swift.String(describing: principalId)), sid: \(Swift.String(describing: sid)))"}
}
...
public struct UpdateLaunchProfileInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLaunchProfileInputURLHostMiddleware"
...
public struct UpdateLaunchProfileMemberInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateLaunchProfileMemberInputURLHostMiddleware"
...
public struct UpdateStreamingImageInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateStreamingImageInputURLHostMiddleware"
...
public struct UpdateStudioComponentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateStudioComponentInputURLHostMiddleware"
...
public struct UpdateStudioInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateStudioInputURLHostMiddleware"
