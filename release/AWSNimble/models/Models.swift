...
public struct AcceptEulasInput: Swift.Equatable {
    ...
    var clientToken: Swift.String?
    /// The EULA ID.
    var eulaIds: [Swift.String]?
    /// A collection of EULA IDs.
    /// This member is required.
    var studioId: Swift.String?
...
public struct AcceptEulasOutputResponse: Swift.Equatable {
    ...
    var eulaAcceptances: [NimbleClientTypes.EulaAcceptance]?
...
extension NimbleClientTypes {
    ...
    public struct ActiveDirectoryConfiguration: Swift.Equatable {
        ...
        var computerAttributes: [NimbleClientTypes.ActiveDirectoryComputerAttribute]?
...
extension NimbleClientTypes {
    ...
    public struct ComputeFarmConfiguration: Swift.Equatable {
        ...
        var activeDirectoryUser: Swift.String?
...
public struct CreateLaunchProfileInput: Swift.Equatable {
    ...
    /// This member is required.
    var ec2SubnetIds: [Swift.String]?
    /// The version number of the protocol that is used by the launch profile. The only valid version is "2021-03-31".
    /// This member is required.
    var launchProfileProtocolVersions: [Swift.String]?
    /// The name for the launch profile.
    /// This member is required.
    var name: Swift.String?
    /// A configuration for a streaming session.
    /// This member is required.
    var streamConfiguration: NimbleClientTypes.StreamConfigurationCreate?
    /// Unique identifiers for a collection of studio components that can be used with this launch profile.
    /// This member is required.
    var studioComponentIds: [Swift.String]?
    /// The studio ID.
    /// This member is required.
    var studioId: Swift.String?
...
public struct CreateLaunchProfileOutputResponse: Swift.Equatable {
    /// The launch profile.
    var launchProfile: NimbleClientTypes.LaunchProfile?
...
public struct CreateStreamingImageOutputResponse: Swift.Equatable {
    /// The streaming image.
    var streamingImage: NimbleClientTypes.StreamingImage?
...
public struct CreateStreamingSessionInput: Swift.Equatable {
    ...
    var ec2InstanceType: NimbleClientTypes.StreamingInstanceType?
    /// The launch profile ID.
    var launchProfileId: Swift.String?
    /// The user ID of the user that owns the streaming session.
    var ownedBy: Swift.String?
    /// The ID of the streaming image.
    var streamingImageId: Swift.String?
    /// The studio ID.
    /// This member is required.
    var studioId: Swift.String?
    /// A collection of labels, in the form of key:value pairs, that apply to this resource.
...
public struct CreateStreamingSessionOutputResponse: Swift.Equatable {
    /// The session.
    var session: NimbleClientTypes.StreamingSession?
...
public struct CreateStreamingSessionStreamInput: Swift.Equatable {
    ...
    var expirationInSeconds: Swift.Int?
...
public struct CreateStreamingSessionStreamOutputResponse: Swift.Equatable {
    /// The stream.
    var stream: NimbleClientTypes.StreamingSessionStream?
...
public struct CreateStudioComponentInput: Swift.Equatable {
    ...
    var configuration: NimbleClientTypes.StudioComponentConfiguration?
    /// The description.
    var description: Swift.String?
    /// The EC2 security groups that control access to the studio component.
    var ec2SecurityGroupIds: [Swift.String]?
    /// Initialization scripts for studio components.
    var initializationScripts: [NimbleClientTypes.StudioComponentInitializationScript]?
    /// The name for the studio component.
    /// This member is required.
    var name: Swift.String?
    /// Parameters for the studio component scripts.
    var scriptParameters: [NimbleClientTypes.ScriptParameterKeyValue]?
    /// The studio ID.
    /// This member is required.
    var studioId: Swift.String?
    /// The specific subtype of a studio component.
    var subtype: NimbleClientTypes.StudioComponentSubtype?
    /// A collection of labels, in the form of key:value pairs, that apply to this resource.
    var tags: [Swift.String:Swift.String]?
    /// The type of the studio component.
    /// This member is required.
    var type: NimbleClientTypes.StudioComponentType?
...
public struct CreateStudioComponentOutputResponse: Swift.Equatable {
    ...
    var studioComponent: NimbleClientTypes.StudioComponent?
...
public struct CreateStudioInput: Swift.Equatable {
    ...
    var studioEncryptionConfiguration: NimbleClientTypes.StudioEncryptionConfiguration?
    /// The studio name that is used in the URL of the Nimble Studio portal when accessed by Nimble Studio users.
    /// This member is required.
    var studioName: Swift.String?
    /// A collection of labels, in the form of key:value pairs, that apply to this resource.
    var tags: [Swift.String:Swift.String]?
    /// The IAM role that Studio Users will assume when logging in to the Nimble Studio portal.
    /// This member is required.
    var userRoleArn: Swift.String?
...
public struct CreateStudioOutputResponse: Swift.Equatable {
    ...
    var studio: NimbleClientTypes.Studio?
...
public struct DeleteStudioComponentInput: Swift.Equatable {
    ...
    /// This member is required.
    var studioComponentId: Swift.String?
    /// The studio ID.
    /// This member is required.
    var studioId: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct EulaAcceptance: Swift.Equatable {
        ...
        var acceptedAt: ClientRuntime.Date?
        /// The ID of the person who accepted the EULA.
        var acceptedBy: Swift.String?
        /// The ID of the acceptee.
        var accepteeId: Swift.String?
        /// The EULA acceptance ID.
        var eulaAcceptanceId: Swift.String?
        /// The EULA ID.
        var eulaId: Swift.String?
...
public struct GetEulaOutputResponse: Swift.Equatable {
    /// The EULA.
    var eula: NimbleClientTypes.Eula?
...
public struct GetLaunchProfileDetailsOutputResponse: Swift.Equatable {
    ...
    var streamingImages: [NimbleClientTypes.StreamingImage]?
    /// A collection of studio component summaries.
    var studioComponentSummaries: [NimbleClientTypes.StudioComponentSummary]?
...
public struct GetLaunchProfileInitializationInput: Swift.Equatable {
    ...
    /// The launch purpose.
    /// This member is required.
    var launchPurpose: Swift.String?
    /// The platform where this Launch Profile will be used, either WINDOWS or LINUX.
    /// This member is required.
    var platform: Swift.String?
    /// The studio ID.
    /// This member is required.
    var studioId: Swift.String?
...
public struct GetLaunchProfileInitializationOutputResponse: Swift.Equatable {
    ...
    var launchProfileInitialization: NimbleClientTypes.LaunchProfileInitialization?
...
public struct GetLaunchProfileMemberOutputResponse: Swift.Equatable {
    /// The member.
    var member: NimbleClientTypes.LaunchProfileMembership?
...
public struct GetStudioMemberOutputResponse: Swift.Equatable {
    /// The member.
    var member: NimbleClientTypes.StudioMembership?
...
extension NimbleClientTypes {
    ...
    public struct LaunchProfile: Swift.Equatable {
        ...
        var name: Swift.String?
        /// The current state.
        var state: NimbleClientTypes.LaunchProfileState?
        /// The status code.
        var statusCode: NimbleClientTypes.LaunchProfileStatusCode?
        /// The status message for the launch profile.
        var statusMessage: Swift.String?
        /// A configuration for a streaming session.
        var streamConfiguration: NimbleClientTypes.StreamConfiguration?
        /// Unique identifiers for a collection of studio components that can be used with this launch profile.
        var studioComponentIds: [Swift.String]?
        /// A collection of labels, in the form of key:value pairs, that apply to this resource.
        var tags: [Swift.String:Swift.String]?
...
extension NimbleClientTypes {
    ...
    public struct LaunchProfileInitialization: Swift.Equatable {
        ...
        var activeDirectory: NimbleClientTypes.LaunchProfileInitializationActiveDirectory?
        /// The EC2 security groups that control access to the studio component.
        var ec2SecurityGroupIds: [Swift.String]?
        /// The launch profile ID.
        var launchProfileId: Swift.String?
        /// The version number of the protocol that is used by the launch profile. The only valid version is "2021-03-31".
        var launchProfileProtocolVersion: Swift.String?
        /// The launch purpose.
        var launchPurpose: Swift.String?
        /// The name for the launch profile.
        var name: Swift.String?
        /// The platform of the launch platform, either WINDOWS or LINUX.
        var platform: NimbleClientTypes.LaunchProfilePlatform?
        /// The system initializtion scripts.
        var systemInitializationScripts: [NimbleClientTypes.LaunchProfileInitializationScript]?
        /// The user initializtion scripts.
        var userInitializationScripts: [NimbleClientTypes.LaunchProfileInitializationScript]?
...
extension NimbleClientTypes {
    ...
    public struct LaunchProfileInitializationActiveDirectory: Swift.Equatable {
        ...
        /// The DNS IP address.
        var dnsIpAddresses: [Swift.String]?
        /// The name for the organizational unit distinguished name.
        var organizationalUnitDistinguishedName: Swift.String?
        /// The unique identifier for a studio component resource.
        var studioComponentId: Swift.String?
        /// The name for the studio component.
        var studioComponentName: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct LaunchProfileMembership: Swift.Equatable {
        ...
        var identityStoreId: Swift.String?
        /// The persona.
        var persona: NimbleClientTypes.LaunchProfilePersona?
        /// The principal ID.
        var principalId: Swift.String?
        /// The Active Directory Security Identifier for this user, if available.
        var sid: Swift.String?
...
public struct ListEulasOutputResponse: Swift.Equatable {
    ...
    var eulas: [NimbleClientTypes.Eula]?
    /// The token for the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListLaunchProfileMembersOutputResponse: Swift.Equatable {
    /// A list of members.
    var members: [NimbleClientTypes.LaunchProfileMembership]?
    /// The token for the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListLaunchProfilesOutputResponse: Swift.Equatable {
    ...
    var launchProfiles: [NimbleClientTypes.LaunchProfile]?
    /// The token for the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListStreamingSessionsOutputResponse: Swift.Equatable {
    ...
    var sessions: [NimbleClientTypes.StreamingSession]?
...
public struct ListStudioComponentsOutputResponse: Swift.Equatable {
    ...
    var studioComponents: [NimbleClientTypes.StudioComponent]?
...
public struct ListStudioMembersOutputResponse: Swift.Equatable {
    /// A list of members.
    var members: [NimbleClientTypes.StudioMembership]?
    /// The token for the next set of results, or null if there are no more results.
    var nextToken: Swift.String?
...
public struct ListStudiosOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var studios: [NimbleClientTypes.Studio]?
...
extension NimbleClientTypes {
    ...
    public struct NewStudioMember: Swift.Equatable {
        /// The persona.
        /// This member is required.
        var persona: NimbleClientTypes.StudioPersona?
        /// The principal ID.
        /// This member is required.
        var principalId: Swift.String?
...
public struct PutLaunchProfileMembersInput: Swift.Equatable {
    ...
    /// A list of members.
    /// This member is required.
    var members: [NimbleClientTypes.NewLaunchProfileMember]?
    /// The studio ID.
    /// This member is required.
    var studioId: Swift.String?
...
public struct PutStudioMembersInput: Swift.Equatable {
    ...
    /// A list of members.
    /// This member is required.
    var members: [NimbleClientTypes.NewStudioMember]?
    /// The studio ID.
    /// This member is required.
    var studioId: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct SharedFileSystemConfiguration: Swift.Equatable {
        ...
        var linuxMountPoint: Swift.String?
        /// The name of the file share.
        var shareName: Swift.String?
        /// The mount location for a shared file system on a Windows virtual workstation.
        var windowsMountDrive: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct StreamConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var clipboardMode: NimbleClientTypes.StreamingClipboardMode?
        /// The EC2 instance types that users can select from when launching a streaming session with this launch profile.
        /// This member is required.
        var ec2InstanceTypes: [NimbleClientTypes.StreamingInstanceType]?
        /// The length of time, in minutes, that a streaming session can be active before it is stopped or terminated. After this point, Nimble Studio automatically terminates or stops the session. The default length of time is 690 minutes, and the maximum length of time is 30 days.
        var maxSessionLengthInMinutes: Swift.Int?
        ...
        var maxStoppedSessionLengthInMinutes: Swift.Int?
        /// The streaming images that users can select from when launching a streaming session with this launch profile.
        /// This member is required.
        var streamingImageIds: [Swift.String]?
...
extension NimbleClientTypes {
    ...
    public struct StreamingImage: Swift.Equatable {
        ...
        var encryptionConfiguration: NimbleClientTypes.StreamingImageEncryptionConfiguration?
        ...
        var platform: Swift.String?
        /// The current state.
        var state: NimbleClientTypes.StreamingImageState?
        /// The status code.
        var statusCode: NimbleClientTypes.StreamingImageStatusCode?
...
extension NimbleClientTypes {
    ...
    public struct StreamingImageEncryptionConfiguration: Swift.Equatable {
        ...
        var keyArn: Swift.String?
        /// The type of KMS key that is used to encrypt studio data.
        /// This member is required.
        var keyType: NimbleClientTypes.StreamingImageEncryptionConfigurationKeyType?
...
extension NimbleClientTypes {
    ...
    public struct StreamingSession: Swift.Equatable {
        ...
        var createdBy: Swift.String?
        /// The EC2 Instance type used for the streaming session.
        var ec2InstanceType: Swift.String?
        ...
        var startedBy: Swift.String?
        /// The current state.
        var state: NimbleClientTypes.StreamingSessionState?
        /// The status code.
        var statusCode: NimbleClientTypes.StreamingSessionStatusCode?
        /// The status message for the streaming session.
        var statusMessage: Swift.String?
        /// The time the streaming session will automatically be stopped if the user doesn’t stop the session themselves.
        var stopAt: ClientRuntime.Date?
        /// The time the session entered STOP_IN_PROGRESS state.
        var stoppedAt: ClientRuntime.Date?
        /// The user ID of the user that stopped the streaming session.
        var stoppedBy: Swift.String?
        /// The ID of the streaming image.
        var streamingImageId: Swift.String?
        /// A collection of labels, in the form of key:value pairs, that apply to this resource.
        var tags: [Swift.String:Swift.String]?
        /// The time the streaming session will automatically terminate if not terminated by the user.
        var terminateAt: ClientRuntime.Date?
        /// The Unix epoch timestamp in seconds for when the resource was updated.
        var updatedAt: ClientRuntime.Date?
        /// The user ID of the user that most recently updated the resource.
        var updatedBy: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct StreamingSessionStream: Swift.Equatable {
        ...
        var expiresAt: ClientRuntime.Date?
        /// The user ID of the user that owns the streaming session.
        var ownedBy: Swift.String?
        /// The current state.
        var state: NimbleClientTypes.StreamingSessionStreamState?
        /// The streaming session stream status code.
        var statusCode: NimbleClientTypes.StreamingSessionStreamStatusCode?
        /// The stream ID.
        var streamId: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct Studio: Swift.Equatable {
        ...
        var ssoClientId: Swift.String?
        /// The current state of the studio resource.
        var state: NimbleClientTypes.StudioState?
        /// Status codes that provide additional detail on the studio state.
        var statusCode: NimbleClientTypes.StudioStatusCode?
...
extension NimbleClientTypes {
    ...
    public struct StudioComponent: Swift.Equatable {
        ...
        var scriptParameters: [NimbleClientTypes.ScriptParameterKeyValue]?
        /// The current state.
        var state: NimbleClientTypes.StudioComponentState?
        /// The status code.
        var statusCode: NimbleClientTypes.StudioComponentStatusCode?
...
extension NimbleClientTypes {
    ...
    public struct StudioComponentInitializationScript: Swift.Equatable {
        ...
        var runContext: NimbleClientTypes.StudioComponentInitializationScriptRunContext?
        /// The initialization script.
        var script: Swift.String?
...
extension NimbleClientTypes {
    ...
    public struct StudioEncryptionConfiguration: Swift.Equatable {
        ...
        /// The type of KMS key that is used to encrypt studio data.
        /// This member is required.
        var keyType: NimbleClientTypes.StudioEncryptionConfigurationKeyType?
