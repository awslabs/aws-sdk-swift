...
extension Route53ClientTypes.HealthCheckConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "HealthCheckConfig(alarmIdentifier: \(Swift.String(describing: alarmIdentifier)), childHealthChecks: \(Swift.String(describing: childHealthChecks)), disabled: \(Swift.String(describing: disabled)), enableSNI: \(Swift.String(describing: enableSNI)), failureThreshold: \(Swift.String(describing: failureThreshold)), fullyQualifiedDomainName: \(Swift.String(describing: fullyQualifiedDomainName)), healthThreshold: \(Swift.String(describing: healthThreshold)), iPAddress: \(Swift.String(describing: iPAddress)), insufficientDataHealthStatus: \(Swift.String(describing: insufficientDataHealthStatus)), inverted: \(Swift.String(describing: inverted)), measureLatency: \(Swift.String(describing: measureLatency)), port: \(Swift.String(describing: port)), regions: \(Swift.String(describing: regions)), requestInterval: \(Swift.String(describing: requestInterval)), resourcePath: \(Swift.String(describing: resourcePath)), routingControlArn: \(Swift.String(describing: routingControlArn)), searchString: \(Swift.String(describing: searchString)), type: \(Swift.String(describing: type)))"}
}
