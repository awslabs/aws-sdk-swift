...
public protocol SqsClientProtocol {
    ...
    ///          </important>
    func changeMessageVisibility(input: ChangeMessageVisibilityInput, completion: @escaping (SdkResult<ChangeMessageVisibilityOutputResponse, ChangeMessageVisibilityOutputError>) -> Void)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    func changeMessageVisibilityBatch(input: ChangeMessageVisibilityBatchInput, completion: @escaping (SdkResult<ChangeMessageVisibilityBatchOutputResponse, ChangeMessageVisibilityBatchOutputError>) -> Void)
    ...
    ///          </note>
    func deleteMessage(input: DeleteMessageInput, completion: @escaping (SdkResult<DeleteMessageOutputResponse, DeleteMessageOutputError>) -> Void)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    func deleteMessageBatch(input: DeleteMessageBatchInput, completion: @escaping (SdkResult<DeleteMessageBatchOutputResponse, DeleteMessageBatchOutputError>) -> Void)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///          </note>
    func deleteQueue(input: DeleteQueueInput, completion: @escaping (SdkResult<DeleteQueueOutputResponse, DeleteQueueOutputError>) -> Void)
    ...
    ///          </note>
    func getQueueAttributes(input: GetQueueAttributesInput, completion: @escaping (SdkResult<GetQueueAttributesOutputResponse, GetQueueAttributesOutputError>) -> Void)
    ...
    ///     </p>
    func getQueueUrl(input: GetQueueUrlInput, completion: @escaping (SdkResult<GetQueueUrlOutputResponse, GetQueueUrlOutputError>) -> Void)
    ...
    func listDeadLetterSourceQueues(input: ListDeadLetterSourceQueuesInput, completion: @escaping (SdkResult<ListDeadLetterSourceQueuesOutputResponse, ListDeadLetterSourceQueuesOutputError>) -> Void)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    func listQueueTags(input: ListQueueTagsInput, completion: @escaping (SdkResult<ListQueueTagsOutputResponse, ListQueueTagsOutputError>) -> Void)
    ...
    func purgeQueue(input: PurgeQueueInput, completion: @escaping (SdkResult<PurgeQueueOutputResponse, PurgeQueueOutputError>) -> Void)
    ...
    ///          </note>
    func receiveMessage(input: ReceiveMessageInput, completion: @escaping (SdkResult<ReceiveMessageOutputResponse, ReceiveMessageOutputError>) -> Void)
    ...
    ///          </important>
    func sendMessage(input: SendMessageInput, completion: @escaping (SdkResult<SendMessageOutputResponse, SendMessageOutputError>) -> Void)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    func sendMessageBatch(input: SendMessageBatchInput, completion: @escaping (SdkResult<SendMessageBatchOutputResponse, SendMessageBatchOutputError>) -> Void)
    ...
    ///             </ul>
    ///          </note>
    func setQueueAttributes(input: SetQueueAttributesInput, completion: @escaping (SdkResult<SetQueueAttributesOutputResponse, SetQueueAttributesOutputError>) -> Void)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    func tagQueue(input: TagQueueInput, completion: @escaping (SdkResult<TagQueueOutputResponse, TagQueueOutputError>) -> Void)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    func untagQueue(input: UntagQueueInput, completion: @escaping (SdkResult<UntagQueueOutputResponse, UntagQueueOutputError>) -> Void)
}
