...
public protocol SqsClientProtocol {
    ...
    ///          </important>
    func changeMessageVisibility(input: ChangeMessageVisibilityInput, completion: @escaping (SdkResult<ChangeMessageVisibilityOutput, ChangeMessageVisibilityOutputError>) -> Void)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    func changeMessageVisibilityBatch(input: ChangeMessageVisibilityBatchInput, completion: @escaping (SdkResult<ChangeMessageVisibilityBatchOutput, ChangeMessageVisibilityBatchOutputError>) -> Void)
    ...
    ///          </note>
    func deleteMessage(input: DeleteMessageInput, completion: @escaping (SdkResult<DeleteMessageOutput, DeleteMessageOutputError>) -> Void)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    func deleteMessageBatch(input: DeleteMessageBatchInput, completion: @escaping (SdkResult<DeleteMessageBatchOutput, DeleteMessageBatchOutputError>) -> Void)
    ...
    ///          </note>
    func getQueueAttributes(input: GetQueueAttributesInput, completion: @escaping (SdkResult<GetQueueAttributesOutput, GetQueueAttributesOutputError>) -> Void)
    ...
    ///     </p>
    func getQueueUrl(input: GetQueueUrlInput, completion: @escaping (SdkResult<GetQueueUrlOutput, GetQueueUrlOutputError>) -> Void)
    ...
    func listDeadLetterSourceQueues(input: ListDeadLetterSourceQueuesInput, completion: @escaping (SdkResult<ListDeadLetterSourceQueuesOutput, ListDeadLetterSourceQueuesOutputError>) -> Void)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    func listQueueTags(input: ListQueueTagsInput, completion: @escaping (SdkResult<ListQueueTagsOutput, ListQueueTagsOutputError>) -> Void)
    ...
    func purgeQueue(input: PurgeQueueInput, completion: @escaping (SdkResult<PurgeQueueOutput, PurgeQueueOutputError>) -> Void)
    ...
    ///          </note>
    func receiveMessage(input: ReceiveMessageInput, completion: @escaping (SdkResult<ReceiveMessageOutput, ReceiveMessageOutputError>) -> Void)
    ...
    ///          </important>
    func sendMessage(input: SendMessageInput, completion: @escaping (SdkResult<SendMessageOutput, SendMessageOutputError>) -> Void)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    func sendMessageBatch(input: SendMessageBatchInput, completion: @escaping (SdkResult<SendMessageBatchOutput, SendMessageBatchOutputError>) -> Void)
    ...
    ///             </ul>
    ///          </note>
    func setQueueAttributes(input: SetQueueAttributesInput, completion: @escaping (SdkResult<SetQueueAttributesOutput, SetQueueAttributesOutputError>) -> Void)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    func tagQueue(input: TagQueueInput, completion: @escaping (SdkResult<TagQueueOutput, TagQueueOutputError>) -> Void)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    func untagQueue(input: UntagQueueInput, completion: @escaping (SdkResult<UntagQueueOutput, UntagQueueOutputError>) -> Void)
}
