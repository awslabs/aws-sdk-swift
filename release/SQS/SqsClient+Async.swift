...
public extension SqsClient {
    ...
    {
        typealias changeMessageVisibilityContinuation = CheckedContinuation<ChangeMessageVisibilityOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: changeMessageVisibilityContinuation) in
            changeMessageVisibility(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias changeMessageVisibilityBatchContinuation = CheckedContinuation<ChangeMessageVisibilityBatchOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: changeMessageVisibilityBatchContinuation) in
            changeMessageVisibilityBatch(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteMessageContinuation = CheckedContinuation<DeleteMessageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteMessageContinuation) in
            deleteMessage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteMessageBatchContinuation = CheckedContinuation<DeleteMessageBatchOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteMessageBatchContinuation) in
            deleteMessageBatch(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getQueueAttributesContinuation = CheckedContinuation<GetQueueAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getQueueAttributesContinuation) in
            getQueueAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias getQueueUrlContinuation = CheckedContinuation<GetQueueUrlOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: getQueueUrlContinuation) in
            getQueueUrl(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listDeadLetterSourceQueuesContinuation = CheckedContinuation<ListDeadLetterSourceQueuesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listDeadLetterSourceQueuesContinuation) in
            listDeadLetterSourceQueues(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listQueueTagsContinuation = CheckedContinuation<ListQueueTagsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listQueueTagsContinuation) in
            listQueueTags(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias purgeQueueContinuation = CheckedContinuation<PurgeQueueOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: purgeQueueContinuation) in
            purgeQueue(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias receiveMessageContinuation = CheckedContinuation<ReceiveMessageOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: receiveMessageContinuation) in
            receiveMessage(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias sendMessageBatchContinuation = CheckedContinuation<SendMessageBatchOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: sendMessageBatchContinuation) in
            sendMessageBatch(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias setQueueAttributesContinuation = CheckedContinuation<SetQueueAttributesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: setQueueAttributesContinuation) in
            setQueueAttributes(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias tagQueueContinuation = CheckedContinuation<TagQueueOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: tagQueueContinuation) in
            tagQueue(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias untagQueueContinuation = CheckedContinuation<UntagQueueOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: untagQueueContinuation) in
            untagQueue(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
