...
public class SqsClient {
    ...
    let config: SqsClientConfiguration
    let serviceName = "SQS"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: SqsClientConfiguration) {
    ...
    public class SqsClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        ) throws
        {
            ...
            self.logger = logger ?? SwiftLogger(label: "SqsClient")
        }
        ...
        public static func `default`() throws -> SqsClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return try SqsClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}

public struct SqsClientLogHandlerFactory: SDKLogHandlerFactory {
...
extension SqsClient: SqsClientProtocol {
    ...
    ///          </important>
    public func changeMessageVisibility(input: ChangeMessageVisibilityInput, completion: @escaping (SdkResult<ChangeMessageVisibilityOutputResponse, ChangeMessageVisibilityOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    public func changeMessageVisibilityBatch(input: ChangeMessageVisibilityBatchInput, completion: @escaping (SdkResult<ChangeMessageVisibilityBatchOutputResponse, ChangeMessageVisibilityBatchOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          </note>
    public func deleteMessage(input: DeleteMessageInput, completion: @escaping (SdkResult<DeleteMessageOutputResponse, DeleteMessageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    public func deleteMessageBatch(input: DeleteMessageBatchInput, completion: @escaping (SdkResult<DeleteMessageBatchOutputResponse, DeleteMessageBatchOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          </note>
    public func getQueueAttributes(input: GetQueueAttributesInput, completion: @escaping (SdkResult<GetQueueAttributesOutputResponse, GetQueueAttributesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///     </p>
    public func getQueueUrl(input: GetQueueUrlInput, completion: @escaping (SdkResult<GetQueueUrlOutputResponse, GetQueueUrlOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func listDeadLetterSourceQueues(input: ListDeadLetterSourceQueuesInput, completion: @escaping (SdkResult<ListDeadLetterSourceQueuesOutputResponse, ListDeadLetterSourceQueuesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    public func listQueueTags(input: ListQueueTagsInput, completion: @escaping (SdkResult<ListQueueTagsOutputResponse, ListQueueTagsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    public func purgeQueue(input: PurgeQueueInput, completion: @escaping (SdkResult<PurgeQueueOutputResponse, PurgeQueueOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///          </note>
    public func receiveMessage(input: ReceiveMessageInput, completion: @escaping (SdkResult<ReceiveMessageOutputResponse, ReceiveMessageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             <code>&AttributeName.2=second</code>
    ///          </p>
    public func sendMessageBatch(input: SendMessageBatchInput, completion: @escaping (SdkResult<SendMessageBatchOutputResponse, SendMessageBatchOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             </ul>
    ///          </note>
    public func setQueueAttributes(input: SetQueueAttributesInput, completion: @escaping (SdkResult<SetQueueAttributesOutputResponse, SetQueueAttributesOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    public func tagQueue(input: TagQueueInput, completion: @escaping (SdkResult<TagQueueOutputResponse, TagQueueOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
    ...
    ///             <p>Cross-account permissions don't apply to this action. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant cross-account permissions to a role and a user name</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p>
    ///         </note>
    public func untagQueue(input: UntagQueueInput, completion: @escaping (SdkResult<UntagQueueOutputResponse, UntagQueueOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
