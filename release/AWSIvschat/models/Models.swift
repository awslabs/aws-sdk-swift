...
extension CreateChatTokenInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let sessionDurationInMinutesDecoded = try containerValues.decode(Swift.Int.self, forKey: .sessionDurationInMinutes)
...
extension CreateRoomInputBody: Swift.Decodable {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        name = nameDecoded
        let maximumMessageRatePerSecondDecoded = try containerValues.decode(Swift.Int.self, forKey: .maximumMessageRatePerSecond)
        maximumMessageRatePerSecond = maximumMessageRatePerSecondDecoded
        let maximumMessageLengthDecoded = try containerValues.decode(Swift.Int.self, forKey: .maximumMessageLength)
