...
public extension QuickSightClient {
    ...
    {
        typealias createFolderMembershipContinuation = CheckedContinuation<CreateFolderMembershipOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createFolderMembershipContinuation) in
            createFolderMembership(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteFolderMembershipContinuation = CheckedContinuation<DeleteFolderMembershipOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteFolderMembershipContinuation) in
            deleteFolderMembership(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeFolderContinuation = CheckedContinuation<DescribeFolderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFolderContinuation) in
            describeFolder(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeFolderPermissionsContinuation = CheckedContinuation<DescribeFolderPermissionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFolderPermissionsContinuation) in
            describeFolderPermissions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeFolderResolvedPermissionsContinuation = CheckedContinuation<DescribeFolderResolvedPermissionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFolderResolvedPermissionsContinuation) in
            describeFolderResolvedPermissions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeIpRestrictionContinuation = CheckedContinuation<DescribeIpRestrictionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeIpRestrictionContinuation) in
            describeIpRestriction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias generateEmbedUrlForAnonymousUserContinuation = CheckedContinuation<GenerateEmbedUrlForAnonymousUserOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: generateEmbedUrlForAnonymousUserContinuation) in
            generateEmbedUrlForAnonymousUser(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias generateEmbedUrlForRegisteredUserContinuation = CheckedContinuation<GenerateEmbedUrlForRegisteredUserOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: generateEmbedUrlForRegisteredUserContinuation) in
            generateEmbedUrlForRegisteredUser(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listFolderMembersContinuation = CheckedContinuation<ListFolderMembersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listFolderMembersContinuation) in
            listFolderMembers(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listFoldersContinuation = CheckedContinuation<ListFoldersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listFoldersContinuation) in
            listFolders(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias searchFoldersContinuation = CheckedContinuation<SearchFoldersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: searchFoldersContinuation) in
            searchFolders(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateFolderPermissionsContinuation = CheckedContinuation<UpdateFolderPermissionsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateFolderPermissionsContinuation) in
            updateFolderPermissions(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateIpRestrictionContinuation = CheckedContinuation<UpdateIpRestrictionOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateIpRestrictionContinuation) in
            updateIpRestriction(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
