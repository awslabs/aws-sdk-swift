...
public protocol QuickSightClientProtocol {
    ...
    func describeIpRestriction(input: DescribeIpRestrictionInput, completion: @escaping (ClientRuntime.SdkResult<DescribeIpRestrictionOutputResponse, DescribeIpRestrictionOutputError>) -> Void)
    ...
    func updateIpRestriction(input: UpdateIpRestrictionInput, completion: @escaping (ClientRuntime.SdkResult<UpdateIpRestrictionOutputResponse, UpdateIpRestrictionOutputError>) -> Void)
