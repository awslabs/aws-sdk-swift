...
public protocol WorkSpacesClientProtocol {
    ...
    func createConnectClientAddIn(input: CreateConnectClientAddInInput) async throws -> CreateConnectClientAddInOutputResponse
    ...
    func createWorkspaceImage(input: CreateWorkspaceImageInput) async throws -> CreateWorkspaceImageOutputResponse
    ...
    func deleteClientBranding(input: DeleteClientBrandingInput) async throws -> DeleteClientBrandingOutputResponse
    /// Deletes a client-add-in for Amazon Connect that is configured within a directory.
    func deleteConnectClientAddIn(input: DeleteConnectClientAddInInput) async throws -> DeleteConnectClientAddInOutputResponse
    ...
    func describeClientBranding(input: DescribeClientBrandingInput) async throws -> DescribeClientBrandingOutputResponse
    ...
    func describeConnectClientAddIns(input: DescribeConnectClientAddInsInput) async throws -> DescribeConnectClientAddInsOutputResponse
    ...
    func importClientBranding(input: ImportClientBrandingInput) async throws -> ImportClientBrandingOutputResponse
    ...
    func modifySamlProperties(input: ModifySamlPropertiesInput) async throws -> ModifySamlPropertiesOutputResponse
    ...
    func updateConnectClientAddIn(input: UpdateConnectClientAddInInput) async throws -> UpdateConnectClientAddInOutputResponse
...
public protocol WorkSpacesClientConfigurationProtocol : AWSClientRuntime.AWSClientConfiguration {
