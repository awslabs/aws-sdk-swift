...
extension MigrationHubRefactorSpacesClientTypes {
    ...
    public struct ApiGatewayProxyConfig: Swift.Equatable {
        ...
        var apiGatewayId: Swift.String?
        /// The type of API Gateway endpoint created.
        var endpointType: MigrationHubRefactorSpacesClientTypes.ApiGatewayEndpointType?
        /// The Amazon Resource Name (ARN) of the Network Load Balancer configured by the API Gateway proxy.
        var nlbArn: Swift.String?
        /// The name of the Network Load Balancer that is configured by the API Gateway proxy.
        var nlbName: Swift.String?
        /// The endpoint URL of the API Gateway proxy.
        var proxyUrl: Swift.String?
...
extension MigrationHubRefactorSpacesClientTypes {
    ...
    public struct ApplicationSummary: Swift.Equatable {
        ...
        var proxyType: MigrationHubRefactorSpacesClientTypes.ProxyType?
        /// The current state of the application.
        var state: MigrationHubRefactorSpacesClientTypes.ApplicationState?
...
public struct CreateApplicationInput: Swift.Equatable {
    ...
    var apiGatewayProxy: MigrationHubRefactorSpacesClientTypes.ApiGatewayProxyInput?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
    var clientToken: Swift.String?
    /// The unique identifier of the environment.
    /// This member is required.
    var environmentIdentifier: Swift.String?
...
public struct CreateEnvironmentInput: Swift.Equatable {
    ...
    /// This member is required.
    var networkFabricType: MigrationHubRefactorSpacesClientTypes.NetworkFabricType?
...
public struct CreateEnvironmentOutputResponse: Swift.Equatable {
    ...
    var state: MigrationHubRefactorSpacesClientTypes.EnvironmentState?
...
public struct CreateRouteInput: Swift.Equatable {
    ...
    /// This member is required.
    var applicationIdentifier: Swift.String?
    /// A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
    var clientToken: Swift.String?
    ...
    var uriPathRoute: MigrationHubRefactorSpacesClientTypes.UriPathRouteInput?
...
public struct CreateRouteOutputResponse: Swift.Equatable {
    ...
    var state: MigrationHubRefactorSpacesClientTypes.RouteState?
...
public struct CreateServiceInput: Swift.Equatable {
    ...
    /// This member is required.
    var endpointType: MigrationHubRefactorSpacesClientTypes.ServiceEndpointType?
    /// The ID of the environment in which the service is created.
    /// This member is required.
    var environmentIdentifier: Swift.String?
    /// The configuration for the Lambda endpoint type.
    var lambdaEndpoint: MigrationHubRefactorSpacesClientTypes.LambdaEndpointInput?
    ...
    var urlEndpoint: MigrationHubRefactorSpacesClientTypes.UrlEndpointInput?
    /// The ID of the VPC.
    var vpcId: Swift.String?
...
public struct CreateServiceOutputResponse: Swift.Equatable {
    ...
    var state: MigrationHubRefactorSpacesClientTypes.ServiceState?
...
public struct DeleteRouteInput: Swift.Equatable {
    ...
    /// This member is required.
    var routeIdentifier: Swift.String?
...
extension MigrationHubRefactorSpacesClientTypes {
    ...
    public struct EnvironmentSummary: Swift.Equatable {
        ...
        var transitGatewayId: Swift.String?
...
extension MigrationHubRefactorSpacesClientTypes {
    ...
    public struct ErrorResponse: Swift.Equatable {
        ...
        var additionalDetails: [Swift.String:Swift.String]?
        /// The error code associated with the error.
        var code: MigrationHubRefactorSpacesClientTypes.ErrorCode?
        /// The message associated with the error.
        var message: Swift.String?
        /// The ID of the resource.
        var resourceIdentifier: Swift.String?
        /// The type of resource.
        var resourceType: MigrationHubRefactorSpacesClientTypes.ErrorResourceType?
...
public struct GetApplicationOutputResponse: Swift.Equatable {
    /// The endpoint URL of the API Gateway proxy.
    var apiGatewayProxy: MigrationHubRefactorSpacesClientTypes.ApiGatewayProxyConfig?
    /// The unique identifier of the application.
    var applicationId: Swift.String?
    /// The Amazon Resource Name (ARN) of the application.
    var arn: Swift.String?
...
public struct GetRouteOutputResponse: Swift.Equatable {
    ...
    var includeChildPaths: Swift.Bool?
    /// A timestamp that indicates when the route was last updated.
    var lastUpdatedTime: ClientRuntime.Date?
    /// A list of HTTP methods to match. An empty list matches all values. If a method is present, only HTTP requests using that method are forwarded to this route’s service.
    var methods: [MigrationHubRefactorSpacesClientTypes.HttpMethod]?
    /// The Amazon Web Services account ID of the route owner.
    var ownerAccountId: Swift.String?
    /// A mapping of Amazon API Gateway path resources to resource IDs.
    var pathResourceToId: [Swift.String:Swift.String]?
...
public struct GetServiceOutputResponse: Swift.Equatable {
    ...
    var lambdaEndpoint: MigrationHubRefactorSpacesClientTypes.LambdaEndpointConfig?
    /// A timestamp that indicates when the service was last updated.
    var lastUpdatedTime: ClientRuntime.Date?
    /// The name of the service.
    var name: Swift.String?
    ...
    var urlEndpoint: MigrationHubRefactorSpacesClientTypes.UrlEndpointConfig?
    /// The ID of the virtual private cloud (VPC).
    var vpcId: Swift.String?
...
public struct ListApplicationsOutputResponse: Swift.Equatable {
    /// The list of ApplicationSummary objects.
    var applicationSummaryList: [MigrationHubRefactorSpacesClientTypes.ApplicationSummary]?
    /// The token for the next page of results.
    var nextToken: Swift.String?
...
public struct ListEnvironmentVpcsOutputResponse: Swift.Equatable {
    ...
    var environmentVpcList: [MigrationHubRefactorSpacesClientTypes.EnvironmentVpc]?
    /// The token for the next page of results.
    var nextToken: Swift.String?
...
public struct ListEnvironmentsOutputResponse: Swift.Equatable {
    ...
    var environmentSummaryList: [MigrationHubRefactorSpacesClientTypes.EnvironmentSummary]?
    /// The token for the next page of results.
    var nextToken: Swift.String?
...
public struct ListRoutesOutputResponse: Swift.Equatable {
    ...
    var routeSummaryList: [MigrationHubRefactorSpacesClientTypes.RouteSummary]?
...
public struct ListServicesOutputResponse: Swift.Equatable {
    ...
    var serviceSummaryList: [MigrationHubRefactorSpacesClientTypes.ServiceSummary]?
...
extension MigrationHubRefactorSpacesClientTypes {
    ...
    public struct ServiceSummary: Swift.Equatable {
        ...
        var lambdaEndpoint: MigrationHubRefactorSpacesClientTypes.LambdaEndpointSummary?
        /// A timestamp that indicates when the service was last updated.
        var lastUpdatedTime: ClientRuntime.Date?
        /// The name of the service.
        var name: Swift.String?
        ...
        var urlEndpoint: MigrationHubRefactorSpacesClientTypes.UrlEndpointSummary?
        /// The ID of the virtual private cloud (VPC).
        var vpcId: Swift.String?
...
extension MigrationHubRefactorSpacesClientTypes {
    ...
    public struct UriPathRouteInput: Swift.Equatable {
        ...
        /// This member is required.
        var activationState: MigrationHubRefactorSpacesClientTypes.RouteActivationState?
        /// Indicates whether to match all subpaths of the given source path. If this value is false, requests must match the source path exactly before they are forwarded to this route's service.
        var includeChildPaths: Swift.Bool?
        /// A list of HTTP methods to match. An empty list matches all values. If a method is present, only HTTP requests using that method are forwarded to this route’s service.
        var methods: [MigrationHubRefactorSpacesClientTypes.HttpMethod]?
