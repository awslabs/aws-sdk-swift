...
extension MediaPackageVodClientTypes.AssetShallow: Swift.Codable, ClientRuntime.Reflection {
...
extension MediaPackageVodClientTypes.AssetShallow: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "AssetShallow(arn: \(Swift.String(describing: arn)), createdAt: \(Swift.String(describing: createdAt)), id: \(Swift.String(describing: id)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), resourceId: \(Swift.String(describing: resourceId)), sourceArn: \(Swift.String(describing: sourceArn)), sourceRoleArn: \(Swift.String(describing: sourceRoleArn)), tags: \(Swift.String(describing: tags)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct AssetShallow: Swift.Equatable {
        ...
        public let packagingGroupId: Swift.String?
        /// The resource ID to include in SPEKE key requests.
        public let resourceId: Swift.String?
        /// ARN of the source object in S3.
        public let sourceArn: Swift.String?
        /// The IAM role ARN used to access the source S3 bucket.
        public let sourceRoleArn: Swift.String?
...
extension MediaPackageVodClientTypes.Authorization: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.Authorization: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension MediaPackageVodClientTypes.CmafEncryption: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.CmafEncryption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CmafEncryption(spekeKeyProvider: \(Swift.String(describing: spekeKeyProvider)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct CmafEncryption: Swift.Equatable {
        ...
        public let spekeKeyProvider: MediaPackageVodClientTypes.SpekeKeyProvider?
...
extension MediaPackageVodClientTypes.CmafPackage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let includeEncoderConfigurationInSegmentsDecoded = try containerValues.decode(Swift.Bool.self, forKey: .includeEncoderConfigurationInSegments)
...
extension MediaPackageVodClientTypes.CmafPackage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CmafPackage(encryption: \(Swift.String(describing: encryption)), hlsManifests: \(Swift.String(describing: hlsManifests)), includeEncoderConfigurationInSegments: \(Swift.String(describing: includeEncoderConfigurationInSegments)), segmentDurationSeconds: \(Swift.String(describing: segmentDurationSeconds)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct CmafPackage: Swift.Equatable {
        /// A CMAF encryption configuration.
        public let encryption: MediaPackageVodClientTypes.CmafEncryption?
        /// A list of HLS manifest configurations.
        public let hlsManifests: [MediaPackageVodClientTypes.HlsManifest]?
        /// When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        public let includeEncoderConfigurationInSegments: Swift.Bool
        ...
        public init (
            ...
            includeEncoderConfigurationInSegments: Swift.Bool = false,
...
extension ConfigureLogsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConfigureLogsInput(egressAccessLogs: \(Swift.String(describing: egressAccessLogs)), id: \(Swift.String(describing: id)))"}
}
...
public struct ConfigureLogsInput: Swift.Equatable {
    ...
    public let egressAccessLogs: MediaPackageVodClientTypes.EgressAccessLogs?
...
extension ConfigureLogsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ConfigureLogsOutputResponse(arn: \(Swift.String(describing: arn)), authorization: \(Swift.String(describing: authorization)), domainName: \(Swift.String(describing: domainName)), egressAccessLogs: \(Swift.String(describing: egressAccessLogs)), id: \(Swift.String(describing: id)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct ConfigureLogsOutputResponse: Swift.Equatable {
    ...
    public let arn: Swift.String?
    /// CDN Authorization credentials
    public let authorization: MediaPackageVodClientTypes.Authorization?
...
extension CreateAssetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAssetInput(id: \(Swift.String(describing: id)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), resourceId: \(Swift.String(describing: resourceId)), sourceArn: \(Swift.String(describing: sourceArn)), sourceRoleArn: \(Swift.String(describing: sourceRoleArn)), tags: \(Swift.String(describing: tags)))"}
}
...
extension CreateAssetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateAssetOutputResponse(arn: \(Swift.String(describing: arn)), createdAt: \(Swift.String(describing: createdAt)), egressEndpoints: \(Swift.String(describing: egressEndpoints)), id: \(Swift.String(describing: id)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), resourceId: \(Swift.String(describing: resourceId)), sourceArn: \(Swift.String(describing: sourceArn)), sourceRoleArn: \(Swift.String(describing: sourceRoleArn)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreateAssetOutputResponse: Swift.Equatable {
    ...
    public let egressEndpoints: [MediaPackageVodClientTypes.EgressEndpoint]?
    /// The unique identifier for the Asset.
    public let id: Swift.String?
    /// The ID of the PackagingGroup for the Asset.
    public let packagingGroupId: Swift.String?
...
public struct CreatePackagingConfigurationInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePackagingConfigurationInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreatePackagingConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreatePackagingConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreatePackagingConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreatePackagingConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreatePackagingConfigurationOutputError>
}

extension CreatePackagingConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePackagingConfigurationInput(cmafPackage: \(Swift.String(describing: cmafPackage)), dashPackage: \(Swift.String(describing: dashPackage)), hlsPackage: \(Swift.String(describing: hlsPackage)), id: \(Swift.String(describing: id)), mssPackage: \(Swift.String(describing: mssPackage)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), tags: \(Swift.String(describing: tags)))"}
}

extension CreatePackagingConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct CreatePackagingConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePackagingConfigurationInputHeadersMiddleware"
...
public struct CreatePackagingConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePackagingConfigurationInputQueryItemMiddleware"
...
public struct CreatePackagingConfigurationInput: Swift.Equatable {
    /// A CMAF packaging configuration.
    public let cmafPackage: MediaPackageVodClientTypes.CmafPackage?
    /// A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
    public let dashPackage: MediaPackageVodClientTypes.DashPackage?
    /// An HTTP Live Streaming (HLS) packaging configuration.
    public let hlsPackage: MediaPackageVodClientTypes.HlsPackage?
    /// The ID of the PackagingConfiguration.
    public let id: Swift.String?
    /// A Microsoft Smooth Streaming (MSS) PackagingConfiguration.
    public let mssPackage: MediaPackageVodClientTypes.MssPackage?
...
extension CreatePackagingConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePackagingConfigurationOutputResponse(arn: \(Swift.String(describing: arn)), cmafPackage: \(Swift.String(describing: cmafPackage)), dashPackage: \(Swift.String(describing: dashPackage)), hlsPackage: \(Swift.String(describing: hlsPackage)), id: \(Swift.String(describing: id)), mssPackage: \(Swift.String(describing: mssPackage)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), tags: \(Swift.String(describing: tags)))"}
}
...
public struct CreatePackagingGroupInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePackagingGroupInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreatePackagingGroupInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreatePackagingGroupOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreatePackagingGroupInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreatePackagingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreatePackagingGroupOutputError>
}

extension CreatePackagingGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePackagingGroupInput(authorization: \(Swift.String(describing: authorization)), egressAccessLogs: \(Swift.String(describing: egressAccessLogs)), id: \(Swift.String(describing: id)), tags: \(Swift.String(describing: tags)))"}
}

extension CreatePackagingGroupInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case authorization = "authorization"
        case egressAccessLogs = "egressAccessLogs"
        case id = "id"
...
public struct CreatePackagingGroupInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePackagingGroupInputHeadersMiddleware"
...
public struct CreatePackagingGroupInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreatePackagingGroupInputQueryItemMiddleware"
...
extension CreatePackagingGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreatePackagingGroupOutputResponse(arn: \(Swift.String(describing: arn)), authorization: \(Swift.String(describing: authorization)), domainName: \(Swift.String(describing: domainName)), egressAccessLogs: \(Swift.String(describing: egressAccessLogs)), id: \(Swift.String(describing: id)), tags: \(Swift.String(describing: tags)))"}
}
...
extension MediaPackageVodClientTypes.DashEncryption: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case spekeKeyProvider = "spekeKeyProvider"
    }
...
extension MediaPackageVodClientTypes.DashEncryption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DashEncryption(spekeKeyProvider: \(Swift.String(describing: spekeKeyProvider)))"}
}
...
extension MediaPackageVodClientTypes.DashManifest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.DashManifest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DashManifest(manifestLayout: \(Swift.String(describing: manifestLayout)), manifestName: \(Swift.String(describing: manifestName)), minBufferTimeSeconds: \(Swift.String(describing: minBufferTimeSeconds)), profile: \(Swift.String(describing: profile)), streamSelection: \(Swift.String(describing: streamSelection)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct DashManifest: Swift.Equatable {
        ...
        public let manifestLayout: MediaPackageVodClientTypes.ManifestLayout?
        ...
        public let profile: MediaPackageVodClientTypes.Profile?
        /// A StreamSelection configuration.
        public let streamSelection: MediaPackageVodClientTypes.StreamSelection?
...
extension MediaPackageVodClientTypes.DashPackage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.DashPackage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DashPackage(dashManifests: \(Swift.String(describing: dashManifests)), encryption: \(Swift.String(describing: encryption)), includeEncoderConfigurationInSegments: \(Swift.String(describing: includeEncoderConfigurationInSegments)), periodTriggers: \(Swift.String(describing: periodTriggers)), segmentDurationSeconds: \(Swift.String(describing: segmentDurationSeconds)), segmentTemplateFormat: \(Swift.String(describing: segmentTemplateFormat)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct DashPackage: Swift.Equatable {
        ...
        public let dashManifests: [MediaPackageVodClientTypes.DashManifest]?
        /// A Dynamic Adaptive Streaming over HTTP (DASH) encryption configuration.
        public let encryption: MediaPackageVodClientTypes.DashEncryption?
        /// When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
        public let includeEncoderConfigurationInSegments: Swift.Bool
        ...
        public let periodTriggers: [MediaPackageVodClientTypes.__PeriodTriggersElement]?
        /// Duration (in seconds) of each segment. Actual segments will be
        /// rounded to the nearest multiple of the source segment duration.
        public let segmentDurationSeconds: Swift.Int
        /// Determines the type of SegmentTemplate included in the Media Presentation Description (MPD).  When set to NUMBER_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Number$ media URLs.  When set to TIME_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Time$ media URLs. When set to NUMBER_WITH_DURATION, only a duration is included in each SegmentTemplate, with $Number$ media URLs.
        public let segmentTemplateFormat: MediaPackageVodClientTypes.SegmentTemplateFormat?
...
extension DeleteAssetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteAssetInput(id: \(Swift.String(describing: id)))"}
}
...
extension DeletePackagingConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeletePackagingConfigurationInput(id: \(Swift.String(describing: id)))"}
}

extension DeletePackagingConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeletePackagingConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePackagingConfigurationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeletePackagingConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeletePackagingConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeletePackagingConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePackagingConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePackagingConfigurationOutputError>
}

public struct DeletePackagingConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePackagingConfigurationInputQueryItemMiddleware"
...
extension DeletePackagingConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeletePackagingConfigurationOutputResponseBody: Swift.Equatable {
}

extension DeletePackagingConfigurationOutputResponseBody: Swift.Decodable {

    public init (from decoder: Swift.Decoder) throws {
    }
}

extension DeletePackagingGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeletePackagingGroupInput(id: \(Swift.String(describing: id)))"}
}

extension DeletePackagingGroupInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DeletePackagingGroupInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePackagingGroupInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeletePackagingGroupInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeletePackagingGroupOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeletePackagingGroupInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeletePackagingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeletePackagingGroupOutputError>
}

public struct DeletePackagingGroupInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeletePackagingGroupInputQueryItemMiddleware"
...
extension DeletePackagingGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct DeletePackagingGroupOutputResponseBody: Swift.Equatable {
}

extension DeletePackagingGroupOutputResponseBody: Swift.Decodable {
...
extension DescribeAssetInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAssetInput(id: \(Swift.String(describing: id)))"}
}
...
extension DescribeAssetOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeAssetOutputResponse(arn: \(Swift.String(describing: arn)), createdAt: \(Swift.String(describing: createdAt)), egressEndpoints: \(Swift.String(describing: egressEndpoints)), id: \(Swift.String(describing: id)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), resourceId: \(Swift.String(describing: resourceId)), sourceArn: \(Swift.String(describing: sourceArn)), sourceRoleArn: \(Swift.String(describing: sourceRoleArn)), tags: \(Swift.String(describing: tags)))"}
}
...
extension DescribePackagingConfigurationInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePackagingConfigurationInput(id: \(Swift.String(describing: id)))"}
}

extension DescribePackagingConfigurationInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribePackagingConfigurationInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePackagingConfigurationInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribePackagingConfigurationInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribePackagingConfigurationOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribePackagingConfigurationInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribePackagingConfigurationOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribePackagingConfigurationOutputError>
}

public struct DescribePackagingConfigurationInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePackagingConfigurationInputQueryItemMiddleware"
...
extension DescribePackagingConfigurationOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePackagingConfigurationOutputResponse(arn: \(Swift.String(describing: arn)), cmafPackage: \(Swift.String(describing: cmafPackage)), dashPackage: \(Swift.String(describing: dashPackage)), hlsPackage: \(Swift.String(describing: hlsPackage)), id: \(Swift.String(describing: id)), mssPackage: \(Swift.String(describing: mssPackage)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), tags: \(Swift.String(describing: tags)))"}
}
...
extension DescribePackagingGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePackagingGroupInput(id: \(Swift.String(describing: id)))"}
}

extension DescribePackagingGroupInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct DescribePackagingGroupInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePackagingGroupInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribePackagingGroupInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribePackagingGroupOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribePackagingGroupInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribePackagingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribePackagingGroupOutputError>
}

public struct DescribePackagingGroupInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribePackagingGroupInputQueryItemMiddleware"
...
extension DescribePackagingGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribePackagingGroupOutputResponse(arn: \(Swift.String(describing: arn)), authorization: \(Swift.String(describing: authorization)), domainName: \(Swift.String(describing: domainName)), egressAccessLogs: \(Swift.String(describing: egressAccessLogs)), id: \(Swift.String(describing: id)), tags: \(Swift.String(describing: tags)))"}
}
...
extension MediaPackageVodClientTypes.EgressAccessLogs: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.EgressAccessLogs: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension MediaPackageVodClientTypes.EgressEndpoint: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.EgressEndpoint: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "EgressEndpoint(packagingConfigurationId: \(Swift.String(describing: packagingConfigurationId)), url: \(Swift.String(describing: url)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct EgressEndpoint: Swift.Equatable {
        ...
        public let packagingConfigurationId: Swift.String?
...
extension MediaPackageVodClientTypes.HlsEncryption: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.HlsEncryption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "HlsEncryption(constantInitializationVector: \(Swift.String(describing: constantInitializationVector)), encryptionMethod: \(Swift.String(describing: encryptionMethod)), spekeKeyProvider: \(Swift.String(describing: spekeKeyProvider)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct HlsEncryption: Swift.Equatable {
        ...
        public let encryptionMethod: MediaPackageVodClientTypes.EncryptionMethod?
        /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
        public let spekeKeyProvider: MediaPackageVodClientTypes.SpekeKeyProvider?
...
extension MediaPackageVodClientTypes.HlsManifest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.HlsManifest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "HlsManifest(adMarkers: \(Swift.String(describing: adMarkers)), includeIframeOnlyStream: \(Swift.String(describing: includeIframeOnlyStream)), manifestName: \(Swift.String(describing: manifestName)), programDateTimeIntervalSeconds: \(Swift.String(describing: programDateTimeIntervalSeconds)), repeatExtXKey: \(Swift.String(describing: repeatExtXKey)), streamSelection: \(Swift.String(describing: streamSelection)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct HlsManifest: Swift.Equatable {
        ...
        public let adMarkers: MediaPackageVodClientTypes.AdMarkers?
...
extension MediaPackageVodClientTypes.HlsPackage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case encryption = "encryption"
        case hlsManifests = "hlsManifests"
        case segmentDurationSeconds = "segmentDurationSeconds"
...
extension MediaPackageVodClientTypes.HlsPackage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "HlsPackage(encryption: \(Swift.String(describing: encryption)), hlsManifests: \(Swift.String(describing: hlsManifests)), segmentDurationSeconds: \(Swift.String(describing: segmentDurationSeconds)), useAudioRenditionGroup: \(Swift.String(describing: useAudioRenditionGroup)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct HlsPackage: Swift.Equatable {
        /// An HTTP Live Streaming (HLS) encryption configuration.
        public let encryption: MediaPackageVodClientTypes.HlsEncryption?
        /// A list of HLS manifest configurations.
        public let hlsManifests: [MediaPackageVodClientTypes.HlsManifest]?
        /// Duration (in seconds) of each fragment. Actual fragments will be
        /// rounded to the nearest multiple of the source fragment duration.
...
extension ListAssetsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAssetsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), packagingGroupId: \(Swift.String(describing: packagingGroupId)))"}
}
...
extension ListAssetsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListAssetsOutputResponse(assets: \(Swift.String(describing: assets)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
public struct ListAssetsOutputResponse: Swift.Equatable {
    ...
    public let assets: [MediaPackageVodClientTypes.AssetShallow]?
...
extension ListPackagingConfigurationsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPackagingConfigurationsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), packagingGroupId: \(Swift.String(describing: packagingGroupId)))"}
}

extension ListPackagingConfigurationsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListPackagingConfigurationsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPackagingConfigurationsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListPackagingConfigurationsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListPackagingConfigurationsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListPackagingConfigurationsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListPackagingConfigurationsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPackagingConfigurationsOutputError>
}

public struct ListPackagingConfigurationsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPackagingConfigurationsInputQueryItemMiddleware"
...
extension ListPackagingConfigurationsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPackagingConfigurationsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), packagingConfigurations: \(Swift.String(describing: packagingConfigurations)))"}
}
...
public struct ListPackagingConfigurationsOutputResponse: Swift.Equatable {
    ...
    public let packagingConfigurations: [MediaPackageVodClientTypes.PackagingConfiguration]?
...
extension ListPackagingGroupsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPackagingGroupsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListPackagingGroupsInput: Swift.Encodable, ClientRuntime.Reflection {

    public func encode(to encoder: Swift.Encoder) throws {
    }
}

public struct ListPackagingGroupsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPackagingGroupsInputHeadersMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListPackagingGroupsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListPackagingGroupsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListPackagingGroupsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListPackagingGroupsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListPackagingGroupsOutputError>
}

public struct ListPackagingGroupsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListPackagingGroupsInputQueryItemMiddleware"
...
extension ListPackagingGroupsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListPackagingGroupsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), packagingGroups: \(Swift.String(describing: packagingGroups)))"}
}
...
public struct ListPackagingGroupsOutputResponse: Swift.Equatable {
    ...
    public let packagingGroups: [MediaPackageVodClientTypes.PackagingGroup]?
...
extension MediaPackageVodClientTypes.MssEncryption: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case spekeKeyProvider = "spekeKeyProvider"
    }
...
extension MediaPackageVodClientTypes.MssEncryption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension MediaPackageVodClientTypes.MssManifest: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case manifestName = "manifestName"
        case streamSelection = "streamSelection"
    }
...
extension MediaPackageVodClientTypes.MssManifest: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MssManifest(manifestName: \(Swift.String(describing: manifestName)), streamSelection: \(Swift.String(describing: streamSelection)))"}
}
...
extension MediaPackageVodClientTypes.MssPackage: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case encryption = "encryption"
...
extension MediaPackageVodClientTypes.MssPackage: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "MssPackage(encryption: \(Swift.String(describing: encryption)), mssManifests: \(Swift.String(describing: mssManifests)), segmentDurationSeconds: \(Swift.String(describing: segmentDurationSeconds)))"}
}
...
extension MediaPackageVodClientTypes {
    ...
    public struct MssPackage: Swift.Equatable {
        /// A Microsoft Smooth Streaming (MSS) encryption configuration.
        public let encryption: MediaPackageVodClientTypes.MssEncryption?
        /// A list of MSS manifest configurations.
        public let mssManifests: [MediaPackageVodClientTypes.MssManifest]?
...
extension MediaPackageVodClientTypes.PackagingConfiguration: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "arn"
        case cmafPackage = "cmafPackage"
        case dashPackage = "dashPackage"
...
extension MediaPackageVodClientTypes.PackagingConfiguration: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PackagingConfiguration(arn: \(Swift.String(describing: arn)), cmafPackage: \(Swift.String(describing: cmafPackage)), dashPackage: \(Swift.String(describing: dashPackage)), hlsPackage: \(Swift.String(describing: hlsPackage)), id: \(Swift.String(describing: id)), mssPackage: \(Swift.String(describing: mssPackage)), packagingGroupId: \(Swift.String(describing: packagingGroupId)), tags: \(Swift.String(describing: tags)))"}
}
...
extension MediaPackageVodClientTypes.PackagingGroup: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case arn = "arn"
        case authorization = "authorization"
        case domainName = "domainName"
...
extension MediaPackageVodClientTypes.PackagingGroup: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PackagingGroup(arn: \(Swift.String(describing: arn)), authorization: \(Swift.String(describing: authorization)), domainName: \(Swift.String(describing: domainName)), egressAccessLogs: \(Swift.String(describing: egressAccessLogs)), id: \(Swift.String(describing: id)), tags: \(Swift.String(describing: tags)))"}
}
...
extension MediaPackageVodClientTypes.SpekeKeyProvider: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.SpekeKeyProvider: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "SpekeKeyProvider(roleArn: \(Swift.String(describing: roleArn)), systemIds: \(Swift.String(describing: systemIds)), url: \(Swift.String(describing: url)))"}
}
...
extension MediaPackageVodClientTypes.StreamSelection: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension MediaPackageVodClientTypes.StreamSelection: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
extension MediaPackageVodClientTypes {
    ...
    public struct StreamSelection: Swift.Equatable {
        ...
        public let streamOrder: MediaPackageVodClientTypes.StreamOrder?
...
public struct UpdatePackagingGroupInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePackagingGroupInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdatePackagingGroupInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdatePackagingGroupOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdatePackagingGroupInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdatePackagingGroupOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdatePackagingGroupOutputError>
}

extension UpdatePackagingGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdatePackagingGroupInput(authorization: \(Swift.String(describing: authorization)), id: \(Swift.String(describing: id)))"}
}

extension UpdatePackagingGroupInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case authorization = "authorization"
    }
...
public struct UpdatePackagingGroupInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePackagingGroupInputHeadersMiddleware"
...
public struct UpdatePackagingGroupInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdatePackagingGroupInputQueryItemMiddleware"
...
extension UpdatePackagingGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdatePackagingGroupOutputResponse(arn: \(Swift.String(describing: arn)), authorization: \(Swift.String(describing: authorization)), domainName: \(Swift.String(describing: domainName)), egressAccessLogs: \(Swift.String(describing: egressAccessLogs)), id: \(Swift.String(describing: id)), tags: \(Swift.String(describing: tags)))"}
}
