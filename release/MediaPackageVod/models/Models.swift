...
extension MediaPackageVodClientTypes.CmafEncryption: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CmafEncryption(constantInitializationVector: \(Swift.String(describing: constantInitializationVector)), spekeKeyProvider: \(Swift.String(describing: spekeKeyProvider)))"}
}
