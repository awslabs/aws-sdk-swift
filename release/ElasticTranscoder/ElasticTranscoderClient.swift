...
public class ElasticTranscoderClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try ElasticTranscoderClientConfiguration(region: unwrappedRegion)
    ...
    public class ElasticTranscoderClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("ElasticTranscoderClient")
...
public struct ElasticTranscoderClientLogHandlerFactory: SDKLogHandlerFactory {
