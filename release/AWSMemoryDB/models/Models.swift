...
extension MemoryDbClientTypes {
    ...
    public struct ACL: Swift.Equatable {
        ...
        var pendingChanges: MemoryDbClientTypes.ACLPendingChanges?
        /// Indicates ACL status. Can be "creating", "active", "modifying", "deleting".
        var status: Swift.String?
        /// The list of user names that belong to the ACL.
        var userNames: [Swift.String]?
...
extension MemoryDbClientTypes {
    ...
    public struct ACLPendingChanges: Swift.Equatable {
        ...
        var userNamesToAdd: [Swift.String]?
        /// A list of user names being removed from the ACL
        var userNamesToRemove: [Swift.String]?
...
extension MemoryDbClientTypes {
    ...
    public struct Authentication: Swift.Equatable {
        ...
        var type: MemoryDbClientTypes.AuthenticationType?
...
extension MemoryDbClientTypes {
    ...
    public struct AuthenticationMode: Swift.Equatable {
        ...
        var type: MemoryDbClientTypes.InputAuthenticationType?
...
public struct BatchUpdateClusterInput: Swift.Equatable {
    ...
    var clusterNames: [Swift.String]?
    /// The unique ID of the service update
    var serviceUpdate: MemoryDbClientTypes.ServiceUpdateRequest?
...
public struct BatchUpdateClusterOutputResponse: Swift.Equatable {
    ...
    var processedClusters: [MemoryDbClientTypes.Cluster]?
    /// The list of clusters where updates have not been applied.
    var unprocessedClusters: [MemoryDbClientTypes.UnprocessedCluster]?
...
extension MemoryDbClientTypes {
    ...
    public struct Cluster: Swift.Equatable {
        ...
        var aCLName: Swift.String?
        /// The Amazon Resource Name (ARN) of the cluster.
        var aRN: Swift.String?
        /// When set to true, the cluster will automatically receive minor engine version upgrades after launch.
        var autoMinorVersionUpgrade: Swift.Bool?
        /// Indicates if the cluster has a Multi-AZ configuration (multiaz) or not (singleaz).
        var availabilityMode: MemoryDbClientTypes.AZStatus?
        /// The cluster's configuration endpoint
        var clusterEndpoint: MemoryDbClientTypes.Endpoint?
        /// A description of the cluster
        var description: Swift.String?
        /// The Redis engine patch version used by the cluster
        var enginePatchVersion: Swift.String?
        /// The Redis engine version used by the cluster
        var engineVersion: Swift.String?
        /// The ID of the KMS key used to encrypt the cluster
        var kmsKeyId: Swift.String?
        /// Specifies the weekly time range during which maintenance on the cluster is performed. It is specified as a range in the format ddd:hh24:mi-ddd:hh24:mi (24H Clock UTC). The minimum maintenance window is a 60 minute period.
        var maintenanceWindow: Swift.String?
        /// The user-supplied name of the cluster. This identifier is a unique key that identifies a cluster.
        var name: Swift.String?
        /// The cluster's node type
        var nodeType: Swift.String?
        /// The number of shards in the cluster
        var numberOfShards: Swift.Int?
        /// The name of the parameter group used by the cluster
        var parameterGroupName: Swift.String?
        /// The status of the parameter group used by the cluster, for example 'active' or 'applying'.
        var parameterGroupStatus: Swift.String?
        /// A group of settings that are currently being applied.
        var pendingUpdates: MemoryDbClientTypes.ClusterPendingUpdates?
        /// A list of security groups used by the cluster
        var securityGroups: [MemoryDbClientTypes.SecurityGroupMembership]?
        /// A list of shards that are members of the cluster.
        var shards: [MemoryDbClientTypes.Shard]?
        ...
        var snsTopicStatus: Swift.String?
        /// The status of the cluster. For example, Available, Updating, Creating.
        var status: Swift.String?
        /// The name of the subnet group used by the cluster
        var subnetGroupName: Swift.String?
        /// A flag to indicate if In-transit encryption is enabled
        var tLSEnabled: Swift.Bool?
...
extension MemoryDbClientTypes {
    ...
    public struct ClusterConfiguration: Swift.Equatable {
        ...
        var nodeType: Swift.String?
        /// The number of shards in the cluster
        var numShards: Swift.Int?
        /// The name of parameter group used by the cluster
        var parameterGroupName: Swift.String?
        /// The port used by the cluster
        var port: Swift.Int?
        /// The list of shards in the cluster
        var shards: [MemoryDbClientTypes.ShardDetail]?
...
extension MemoryDbClientTypes {
    ...
    public struct ClusterPendingUpdates: Swift.Equatable {
        ...
        var aCLs: MemoryDbClientTypes.ACLsUpdateStatus?
        /// The status of an online resharding operation.
        var resharding: MemoryDbClientTypes.ReshardingStatus?
        /// A list of service updates being applied to the cluster
        var serviceUpdates: [MemoryDbClientTypes.PendingModifiedServiceUpdate]?
...
public struct CopySnapshotInput: Swift.Equatable {
    ...
    var tags: [MemoryDbClientTypes.Tag]?
...
public struct CopySnapshotOutputResponse: Swift.Equatable {
    ...
    var snapshot: MemoryDbClientTypes.Snapshot?
...
public struct CreateACLOutputResponse: Swift.Equatable {
    ...
    var aCL: MemoryDbClientTypes.ACL?
...
public struct CreateClusterInput: Swift.Equatable {
    ...
    var numReplicasPerShard: Swift.Int?
...
public struct CreateClusterOutputResponse: Swift.Equatable {
    ...
    var cluster: MemoryDbClientTypes.Cluster?
...
public struct CreateParameterGroupOutputResponse: Swift.Equatable {
    ...
    var parameterGroup: MemoryDbClientTypes.ParameterGroup?
...
public struct CreateSubnetGroupOutputResponse: Swift.Equatable {
    ...
    var subnetGroup: MemoryDbClientTypes.SubnetGroup?
...
public struct CreateUserInput: Swift.Equatable {
    ...
    /// This member is required.
    var authenticationMode: MemoryDbClientTypes.AuthenticationMode?
    /// A list of tags to be added to this resource. A tag is a key-value pair. A tag key must be accompanied by a tag value, although null is accepted.
    var tags: [MemoryDbClientTypes.Tag]?
...
public struct CreateUserOutputResponse: Swift.Equatable {
    ...
    var user: MemoryDbClientTypes.User?
...
public struct DeleteClusterInput: Swift.Equatable {
    ...
    var finalSnapshotName: Swift.String?
...
public struct DescribeACLsOutputResponse: Swift.Equatable {
    /// The list of ACLs
    var aCLs: [MemoryDbClientTypes.ACL]?
...
public struct DescribeClustersInput: Swift.Equatable {
    ...
    var showShardDetails: Swift.Bool?
...
public struct DescribeClustersOutputResponse: Swift.Equatable {
    /// A list of clusters
    var clusters: [MemoryDbClientTypes.Cluster]?
    /// An optional argument to pass in case the total number of records exceeds the value of MaxResults. If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged.
    var nextToken: Swift.String?
...
public struct DescribeEngineVersionsInput: Swift.Equatable {
    ...
    var parameterGroupFamily: Swift.String?
...
public struct DescribeEngineVersionsOutputResponse: Swift.Equatable {
    ...
    var engineVersions: [MemoryDbClientTypes.EngineVersionInfo]?
    /// An optional argument to pass in case the total number of records exceeds the value of MaxResults. If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged.
    var nextToken: Swift.String?
...
public struct DescribeEventsInput: Swift.Equatable {
    ...
    var sourceType: MemoryDbClientTypes.SourceType?
...
public struct DescribeEventsOutputResponse: Swift.Equatable {
    ...
    var events: [MemoryDbClientTypes.Event]?
    /// An optional argument to pass in case the total number of records exceeds the value of MaxResults. If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged.
    var nextToken: Swift.String?
...
public struct DescribeParameterGroupsOutputResponse: Swift.Equatable {
    ...
    var parameterGroups: [MemoryDbClientTypes.ParameterGroup]?
...
public struct DescribeParametersOutputResponse: Swift.Equatable {
    ...
    var parameters: [MemoryDbClientTypes.Parameter]?
...
public struct DescribeServiceUpdatesInput: Swift.Equatable {
    ...
    var status: [MemoryDbClientTypes.ServiceUpdateStatus]?
...
public struct DescribeServiceUpdatesOutputResponse: Swift.Equatable {
    ...
    var serviceUpdates: [MemoryDbClientTypes.ServiceUpdate]?
...
public struct DescribeSnapshotsOutputResponse: Swift.Equatable {
    ...
    var snapshots: [MemoryDbClientTypes.Snapshot]?
...
public struct DescribeSubnetGroupsOutputResponse: Swift.Equatable {
    ...
    var subnetGroups: [MemoryDbClientTypes.SubnetGroup]?
...
public struct DescribeUsersInput: Swift.Equatable {
    ...
    var filters: [MemoryDbClientTypes.Filter]?
    /// The maximum number of records to include in the response. If more records exist than the specified MaxResults value, a token is included in the response so that the remaining results can be retrieved.
    var maxResults: Swift.Int?
    /// An optional argument to pass in case the total number of records exceeds the value of MaxResults. If nextToken is returned, there are more results available. The value of nextToken is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged.
    var nextToken: Swift.String?
...
public struct DescribeUsersOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// A list of users.
    var users: [MemoryDbClientTypes.User]?
...
public struct ListAllowedNodeTypeUpdatesOutputResponse: Swift.Equatable {
    ...
    var scaleDownNodeTypes: [Swift.String]?
    /// A list node types which you can use to scale up your cluster.
    var scaleUpNodeTypes: [Swift.String]?
...
public struct ListTagsOutputResponse: Swift.Equatable {
    ...
    var tagList: [MemoryDbClientTypes.Tag]?
...
extension MemoryDbClientTypes {
    ...
    public struct Node: Swift.Equatable {
        ...
        var endpoint: MemoryDbClientTypes.Endpoint?
...
public struct ResetParameterGroupInput: Swift.Equatable {
    ...
    var parameterNames: [Swift.String]?
...
extension MemoryDbClientTypes {
    ...
    public struct ReshardingStatus: Swift.Equatable {
        ...
        var slotMigration: MemoryDbClientTypes.SlotMigration?
...
extension MemoryDbClientTypes {
    ...
    public struct ServiceUpdate: Swift.Equatable {
        ...
        var autoUpdateStartDate: ClientRuntime.Date?
        ...
        var type: MemoryDbClientTypes.ServiceUpdateType?
...
extension MemoryDbClientTypes {
    ...
    public struct ServiceUpdateRequest: Swift.Equatable {
        /// The unique ID of the service update
        var serviceUpdateNameToApply: Swift.String?
...
extension MemoryDbClientTypes {
    ...
    public struct Shard: Swift.Equatable {
        ...
        var nodes: [MemoryDbClientTypes.Node]?
        /// The number of nodes in the shard
        var numberOfNodes: Swift.Int?
...
extension MemoryDbClientTypes {
    ...
    public struct ShardDetail: Swift.Equatable {
        ...
        var configuration: MemoryDbClientTypes.ShardConfiguration?
        /// The name of the shard
        var name: Swift.String?
        /// The size of the shard's snapshot
        var size: Swift.String?
        /// The date and time that the shard's snapshot was created
        var snapshotCreationTime: ClientRuntime.Date?
...
extension MemoryDbClientTypes {
    ...
    public struct Snapshot: Swift.Equatable {
        ...
        var clusterConfiguration: MemoryDbClientTypes.ClusterConfiguration?
        /// The ID of the KMS key used to encrypt the snapshot.
        var kmsKeyId: Swift.String?
...
extension MemoryDbClientTypes {
    ...
    public struct Subnet: Swift.Equatable {
        ...
        var availabilityZone: MemoryDbClientTypes.AvailabilityZone?
...
extension MemoryDbClientTypes {
    ...
    public struct SubnetGroup: Swift.Equatable {
        ...
        var subnets: [MemoryDbClientTypes.Subnet]?
...
public struct UpdateClusterInput: Swift.Equatable {
    ...
    var replicaConfiguration: MemoryDbClientTypes.ReplicaConfigurationRequest?
    /// The SecurityGroupIds to update
    var securityGroupIds: [Swift.String]?
    /// The number of shards in the cluster
    var shardConfiguration: MemoryDbClientTypes.ShardConfigurationRequest?
...
public struct UpdateParameterGroupInput: Swift.Equatable {
    ...
    /// This member is required.
    var parameterNameValues: [MemoryDbClientTypes.ParameterNameValue]?
...
extension MemoryDbClientTypes {
    ...
    public struct User: Swift.Equatable {
        ...
        var aCLNames: [Swift.String]?
        /// The Amazon Resource Name (ARN) of the user.
        var aRN: Swift.String?
        /// Access permissions string used for this user.
        var accessString: Swift.String?
        /// Denotes whether the user requires a password to authenticate.
        var authentication: MemoryDbClientTypes.Authentication?
