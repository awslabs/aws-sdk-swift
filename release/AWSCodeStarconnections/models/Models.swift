...
extension CodeStarConnectionsClientTypes {
    ...
    public struct Connection: Swift.Equatable {
        ...
        var connectionArn: Swift.String?
        /// The name of the connection. Connection names must be unique in an AWS user account.
        var connectionName: Swift.String?
        /// The current status of the connection.
        var connectionStatus: CodeStarConnectionsClientTypes.ConnectionStatus?
        /// The Amazon Resource Name (ARN) of the host associated with the connection.
        var hostArn: Swift.String?
        /// The identifier of the external provider where your third-party code repository is configured. For Bitbucket, this is the account ID of the owner of the Bitbucket repository.
        var ownerAccountId: Swift.String?
        /// The name of the external provider where your third-party code repository is configured.
        var providerType: CodeStarConnectionsClientTypes.ProviderType?
...
public struct CreateConnectionInput: Swift.Equatable {
    ...
    var tags: [CodeStarConnectionsClientTypes.Tag]?
...
public struct CreateHostInput: Swift.Equatable {
    ...
    /// This member is required.
    var providerEndpoint: Swift.String?
    /// The name of the installed provider to be associated with your connection. The host resource represents the infrastructure where your provider type is installed. The valid provider type is GitHub Enterprise Server.
    /// This member is required.
    var providerType: CodeStarConnectionsClientTypes.ProviderType?
    var tags: [CodeStarConnectionsClientTypes.Tag]?
    /// The VPC configuration to be provisioned for the host. A VPC must be configured and the infrastructure to be represented by the host must already be connected to the VPC.
    var vpcConfiguration: CodeStarConnectionsClientTypes.VpcConfiguration?
...
public struct GetConnectionOutputResponse: Swift.Equatable {
    ...
    var connection: CodeStarConnectionsClientTypes.Connection?
...
public struct ListConnectionsInput: Swift.Equatable {
    ...
    var hostArnFilter: Swift.String?
    ...
    var providerTypeFilter: CodeStarConnectionsClientTypes.ProviderType?
...
public struct ListConnectionsOutputResponse: Swift.Equatable {
    ...
    var connections: [CodeStarConnectionsClientTypes.Connection]?
...
public struct ListHostsOutputResponse: Swift.Equatable {
    ...
    var hosts: [CodeStarConnectionsClientTypes.Host]?
...
extension CodeStarConnectionsClientTypes {
    ...
    public struct VpcConfiguration: Swift.Equatable {
        ...
        var tlsCertificate: Swift.String?
