...
public class GuardDutyClient {
    ...
    public class GuardDutyClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("GuardDutyClient")
...
public struct GuardDutyClientLogHandlerFactory: SDKLogHandlerFactory {
