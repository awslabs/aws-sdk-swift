...
public protocol GuardDutyClientProtocol {
    ...
    ///          </note>
    func archiveFindings(input: ArchiveFindingsInput, completion: @escaping (SdkResult<ArchiveFindingsOutput, ArchiveFindingsOutputError>) -> Void)
    ...
    func createDetector(input: CreateDetectorInput, completion: @escaping (SdkResult<CreateDetectorOutput, CreateDetectorOutputError>) -> Void)
    /// <p>Creates a filter using the specified finding criteria.</p>
    func createFilter(input: CreateFilterInput, completion: @escaping (SdkResult<CreateFilterOutput, CreateFilterOutputError>) -> Void)
    ...
    func createPublishingDestination(input: CreatePublishingDestinationInput, completion: @escaping (SdkResult<CreatePublishingDestinationOutput, CreatePublishingDestinationOutputError>) -> Void)
    ...
    func createThreatIntelSet(input: CreateThreatIntelSetInput, completion: @escaping (SdkResult<CreateThreatIntelSetOutput, CreateThreatIntelSetOutputError>) -> Void)
    ...
    func deleteFilter(input: DeleteFilterInput, completion: @escaping (SdkResult<DeleteFilterOutput, DeleteFilterOutputError>) -> Void)
    ...
    func deletePublishingDestination(input: DeletePublishingDestinationInput, completion: @escaping (SdkResult<DeletePublishingDestinationOutput, DeletePublishingDestinationOutputError>) -> Void)
    /// <p>Deletes the ThreatIntelSet specified by the ThreatIntelSet ID.</p>
    func deleteThreatIntelSet(input: DeleteThreatIntelSetInput, completion: @escaping (SdkResult<DeleteThreatIntelSetOutput, DeleteThreatIntelSetOutputError>) -> Void)
    ...
    func describePublishingDestination(input: DescribePublishingDestinationInput, completion: @escaping (SdkResult<DescribePublishingDestinationOutput, DescribePublishingDestinationOutputError>) -> Void)
    ...
    func disassociateMembers(input: DisassociateMembersInput, completion: @escaping (SdkResult<DisassociateMembersOutput, DisassociateMembersOutputError>) -> Void)
    ...
    func getDetector(input: GetDetectorInput, completion: @escaping (SdkResult<GetDetectorOutput, GetDetectorOutputError>) -> Void)
    /// <p>Returns the details of the filter specified by the filter name.</p>
    func getFilter(input: GetFilterInput, completion: @escaping (SdkResult<GetFilterOutput, GetFilterOutputError>) -> Void)
    ...
    func getFindingsStatistics(input: GetFindingsStatisticsInput, completion: @escaping (SdkResult<GetFindingsStatisticsOutput, GetFindingsStatisticsOutputError>) -> Void)
    ...
    func getMemberDetectors(input: GetMemberDetectorsInput, completion: @escaping (SdkResult<GetMemberDetectorsOutput, GetMemberDetectorsOutputError>) -> Void)
    ...
    func getThreatIntelSet(input: GetThreatIntelSetInput, completion: @escaping (SdkResult<GetThreatIntelSetOutput, GetThreatIntelSetOutputError>) -> Void)
    ...
    func inviteMembers(input: InviteMembersInput, completion: @escaping (SdkResult<InviteMembersOutput, InviteMembersOutputError>) -> Void)
    ...
    func listFilters(input: ListFiltersInput, completion: @escaping (SdkResult<ListFiltersOutput, ListFiltersOutputError>) -> Void)
    ...
    func listPublishingDestinations(input: ListPublishingDestinationsInput, completion: @escaping (SdkResult<ListPublishingDestinationsOutput, ListPublishingDestinationsOutputError>) -> Void)
    ...
    func listThreatIntelSets(input: ListThreatIntelSetsInput, completion: @escaping (SdkResult<ListThreatIntelSetsOutput, ListThreatIntelSetsOutputError>) -> Void)
    ...
    func startMonitoringMembers(input: StartMonitoringMembersInput, completion: @escaping (SdkResult<StartMonitoringMembersOutput, StartMonitoringMembersOutputError>) -> Void)
    ...
    ///       accounts.</p>
    func stopMonitoringMembers(input: StopMonitoringMembersInput, completion: @escaping (SdkResult<StopMonitoringMembersOutput, StopMonitoringMembersOutputError>) -> Void)
    ...
    func unarchiveFindings(input: UnarchiveFindingsInput, completion: @escaping (SdkResult<UnarchiveFindingsOutput, UnarchiveFindingsOutputError>) -> Void)
    ...
    func updateDetector(input: UpdateDetectorInput, completion: @escaping (SdkResult<UpdateDetectorOutput, UpdateDetectorOutputError>) -> Void)
    /// <p>Updates the filter specified by the filter name.</p>
    func updateFilter(input: UpdateFilterInput, completion: @escaping (SdkResult<UpdateFilterOutput, UpdateFilterOutputError>) -> Void)
    /// <p>Marks the specified GuardDuty findings as useful or not useful.</p>
    func updateFindingsFeedback(input: UpdateFindingsFeedbackInput, completion: @escaping (SdkResult<UpdateFindingsFeedbackOutput, UpdateFindingsFeedbackOutputError>) -> Void)
    ...
    func updateMemberDetectors(input: UpdateMemberDetectorsInput, completion: @escaping (SdkResult<UpdateMemberDetectorsOutput, UpdateMemberDetectorsOutputError>) -> Void)
    ...
    ///         <code>destinationId</code>.</p>
    func updatePublishingDestination(input: UpdatePublishingDestinationInput, completion: @escaping (SdkResult<UpdatePublishingDestinationOutput, UpdatePublishingDestinationOutputError>) -> Void)
    /// <p>Updates the ThreatIntelSet specified by the ThreatIntelSet ID.</p>
    func updateThreatIntelSet(input: UpdateThreatIntelSetInput, completion: @escaping (SdkResult<UpdateThreatIntelSetOutput, UpdateThreatIntelSetOutputError>) -> Void)
}
