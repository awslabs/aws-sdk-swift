...
public protocol IoTSiteWiseClientProtocol {
    ...
    func associateAssets(input: AssociateAssetsInput, completion: @escaping (SdkResult<AssociateAssetsOutput, AssociateAssetsOutputError>) -> Void)
    /// <p>Associates a group (batch) of assets with an AWS IoT SiteWise Monitor project.</p>
    func batchAssociateProjectAssets(input: BatchAssociateProjectAssetsInput, completion: @escaping (SdkResult<BatchAssociateProjectAssetsOutput, BatchAssociateProjectAssetsOutputError>) -> Void)
    /// <p>Disassociates a group (batch) of assets from an AWS IoT SiteWise Monitor project.</p>
    func batchDisassociateProjectAssets(input: BatchDisassociateProjectAssetsInput, completion: @escaping (SdkResult<BatchDisassociateProjectAssetsOutput, BatchDisassociateProjectAssetsOutputError>) -> Void)
    ...
    ///       <i>AWS IoT SiteWise User Guide</i>.</p>
    func batchPutAssetPropertyValue(input: BatchPutAssetPropertyValueInput, completion: @escaping (SdkResult<BatchPutAssetPropertyValueOutput, BatchPutAssetPropertyValueOutputError>) -> Void)
    ...
    func createAccessPolicy(input: CreateAccessPolicyInput, completion: @escaping (SdkResult<CreateAccessPolicyOutput, CreateAccessPolicyOutputError>) -> Void)
    ...
    ///         <i>AWS IoT SiteWise User Guide</i>.</p>
    func createAssetModel(input: CreateAssetModelInput, completion: @escaping (SdkResult<CreateAssetModelOutput, CreateAssetModelOutputError>) -> Void)
    ...
    ///         <i>AWS IoT SiteWise User Guide</i>.</p>
    func createGateway(input: CreateGatewayInput, completion: @escaping (SdkResult<CreateGatewayOutput, CreateGatewayOutputError>) -> Void)
    ...
    ///          </note>
    func createPortal(input: CreatePortalInput, completion: @escaping (SdkResult<CreatePortalOutput, CreatePortalOutputError>) -> Void)
    ...
    ///       resource.</p>
    func deleteAccessPolicy(input: DeleteAccessPolicyInput, completion: @escaping (SdkResult<DeleteAccessPolicyOutput, DeleteAccessPolicyOutputError>) -> Void)
    ...
    ///         <i>AWS IoT SiteWise User Guide</i>.</p>
    func deleteAssetModel(input: DeleteAssetModelInput, completion: @escaping (SdkResult<DeleteAssetModelOutput, DeleteAssetModelOutputError>) -> Void)
    ...
    func deletePortal(input: DeletePortalInput, completion: @escaping (SdkResult<DeletePortalOutput, DeletePortalOutputError>) -> Void)
    ...
    ///       project.</p>
    func describeAccessPolicy(input: DescribeAccessPolicyInput, completion: @escaping (SdkResult<DescribeAccessPolicyOutput, DescribeAccessPolicyOutputError>) -> Void)
    ...
    func describeAssetModel(input: DescribeAssetModelInput, completion: @escaping (SdkResult<DescribeAssetModelOutput, DescribeAssetModelOutputError>) -> Void)
    ...
    func describeAssetProperty(input: DescribeAssetPropertyInput, completion: @escaping (SdkResult<DescribeAssetPropertyOutput, DescribeAssetPropertyOutputError>) -> Void)
    ...
    func describeDefaultEncryptionConfiguration(input: DescribeDefaultEncryptionConfigurationInput, completion: @escaping (SdkResult<DescribeDefaultEncryptionConfigurationOutput, DescribeDefaultEncryptionConfigurationOutputError>) -> Void)
    /// <p>Retrieves information about a gateway.</p>
    func describeGateway(input: DescribeGatewayInput, completion: @escaping (SdkResult<DescribeGatewayOutput, DescribeGatewayOutputError>) -> Void)
    ...
    func describeGatewayCapabilityConfiguration(input: DescribeGatewayCapabilityConfigurationInput, completion: @escaping (SdkResult<DescribeGatewayCapabilityConfigurationOutput, DescribeGatewayCapabilityConfigurationOutputError>) -> Void)
    ...
    func describePortal(input: DescribePortalInput, completion: @escaping (SdkResult<DescribePortalOutput, DescribePortalOutputError>) -> Void)
    ...
    func disassociateAssets(input: DisassociateAssetsInput, completion: @escaping (SdkResult<DisassociateAssetsOutput, DisassociateAssetsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func getAssetPropertyAggregates(input: GetAssetPropertyAggregatesInput, completion: @escaping (SdkResult<GetAssetPropertyAggregatesOutput, GetAssetPropertyAggregatesOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func getAssetPropertyValue(input: GetAssetPropertyValueInput, completion: @escaping (SdkResult<GetAssetPropertyValueOutput, GetAssetPropertyValueOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func getAssetPropertyValueHistory(input: GetAssetPropertyValueHistoryInput, completion: @escaping (SdkResult<GetAssetPropertyValueHistoryOutput, GetAssetPropertyValueHistoryOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func getInterpolatedAssetPropertyValues(input: GetInterpolatedAssetPropertyValuesInput, completion: @escaping (SdkResult<GetInterpolatedAssetPropertyValuesOutput, GetInterpolatedAssetPropertyValuesOutputError>) -> Void)
    ...
    func listAccessPolicies(input: ListAccessPoliciesInput, completion: @escaping (SdkResult<ListAccessPoliciesOutput, ListAccessPoliciesOutputError>) -> Void)
    /// <p>Retrieves a paginated list of summaries of all asset models.</p>
    func listAssetModels(input: ListAssetModelsInput, completion: @escaping (SdkResult<ListAssetModelsOutput, ListAssetModelsOutputError>) -> Void)
    ...
    ///       root.</p>
    func listAssetRelationships(input: ListAssetRelationshipsInput, completion: @escaping (SdkResult<ListAssetRelationshipsOutput, ListAssetRelationshipsOutputError>) -> Void)
    ...
    ///             </li>
    ///          </ul>
    func listAssociatedAssets(input: ListAssociatedAssetsInput, completion: @escaping (SdkResult<ListAssociatedAssetsOutput, ListAssociatedAssetsOutputError>) -> Void)
    ...
    func listPortals(input: ListPortalsInput, completion: @escaping (SdkResult<ListPortalsOutput, ListPortalsOutputError>) -> Void)
    /// <p>Retrieves a paginated list of assets associated with an AWS IoT SiteWise Monitor project.</p>
    func listProjectAssets(input: ListProjectAssetsInput, completion: @escaping (SdkResult<ListProjectAssetsOutput, ListProjectAssetsOutputError>) -> Void)
    ...
    ///       in the <i>AWS IoT SiteWise User Guide</i>.</p>
    func putDefaultEncryptionConfiguration(input: PutDefaultEncryptionConfigurationInput, completion: @escaping (SdkResult<PutDefaultEncryptionConfigurationOutput, PutDefaultEncryptionConfigurationOutputError>) -> Void)
    ...
    func updateAccessPolicy(input: UpdateAccessPolicyInput, completion: @escaping (SdkResult<UpdateAccessPolicyOutput, UpdateAccessPolicyOutputError>) -> Void)
    ...
    ///         property.</p>
    ///          </important>
    func updateAssetModel(input: UpdateAssetModelInput, completion: @escaping (SdkResult<UpdateAssetModelOutput, UpdateAssetModelOutputError>) -> Void)
    ...
    ///          </important>
    func updateAssetProperty(input: UpdateAssetPropertyInput, completion: @escaping (SdkResult<UpdateAssetPropertyOutput, UpdateAssetPropertyOutputError>) -> Void)
    ...
    ///       the AWS IoT SiteWise console, all of your OPC-UA sources are stored in one capability configuration. To
    ///       list all capability configurations for a gateway, use <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_DescribeGateway.html">DescribeGateway</a>.</p>
    func updateGatewayCapabilityConfiguration(input: UpdateGatewayCapabilityConfigurationInput, completion: @escaping (SdkResult<UpdateGatewayCapabilityConfigurationOutput, UpdateGatewayCapabilityConfigurationOutputError>) -> Void)
    /// <p>Updates an AWS IoT SiteWise Monitor portal.</p>
    func updatePortal(input: UpdatePortalInput, completion: @escaping (SdkResult<UpdatePortalOutput, UpdatePortalOutputError>) -> Void)
