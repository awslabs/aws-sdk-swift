...
extension IoTSiteWiseClient: IoTSiteWiseClientProtocol {
    ...
    public func associateAssets(input: AssociateAssetsInput, completion: @escaping (SdkResult<AssociateAssetsOutput, AssociateAssetsOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<AssociateAssetsInput, AssociateAssetsOutput, AssociateAssetsOutputError>(id: "associateAssets")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<AssociateAssetsOutput>, SdkError<AssociateAssetsOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AssociateAssetsInput, AssociateAssetsOutput, AssociateAssetsOutputError>(contentType: "application/json"))
    ...
    public func batchAssociateProjectAssets(input: BatchAssociateProjectAssetsInput, completion: @escaping (SdkResult<BatchAssociateProjectAssetsOutput, BatchAssociateProjectAssetsOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<BatchAssociateProjectAssetsInput, BatchAssociateProjectAssetsOutput, BatchAssociateProjectAssetsOutputError>(id: "batchAssociateProjectAssets")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<BatchAssociateProjectAssetsOutput>, SdkError<BatchAssociateProjectAssetsOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<BatchAssociateProjectAssetsInput, BatchAssociateProjectAssetsOutput, BatchAssociateProjectAssetsOutputError>(contentType: "application/json"))
    ...
    public func batchDisassociateProjectAssets(input: BatchDisassociateProjectAssetsInput, completion: @escaping (SdkResult<BatchDisassociateProjectAssetsOutput, BatchDisassociateProjectAssetsOutputError>) -> Void)
    {
        guard let projectId = input.projectId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component projectId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<BatchDisassociateProjectAssetsInput, BatchDisassociateProjectAssetsOutput, BatchDisassociateProjectAssetsOutputError>(id: "batchDisassociateProjectAssets")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<BatchDisassociateProjectAssetsOutput>, SdkError<BatchDisassociateProjectAssetsOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<BatchDisassociateProjectAssetsInput, BatchDisassociateProjectAssetsOutput, BatchDisassociateProjectAssetsOutputError>(contentType: "application/json"))
    ...
    ///       <i>AWS IoT SiteWise User Guide</i>.</p>
    public func batchPutAssetPropertyValue(input: BatchPutAssetPropertyValueInput, completion: @escaping (SdkResult<BatchPutAssetPropertyValueOutput, BatchPutAssetPropertyValueOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<BatchPutAssetPropertyValueInput, BatchPutAssetPropertyValueOutput, BatchPutAssetPropertyValueOutputError>(id: "batchPutAssetPropertyValue")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<BatchPutAssetPropertyValueInput, BatchPutAssetPropertyValueOutput, BatchPutAssetPropertyValueOutputError>(contentType: "application/json"))
    ...
    public func createAccessPolicy(input: CreateAccessPolicyInput, completion: @escaping (SdkResult<CreateAccessPolicyOutput, CreateAccessPolicyOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateAccessPolicyInput, CreateAccessPolicyOutput, CreateAccessPolicyOutputError>(id: "createAccessPolicy")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateAccessPolicyOutput>, SdkError<CreateAccessPolicyOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateAccessPolicyInput, CreateAccessPolicyOutput, CreateAccessPolicyOutputError>(contentType: "application/json"))
    ...
    public func createAsset(input: CreateAssetInput, completion: @escaping (SdkResult<CreateAssetOutput, CreateAssetOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateAssetOutput>, SdkError<CreateAssetOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
    ...
    ///         <i>AWS IoT SiteWise User Guide</i>.</p>
    public func createAssetModel(input: CreateAssetModelInput, completion: @escaping (SdkResult<CreateAssetModelOutput, CreateAssetModelOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateAssetModelInput, CreateAssetModelOutput, CreateAssetModelOutputError>(id: "createAssetModel")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateAssetModelOutput>, SdkError<CreateAssetModelOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateAssetModelInput, CreateAssetModelOutput, CreateAssetModelOutputError>(contentType: "application/json"))
    ...
    public func createDashboard(input: CreateDashboardInput, completion: @escaping (SdkResult<CreateDashboardOutput, CreateDashboardOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateDashboardInput, CreateDashboardOutput, CreateDashboardOutputError>(id: "createDashboard")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateDashboardOutput>, SdkError<CreateDashboardOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateDashboardInput, CreateDashboardOutput, CreateDashboardOutputError>(contentType: "application/json"))
    ...
    ///         <i>AWS IoT SiteWise User Guide</i>.</p>
    public func createGateway(input: CreateGatewayInput, completion: @escaping (SdkResult<CreateGatewayOutput, CreateGatewayOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateGatewayInput, CreateGatewayOutput, CreateGatewayOutputError>(id: "createGateway")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateGatewayInput, CreateGatewayOutput, CreateGatewayOutputError>(contentType: "application/json"))
    ...
    ///          </note>
    public func createPortal(input: CreatePortalInput, completion: @escaping (SdkResult<CreatePortalOutput, CreatePortalOutputError>) -> Void)
    {
        let urlPath = "/portals"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreatePortalInput, CreatePortalOutput, CreatePortalOutputError>(id: "createPortal")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreatePortalOutput>, SdkError<CreatePortalOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreatePortalInput, CreatePortalOutput, CreatePortalOutputError>(contentType: "application/json"))
    ...
    ///       resource.</p>
    public func deleteAccessPolicy(input: DeleteAccessPolicyInput, completion: @escaping (SdkResult<DeleteAccessPolicyOutput, DeleteAccessPolicyOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAccessPolicyInput, DeleteAccessPolicyOutput, DeleteAccessPolicyOutputError>(id: "deleteAccessPolicy")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DeleteAccessPolicyOutput>, SdkError<DeleteAccessPolicyOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAccessPolicyInput, DeleteAccessPolicyOutput, DeleteAccessPolicyOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deleteAsset(input: DeleteAssetInput, completion: @escaping (SdkResult<DeleteAssetOutput, DeleteAssetOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DeleteAssetOutput>, SdkError<DeleteAssetOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
    ...
    ///         <i>AWS IoT SiteWise User Guide</i>.</p>
    public func deleteAssetModel(input: DeleteAssetModelInput, completion: @escaping (SdkResult<DeleteAssetModelOutput, DeleteAssetModelOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteAssetModelInput, DeleteAssetModelOutput, DeleteAssetModelOutputError>(id: "deleteAssetModel")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DeleteAssetModelOutput>, SdkError<DeleteAssetModelOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteAssetModelInput, DeleteAssetModelOutput, DeleteAssetModelOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deleteDashboard(input: DeleteDashboardInput, completion: @escaping (SdkResult<DeleteDashboardOutput, DeleteDashboardOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteDashboardInput, DeleteDashboardOutput, DeleteDashboardOutputError>(id: "deleteDashboard")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DeleteDashboardOutput>, SdkError<DeleteDashboardOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteDashboardInput, DeleteDashboardOutput, DeleteDashboardOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deleteGateway(input: DeleteGatewayInput, completion: @escaping (SdkResult<DeleteGatewayOutput, DeleteGatewayOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteGatewayInput, DeleteGatewayOutput, DeleteGatewayOutputError>(id: "deleteGateway")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteGatewayInput, DeleteGatewayOutput, DeleteGatewayOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func deletePortal(input: DeletePortalInput, completion: @escaping (SdkResult<DeletePortalOutput, DeletePortalOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeletePortalInput, DeletePortalOutput, DeletePortalOutputError>(id: "deletePortal")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DeletePortalOutput>, SdkError<DeletePortalOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeletePortalInput, DeletePortalOutput, DeletePortalOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       project.</p>
    public func describeAccessPolicy(input: DescribeAccessPolicyInput, completion: @escaping (SdkResult<DescribeAccessPolicyOutput, DescribeAccessPolicyOutputError>) -> Void)
    {
        guard let accessPolicyId = input.accessPolicyId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component accessPolicyId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAccessPolicyInput, DescribeAccessPolicyOutput, DescribeAccessPolicyOutputError>(id: "describeAccessPolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAccessPolicyInput, DescribeAccessPolicyOutput, DescribeAccessPolicyOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeAssetModel(input: DescribeAssetModelInput, completion: @escaping (SdkResult<DescribeAssetModelOutput, DescribeAssetModelOutputError>) -> Void)
    {
        guard let assetModelId = input.assetModelId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component assetModelId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAssetModelInput, DescribeAssetModelOutput, DescribeAssetModelOutputError>(id: "describeAssetModel")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAssetModelInput, DescribeAssetModelOutput, DescribeAssetModelOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeAssetProperty(input: DescribeAssetPropertyInput, completion: @escaping (SdkResult<DescribeAssetPropertyOutput, DescribeAssetPropertyOutputError>) -> Void)
    {
        guard let assetId = input.assetId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component assetId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeAssetPropertyInput, DescribeAssetPropertyOutput, DescribeAssetPropertyOutputError>(id: "describeAssetProperty")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeAssetPropertyInput, DescribeAssetPropertyOutput, DescribeAssetPropertyOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeDashboard(input: DescribeDashboardInput, completion: @escaping (SdkResult<DescribeDashboardOutput, DescribeDashboardOutputError>) -> Void)
    {
        guard let dashboardId = input.dashboardId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component dashboardId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeDashboardInput, DescribeDashboardOutput, DescribeDashboardOutputError>(id: "describeDashboard")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeDashboardInput, DescribeDashboardOutput, DescribeDashboardOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeDefaultEncryptionConfiguration(input: DescribeDefaultEncryptionConfigurationInput, completion: @escaping (SdkResult<DescribeDefaultEncryptionConfigurationOutput, DescribeDefaultEncryptionConfigurationOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeDefaultEncryptionConfigurationInput, DescribeDefaultEncryptionConfigurationOutput, DescribeDefaultEncryptionConfigurationOutputError>(id: "describeDefaultEncryptionConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeDefaultEncryptionConfigurationInput, DescribeDefaultEncryptionConfigurationOutput, DescribeDefaultEncryptionConfigurationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeGateway(input: DescribeGatewayInput, completion: @escaping (SdkResult<DescribeGatewayOutput, DescribeGatewayOutputError>) -> Void)
    {
        guard let gatewayId = input.gatewayId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component gatewayId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeGatewayInput, DescribeGatewayOutput, DescribeGatewayOutputError>(id: "describeGateway")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeGatewayInput, DescribeGatewayOutput, DescribeGatewayOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describeGatewayCapabilityConfiguration(input: DescribeGatewayCapabilityConfigurationInput, completion: @escaping (SdkResult<DescribeGatewayCapabilityConfigurationOutput, DescribeGatewayCapabilityConfigurationOutputError>) -> Void)
    {
        guard let gatewayId = input.gatewayId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component gatewayId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeGatewayCapabilityConfigurationInput, DescribeGatewayCapabilityConfigurationOutput, DescribeGatewayCapabilityConfigurationOutputError>(id: "describeGatewayCapabilityConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeGatewayCapabilityConfigurationInput, DescribeGatewayCapabilityConfigurationOutput, DescribeGatewayCapabilityConfigurationOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func describePortal(input: DescribePortalInput, completion: @escaping (SdkResult<DescribePortalOutput, DescribePortalOutputError>) -> Void)
    {
        guard let portalId = input.portalId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component portalId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribePortalInput, DescribePortalOutput, DescribePortalOutputError>(id: "describePortal")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribePortalInput, DescribePortalOutput, DescribePortalOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func disassociateAssets(input: DisassociateAssetsInput, completion: @escaping (SdkResult<DisassociateAssetsOutput, DisassociateAssetsOutputError>) -> Void)
    {
        guard let assetId = input.assetId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component assetId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DisassociateAssetsInput, DisassociateAssetsOutput, DisassociateAssetsOutputError>(id: "disassociateAssets")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<DisassociateAssetsOutput>, SdkError<DisassociateAssetsOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DisassociateAssetsInput, DisassociateAssetsOutput, DisassociateAssetsOutputError>(contentType: "application/json"))
    ...
    ///             </li>
    ///          </ul>
    public func getAssetPropertyAggregates(input: GetAssetPropertyAggregatesInput, completion: @escaping (SdkResult<GetAssetPropertyAggregatesOutput, GetAssetPropertyAggregatesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAssetPropertyAggregatesInput, GetAssetPropertyAggregatesOutput, GetAssetPropertyAggregatesOutputError>(id: "getAssetPropertyAggregates")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAssetPropertyAggregatesInput, GetAssetPropertyAggregatesOutput, GetAssetPropertyAggregatesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getAssetPropertyValue(input: GetAssetPropertyValueInput, completion: @escaping (SdkResult<GetAssetPropertyValueOutput, GetAssetPropertyValueOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAssetPropertyValueInput, GetAssetPropertyValueOutput, GetAssetPropertyValueOutputError>(id: "getAssetPropertyValue")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAssetPropertyValueInput, GetAssetPropertyValueOutput, GetAssetPropertyValueOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getAssetPropertyValueHistory(input: GetAssetPropertyValueHistoryInput, completion: @escaping (SdkResult<GetAssetPropertyValueHistoryOutput, GetAssetPropertyValueHistoryOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetAssetPropertyValueHistoryInput, GetAssetPropertyValueHistoryOutput, GetAssetPropertyValueHistoryOutputError>(id: "getAssetPropertyValueHistory")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetAssetPropertyValueHistoryInput, GetAssetPropertyValueHistoryOutput, GetAssetPropertyValueHistoryOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func getInterpolatedAssetPropertyValues(input: GetInterpolatedAssetPropertyValuesInput, completion: @escaping (SdkResult<GetInterpolatedAssetPropertyValuesOutput, GetInterpolatedAssetPropertyValuesOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetInterpolatedAssetPropertyValuesInput, GetInterpolatedAssetPropertyValuesOutput, GetInterpolatedAssetPropertyValuesOutputError>(id: "getInterpolatedAssetPropertyValues")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetInterpolatedAssetPropertyValuesInput, GetInterpolatedAssetPropertyValuesOutput, GetInterpolatedAssetPropertyValuesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listAccessPolicies(input: ListAccessPoliciesInput, completion: @escaping (SdkResult<ListAccessPoliciesOutput, ListAccessPoliciesOutputError>) -> Void)
    {
        let urlPath = "/access-policies"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAccessPoliciesInput, ListAccessPoliciesOutput, ListAccessPoliciesOutputError>(id: "listAccessPolicies")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAccessPoliciesInput, ListAccessPoliciesOutput, ListAccessPoliciesOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listAssetModels(input: ListAssetModelsInput, completion: @escaping (SdkResult<ListAssetModelsOutput, ListAssetModelsOutputError>) -> Void)
    {
        let urlPath = "/asset-models"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAssetModelsInput, ListAssetModelsOutput, ListAssetModelsOutputError>(id: "listAssetModels")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAssetModelsInput, ListAssetModelsOutput, ListAssetModelsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       root.</p>
    public func listAssetRelationships(input: ListAssetRelationshipsInput, completion: @escaping (SdkResult<ListAssetRelationshipsOutput, ListAssetRelationshipsOutputError>) -> Void)
    {
        guard let assetId = input.assetId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component assetId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAssetRelationshipsInput, ListAssetRelationshipsOutput, ListAssetRelationshipsOutputError>(id: "listAssetRelationships")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAssetRelationshipsInput, ListAssetRelationshipsOutput, ListAssetRelationshipsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///             </li>
    ///          </ul>
    public func listAssociatedAssets(input: ListAssociatedAssetsInput, completion: @escaping (SdkResult<ListAssociatedAssetsOutput, ListAssociatedAssetsOutputError>) -> Void)
    {
        guard let assetId = input.assetId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component assetId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListAssociatedAssetsInput, ListAssociatedAssetsOutput, ListAssociatedAssetsOutputError>(id: "listAssociatedAssets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListAssociatedAssetsInput, ListAssociatedAssetsOutput, ListAssociatedAssetsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listDashboards(input: ListDashboardsInput, completion: @escaping (SdkResult<ListDashboardsOutput, ListDashboardsOutputError>) -> Void)
    {
        let urlPath = "/dashboards"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListDashboardsInput, ListDashboardsOutput, ListDashboardsOutputError>(id: "listDashboards")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListDashboardsInput, ListDashboardsOutput, ListDashboardsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listGateways(input: ListGatewaysInput, completion: @escaping (SdkResult<ListGatewaysOutput, ListGatewaysOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListGatewaysInput, ListGatewaysOutput, ListGatewaysOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listPortals(input: ListPortalsInput, completion: @escaping (SdkResult<ListPortalsOutput, ListPortalsOutputError>) -> Void)
    {
        let urlPath = "/portals"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListPortalsInput, ListPortalsOutput, ListPortalsOutputError>(id: "listPortals")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListPortalsInput, ListPortalsOutput, ListPortalsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listProjectAssets(input: ListProjectAssetsInput, completion: @escaping (SdkResult<ListProjectAssetsOutput, ListProjectAssetsOutputError>) -> Void)
    {
        guard let projectId = input.projectId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component projectId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListProjectAssetsInput, ListProjectAssetsOutput, ListProjectAssetsOutputError>(id: "listProjectAssets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListProjectAssetsInput, ListProjectAssetsOutput, ListProjectAssetsOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    ///       in the <i>AWS IoT SiteWise User Guide</i>.</p>
    public func putDefaultEncryptionConfiguration(input: PutDefaultEncryptionConfigurationInput, completion: @escaping (SdkResult<PutDefaultEncryptionConfigurationOutput, PutDefaultEncryptionConfigurationOutputError>) -> Void)
    {
        let urlPath = "/configuration/account/encryption"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutDefaultEncryptionConfigurationInput, PutDefaultEncryptionConfigurationOutput, PutDefaultEncryptionConfigurationOutputError>(id: "putDefaultEncryptionConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutDefaultEncryptionConfigurationInput, PutDefaultEncryptionConfigurationOutput, PutDefaultEncryptionConfigurationOutputError>(contentType: "application/json"))
    ...
    public func updateAccessPolicy(input: UpdateAccessPolicyInput, completion: @escaping (SdkResult<UpdateAccessPolicyOutput, UpdateAccessPolicyOutputError>) -> Void)
    {
        guard let accessPolicyId = input.accessPolicyId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component accessPolicyId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateAccessPolicyInput, UpdateAccessPolicyOutput, UpdateAccessPolicyOutputError>(id: "updateAccessPolicy")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateAccessPolicyOutput>, SdkError<UpdateAccessPolicyOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateAccessPolicyInput, UpdateAccessPolicyOutput, UpdateAccessPolicyOutputError>(contentType: "application/json"))
    ...
    public func updateAsset(input: UpdateAssetInput, completion: @escaping (SdkResult<UpdateAssetOutput, UpdateAssetOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateAssetOutput>, SdkError<UpdateAssetOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
    ...
    ///         property.</p>
    ///          </important>
    public func updateAssetModel(input: UpdateAssetModelInput, completion: @escaping (SdkResult<UpdateAssetModelOutput, UpdateAssetModelOutputError>) -> Void)
    {
        guard let assetModelId = input.assetModelId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component assetModelId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateAssetModelInput, UpdateAssetModelOutput, UpdateAssetModelOutputError>(id: "updateAssetModel")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateAssetModelOutput>, SdkError<UpdateAssetModelOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateAssetModelInput, UpdateAssetModelOutput, UpdateAssetModelOutputError>(contentType: "application/json"))
    ...
    ///          </important>
    public func updateAssetProperty(input: UpdateAssetPropertyInput, completion: @escaping (SdkResult<UpdateAssetPropertyOutput, UpdateAssetPropertyOutputError>) -> Void)
    {
        guard let assetId = input.assetId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component assetId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateAssetPropertyInput, UpdateAssetPropertyOutput, UpdateAssetPropertyOutputError>(id: "updateAssetProperty")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateAssetPropertyOutput>, SdkError<UpdateAssetPropertyOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateAssetPropertyInput, UpdateAssetPropertyOutput, UpdateAssetPropertyOutputError>(contentType: "application/json"))
    ...
    public func updateDashboard(input: UpdateDashboardInput, completion: @escaping (SdkResult<UpdateDashboardOutput, UpdateDashboardOutputError>) -> Void)
    {
        guard let dashboardId = input.dashboardId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component dashboardId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateDashboardInput, UpdateDashboardOutput, UpdateDashboardOutputError>(id: "updateDashboard")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateDashboardOutput>, SdkError<UpdateDashboardOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateDashboardInput, UpdateDashboardOutput, UpdateDashboardOutputError>(contentType: "application/json"))
    ...
    public func updateGateway(input: UpdateGatewayInput, completion: @escaping (SdkResult<UpdateGatewayOutput, UpdateGatewayOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateGatewayInput, UpdateGatewayOutput, UpdateGatewayOutputError>(contentType: "application/json"))
    ...
    ///       the AWS IoT SiteWise console, all of your OPC-UA sources are stored in one capability configuration. To
    ///       list all capability configurations for a gateway, use <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_DescribeGateway.html">DescribeGateway</a>.</p>
    public func updateGatewayCapabilityConfiguration(input: UpdateGatewayCapabilityConfigurationInput, completion: @escaping (SdkResult<UpdateGatewayCapabilityConfigurationOutput, UpdateGatewayCapabilityConfigurationOutputError>) -> Void)
    {
        guard let gatewayId = input.gatewayId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component gatewayId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateGatewayCapabilityConfigurationInput, UpdateGatewayCapabilityConfigurationOutput, UpdateGatewayCapabilityConfigurationOutputError>(id: "updateGatewayCapabilityConfiguration")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateGatewayCapabilityConfigurationInput, UpdateGatewayCapabilityConfigurationOutput, UpdateGatewayCapabilityConfigurationOutputError>(contentType: "application/json"))
    ...
    public func updatePortal(input: UpdatePortalInput, completion: @escaping (SdkResult<UpdatePortalOutput, UpdatePortalOutputError>) -> Void)
    {
        guard let portalId = input.portalId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component portalId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "iotsitewise")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdatePortalInput, UpdatePortalOutput, UpdatePortalOutputError>(id: "updatePortal")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdatePortalOutput>, SdkError<UpdatePortalOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdatePortalInput, UpdatePortalOutput, UpdatePortalOutputError>(contentType: "application/json"))
    ...
    public func updateProject(input: UpdateProjectInput, completion: @escaping (SdkResult<UpdateProjectOutput, UpdateProjectOutputError>) -> Void)
    {
        ...
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateProjectOutput>, SdkError<UpdateProjectOutputError>> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientToken == nil {
                copiedInput.clientToken = idempotencyTokenGenerator.generateToken()
