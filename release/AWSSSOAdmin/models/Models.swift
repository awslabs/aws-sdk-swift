...
extension SsoAdminClientTypes {
    ...
    public struct AccountAssignment: Swift.Equatable {
        ...
        var permissionSetArn: Swift.String?
        ...
        var principalType: SsoAdminClientTypes.PrincipalType?
...
extension SsoAdminClientTypes {
    ...
    public struct AccountAssignmentOperationStatus: Swift.Equatable {
        ...
        var status: SsoAdminClientTypes.StatusValues?
        ...
        /// The entity type for which the assignment will be created.
        var targetType: SsoAdminClientTypes.TargetType?
...
public struct AttachManagedPolicyToPermissionSetInput: Swift.Equatable {
    ...
    /// This member is required.
    var managedPolicyArn: Swift.String?
...
public struct CreateAccountAssignmentOutputResponse: Swift.Equatable {
    ...
    var accountAssignmentCreationStatus: SsoAdminClientTypes.AccountAssignmentOperationStatus?
...
public struct CreateInstanceAccessControlAttributeConfigurationInput: Swift.Equatable {
    ...
    /// This member is required.
    var instanceAccessControlAttributeConfiguration: SsoAdminClientTypes.InstanceAccessControlAttributeConfiguration?
...
public struct CreatePermissionSetInput: Swift.Equatable {
    ...
    var relayState: Swift.String?
    /// The length of time that the application user sessions are valid in the ISO-8601 standard.
    var sessionDuration: Swift.String?
    /// The tags to attach to the new [PermissionSet].
    var tags: [SsoAdminClientTypes.Tag]?
...
public struct CreatePermissionSetOutputResponse: Swift.Equatable {
    ...
    var permissionSet: SsoAdminClientTypes.PermissionSet?
...
public struct DeleteAccountAssignmentOutputResponse: Swift.Equatable {
    ...
    var accountAssignmentDeletionStatus: SsoAdminClientTypes.AccountAssignmentOperationStatus?
...
public struct DescribeAccountAssignmentCreationStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var accountAssignmentCreationRequestId: Swift.String?
    /// The ARN of the SSO instance under which the operation will be executed. For more information about ARNs, see [Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces] in the Amazon Web Services General Reference.
    /// This member is required.
    var instanceArn: Swift.String?
...
public struct DescribeAccountAssignmentDeletionStatusInput: Swift.Equatable {
    /// The identifier that is used to track the request operation progress.
    /// This member is required.
    var accountAssignmentDeletionRequestId: Swift.String?
    /// The ARN of the SSO instance under which the operation will be executed. For more information about ARNs, see [Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces] in the Amazon Web Services General Reference.
    /// This member is required.
    var instanceArn: Swift.String?
...
public struct DescribeInstanceAccessControlAttributeConfigurationOutputResponse: Swift.Equatable {
    ...
    var status: SsoAdminClientTypes.InstanceAccessControlAttributeConfigurationStatus?
...
public struct DescribePermissionSetProvisioningStatusInput: Swift.Equatable {
    ...
    /// This member is required.
    var provisionPermissionSetRequestId: Swift.String?
...
public struct DescribePermissionSetProvisioningStatusOutputResponse: Swift.Equatable {
    ...
    var permissionSetProvisioningStatus: SsoAdminClientTypes.PermissionSetProvisioningStatus?
...
extension SsoAdminClientTypes {
    ...
    public struct InstanceAccessControlAttributeConfiguration: Swift.Equatable {
        ...
        /// This member is required.
        var accessControlAttributes: [SsoAdminClientTypes.AccessControlAttribute]?
...
public struct ListAccountAssignmentCreationStatusInput: Swift.Equatable {
    ...
    var filter: SsoAdminClientTypes.OperationStatusFilter?
    /// The ARN of the SSO instance under which the operation will be executed. For more information about ARNs, see [Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces] in the Amazon Web Services General Reference.
    /// This member is required.
    var instanceArn: Swift.String?
...
public struct ListAccountAssignmentCreationStatusOutputResponse: Swift.Equatable {
    /// The status object for the account assignment creation operation.
    var accountAssignmentsCreationStatus: [SsoAdminClientTypes.AccountAssignmentOperationStatusMetadata]?
    /// The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls.
    var nextToken: Swift.String?
...
public struct ListAccountAssignmentDeletionStatusOutputResponse: Swift.Equatable {
    /// The status object for the account assignment deletion operation.
    var accountAssignmentsDeletionStatus: [SsoAdminClientTypes.AccountAssignmentOperationStatusMetadata]?
    /// The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls.
    var nextToken: Swift.String?
...
public struct ListAccountAssignmentsOutputResponse: Swift.Equatable {
    ...
    var accountAssignments: [SsoAdminClientTypes.AccountAssignment]?
    /// The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls.
    var nextToken: Swift.String?
...
public struct ListAccountsForProvisionedPermissionSetInput: Swift.Equatable {
    ...
    var provisioningStatus: SsoAdminClientTypes.ProvisioningStatus?
...
public struct ListInstancesOutputResponse: Swift.Equatable {
    ...
    var instances: [SsoAdminClientTypes.InstanceMetadata]?
    /// The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls.
    var nextToken: Swift.String?
...
public struct ListManagedPoliciesInPermissionSetOutputResponse: Swift.Equatable {
    ...
    var attachedManagedPolicies: [SsoAdminClientTypes.AttachedManagedPolicy]?
    /// The pagination token for the list API. Initially the value is null. Use the output of previous API calls to make subsequent calls.
    var nextToken: Swift.String?
...
public struct ListPermissionSetProvisioningStatusOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// The status object for the permission set provisioning operation.
    var permissionSetsProvisioningStatus: [SsoAdminClientTypes.PermissionSetProvisioningStatusMetadata]?
...
public struct ListPermissionSetsOutputResponse: Swift.Equatable {
    ...
    var nextToken: Swift.String?
    /// Defines the level of access on an Amazon Web Services account.
    var permissionSets: [Swift.String]?
...
public struct ProvisionPermissionSetInput: Swift.Equatable {
    ...
    /// The entity type for which the assignment will be created.
    /// This member is required.
    var targetType: SsoAdminClientTypes.ProvisionTargetType?
