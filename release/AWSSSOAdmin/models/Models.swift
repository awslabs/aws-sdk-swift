...
extension SsoAdminClientTypes {
    /// The value used for mapping a specified attribute to an identity source. For more information, see [Attribute mappings](https://docs.aws.amazon.com/singlesignon/latest/userguide/attributemappingsconcept.html) in the Amazon Web Services Single Sign-On User Guide.
...
extension SsoAdminClientTypes {
    ...
    public struct CustomerManagedPolicyReference: Swift.Equatable {
        ...
        /// This member is required.
        public var name: Swift.String?
        /// The path for the policy. The default is /. For more information, see [Friendly names and paths](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-friendly-names) in the Identity and Access Management user guide.
