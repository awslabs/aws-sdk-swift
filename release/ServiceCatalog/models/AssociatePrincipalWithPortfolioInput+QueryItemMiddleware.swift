...
public struct AssociatePrincipalWithPortfolioInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<AssociatePrincipalWithPortfolioOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AssociatePrincipalWithPortfolioOutput>
