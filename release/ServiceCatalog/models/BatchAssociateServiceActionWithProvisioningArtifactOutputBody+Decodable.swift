...
struct BatchAssociateServiceActionWithProvisioningArtifactOutputBody: Equatable {
    public let failedServiceActionAssociations: [FailedServiceActionAssociation]?
}

extension BatchAssociateServiceActionWithProvisioningArtifactOutputBody: Decodable {
