...
public struct DisassociatePrincipalFromPortfolioInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DisassociatePrincipalFromPortfolioOutput>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DisassociatePrincipalFromPortfolioOutput>
