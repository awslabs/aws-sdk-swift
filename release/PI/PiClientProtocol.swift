...
public protocol PiClientProtocol {
    ...
    ///          </note>
    func describeDimensionKeys(input: DescribeDimensionKeysInput, completion: @escaping (SdkResult<DescribeDimensionKeysOutput, DescribeDimensionKeysOutputError>) -> Void)
    ...
    func getDimensionKeyDetails(input: GetDimensionKeyDetailsInput, completion: @escaping (SdkResult<GetDimensionKeyDetailsOutput, GetDimensionKeyDetailsOutputError>) -> Void)
    ...
    ///                only the first 500 bytes are returned.</p>
    ///          </note>
    func getResourceMetrics(input: GetResourceMetricsInput, completion: @escaping (SdkResult<GetResourceMetricsOutput, GetResourceMetricsOutputError>) -> Void)
}
