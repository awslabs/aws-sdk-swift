...
extension EfsClientTypes {
    ...
    public struct AccessPointDescription: Swift.Equatable {
        ...
        var accessPointArn: Swift.String?
        ...
        var lifeCycleState: EfsClientTypes.LifeCycleState?
        ...
        var posixUser: EfsClientTypes.PosixUser?
        /// The directory on the Amazon EFS file system that the access point exposes as the root directory to NFS clients using the access point.
        var rootDirectory: EfsClientTypes.RootDirectory?
        /// The tags associated with the access point, presented as an array of Tag objects.
        var tags: [EfsClientTypes.Tag]?
...
extension EfsClientTypes {
    ...
    public struct BackupPolicy: Swift.Equatable {
        ...
        /// This member is required.
        var status: EfsClientTypes.Status?
...
public struct CreateFileSystemInput: Swift.Equatable {
    ...
    var availabilityZoneName: Swift.String?
    ...
    var backup: Swift.Bool?
    /// A string of up to 64 ASCII characters. Amazon EFS uses this to ensure idempotent creation.
    /// This member is required.
    var creationToken: Swift.String?
    ...
    var performanceMode: EfsClientTypes.PerformanceMode?
    ...
    var provisionedThroughputInMibps: Swift.Double?
    ...
    var throughputMode: EfsClientTypes.ThroughputMode?
...
public struct CreateFileSystemOutputResponse: Swift.Equatable {
    ...
    var fileSystemArn: Swift.String?
    ...
    /// This member is required.
    var numberOfMountTargets: Swift.Int
    ...
    /// This member is required.
    var sizeInBytes: EfsClientTypes.FileSystemSize?
...
public struct CreateMountTargetOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var mountTargetId: Swift.String?
...
extension EfsClientTypes {
    ...
    public struct CreationInfo: Swift.Equatable {
        ...
        /// This member is required.
        var ownerGid: Swift.Int?
        /// Specifies the POSIX user ID to apply to the RootDirectory. Accepts values from 0 to 2^32 (4294967295).
        /// This member is required.
        var ownerUid: Swift.Int?
        /// Specifies the POSIX permissions to apply to the RootDirectory, in the format of an octal number representing the file's mode bits.
        /// This member is required.
        var permissions: Swift.String?
...
public struct DescribeAccessPointsOutputResponse: Swift.Equatable {
    ...
    var accessPoints: [EfsClientTypes.AccessPointDescription]?
...
public struct DescribeAccountPreferencesOutputResponse: Swift.Equatable {
    ...
    var resourceIdPreference: EfsClientTypes.ResourceIdPreference?
...
public struct DescribeBackupPolicyOutputResponse: Swift.Equatable {
    ...
    var backupPolicy: EfsClientTypes.BackupPolicy?
...
public struct DescribeFileSystemsOutputResponse: Swift.Equatable {
    ...
    var fileSystems: [EfsClientTypes.FileSystemDescription]?
...
public struct DescribeLifecycleConfigurationOutputResponse: Swift.Equatable {
    ...
    var lifecyclePolicies: [EfsClientTypes.LifecyclePolicy]?
...
public struct DescribeMountTargetsOutputResponse: Swift.Equatable {
    ...
    var mountTargets: [EfsClientTypes.MountTargetDescription]?
...
extension EfsClientTypes {
    ...
    public struct FileSystemSize: Swift.Equatable {
        ...
        var valueInIA: Swift.Int?
        /// The latest known metered size (in bytes) of data stored in the Standard storage class.
        var valueInStandard: Swift.Int?
...
extension EfsClientTypes {
    ...
    public struct LifecyclePolicy: Swift.Equatable {
        ...
        var transitionToIA: EfsClientTypes.TransitionToIARules?
        /// Describes when to transition a file from IA storage to primary storage. Metadata operations such as listing the contents of a directory don't count as file access events.
        var transitionToPrimaryStorageClass: EfsClientTypes.TransitionToPrimaryStorageClassRules?
...
public struct PutAccountPreferencesInput: Swift.Equatable {
    ...
    /// This member is required.
    var resourceIdType: EfsClientTypes.ResourceIdType?
...
public struct PutFileSystemPolicyInput: Swift.Equatable {
    ...
    var bypassPolicyLockoutSafetyCheck: Swift.Bool
...
extension EfsClientTypes {
    ...
    public struct ResourceIdPreference: Swift.Equatable {
        ...
        var resources: [EfsClientTypes.Resource]?
...
extension EfsClientTypes {
    ...
    public struct RootDirectory: Swift.Equatable {
        ...
        var creationInfo: EfsClientTypes.CreationInfo?
