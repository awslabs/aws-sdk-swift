...
public extension EfsClient {
    ...
    {
        typealias createFileSystemContinuation = CheckedContinuation<CreateFileSystemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createFileSystemContinuation) in
            createFileSystem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    ///
    func createMountTarget(input: CreateMountTargetInput) async throws -> CreateMountTargetOutputResponse
    {
        typealias createMountTargetContinuation = CheckedContinuation<CreateMountTargetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createMountTargetContinuation) in
            createMountTarget(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteFileSystemContinuation = CheckedContinuation<DeleteFileSystemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteFileSystemContinuation) in
            deleteFileSystem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func deleteFileSystemPolicy(input: DeleteFileSystemPolicyInput) async throws -> DeleteFileSystemPolicyOutputResponse
    {
        typealias deleteFileSystemPolicyContinuation = CheckedContinuation<DeleteFileSystemPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteFileSystemPolicyContinuation) in
            deleteFileSystemPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteMountTargetContinuation = CheckedContinuation<DeleteMountTargetOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteMountTargetContinuation) in
            deleteMountTarget(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeAccessPointsContinuation = CheckedContinuation<DescribeAccessPointsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAccessPointsContinuation) in
            describeAccessPoints(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeAccountPreferences(input: DescribeAccountPreferencesInput) async throws -> DescribeAccountPreferencesOutputResponse
    {
        typealias describeAccountPreferencesContinuation = CheckedContinuation<DescribeAccountPreferencesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeAccountPreferencesContinuation) in
            describeAccountPreferences(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeBackupPolicy(input: DescribeBackupPolicyInput) async throws -> DescribeBackupPolicyOutputResponse
    {
        typealias describeBackupPolicyContinuation = CheckedContinuation<DescribeBackupPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeBackupPolicyContinuation) in
            describeBackupPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeFileSystemPolicy(input: DescribeFileSystemPolicyInput) async throws -> DescribeFileSystemPolicyOutputResponse
    {
        typealias describeFileSystemPolicyContinuation = CheckedContinuation<DescribeFileSystemPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFileSystemPolicyContinuation) in
            describeFileSystemPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeFileSystemsContinuation = CheckedContinuation<DescribeFileSystemsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeFileSystemsContinuation) in
            describeFileSystems(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeLifecycleConfiguration(input: DescribeLifecycleConfigurationInput) async throws -> DescribeLifecycleConfigurationOutputResponse
    {
        typealias describeLifecycleConfigurationContinuation = CheckedContinuation<DescribeLifecycleConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeLifecycleConfigurationContinuation) in
            describeLifecycleConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    ///
    func describeMountTargetSecurityGroups(input: DescribeMountTargetSecurityGroupsInput) async throws -> DescribeMountTargetSecurityGroupsOutputResponse
    {
        typealias describeMountTargetSecurityGroupsContinuation = CheckedContinuation<DescribeMountTargetSecurityGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeMountTargetSecurityGroupsContinuation) in
            describeMountTargetSecurityGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func describeMountTargets(input: DescribeMountTargetsInput) async throws -> DescribeMountTargetsOutputResponse
    {
        typealias describeMountTargetsContinuation = CheckedContinuation<DescribeMountTargetsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeMountTargetsContinuation) in
            describeMountTargets(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///
    ///
    func modifyMountTargetSecurityGroups(input: ModifyMountTargetSecurityGroupsInput) async throws -> ModifyMountTargetSecurityGroupsOutputResponse
    {
        typealias modifyMountTargetSecurityGroupsContinuation = CheckedContinuation<ModifyMountTargetSecurityGroupsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: modifyMountTargetSecurityGroupsContinuation) in
            modifyMountTargetSecurityGroups(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putAccountPreferences(input: PutAccountPreferencesInput) async throws -> PutAccountPreferencesOutputResponse
    {
        typealias putAccountPreferencesContinuation = CheckedContinuation<PutAccountPreferencesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putAccountPreferencesContinuation) in
            putAccountPreferences(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putBackupPolicy(input: PutBackupPolicyInput) async throws -> PutBackupPolicyOutputResponse
    {
        typealias putBackupPolicyContinuation = CheckedContinuation<PutBackupPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putBackupPolicyContinuation) in
            putBackupPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    func putFileSystemPolicy(input: PutFileSystemPolicyInput) async throws -> PutFileSystemPolicyOutputResponse
    {
        typealias putFileSystemPolicyContinuation = CheckedContinuation<PutFileSystemPolicyOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putFileSystemPolicyContinuation) in
            putFileSystemPolicy(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    ///       file system.
    func putLifecycleConfiguration(input: PutLifecycleConfigurationInput) async throws -> PutLifecycleConfigurationOutputResponse
    {
        typealias putLifecycleConfigurationContinuation = CheckedContinuation<PutLifecycleConfigurationOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: putLifecycleConfigurationContinuation) in
            putLifecycleConfiguration(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateFileSystemContinuation = CheckedContinuation<UpdateFileSystemOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateFileSystemContinuation) in
            updateFileSystem(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
