...
public struct AbortDocumentVersionUploadInput: Swift.Equatable {
    ...
    var authenticationToken: Swift.String?
    /// The ID of the document.
    /// This member is required.
    var documentId: Swift.String?
...
public struct ActivateUserOutputResponse: Swift.Equatable {
    ...
    var user: WorkDocsClientTypes.User?
...
extension WorkDocsClientTypes {
    ...
    public struct Activity: Swift.Equatable {
        ...
        var commentMetadata: WorkDocsClientTypes.CommentMetadata?
        /// The user who performed the action.
        var initiator: WorkDocsClientTypes.UserMetadata?
        /// Indicates whether an activity is indirect or direct. An indirect activity results from a direct activity performed on a parent resource. For example, sharing a parent folder (the direct activity) shares all of the subfolders and documents within the parent folder (the indirect activity).
        var isIndirectActivity: Swift.Bool
        /// The ID of the organization.
        var organizationId: Swift.String?
        /// The original parent of the resource. This is an optional field and is filled for move activities.
        var originalParent: WorkDocsClientTypes.ResourceMetadata?
        /// The list of users or groups impacted by this action. This is an optional field and is filled for the following sharing activities: DOCUMENT_SHARED, DOCUMENT_SHARED, DOCUMENT_UNSHARED, FOLDER_SHARED, FOLDER_UNSHARED.
        var participants: WorkDocsClientTypes.Participants?
        /// The metadata of the resource involved in the user action.
        var resourceMetadata: WorkDocsClientTypes.ResourceMetadata?
        /// The timestamp when the action was performed.
        var timeStamp: ClientRuntime.Date?
        /// The activity type.
        var type: WorkDocsClientTypes.ActivityType?
...
public struct AddResourcePermissionsInput: Swift.Equatable {
    ...
    var notificationOptions: WorkDocsClientTypes.NotificationOptions?
    /// The users, groups, or organization being granted permission.
    /// This member is required.
    var principals: [WorkDocsClientTypes.SharePrincipal]?
...
public struct AddResourcePermissionsOutputResponse: Swift.Equatable {
    /// The share results.
    var shareResults: [WorkDocsClientTypes.ShareResult]?
...
extension WorkDocsClientTypes {
    ...
    public struct CommentMetadata: Swift.Equatable {
        ...
        var commentId: Swift.String?
        /// The status of the comment.
        var commentStatus: WorkDocsClientTypes.CommentStatusType?
...
public struct CreateCommentInput: Swift.Equatable {
    ...
    var notifyCollaborators: Swift.Bool
    /// The ID of the parent comment.
    var parentId: Swift.String?
    /// The text of the comment.
    /// This member is required.
...
public struct CreateCommentOutputResponse: Swift.Equatable {
    ...
    var comment: WorkDocsClientTypes.Comment?
...
public struct CreateFolderInput: Swift.Equatable {
    ...
    /// This member is required.
    var parentFolderId: Swift.String?
...
public struct CreateFolderOutputResponse: Swift.Equatable {
    ...
    var metadata: WorkDocsClientTypes.FolderMetadata?
...
public struct CreateNotificationSubscriptionInput: Swift.Equatable {
    ...
    /// This member is required.
    var `protocol`: WorkDocsClientTypes.SubscriptionProtocolType?
    ...
    /// This member is required.
    var subscriptionType: WorkDocsClientTypes.SubscriptionType?
...
public struct CreateNotificationSubscriptionOutputResponse: Swift.Equatable {
    /// The subscription.
    var subscription: WorkDocsClientTypes.Subscription?
...
public struct CreateUserInput: Swift.Equatable {
    ...
    var storageRule: WorkDocsClientTypes.StorageRuleType?
    /// The surname of the user.
    /// This member is required.
    var surname: Swift.String?
    /// The time zone ID of the user.
    var timeZoneId: Swift.String?
...
public struct DescribeActivitiesOutputResponse: Swift.Equatable {
    ...
    var userActivities: [WorkDocsClientTypes.Activity]?
...
public struct DescribeCommentsOutputResponse: Swift.Equatable {
    ...
    var comments: [WorkDocsClientTypes.Comment]?
    /// The marker for the next set of results. This marker was received from a previous call.
    var marker: Swift.String?
...
public struct DescribeDocumentVersionsOutputResponse: Swift.Equatable {
    ...
    var documentVersions: [WorkDocsClientTypes.DocumentVersionMetadata]?
...
public struct DescribeFolderContentsInput: Swift.Equatable {
    ...
    var order: WorkDocsClientTypes.OrderType?
    /// The sorting criteria.
    var sort: WorkDocsClientTypes.ResourceSortType?
    /// The type of items.
    var type: WorkDocsClientTypes.FolderContentType?
...
public struct DescribeFolderContentsOutputResponse: Swift.Equatable {
    ...
    var documents: [WorkDocsClientTypes.DocumentMetadata]?
    /// The subfolders in the specified folder.
    var folders: [WorkDocsClientTypes.FolderMetadata]?
    /// The marker to use when requesting the next set of results. If there are no additional results, the string is empty.
    var marker: Swift.String?
...
public struct DescribeGroupsOutputResponse: Swift.Equatable {
    /// The list of groups.
    var groups: [WorkDocsClientTypes.GroupMetadata]?
    /// The marker to use when requesting the next set of results. If there are no additional results, the string is empty.
    var marker: Swift.String?
...
public struct DescribeNotificationSubscriptionsOutputResponse: Swift.Equatable {
    ...
    var marker: Swift.String?
    /// The subscriptions.
    var subscriptions: [WorkDocsClientTypes.Subscription]?
...
public struct DescribeResourcePermissionsOutputResponse: Swift.Equatable {
    ...
    var marker: Swift.String?
    /// The principals.
    var principals: [WorkDocsClientTypes.Principal]?
...
public struct DescribeUsersInput: Swift.Equatable {
    ...
    var include: WorkDocsClientTypes.UserFilterType?
    /// The maximum number of items to return.
    var limit: Swift.Int?
    /// The marker for the next set of results. (You received this marker from a previous call.)
    var marker: Swift.String?
    ...
    /// The sorting criteria.
    var sort: WorkDocsClientTypes.UserSortType?
...
public struct DescribeUsersOutputResponse: Swift.Equatable {
    ...
    var totalNumberOfUsers: Swift.Int?
    /// The users.
    var users: [WorkDocsClientTypes.User]?
...
extension WorkDocsClientTypes {
    ...
    public struct DocumentMetadata: Swift.Equatable {
        ...
        var creatorId: Swift.String?
        /// The ID of the document.
        var id: Swift.String?
        /// List of labels on the document.
        var labels: [Swift.String]?
        /// The latest version of the document.
        var latestVersionMetadata: WorkDocsClientTypes.DocumentVersionMetadata?
        /// The time when the document was updated.
        var modifiedTimestamp: ClientRuntime.Date?
        /// The ID of the parent folder.
        var parentFolderId: Swift.String?
        /// The resource state.
        var resourceState: WorkDocsClientTypes.ResourceStateType?
...
extension WorkDocsClientTypes {
    ...
    public struct DocumentVersionMetadata: Swift.Equatable {
        ...
        var contentCreatedTimestamp: ClientRuntime.Date?
        /// The timestamp when the content of the document was modified.
        var contentModifiedTimestamp: ClientRuntime.Date?
        ...
        var source: [Swift.String:Swift.String]?
        /// The status of the document.
        var status: WorkDocsClientTypes.DocumentStatusType?
        /// The thumbnail of the document.
        var thumbnail: [Swift.String:Swift.String]?
...
extension WorkDocsClientTypes {
    ...
    public struct FolderMetadata: Swift.Equatable {
        ...
        var latestVersionSize: Swift.Int?
...
public struct GetDocumentInput: Swift.Equatable {
    ...
    var includeCustomMetadata: Swift.Bool
...
public struct GetDocumentOutputResponse: Swift.Equatable {
    ...
    var metadata: WorkDocsClientTypes.DocumentMetadata?
...
public struct GetDocumentPathOutputResponse: Swift.Equatable {
    ...
    var path: WorkDocsClientTypes.ResourcePath?
...
public struct GetDocumentVersionOutputResponse: Swift.Equatable {
    ...
    var metadata: WorkDocsClientTypes.DocumentVersionMetadata?
...
public struct GetResourcesInput: Swift.Equatable {
    ...
    var authenticationToken: Swift.String?
    /// The collection type.
    var collectionType: WorkDocsClientTypes.ResourceCollectionType?
...
public struct InitiateDocumentVersionUploadInput: Swift.Equatable {
    ...
    var contentType: Swift.String?
    /// The size of the document, in bytes.
    var documentSizeInBytes: Swift.Int?
    /// The ID of the document.
    var id: Swift.String?
...
public struct InitiateDocumentVersionUploadOutputResponse: Swift.Equatable {
    ...
    var metadata: WorkDocsClientTypes.DocumentMetadata?
    /// The upload metadata.
    var uploadMetadata: WorkDocsClientTypes.UploadMetadata?
...
extension WorkDocsClientTypes {
    ...
    public struct Participants: Swift.Equatable {
        ...
        var groups: [WorkDocsClientTypes.GroupMetadata]?
        /// The list of users.
        var users: [WorkDocsClientTypes.UserMetadata]?
...
extension WorkDocsClientTypes {
    ...
    public struct PermissionInfo: Swift.Equatable {
        ...
        var role: WorkDocsClientTypes.RoleType?
        /// The type of permissions.
        var type: WorkDocsClientTypes.RolePermissionType?
...
extension WorkDocsClientTypes {
    ...
    public struct Principal: Swift.Equatable {
        ...
        var roles: [WorkDocsClientTypes.PermissionInfo]?
        /// The type of resource.
        var type: WorkDocsClientTypes.PrincipalType?
...
public struct RemoveResourcePermissionInput: Swift.Equatable {
    ...
    var principalType: WorkDocsClientTypes.PrincipalType?
    /// The ID of the resource.
    /// This member is required.
    var resourceId: Swift.String?
...
extension WorkDocsClientTypes {
    ...
    public struct ResourceMetadata: Swift.Equatable {
        ...
        var originalName: Swift.String?
        /// The owner of the resource.
        var owner: WorkDocsClientTypes.UserMetadata?
        /// The parent ID of the resource before a rename operation.
        var parentId: Swift.String?
        /// The type of resource.
        var type: WorkDocsClientTypes.ResourceType?
...
extension WorkDocsClientTypes {
    ...
    public struct ResourcePath: Swift.Equatable {
        ...
        var components: [WorkDocsClientTypes.ResourcePathComponent]?
...
extension WorkDocsClientTypes {
    ...
    public struct ShareResult: Swift.Equatable {
        ...
        var inviteePrincipalId: Swift.String?
        /// The ID of the principal.
        var principalId: Swift.String?
        /// The role.
        var role: WorkDocsClientTypes.RoleType?
        /// The ID of the resource that was shared.
        var shareId: Swift.String?
        /// The status.
        var status: WorkDocsClientTypes.ShareStatusType?
        /// The status message.
...
extension WorkDocsClientTypes {
    ...
    public struct StorageRuleType: Swift.Equatable {
        ...
        var storageAllocatedInBytes: Swift.Int?
        /// The type of storage.
        var storageType: WorkDocsClientTypes.StorageType?
...
public struct UpdateDocumentVersionInput: Swift.Equatable {
    ...
    var versionStatus: WorkDocsClientTypes.DocumentVersionStatus?
...
public struct UpdateUserInput: Swift.Equatable {
    ...
    var grantPoweruserPrivileges: WorkDocsClientTypes.BooleanEnumType?
    /// The locale of the user.
    var locale: WorkDocsClientTypes.LocaleType?
    /// The amount of storage for the user.
    var storageRule: WorkDocsClientTypes.StorageRuleType?
    /// The surname of the user.
    var surname: Swift.String?
    ...
    var type: WorkDocsClientTypes.UserType?
    /// The ID of the user.
    /// This member is required.
    var userId: Swift.String?
...
extension WorkDocsClientTypes {
    ...
    public struct UploadMetadata: Swift.Equatable {
        /// The signed headers.
        var signedHeaders: [Swift.String:Swift.String]?
...
extension WorkDocsClientTypes {
    ...
    public struct User: Swift.Equatable {
        ...
        var recycleBinFolderId: Swift.String?
        /// The ID of the root folder.
        var rootFolderId: Swift.String?
        /// The status of the user.
        var status: WorkDocsClientTypes.UserStatusType?
        /// The storage for the user.
        var storage: WorkDocsClientTypes.UserStorageMetadata?
        /// The surname of the user.
        var surname: Swift.String?
        /// The time zone ID of the user.
        var timeZoneId: Swift.String?
...
extension WorkDocsClientTypes {
    ...
    public struct UserStorageMetadata: Swift.Equatable {
        ...
        var storageUtilizedInBytes: Swift.Int?
