...
public struct DeleteReportDefinitionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteReportDefinitionInputBodyMiddleware"
...
extension DeleteReportDefinitionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteReportDefinitionInput(reportName: \(Swift.String(describing: reportName)))"}
}
...
extension DeleteReportDefinitionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteReportDefinitionOutputResponse(responseMessage: \(Swift.String(describing: responseMessage)))"}
}
...
public struct DescribeReportDefinitionsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeReportDefinitionsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeReportDefinitionsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeReportDefinitionsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeReportDefinitionsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeReportDefinitionsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeReportDefinitionsOutputError>
}

extension DescribeReportDefinitionsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeReportDefinitionsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension DescribeReportDefinitionsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct DescribeReportDefinitionsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeReportDefinitionsInputHeadersMiddleware"
...
public struct DescribeReportDefinitionsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeReportDefinitionsInputQueryItemMiddleware"
...
extension DescribeReportDefinitionsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeReportDefinitionsOutputResponse(nextToken: \(Swift.String(describing: nextToken)), reportDefinitions: \(Swift.String(describing: reportDefinitions)))"}
}
...
public struct DescribeReportDefinitionsOutputResponse: Swift.Equatable {
    ...
    public let reportDefinitions: [CostAndUsageReportClientTypes.ReportDefinition]?
...
extension DuplicateReportNameException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DuplicateReportNameException(message: \(Swift.String(describing: message)))"}
}

extension DuplicateReportNameException: AWSClientRuntime.AWSHttpServiceError {
...
public struct DuplicateReportNameException: ClientRuntime.ServiceError, Swift.Equatable {
...
public struct ModifyReportDefinitionInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyReportDefinitionInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ModifyReportDefinitionInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ModifyReportDefinitionOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ModifyReportDefinitionInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ModifyReportDefinitionOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ModifyReportDefinitionOutputError>
}

extension ModifyReportDefinitionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ModifyReportDefinitionInput(reportDefinition: \(Swift.String(describing: reportDefinition)), reportName: \(Swift.String(describing: reportName)))"}
}

extension ModifyReportDefinitionInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
public struct ModifyReportDefinitionInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyReportDefinitionInputHeadersMiddleware"
...
public struct ModifyReportDefinitionInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ModifyReportDefinitionInputQueryItemMiddleware"
...
public struct ModifyReportDefinitionInput: Swift.Equatable {
    ...
    ///     </p>
    public let reportDefinition: CostAndUsageReportClientTypes.ReportDefinition?
...
extension ModifyReportDefinitionOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
...
struct ModifyReportDefinitionOutputResponseBody: Swift.Equatable {
}

extension ModifyReportDefinitionOutputResponseBody: Swift.Decodable {
...
extension PutReportDefinitionInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "PutReportDefinitionInput(reportDefinition: \(Swift.String(describing: reportDefinition)))"}
}
...
extension CostAndUsageReportClientTypes.ReportDefinition: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension CostAndUsageReportClientTypes.ReportDefinition: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReportDefinition(additionalArtifacts: \(Swift.String(describing: additionalArtifacts)), additionalSchemaElements: \(Swift.String(describing: additionalSchemaElements)), billingViewArn: \(Swift.String(describing: billingViewArn)), compression: \(Swift.String(describing: compression)), format: \(Swift.String(describing: format)), refreshClosedReports: \(Swift.String(describing: refreshClosedReports)), reportName: \(Swift.String(describing: reportName)), reportVersioning: \(Swift.String(describing: reportVersioning)), s3Bucket: \(Swift.String(describing: s3Bucket)), s3Prefix: \(Swift.String(describing: s3Prefix)), s3Region: \(Swift.String(describing: s3Region)), timeUnit: \(Swift.String(describing: timeUnit)))"}
}
...
extension CostAndUsageReportClientTypes {
    ...
    public struct ReportDefinition: Swift.Equatable {
        ...
        public let additionalArtifacts: [CostAndUsageReportClientTypes.AdditionalArtifact]?
        ...
        public let additionalSchemaElements: [CostAndUsageReportClientTypes.SchemaElement]?
        /// <p>
        ///       The Amazon resource name of the billing view. You can get this value by using the billing view service public APIs.
        ///     </p>
        public let billingViewArn: Swift.String?
        /// <p>The compression format that AWS uses for the report.</p>
        public let compression: CostAndUsageReportClientTypes.CompressionFormat?
        /// <p>The format that AWS saves the report in.</p>
        public let format: CostAndUsageReportClientTypes.ReportFormat?
        ...
        public let refreshClosedReports: Swift.Bool?
        /// <p>The name of the report that you want to create. The name must be unique,
        ///         is case sensitive, and can't include spaces. </p>
        public let reportName: Swift.String?
        ...
        public let reportVersioning: CostAndUsageReportClientTypes.ReportVersioning?
        ...
        /// <p>The region of the S3 bucket that AWS delivers the report into.</p>
        public let s3Region: CostAndUsageReportClientTypes.AWSRegion?
        /// <p>The length of time covered by the report. </p>
        public let timeUnit: CostAndUsageReportClientTypes.TimeUnit?
...
extension ReportLimitReachedException: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ReportLimitReachedException(message: \(Swift.String(describing: message)))"}
}

extension ReportLimitReachedException: AWSClientRuntime.AWSHttpServiceError {
    public init (httpResponse: ClientRuntime.HttpResponse, decoder: ClientRuntime.ResponseDecoder? = nil, message: Swift.String? = nil, requestID: Swift.String? = nil) throws {
        if case .stream(let reader) = httpResponse.body,
            let responseDecoder = decoder {
            let data = reader.toBytes().toData()
...
public struct ReportLimitReachedException: ClientRuntime.ServiceError, Swift.Equatable {
    public var _headers: ClientRuntime.Headers?
    public var _statusCode: ClientRuntime.HttpStatusCode?
    public var _message: Swift.String?
    public var _requestID: Swift.String?
