...
public protocol CostAndUsageReportClientProtocol {
    ...
    func describeReportDefinitions(input: DescribeReportDefinitionsInput, completion: @escaping (SdkResult<DescribeReportDefinitionsOutputResponse, DescribeReportDefinitionsOutputError>) -> Void)
    /// <p>Allows you to programatically update your report preferences.</p>
    func modifyReportDefinition(input: ModifyReportDefinitionInput, completion: @escaping (SdkResult<ModifyReportDefinitionOutputResponse, ModifyReportDefinitionOutputError>) -> Void)
