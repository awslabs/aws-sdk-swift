...
///             </li>
///          </ul>
public protocol CostAndUsageReportServiceClientProtocol {
    ...
    func describeReportDefinitions(input: DescribeReportDefinitionsInput, completion: @escaping (SdkResult<DescribeReportDefinitionsOutput, DescribeReportDefinitionsOutputError>) -> Void)
    /// <p>Allows you to programatically update your report preferences.</p>
    func modifyReportDefinition(input: ModifyReportDefinitionInput, completion: @escaping (SdkResult<ModifyReportDefinitionOutput, ModifyReportDefinitionOutputError>) -> Void)
