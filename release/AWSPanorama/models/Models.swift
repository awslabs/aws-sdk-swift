...
extension PanoramaClientTypes.ReportedRuntimeContextState: Swift.Codable {
    ...
    public func encode(to encoder: Swift.Encoder) throws {
        ...
        if let deviceReportedTime = self.deviceReportedTime {
            try encodeContainer.encode(deviceReportedTime.timeIntervalSince1970, forKey: .deviceReportedTime)
        }
    ...
    public init (from decoder: Swift.Decoder) throws {
        ...
        let deviceReportedTimeDecoded = try containerValues.decodeIfPresent(ClientRuntime.Date.self, forKey: .deviceReportedTime)
