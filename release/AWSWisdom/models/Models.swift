...
extension WisdomClientTypes {
    ...
    public struct AppIntegrationsConfiguration: Swift.Equatable {
        ...
        var appIntegrationArn: Swift.String?
...
extension WisdomClientTypes {
    ...
    public struct AssistantAssociationData: Swift.Equatable {
        ...
        /// This member is required.
        var assistantArn: Swift.String?
        /// The Amazon Resource Name (ARN) of the assistant association.
        /// This member is required.
        var assistantAssociationArn: Swift.String?
        /// The identifier of the assistant association.
        /// This member is required.
        var assistantAssociationId: Swift.String?
        /// The identifier of the Wisdom assistant.
        /// This member is required.
        var assistantId: Swift.String?
        /// A union type that currently has a single argument, the knowledge base ID.
        /// This member is required.
        var associationData: WisdomClientTypes.AssistantAssociationOutputData?
        /// The type of association.
        /// This member is required.
        var associationType: WisdomClientTypes.AssociationType?
...
extension WisdomClientTypes {
    ...
    public struct AssistantData: Swift.Equatable {
        ...
        var serverSideEncryptionConfiguration: WisdomClientTypes.ServerSideEncryptionConfiguration?
        /// The status of the assistant.
        /// This member is required.
        var status: WisdomClientTypes.AssistantStatus?
        /// The tags used to organize, track, or control access for this resource.
        var tags: [Swift.String:Swift.String]?
        /// The type of assistant.
        /// This member is required.
        var type: WisdomClientTypes.AssistantType?
...
extension WisdomClientTypes {
    ...
    public struct ContentData: Swift.Equatable {
        ...
        /// This member is required.
        var contentArn: Swift.String?
        /// The identifier of the content.
        /// This member is required.
        var contentId: Swift.String?
        /// The media type of the content.
        /// This member is required.
        var contentType: Swift.String?
        /// The Amazon Resource Name (ARN) of the knowledge base.
        /// This member is required.
        var knowledgeBaseArn: Swift.String?
        /// The the identifier of the knowledge base.
        /// This member is required.
        var knowledgeBaseId: Swift.String?
        /// The URI of the content.
        var linkOutUri: Swift.String?
        ...
        /// This member is required.
        var status: WisdomClientTypes.ContentStatus?
        /// The tags used to organize, track, or control access for this resource.
        var tags: [Swift.String:Swift.String]?
        ...
        /// This member is required.
        var urlExpiry: ClientRuntime.Date?
...
public struct CreateAssistantAssociationInput: Swift.Equatable {
    ...
    /// This member is required.
    var association: WisdomClientTypes.AssistantAssociationInputData?
    /// The type of association.
    /// This member is required.
    var associationType: WisdomClientTypes.AssociationType?
...
public struct CreateAssistantAssociationOutputResponse: Swift.Equatable {
    ...
    var assistantAssociation: WisdomClientTypes.AssistantAssociationData?
...
public struct CreateAssistantOutputResponse: Swift.Equatable {
    ...
    var assistant: WisdomClientTypes.AssistantData?
...
public struct CreateContentInput: Swift.Equatable {
    ...
    var overrideLinkOutUri: Swift.String?
    /// The tags used to organize, track, or control access for this resource.
    var tags: [Swift.String:Swift.String]?
...
public struct CreateContentOutputResponse: Swift.Equatable {
    /// The content.
    var content: WisdomClientTypes.ContentData?
...
public struct CreateKnowledgeBaseInput: Swift.Equatable {
    ...
    /// This member is required.
    var knowledgeBaseType: WisdomClientTypes.KnowledgeBaseType?
    /// The name of the knowledge base.
    /// This member is required.
    var name: Swift.String?
    /// Information about how to render the content.
    var renderingConfiguration: WisdomClientTypes.RenderingConfiguration?
    /// The KMS key used for encryption.
    var serverSideEncryptionConfiguration: WisdomClientTypes.ServerSideEncryptionConfiguration?
    /// The source of the knowledge base content. Only set this argument for EXTERNAL knowledge bases.
    var sourceConfiguration: WisdomClientTypes.SourceConfiguration?
    /// The tags used to organize, track, or control access for this resource.
    var tags: [Swift.String:Swift.String]?
...
public struct CreateKnowledgeBaseOutputResponse: Swift.Equatable {
    /// The knowledge base.
    var knowledgeBase: WisdomClientTypes.KnowledgeBaseData?
...
public struct CreateSessionOutputResponse: Swift.Equatable {
    /// The session.
    var session: WisdomClientTypes.SessionData?
...
extension WisdomClientTypes {
    ...
    public struct Document: Swift.Equatable {
        ...
        /// This member is required.
        var contentReference: WisdomClientTypes.ContentReference?
        /// The excerpt from the document.
        var excerpt: WisdomClientTypes.DocumentText?
        /// The title of the document.
        var title: WisdomClientTypes.DocumentText?
...
extension WisdomClientTypes {
    ...
    public struct DocumentText: Swift.Equatable {
        ...
        var highlights: [WisdomClientTypes.Highlight]?
...
extension WisdomClientTypes {
    ...
    public struct Filter: Swift.Equatable {
        ...
        /// This member is required.
        var `operator`: WisdomClientTypes.FilterOperator?
        /// The field on which to filter.
        /// This member is required.
        var field: WisdomClientTypes.FilterField?
...
public struct GetContentSummaryOutputResponse: Swift.Equatable {
    /// The content summary.
    var contentSummary: WisdomClientTypes.ContentSummary?
...
public struct GetRecommendationsOutputResponse: Swift.Equatable {
    /// The recommendations.
    /// This member is required.
    var recommendations: [WisdomClientTypes.RecommendationData]?
...
extension WisdomClientTypes {
    ...
    public struct Highlight: Swift.Equatable {
        ...
        var beginOffsetInclusive: Swift.Int
        /// The offset for the end of the highlight.
        var endOffsetExclusive: Swift.Int
...
extension WisdomClientTypes {
    ...
    public struct KnowledgeBaseData: Swift.Equatable {
        ...
        var lastContentModificationTime: ClientRuntime.Date?
        /// The name of the knowledge base.
        /// This member is required.
        var name: Swift.String?
        /// Information about how to render the content.
        ...
        /// This member is required.
        var status: WisdomClientTypes.KnowledgeBaseStatus?
        /// The tags used to organize, track, or control access for this resource.
        var tags: [Swift.String:Swift.String]?
...
public struct ListAssistantAssociationsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var assistantAssociationSummaries: [WisdomClientTypes.AssistantAssociationSummary]?
...
public struct ListAssistantsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var assistantSummaries: [WisdomClientTypes.AssistantSummary]?
    /// If there are additional results, this is the token for the next set of results.
    var nextToken: Swift.String?
...
public struct ListContentsOutputResponse: Swift.Equatable {
    /// Information about the content.
    /// This member is required.
    var contentSummaries: [WisdomClientTypes.ContentSummary]?
    /// If there are additional results, this is the token for the next set of results.
    var nextToken: Swift.String?
...
public struct ListKnowledgeBasesOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var knowledgeBaseSummaries: [WisdomClientTypes.KnowledgeBaseSummary]?
    /// If there are additional results, this is the token for the next set of results.
    var nextToken: Swift.String?
...
extension WisdomClientTypes {
    ...
    public struct NotifyRecommendationsReceivedError: Swift.Equatable {
        ...
        var recommendationId: Swift.String?
...
public struct NotifyRecommendationsReceivedInput: Swift.Equatable {
    ...
    /// This member is required.
    var recommendationIds: [Swift.String]?
    /// The identifier of the session. Can be either the ID or the ARN. URLs cannot contain the ARN.
    /// This member is required.
    var sessionId: Swift.String?
...
public struct NotifyRecommendationsReceivedOutputResponse: Swift.Equatable {
    ...
    var errors: [WisdomClientTypes.NotifyRecommendationsReceivedError]?
    /// The identifiers of the recommendations.
    var recommendationIds: [Swift.String]?
...
public struct QueryAssistantOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var results: [WisdomClientTypes.ResultData]?
...
extension WisdomClientTypes {
    ...
    public struct RecommendationData: Swift.Equatable {
        ...
        /// This member is required.
        var document: WisdomClientTypes.Document?
        /// The identifier of the recommendation.
        /// This member is required.
        var recommendationId: Swift.String?
        /// The relevance level of the recommendation.
        var relevanceLevel: WisdomClientTypes.RelevanceLevel?
        /// The relevance score of the recommendation.
        var relevanceScore: Swift.Double
...
public struct SearchContentInput: Swift.Equatable {
    ...
    /// This member is required.
    var searchExpression: WisdomClientTypes.SearchExpression?
...
extension WisdomClientTypes {
    ...
    public struct SearchExpression: Swift.Equatable {
        ...
        /// This member is required.
        var filters: [WisdomClientTypes.Filter]?
...
public struct SearchSessionsOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var sessionSummaries: [WisdomClientTypes.SessionSummary]?
...
public struct StartContentUploadOutputResponse: Swift.Equatable {
    ...
    /// This member is required.
    var headersToInclude: [Swift.String:Swift.String]?
...
public struct UpdateContentInput: Swift.Equatable {
    ...
    var removeOverrideLinkOutUri: Swift.Bool?
