...
public struct GetRawMessageContentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRawMessageContentInputURLHostMiddleware"
    ...
    public typealias MInput = GetRawMessageContentInput
    public typealias MOutput = ClientRuntime.OperationOutput<GetRawMessageContentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<GetRawMessageContentOutputError>
}

public struct GetRawMessageContentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetRawMessageContentInputURLPathMiddleware"
    ...
    Self.MError == H.MiddlewareError
    {
        ...
        var urlPath = "/messages/\(messageId.urlPercentEncoding())"
...
///
///
///                The <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-owner-condition.html">S3 bucket owner is not the
...
/// The requested email could not be updated due to an error in the MIME content. Check the error message for more information about
...
public struct PutRawMessageContentInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRawMessageContentInputURLHostMiddleware"
    ...
    public typealias MInput = PutRawMessageContentInput
    public typealias MOutput = ClientRuntime.OperationOutput<PutRawMessageContentOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<PutRawMessageContentOutputError>
}

public struct PutRawMessageContentInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "PutRawMessageContentInputURLPathMiddleware"
...
extension WorkMailMessageFlowClientTypes {
    ...
    ///         <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/mime-types-appendix.html">Unsupported Attachment Types.
    ///
    ///
    ...
    ///
    ///
    ///                Per <a href="https://tools.ietf.org/html/rfc5321#section-4.5.3.1.6">RFC 5321, the maximum length of each line of
