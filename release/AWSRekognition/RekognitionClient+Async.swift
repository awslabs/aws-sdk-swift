...
public extension RekognitionClient {
    ...
    {
        typealias distributeDatasetEntriesContinuation = CheckedContinuation<DistributeDatasetEntriesOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: distributeDatasetEntriesContinuation) in
            distributeDatasetEntries(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listDatasetLabelsContinuation = CheckedContinuation<ListDatasetLabelsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listDatasetLabelsContinuation) in
            listDatasetLabels(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
