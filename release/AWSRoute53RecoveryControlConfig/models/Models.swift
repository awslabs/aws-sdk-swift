...
extension Route53RecoveryControlConfigClientTypes {
    ...
    public struct AssertionRule: Swift.Equatable {
        ...
        /// This member is required.
        var assertedControls: [Swift.String]?
        /// The Amazon Resource Name (ARN) of the control panel.
        /// This member is required.
        var controlPanelArn: Swift.String?
        /// Name of the assertion rule. You can use any non-white space character in the name.
        /// This member is required.
        var name: Swift.String?
        /// The criteria that you set for specific assertion routing controls (AssertedControls) that designate how many routing control states must be ON as the result of a transaction. For example, if you have three assertion routing controls, you might specify atleast 2 for your rule configuration. This means that at least two assertion routing control states must be ON, so that at least two Amazon Web Services Regions have traffic flowing to them.
        /// This member is required.
        var ruleConfig: Route53RecoveryControlConfigClientTypes.RuleConfig?
        /// The Amazon Resource Name (ARN) of the assertion rule.
        /// This member is required.
        var safetyRuleArn: Swift.String?
        /// The deployment status of an assertion rule. Status can be one of the following: PENDING, DEPLOYED, PENDING_DELETION.
        /// This member is required.
        var status: Route53RecoveryControlConfigClientTypes.Status?
        /// An evaluation period, in milliseconds (ms), during which any request against the target routing controls will fail. This helps prevent "flapping" of state. The wait period is 5000 ms by default, but you can choose a custom value.
        /// This member is required.
        var waitPeriodMs: Swift.Int
...
extension Route53RecoveryControlConfigClientTypes {
    ...
    public struct Cluster: Swift.Equatable {
        ...
        var clusterEndpoints: [Route53RecoveryControlConfigClientTypes.ClusterEndpoint]?
...
extension Route53RecoveryControlConfigClientTypes {
    ...
    public struct ControlPanel: Swift.Equatable {
        ...
        var defaultControlPanel: Swift.Bool
        /// The name of the control panel. You can use any non-white space character in the name.
        var name: Swift.String?
        /// The number of routing controls in the control panel.
        var routingControlCount: Swift.Int
...
public struct CreateClusterOutputResponse: Swift.Equatable {
    ...
    var cluster: Route53RecoveryControlConfigClientTypes.Cluster?
...
public struct CreateControlPanelInput: Swift.Equatable {
    ...
    /// This member is required.
    var controlPanelName: Swift.String?
...
public struct CreateControlPanelOutputResponse: Swift.Equatable {
    ...
    var controlPanel: Route53RecoveryControlConfigClientTypes.ControlPanel?
...
public struct CreateRoutingControlInput: Swift.Equatable {
    ...
    /// This member is required.
    var routingControlName: Swift.String?
...
public struct CreateRoutingControlOutputResponse: Swift.Equatable {
    ...
    var routingControl: Route53RecoveryControlConfigClientTypes.RoutingControl?
...
public struct CreateSafetyRuleInput: Swift.Equatable {
    ...
    var assertionRule: Route53RecoveryControlConfigClientTypes.NewAssertionRule?
    /// A unique, case-sensitive string of up to 64 ASCII characters. To make an idempotent API request with an action, specify a client token in the request.
    var clientToken: Swift.String?
    /// The gating rule requested.
    var gatingRule: Route53RecoveryControlConfigClientTypes.NewGatingRule?
...
public struct CreateSafetyRuleOutputResponse: Swift.Equatable {
    ...
    var assertionRule: Route53RecoveryControlConfigClientTypes.AssertionRule?
    /// The gating rule created.
    var gatingRule: Route53RecoveryControlConfigClientTypes.GatingRule?
...
extension Route53RecoveryControlConfigClientTypes {
    ...
    public struct GatingRule: Swift.Equatable {
        ...
        /// This member is required.
        var gatingControls: [Swift.String]?
        ...
        /// This member is required.
        var targetControls: [Swift.String]?
        /// An evaluation period, in milliseconds (ms), during which any request against the target routing controls will fail. This helps prevent "flapping" of state. The wait period is 5000 ms by default, but you can choose a custom value.
        /// This member is required.
        var waitPeriodMs: Swift.Int
...
public struct ListClustersOutputResponse: Swift.Equatable {
    ...
    var clusters: [Route53RecoveryControlConfigClientTypes.Cluster]?
    /// The token that identifies which batch of results you want to see.
    var nextToken: Swift.String?
...
public struct ListControlPanelsOutputResponse: Swift.Equatable {
    ...
    var controlPanels: [Route53RecoveryControlConfigClientTypes.ControlPanel]?
    /// The token that identifies which batch of results you want to see.
    var nextToken: Swift.String?
...
public struct ListRoutingControlsOutputResponse: Swift.Equatable {
    ...
    var routingControls: [Route53RecoveryControlConfigClientTypes.RoutingControl]?
...
public struct ListSafetyRulesOutputResponse: Swift.Equatable {
    ...
    var safetyRules: [Route53RecoveryControlConfigClientTypes.Rule]?
...
extension Route53RecoveryControlConfigClientTypes {
    ...
    public struct Rule: Swift.Equatable {
        ...
        var aSSERTION: Route53RecoveryControlConfigClientTypes.AssertionRule?
        /// A gating rule verifies that a gating routing control or set of gating rounting controls, evaluates as true, based on a rule configuration that you specify, which allows a set of routing control state changes to complete. For example, if you specify one gating routing control and you set the Type in the rule configuration to OR, that indicates that you must set the gating routing control to On for the rule to evaluate as true; that is, for the gating control "switch" to be "On". When you do that, then you can update the routing control states for the target routing controls that you specify in the gating rule.
        var gATING: Route53RecoveryControlConfigClientTypes.GatingRule?
...
extension Route53RecoveryControlConfigClientTypes {
    ...
    public struct RuleConfig: Swift.Equatable {
        ...
        /// This member is required.
        var threshold: Swift.Int
        /// A rule can be one of the following: ATLEAST, AND, or OR.
        /// This member is required.
        var type: Route53RecoveryControlConfigClientTypes.RuleType?
...
public struct UpdateSafetyRuleInput: Swift.Equatable {
    ...
    var assertionRuleUpdate: Route53RecoveryControlConfigClientTypes.AssertionRuleUpdate?
    /// The gating rule to update.
    var gatingRuleUpdate: Route53RecoveryControlConfigClientTypes.GatingRuleUpdate?
