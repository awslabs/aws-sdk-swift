...
public protocol EbsClientProtocol {
    ...
    func completeSnapshot(input: CompleteSnapshotInput, completion: @escaping (SdkResult<CompleteSnapshotOutput, CompleteSnapshotOutputError>) -> Void)
    /// <p>Returns the data in a block in an Amazon Elastic Block Store snapshot.</p>
    func getSnapshotBlock(input: GetSnapshotBlockInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetSnapshotBlockOutput, GetSnapshotBlockOutputError>) -> Void)
    ...
    func listChangedBlocks(input: ListChangedBlocksInput, completion: @escaping (SdkResult<ListChangedBlocksOutput, ListChangedBlocksOutputError>) -> Void)
    /// <p>Returns information about the blocks in an Amazon Elastic Block Store snapshot.</p>
    func listSnapshotBlocks(input: ListSnapshotBlocksInput, completion: @escaping (SdkResult<ListSnapshotBlocksOutput, ListSnapshotBlocksOutputError>) -> Void)
    ...
    func putSnapshotBlock(input: PutSnapshotBlockInput, streamSource: StreamSource, completion: @escaping (SdkResult<PutSnapshotBlockOutput, PutSnapshotBlockOutputError>) -> Void)
    ...
    func startSnapshot(input: StartSnapshotInput, completion: @escaping (SdkResult<StartSnapshotOutput, StartSnapshotOutputError>) -> Void)
}
