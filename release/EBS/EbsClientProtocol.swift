...
public protocol EbsClientProtocol {
    ...
    func getSnapshotBlock(input: GetSnapshotBlockInput, completion: @escaping (SdkResult<GetSnapshotBlockOutputResponse, GetSnapshotBlockOutputError>) -> Void)
    ...
    func putSnapshotBlock(input: PutSnapshotBlockInput, completion: @escaping (SdkResult<PutSnapshotBlockOutputResponse, PutSnapshotBlockOutputError>) -> Void)
