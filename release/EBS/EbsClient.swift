...
extension EbsClient: EbsClientProtocol {
    ...
    public func completeSnapshot(input: CompleteSnapshotInput, completion: @escaping (SdkResult<CompleteSnapshotOutput, CompleteSnapshotOutputError>) -> Void)
    {
        ...
        var operation = OperationStack<CompleteSnapshotInput, CompleteSnapshotOutput, CompleteSnapshotOutputError>(id: "completeSnapshot")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CompleteSnapshotInput, CompleteSnapshotOutput, CompleteSnapshotOutputError>(contentType: "application/json"))
    ...
    public func getSnapshotBlock(input: GetSnapshotBlockInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetSnapshotBlockOutput, GetSnapshotBlockOutputError>) -> Void)
    {
        guard let snapshotId = input.snapshotId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component snapshotId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "ebs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSnapshotBlockInput, GetSnapshotBlockOutput, GetSnapshotBlockOutputError>(id: "getSnapshotBlock")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSnapshotBlockInput, GetSnapshotBlockOutput, GetSnapshotBlockOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listChangedBlocks(input: ListChangedBlocksInput, completion: @escaping (SdkResult<ListChangedBlocksOutput, ListChangedBlocksOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "ebs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListChangedBlocksInput, ListChangedBlocksOutput, ListChangedBlocksOutputError>(id: "listChangedBlocks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListChangedBlocksInput, ListChangedBlocksOutput, ListChangedBlocksOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func listSnapshotBlocks(input: ListSnapshotBlocksInput, completion: @escaping (SdkResult<ListSnapshotBlocksOutput, ListSnapshotBlocksOutputError>) -> Void)
    {
        guard let snapshotId = input.snapshotId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component snapshotId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "ebs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSnapshotBlocksInput, ListSnapshotBlocksOutput, ListSnapshotBlocksOutputError>(id: "listSnapshotBlocks")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSnapshotBlocksInput, ListSnapshotBlocksOutput, ListSnapshotBlocksOutputError>(contentType: "application/json"))
        operation.deserializeStep.intercept(position: .before, middleware: LoggerMiddleware(clientLogMode: config.clientLogMode))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        operation.finalizeStep.intercept(position: .after, middleware: RetrierMiddleware(retrier: config.retrier))
        let sigv4Config = SigV4Config(unsignedBody: false)
    ...
    public func putSnapshotBlock(input: PutSnapshotBlockInput, streamSource: StreamSource, completion: @escaping (SdkResult<PutSnapshotBlockOutput, PutSnapshotBlockOutputError>) -> Void)
    {
        guard let snapshotId = input.snapshotId else {
            completion(.failure(.client(ClientError.serializationFailed("uri component snapshotId unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "ebs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutSnapshotBlockInput, PutSnapshotBlockOutput, PutSnapshotBlockOutputError>(id: "putSnapshotBlock")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutSnapshotBlockInput, PutSnapshotBlockOutput, PutSnapshotBlockOutputError>(contentType: "application/json"))
    ...
    public func startSnapshot(input: StartSnapshotInput, completion: @escaping (SdkResult<StartSnapshotOutput, StartSnapshotOutputError>) -> Void)
    {
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "ebs")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<StartSnapshotInput, StartSnapshotOutput, StartSnapshotOutputError>(id: "startSnapshot")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<StartSnapshotOutput>, SdkError<StartSnapshotOutputError>> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<StartSnapshotInput, StartSnapshotOutput, StartSnapshotOutputError>(contentType: "application/json"))
