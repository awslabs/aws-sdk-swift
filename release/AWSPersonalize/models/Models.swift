...
extension PersonalizeClientTypes.BatchSegmentJob: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
...
extension PersonalizeClientTypes.BatchSegmentJob: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchSegmentJob(batchSegmentJobArn: \(Swift.String(describing: batchSegmentJobArn)), creationDateTime: \(Swift.String(describing: creationDateTime)), failureReason: \(Swift.String(describing: failureReason)), filterArn: \(Swift.String(describing: filterArn)), jobInput: \(Swift.String(describing: jobInput)), jobName: \(Swift.String(describing: jobName)), jobOutput: \(Swift.String(describing: jobOutput)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), numResults: \(Swift.String(describing: numResults)), roleArn: \(Swift.String(describing: roleArn)), solutionVersionArn: \(Swift.String(describing: solutionVersionArn)), status: \(Swift.String(describing: status)))"}
}
...
extension PersonalizeClientTypes.BatchSegmentJobInput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case s3DataSource
    }
...
extension PersonalizeClientTypes.BatchSegmentJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchSegmentJobInput(s3DataSource: \(Swift.String(describing: s3DataSource)))"}
}
...
extension PersonalizeClientTypes.BatchSegmentJobOutput: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case s3DataDestination
    }
...
extension PersonalizeClientTypes.BatchSegmentJobOutput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchSegmentJobOutput(s3DataDestination: \(Swift.String(describing: s3DataDestination)))"}
}
...
extension PersonalizeClientTypes.BatchSegmentJobSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case batchSegmentJobArn
        case creationDateTime
        case failureReason
...
extension PersonalizeClientTypes.BatchSegmentJobSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "BatchSegmentJobSummary(batchSegmentJobArn: \(Swift.String(describing: batchSegmentJobArn)), creationDateTime: \(Swift.String(describing: creationDateTime)), failureReason: \(Swift.String(describing: failureReason)), jobName: \(Swift.String(describing: jobName)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), solutionVersionArn: \(Swift.String(describing: solutionVersionArn)), status: \(Swift.String(describing: status)))"}
}
...
public struct CreateBatchInferenceJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBatchInferenceJobInputURLHostMiddleware"
...
public struct CreateBatchSegmentJobInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBatchSegmentJobInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateBatchSegmentJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateBatchSegmentJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateBatchSegmentJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateBatchSegmentJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateBatchSegmentJobOutputError>
}

extension CreateBatchSegmentJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateBatchSegmentJobInput(filterArn: \(Swift.String(describing: filterArn)), jobInput: \(Swift.String(describing: jobInput)), jobName: \(Swift.String(describing: jobName)), jobOutput: \(Swift.String(describing: jobOutput)), numResults: \(Swift.String(describing: numResults)), roleArn: \(Swift.String(describing: roleArn)), solutionVersionArn: \(Swift.String(describing: solutionVersionArn)))"}
}

extension CreateBatchSegmentJobInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case filterArn
        case jobInput
        case jobName
...
public struct CreateBatchSegmentJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBatchSegmentJobInputHeadersMiddleware"
...
public struct CreateBatchSegmentJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBatchSegmentJobInputQueryItemMiddleware"
...
public struct CreateBatchSegmentJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBatchSegmentJobInputURLHostMiddleware"
    ...
    public typealias MInput = CreateBatchSegmentJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateBatchSegmentJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateBatchSegmentJobOutputError>
}

public struct CreateBatchSegmentJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateBatchSegmentJobInputURLPathMiddleware"
...
struct CreateBatchSegmentJobInputBody: Swift.Equatable {
    ...
    public let filterArn: Swift.String?
    public let numResults: Swift.Int?
    public let jobInput: PersonalizeClientTypes.BatchSegmentJobInput?
    public let jobOutput: PersonalizeClientTypes.BatchSegmentJobOutput?
    public let roleArn: Swift.String?
}
...
extension CreateBatchSegmentJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateBatchSegmentJobOutputResponse(batchSegmentJobArn: \(Swift.String(describing: batchSegmentJobArn)))"}
}
...
struct CreateBatchSegmentJobOutputResponseBody: Swift.Equatable {
    public let batchSegmentJobArn: Swift.String?
}
...
public struct CreateCampaignInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateCampaignInputURLHostMiddleware"
...
public struct CreateDatasetExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateDatasetExportJobInputURLHostMiddleware"
...
extension CreateDatasetGroupInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDatasetGroupInput(domain: \(Swift.String(describing: domain)), kmsKeyArn: \(Swift.String(describing: kmsKeyArn)), name: \(Swift.String(describing: name)), roleArn: \(Swift.String(describing: roleArn)))"}
}
...
struct CreateDatasetGroupInputBody: Swift.Equatable {
    ...
    public let domain: PersonalizeClientTypes.Domain?
}
...
extension CreateDatasetGroupOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateDatasetGroupOutputResponse(datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), domain: \(Swift.String(describing: domain)))"}
}
...
public struct CreateEventTrackerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateEventTrackerInputURLHostMiddleware"
...
public struct CreateRecommenderInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecommenderInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<CreateRecommenderInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<CreateRecommenderOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<CreateRecommenderInput>
    public typealias MOutput = ClientRuntime.OperationOutput<CreateRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateRecommenderOutputError>
}

extension CreateRecommenderInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateRecommenderInput(datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), name: \(Swift.String(describing: name)), recipeArn: \(Swift.String(describing: recipeArn)), recommenderConfig: \(Swift.String(describing: recommenderConfig)))"}
}

extension CreateRecommenderInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case datasetGroupArn
        case name
        case recipeArn
...
public struct CreateRecommenderInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecommenderInputHeadersMiddleware"
...
public struct CreateRecommenderInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecommenderInputQueryItemMiddleware"
...
public struct CreateRecommenderInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecommenderInputURLHostMiddleware"
    ...
    public typealias MInput = CreateRecommenderInput
    public typealias MOutput = ClientRuntime.OperationOutput<CreateRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<CreateRecommenderOutputError>
}

public struct CreateRecommenderInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateRecommenderInputURLPathMiddleware"
...
struct CreateRecommenderInputBody: Swift.Equatable {
    ...
    public let recommenderConfig: PersonalizeClientTypes.RecommenderConfig?
}
...
extension CreateRecommenderOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateRecommenderOutputResponse(recommenderArn: \(Swift.String(describing: recommenderArn)))"}
}
...
extension CreateSchemaInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "CreateSchemaInput(domain: \(Swift.String(describing: domain)), name: \(Swift.String(describing: name)), schema: \(Swift.String(describing: schema)))"}
}
...
public struct CreateSolutionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSolutionInputURLHostMiddleware"
...
public struct CreateSolutionVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "CreateSolutionVersionInputURLHostMiddleware"
...
extension PersonalizeClientTypes.DatasetGroup: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatasetGroup(creationDateTime: \(Swift.String(describing: creationDateTime)), datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), domain: \(Swift.String(describing: domain)), failureReason: \(Swift.String(describing: failureReason)), kmsKeyArn: \(Swift.String(describing: kmsKeyArn)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), name: \(Swift.String(describing: name)), roleArn: \(Swift.String(describing: roleArn)), status: \(Swift.String(describing: status)))"}
}
...
extension PersonalizeClientTypes.DatasetGroupSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatasetGroupSummary(creationDateTime: \(Swift.String(describing: creationDateTime)), datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), domain: \(Swift.String(describing: domain)), failureReason: \(Swift.String(describing: failureReason)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), name: \(Swift.String(describing: name)), status: \(Swift.String(describing: status)))"}
}
...
extension PersonalizeClientTypes.DatasetSchema: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatasetSchema(creationDateTime: \(Swift.String(describing: creationDateTime)), domain: \(Swift.String(describing: domain)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), name: \(Swift.String(describing: name)), schema: \(Swift.String(describing: schema)), schemaArn: \(Swift.String(describing: schemaArn)))"}
}
...
extension PersonalizeClientTypes.DatasetSchemaSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DatasetSchemaSummary(creationDateTime: \(Swift.String(describing: creationDateTime)), domain: \(Swift.String(describing: domain)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), name: \(Swift.String(describing: name)), schemaArn: \(Swift.String(describing: schemaArn)))"}
}
...
public struct DeleteCampaignInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteCampaignInputURLHostMiddleware"
...
public struct DeleteEventTrackerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteEventTrackerInputURLHostMiddleware"
...
public struct DeleteRecommenderInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommenderInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DeleteRecommenderInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DeleteRecommenderOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DeleteRecommenderInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteRecommenderOutputError>
}

extension DeleteRecommenderInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteRecommenderInput(recommenderArn: \(Swift.String(describing: recommenderArn)))"}
}

extension DeleteRecommenderInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case recommenderArn
    }
...
public struct DeleteRecommenderInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommenderInputHeadersMiddleware"
...
public struct DeleteRecommenderInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommenderInputQueryItemMiddleware"
...
public struct DeleteRecommenderInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommenderInputURLHostMiddleware"
    ...
    public typealias MInput = DeleteRecommenderInput
    public typealias MOutput = ClientRuntime.OperationOutput<DeleteRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DeleteRecommenderOutputError>
}

public struct DeleteRecommenderInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteRecommenderInputURLPathMiddleware"
...
extension DeleteRecommenderOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DeleteRecommenderOutputResponse()"}
}
...
struct DeleteRecommenderOutputResponseBody: Swift.Equatable {
}

extension DeleteRecommenderOutputResponseBody: Swift.Decodable {
...
public struct DeleteSolutionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DeleteSolutionInputURLHostMiddleware"
...
public struct DescribeAlgorithmInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeAlgorithmInputURLHostMiddleware"
...
public struct DescribeBatchInferenceJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBatchInferenceJobInputURLHostMiddleware"
...
public struct DescribeBatchSegmentJobInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBatchSegmentJobInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeBatchSegmentJobInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeBatchSegmentJobOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeBatchSegmentJobInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeBatchSegmentJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeBatchSegmentJobOutputError>
}

extension DescribeBatchSegmentJobInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeBatchSegmentJobInput(batchSegmentJobArn: \(Swift.String(describing: batchSegmentJobArn)))"}
}

extension DescribeBatchSegmentJobInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case batchSegmentJobArn
    }
...
public struct DescribeBatchSegmentJobInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBatchSegmentJobInputHeadersMiddleware"
...
public struct DescribeBatchSegmentJobInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBatchSegmentJobInputQueryItemMiddleware"
...
public struct DescribeBatchSegmentJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBatchSegmentJobInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeBatchSegmentJobInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeBatchSegmentJobOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeBatchSegmentJobOutputError>
}

public struct DescribeBatchSegmentJobInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeBatchSegmentJobInputURLPathMiddleware"
...
extension DescribeBatchSegmentJobOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeBatchSegmentJobOutputResponse(batchSegmentJob: \(Swift.String(describing: batchSegmentJob)))"}
}
...
struct DescribeBatchSegmentJobOutputResponseBody: Swift.Equatable {
    public let batchSegmentJob: PersonalizeClientTypes.BatchSegmentJob?
}
...
public struct DescribeCampaignInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeCampaignInputURLHostMiddleware"
...
public struct DescribeDatasetExportJobInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeDatasetExportJobInputURLHostMiddleware"
...
public struct DescribeEventTrackerInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeEventTrackerInputURLHostMiddleware"
...
public struct DescribeFeatureTransformationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeFeatureTransformationInputURLHostMiddleware"
...
public struct DescribeFilterInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeFilterInputURLHostMiddleware"
...
public struct DescribeRecommenderInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommenderInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<DescribeRecommenderInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<DescribeRecommenderOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<DescribeRecommenderInput>
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeRecommenderOutputError>
}

extension DescribeRecommenderInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeRecommenderInput(recommenderArn: \(Swift.String(describing: recommenderArn)))"}
}

extension DescribeRecommenderInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case recommenderArn
    }
...
public struct DescribeRecommenderInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommenderInputHeadersMiddleware"
...
public struct DescribeRecommenderInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommenderInputQueryItemMiddleware"
...
public struct DescribeRecommenderInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommenderInputURLHostMiddleware"
    ...
    public typealias MInput = DescribeRecommenderInput
    public typealias MOutput = ClientRuntime.OperationOutput<DescribeRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<DescribeRecommenderOutputError>
}

public struct DescribeRecommenderInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeRecommenderInputURLPathMiddleware"
...
extension DescribeRecommenderOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "DescribeRecommenderOutputResponse(recommender: \(Swift.String(describing: recommender)))"}
}
...
struct DescribeRecommenderOutputResponseBody: Swift.Equatable {
    public let recommender: PersonalizeClientTypes.Recommender?
}
...
public struct DescribeSolutionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSolutionInputURLHostMiddleware"
...
public struct DescribeSolutionVersionInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "DescribeSolutionVersionInputURLHostMiddleware"
...
public struct GetSolutionMetricsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "GetSolutionMetricsInputURLHostMiddleware"
...
public struct ListBatchInferenceJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBatchInferenceJobsInputURLHostMiddleware"
...
public struct ListBatchSegmentJobsInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBatchSegmentJobsInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListBatchSegmentJobsInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListBatchSegmentJobsOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListBatchSegmentJobsInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListBatchSegmentJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListBatchSegmentJobsOutputError>
}

extension ListBatchSegmentJobsInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListBatchSegmentJobsInput(maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), solutionVersionArn: \(Swift.String(describing: solutionVersionArn)))"}
}

extension ListBatchSegmentJobsInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case maxResults
        case nextToken
        case solutionVersionArn
...
public struct ListBatchSegmentJobsInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBatchSegmentJobsInputHeadersMiddleware"
...
public struct ListBatchSegmentJobsInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBatchSegmentJobsInputQueryItemMiddleware"
...
public struct ListBatchSegmentJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBatchSegmentJobsInputURLHostMiddleware"
    ...
    public typealias MInput = ListBatchSegmentJobsInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListBatchSegmentJobsOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListBatchSegmentJobsOutputError>
}

public struct ListBatchSegmentJobsInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListBatchSegmentJobsInputURLPathMiddleware"
...
extension ListBatchSegmentJobsOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListBatchSegmentJobsOutputResponse(batchSegmentJobs: \(Swift.String(describing: batchSegmentJobs)), nextToken: \(Swift.String(describing: nextToken)))"}
}
...
struct ListBatchSegmentJobsOutputResponseBody: Swift.Equatable {
    public let batchSegmentJobs: [PersonalizeClientTypes.BatchSegmentJobSummary]?
    public let nextToken: Swift.String?
}
...
public struct ListCampaignsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListCampaignsInputURLHostMiddleware"
...
public struct ListDatasetExportJobsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListDatasetExportJobsInputURLHostMiddleware"
...
public struct ListEventTrackersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListEventTrackersInputURLHostMiddleware"
...
extension ListRecipesInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRecipesInput(domain: \(Swift.String(describing: domain)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)), recipeProvider: \(Swift.String(describing: recipeProvider)))"}
}
...
public struct ListRecommendersInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendersInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<ListRecommendersInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<ListRecommendersOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<ListRecommendersInput>
    public typealias MOutput = ClientRuntime.OperationOutput<ListRecommendersOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRecommendersOutputError>
}

extension ListRecommendersInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRecommendersInput(datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), maxResults: \(Swift.String(describing: maxResults)), nextToken: \(Swift.String(describing: nextToken)))"}
}

extension ListRecommendersInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case datasetGroupArn
        case maxResults
        case nextToken
...
public struct ListRecommendersInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendersInputHeadersMiddleware"
...
public struct ListRecommendersInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendersInputQueryItemMiddleware"
...
public struct ListRecommendersInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendersInputURLHostMiddleware"
    ...
    public typealias MInput = ListRecommendersInput
    public typealias MOutput = ClientRuntime.OperationOutput<ListRecommendersOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<ListRecommendersOutputError>
}

public struct ListRecommendersInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListRecommendersInputURLPathMiddleware"
...
extension ListRecommendersOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "ListRecommendersOutputResponse(nextToken: \(Swift.String(describing: nextToken)), recommenders: \(Swift.String(describing: recommenders)))"}
}
...
struct ListRecommendersOutputResponseBody: Swift.Equatable {
    public let recommenders: [PersonalizeClientTypes.RecommenderSummary]?
    public let nextToken: Swift.String?
}
...
public struct ListSolutionVersionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSolutionVersionsInputURLHostMiddleware"
...
public struct ListSolutionsInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "ListSolutionsInputURLHostMiddleware"
...
extension PersonalizeClientTypes.RecipeSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecipeSummary(creationDateTime: \(Swift.String(describing: creationDateTime)), domain: \(Swift.String(describing: domain)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), name: \(Swift.String(describing: name)), recipeArn: \(Swift.String(describing: recipeArn)), status: \(Swift.String(describing: status)))"}
}
...
extension PersonalizeClientTypes.Recommender: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationDateTime
        case datasetGroupArn
        case failureReason
...
extension PersonalizeClientTypes.Recommender: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "Recommender(creationDateTime: \(Swift.String(describing: creationDateTime)), datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), failureReason: \(Swift.String(describing: failureReason)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), latestRecommenderUpdate: \(Swift.String(describing: latestRecommenderUpdate)), name: \(Swift.String(describing: name)), recipeArn: \(Swift.String(describing: recipeArn)), recommenderArn: \(Swift.String(describing: recommenderArn)), recommenderConfig: \(Swift.String(describing: recommenderConfig)), status: \(Swift.String(describing: status)))"}
}
...
extension PersonalizeClientTypes.RecommenderConfig: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case itemExplorationConfig
    }
...
extension PersonalizeClientTypes.RecommenderConfig: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommenderConfig(itemExplorationConfig: \(Swift.String(describing: itemExplorationConfig)))"}
}
...
extension PersonalizeClientTypes.RecommenderSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationDateTime
        case datasetGroupArn
        case lastUpdatedDateTime
...
extension PersonalizeClientTypes.RecommenderSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommenderSummary(creationDateTime: \(Swift.String(describing: creationDateTime)), datasetGroupArn: \(Swift.String(describing: datasetGroupArn)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), name: \(Swift.String(describing: name)), recipeArn: \(Swift.String(describing: recipeArn)), recommenderArn: \(Swift.String(describing: recommenderArn)), recommenderConfig: \(Swift.String(describing: recommenderConfig)), status: \(Swift.String(describing: status)))"}
}
...
extension PersonalizeClientTypes.RecommenderUpdateSummary: Swift.Codable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case creationDateTime
        case failureReason
        case lastUpdatedDateTime
...
extension PersonalizeClientTypes.RecommenderUpdateSummary: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "RecommenderUpdateSummary(creationDateTime: \(Swift.String(describing: creationDateTime)), failureReason: \(Swift.String(describing: failureReason)), lastUpdatedDateTime: \(Swift.String(describing: lastUpdatedDateTime)), recommenderConfig: \(Swift.String(describing: recommenderConfig)), status: \(Swift.String(describing: status)))"}
}
...
public struct StopSolutionVersionCreationInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "StopSolutionVersionCreationInputURLHostMiddleware"
...
public struct UpdateCampaignInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateCampaignInputURLHostMiddleware"
...
public struct UpdateRecommenderInputBodyMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecommenderInputBodyMiddleware"

    public init() {}

    public func handle<H>(context: Context,
                  input: ClientRuntime.SerializeStepInput<UpdateRecommenderInput>,
                  next: H) -> Swift.Result<ClientRuntime.OperationOutput<UpdateRecommenderOutputResponse>, MError>
    where H: Handler,
    Self.MInput == H.Input,
    Self.MOutput == H.Output,
    Self.Context == H.Context,
    ...
    public typealias MInput = ClientRuntime.SerializeStepInput<UpdateRecommenderInput>
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRecommenderOutputError>
}

extension UpdateRecommenderInput: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRecommenderInput(recommenderArn: \(Swift.String(describing: recommenderArn)), recommenderConfig: \(Swift.String(describing: recommenderConfig)))"}
}

extension UpdateRecommenderInput: Swift.Encodable, ClientRuntime.Reflection {
    enum CodingKeys: Swift.String, Swift.CodingKey {
        case recommenderArn
        case recommenderConfig
    }
...
public struct UpdateRecommenderInputHeadersMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecommenderInputHeadersMiddleware"
...
public struct UpdateRecommenderInputQueryItemMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecommenderInputQueryItemMiddleware"
...
public struct UpdateRecommenderInputURLHostMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecommenderInputURLHostMiddleware"
    ...
    public typealias MInput = UpdateRecommenderInput
    public typealias MOutput = ClientRuntime.OperationOutput<UpdateRecommenderOutputResponse>
    public typealias Context = ClientRuntime.HttpContext
    public typealias MError = ClientRuntime.SdkError<UpdateRecommenderOutputError>
}

public struct UpdateRecommenderInputURLPathMiddleware: ClientRuntime.Middleware {
    public let id: Swift.String = "UpdateRecommenderInputURLPathMiddleware"
...
extension UpdateRecommenderOutputResponse: Swift.CustomDebugStringConvertible {
    public var debugDescription: Swift.String {
        "UpdateRecommenderOutputResponse(recommenderArn: \(Swift.String(describing: recommenderArn)))"}
}
