...
public extension PersonalizeClient {
    ...
    {
        typealias createBatchSegmentJobContinuation = CheckedContinuation<CreateBatchSegmentJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createBatchSegmentJobContinuation) in
            createBatchSegmentJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias createRecommenderContinuation = CheckedContinuation<CreateRecommenderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: createRecommenderContinuation) in
            createRecommender(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias deleteRecommenderContinuation = CheckedContinuation<DeleteRecommenderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: deleteRecommenderContinuation) in
            deleteRecommender(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeBatchSegmentJobContinuation = CheckedContinuation<DescribeBatchSegmentJobOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeBatchSegmentJobContinuation) in
            describeBatchSegmentJob(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias describeRecommenderContinuation = CheckedContinuation<DescribeRecommenderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: describeRecommenderContinuation) in
            describeRecommender(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listBatchSegmentJobsContinuation = CheckedContinuation<ListBatchSegmentJobsOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listBatchSegmentJobsContinuation) in
            listBatchSegmentJobs(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias listRecommendersContinuation = CheckedContinuation<ListRecommendersOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: listRecommendersContinuation) in
            listRecommenders(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
    ...
    {
        typealias updateRecommenderContinuation = CheckedContinuation<UpdateRecommenderOutputResponse, Swift.Error>
        return try await withCheckedThrowingContinuation { (continuation: updateRecommenderContinuation) in
            updateRecommender(input: input) { result in
                switch result {
                    case .success(let output):
                        continuation.resume(returning: output)
                    case .failure(let error):
