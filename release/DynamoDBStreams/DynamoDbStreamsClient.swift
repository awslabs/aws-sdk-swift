...
public class DynamoDbStreamsClient {
    ...
    public convenience init(region: String? = nil) throws {
        ...
        let config = try DynamoDbStreamsClientConfiguration(region: unwrappedRegion)
    ...
    public class DynamoDbStreamsClientConfiguration: AWSClientConfiguration {
        ...
        public convenience init(
            ...
            let defaultRuntimeConfig = try DefaultSDKRuntimeConfiguration("DynamoDbStreamsClient")
...
public struct DynamoDbStreamsClientLogHandlerFactory: SDKLogHandlerFactory {
