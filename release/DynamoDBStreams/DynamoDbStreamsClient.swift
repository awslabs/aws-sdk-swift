...
extension DynamoDbStreamsClient: DynamoDbStreamsClientProtocol {
    ...
    public func describeStream(input: DescribeStreamInput, completion: @escaping (SdkResult<DescribeStreamOutput, DescribeStreamOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeStreamInput, DescribeStreamOutput, DescribeStreamOutputError>(contentType: "application/x-amz-json-1.0"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeStreamInput, DescribeStreamOutput, DescribeStreamOutputError>(xAmzTarget: "DynamoDBStreams_20120810.DescribeStream"))
    ...
    public func getRecords(input: GetRecordsInput, completion: @escaping (SdkResult<GetRecordsOutput, GetRecordsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetRecordsInput, GetRecordsOutput, GetRecordsOutputError>(contentType: "application/x-amz-json-1.0"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRecordsInput, GetRecordsOutput, GetRecordsOutputError>(xAmzTarget: "DynamoDBStreams_20120810.GetRecords"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getShardIterator(input: GetShardIteratorInput, completion: @escaping (SdkResult<GetShardIteratorOutput, GetShardIteratorOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetShardIteratorInput, GetShardIteratorOutput, GetShardIteratorOutputError>(contentType: "application/x-amz-json-1.0"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetShardIteratorInput, GetShardIteratorOutput, GetShardIteratorOutputError>(xAmzTarget: "DynamoDBStreams_20120810.GetShardIterator"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func listStreams(input: ListStreamsInput, completion: @escaping (SdkResult<ListStreamsOutput, ListStreamsOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListStreamsInput, ListStreamsOutput, ListStreamsOutputError>(contentType: "application/x-amz-json-1.0"))
        ...
        operation.finalizeStep.intercept(position: .before,
                                                 middleware: SigV4Middleware(config: sigv4Config))
        operation.buildStep.intercept(position: .before, middleware: UserAgentMiddleware(metadata: AWSUserAgentMetadata.fromEnv(apiMetadata: APIMetadata(serviceId: serviceName, version: "1.0"))))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListStreamsInput, ListStreamsOutput, ListStreamsOutputError>(xAmzTarget: "DynamoDBStreams_20120810.ListStreams"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
