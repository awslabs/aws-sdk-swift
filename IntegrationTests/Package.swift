...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:smithy-lang/smithy-swift-opentelemetry.git", from: "1.0.0"),
        .package(url: "git@github.com:open-telemetry/opentelemetry-swift.git", from: "1.13.0"),
    ],
