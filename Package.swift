...
private let serviceClientData: [ServiceClientData] = [
    .init(
        "AWSACM",
        "acm.json",
        [.AWSClientRuntime, .AWSSDKChecksums, .AWSSDKHTTPAuth, .AWSSDKIdentity, .ClientRuntime, .Smithy, .SmithyAWSJSON, .SmithyHTTPAPI, .SmithyHTTPAuthAPI, .SmithyIdentity, .SmithyRetries, .SmithyRetriesAPI, .SmithyWaitersAPI]
    ),
    .init(
        "AWSACMPCA",
        "acm-pca.json",
    ...
    .init(
        "AWSCloudFront",
        "cloudfront.json",
        [.AWSClientRuntime, .AWSSDKChecksums, .AWSSDKHTTPAuth, .AWSSDKIdentity, .ClientRuntime, .Smithy, .SmithyHTTPAPI, .SmithyHTTPAuthAPI, .SmithyIdentity, .SmithyRestXML, .SmithyRetries, .SmithyRetriesAPI, .SmithyWaitersAPI]
    ),
    .init(
    ...
    .init(
        ...
        [.AWSClientRuntime, .AWSSDKChecksums, .AWSSDKHTTPAuth, .AWSSDKIdentity, .ClientRuntime, .Smithy, .SmithyAWSJSON, .SmithyHTTPAPI, .SmithyHTTPAuthAPI, .SmithyIdentity, .SmithyReadWrite, .SmithyRetries, .SmithyRetriesAPI]
    ),
    .init(
        "AWSCognitoSync",
        "cognito-sync.json",
    ...
    .init(
        "AWSS3",
        "s3.json",
        [.AWSClientRuntime, .AWSSDKChecksums, .AWSSDKHTTPAuth, .AWSSDKIdentity, .AWSSDKIdentityAPI, .ClientRuntime, .Smithy, .SmithyHTTPAPI, .SmithyHTTPAuthAPI, .SmithyIdentity, .SmithyRestXML, .SmithyRetries, .SmithyRetriesAPI, .SmithyTimestamps, .SmithyWaitersAPI]
    ),
    .init(
        "AWSS3Control",
        "s3-control.json",
        [.AWSClientRuntime, .AWSSDKChecksums, .AWSSDKHTTPAuth, .AWSSDKIdentity, .ClientRuntime, .Smithy, .SmithyHTTPAPI, .SmithyHTTPAuthAPI, .SmithyIdentity, .SmithyRestXML, .SmithyRetries, .SmithyRetriesAPI]
    ),
    .init(
        "AWSS3Files",
        "s3files.json",
    ...
    .init(
        ...
        "cognito-identity.json",
        [.AWSClientRuntime, .AWSSDKChecksums, .AWSSDKHTTPAuth, .ClientRuntime, .Smithy, .SmithyAWSJSON, .SmithyHTTPAPI, .SmithyHTTPAuthAPI, .SmithyIdentity, .SmithyRetries, .SmithyRetriesAPI],
        .internalUse
    ),
    .init(
        "InternalAWSSSO",
...
private var serviceProducts: [Product] {
    selectedServiceClientData.filter { $0.serviceType == .awsServiceClient }.map(productForService(_:))
}
...
private var serviceTargets: [Target] {
    selectedServiceClientData.filter { $0.serviceType == .awsServiceClient }.map(target(_:))
}
