...
let serviceTargetDefs: [String: [Target.Dependency]] = [
...
private var serviceProducts: [Product] {
    serviceTargetDefs.keys.map(product(_:))
}
...
private var serviceTargets: [Target] {
    serviceTargetDefs.map(serviceTarget(_:_:))
}

private func serviceTarget(_ name: String, _ dependencies: [Target.Dependency]) -> Target {
    .target(
        name: name,
...
private var serviceUnitTestTargets: [Target] {
    guard areServiceUnitTestsEnabled else { return [] }
    return serviceTargetDefs.map(serviceUnitTestTarget(_:_:))
}

private func serviceUnitTestTarget(_ name: String, _ dependencies: [Target.Dependency]) -> Target {
...
private var areServiceUnitTestsEnabled: Bool {
    ProcessInfo.processInfo.environment["AWS_SWIFT_SDK_INCLUDE_SERVICE_UNIT_TESTS"] != nil
}
