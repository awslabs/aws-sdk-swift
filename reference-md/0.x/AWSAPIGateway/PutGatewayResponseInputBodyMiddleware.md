# PutGatewayResponseInputBodyMiddleware

``` swift
public struct PutGatewayResponseInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "PutGatewayResponseInputBodyMiddleware"
```
