# PutMethodResponseInputHeadersMiddleware

``` swift
public struct PutMethodResponseInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "PutMethodResponseInputHeadersMiddleware"
```
