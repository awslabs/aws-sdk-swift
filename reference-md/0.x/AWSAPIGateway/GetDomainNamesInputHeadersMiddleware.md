# GetDomainNamesInputHeadersMiddleware

``` swift
public struct GetDomainNamesInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetDomainNamesInputHeadersMiddleware"
```
