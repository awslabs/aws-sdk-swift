# UpdateDocumentationVersionInputHeadersMiddleware

``` swift
public struct UpdateDocumentationVersionInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateDocumentationVersionInputHeadersMiddleware"
```
