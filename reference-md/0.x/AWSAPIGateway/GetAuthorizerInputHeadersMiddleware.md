# GetAuthorizerInputHeadersMiddleware

``` swift
public struct GetAuthorizerInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetAuthorizerInputHeadersMiddleware"
```
