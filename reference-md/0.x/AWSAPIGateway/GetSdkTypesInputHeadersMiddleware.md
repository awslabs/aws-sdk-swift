# GetSdkTypesInputHeadersMiddleware

``` swift
public struct GetSdkTypesInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetSdkTypesInputHeadersMiddleware"
```
