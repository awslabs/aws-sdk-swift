# UpdateIntegrationResponseInputQueryItemMiddleware

``` swift
public struct UpdateIntegrationResponseInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateIntegrationResponseInputQueryItemMiddleware"
```
