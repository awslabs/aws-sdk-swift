# PutIntegrationResponseInputBodyMiddleware

``` swift
public struct PutIntegrationResponseInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "PutIntegrationResponseInputBodyMiddleware"
```
