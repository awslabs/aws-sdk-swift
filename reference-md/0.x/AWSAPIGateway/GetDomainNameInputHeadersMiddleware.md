# GetDomainNameInputHeadersMiddleware

``` swift
public struct GetDomainNameInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetDomainNameInputHeadersMiddleware"
```
