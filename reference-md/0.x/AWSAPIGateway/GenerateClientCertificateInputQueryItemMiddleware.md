# GenerateClientCertificateInputQueryItemMiddleware

``` swift
public struct GenerateClientCertificateInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GenerateClientCertificateInputQueryItemMiddleware"
```
