# GetClientCertificatesInputQueryItemMiddleware

``` swift
public struct GetClientCertificatesInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetClientCertificatesInputQueryItemMiddleware"
```
