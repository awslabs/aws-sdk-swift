# UpdateVpcLinkInputHeadersMiddleware

``` swift
public struct UpdateVpcLinkInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateVpcLinkInputHeadersMiddleware"
```
