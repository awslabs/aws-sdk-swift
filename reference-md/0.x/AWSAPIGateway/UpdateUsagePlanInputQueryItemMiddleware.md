# UpdateUsagePlanInputQueryItemMiddleware

``` swift
public struct UpdateUsagePlanInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateUsagePlanInputQueryItemMiddleware"
```
