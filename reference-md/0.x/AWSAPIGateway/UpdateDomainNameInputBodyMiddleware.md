# UpdateDomainNameInputBodyMiddleware

``` swift
public struct UpdateDomainNameInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateDomainNameInputBodyMiddleware"
```
