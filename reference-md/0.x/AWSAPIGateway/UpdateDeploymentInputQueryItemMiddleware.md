# UpdateDeploymentInputQueryItemMiddleware

``` swift
public struct UpdateDeploymentInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateDeploymentInputQueryItemMiddleware"
```
