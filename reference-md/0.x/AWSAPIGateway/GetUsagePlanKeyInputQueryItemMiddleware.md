# GetUsagePlanKeyInputQueryItemMiddleware

``` swift
public struct GetUsagePlanKeyInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetUsagePlanKeyInputQueryItemMiddleware"
```
