# UpdateDocumentationVersionInputBodyMiddleware

``` swift
public struct UpdateDocumentationVersionInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateDocumentationVersionInputBodyMiddleware"
```
