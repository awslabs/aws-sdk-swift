# CreateUsagePlanInputQueryItemMiddleware

``` swift
public struct CreateUsagePlanInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "CreateUsagePlanInputQueryItemMiddleware"
```
