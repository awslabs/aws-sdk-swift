# UpdateClientCertificateInputBodyMiddleware

``` swift
public struct UpdateClientCertificateInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateClientCertificateInputBodyMiddleware"
```
