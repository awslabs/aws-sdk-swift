# TestInvokeMethodInputBodyMiddleware

``` swift
public struct TestInvokeMethodInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "TestInvokeMethodInputBodyMiddleware"
```
