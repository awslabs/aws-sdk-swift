# CreateUsagePlanKeyInputHeadersMiddleware

``` swift
public struct CreateUsagePlanKeyInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "CreateUsagePlanKeyInputHeadersMiddleware"
```
