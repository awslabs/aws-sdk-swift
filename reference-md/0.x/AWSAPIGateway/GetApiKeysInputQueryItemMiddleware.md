# GetApiKeysInputQueryItemMiddleware

``` swift
public struct GetApiKeysInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetApiKeysInputQueryItemMiddleware"
```
