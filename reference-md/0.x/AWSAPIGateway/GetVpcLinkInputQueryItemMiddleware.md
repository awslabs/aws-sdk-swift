# GetVpcLinkInputQueryItemMiddleware

``` swift
public struct GetVpcLinkInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetVpcLinkInputQueryItemMiddleware"
```
