# GetGatewayResponseInputHeadersMiddleware

``` swift
public struct GetGatewayResponseInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetGatewayResponseInputHeadersMiddleware"
```
