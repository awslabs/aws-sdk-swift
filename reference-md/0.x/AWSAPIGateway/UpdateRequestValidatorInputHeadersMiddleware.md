# UpdateRequestValidatorInputHeadersMiddleware

``` swift
public struct UpdateRequestValidatorInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateRequestValidatorInputHeadersMiddleware"
```
