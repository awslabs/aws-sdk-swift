# GetDocumentationVersionInputQueryItemMiddleware

``` swift
public struct GetDocumentationVersionInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetDocumentationVersionInputQueryItemMiddleware"
```
