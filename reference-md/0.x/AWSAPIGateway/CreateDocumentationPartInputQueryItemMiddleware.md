# CreateDocumentationPartInputQueryItemMiddleware

``` swift
public struct CreateDocumentationPartInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "CreateDocumentationPartInputQueryItemMiddleware"
```
