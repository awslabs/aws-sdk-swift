# UpdateGatewayResponseInputQueryItemMiddleware

``` swift
public struct UpdateGatewayResponseInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateGatewayResponseInputQueryItemMiddleware"
```
