# UpdateUsagePlanInputHeadersMiddleware

``` swift
public struct UpdateUsagePlanInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateUsagePlanInputHeadersMiddleware"
```
