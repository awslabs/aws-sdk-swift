# UpdateRequestValidatorInputBodyMiddleware

``` swift
public struct UpdateRequestValidatorInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateRequestValidatorInputBodyMiddleware"
```
