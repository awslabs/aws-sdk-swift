# ImportDocumentationPartsInputHeadersMiddleware

``` swift
public struct ImportDocumentationPartsInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "ImportDocumentationPartsInputHeadersMiddleware"
```
