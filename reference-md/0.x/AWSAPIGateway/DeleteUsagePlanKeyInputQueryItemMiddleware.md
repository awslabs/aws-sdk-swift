# DeleteUsagePlanKeyInputQueryItemMiddleware

``` swift
public struct DeleteUsagePlanKeyInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "DeleteUsagePlanKeyInputQueryItemMiddleware"
```
