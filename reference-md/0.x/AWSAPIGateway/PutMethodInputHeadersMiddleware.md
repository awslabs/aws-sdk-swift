# PutMethodInputHeadersMiddleware

``` swift
public struct PutMethodInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "PutMethodInputHeadersMiddleware"
```
