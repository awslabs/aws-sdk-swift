# CreateUsagePlanKeyInputQueryItemMiddleware

``` swift
public struct CreateUsagePlanKeyInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "CreateUsagePlanKeyInputQueryItemMiddleware"
```
