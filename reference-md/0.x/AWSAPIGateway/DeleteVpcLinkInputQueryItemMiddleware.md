# DeleteVpcLinkInputQueryItemMiddleware

``` swift
public struct DeleteVpcLinkInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "DeleteVpcLinkInputQueryItemMiddleware"
```
