# CreateBasePathMappingInputBodyMiddleware

``` swift
public struct CreateBasePathMappingInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "CreateBasePathMappingInputBodyMiddleware"
```
