# UpdateDeploymentInputHeadersMiddleware

``` swift
public struct UpdateDeploymentInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateDeploymentInputHeadersMiddleware"
```
