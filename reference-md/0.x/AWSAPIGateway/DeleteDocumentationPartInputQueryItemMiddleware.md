# DeleteDocumentationPartInputQueryItemMiddleware

``` swift
public struct DeleteDocumentationPartInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "DeleteDocumentationPartInputQueryItemMiddleware"
```
