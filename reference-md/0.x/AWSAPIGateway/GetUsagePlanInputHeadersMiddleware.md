# GetUsagePlanInputHeadersMiddleware

``` swift
public struct GetUsagePlanInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetUsagePlanInputHeadersMiddleware"
```
