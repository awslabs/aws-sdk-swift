# CreateDocumentationPartInputBodyMiddleware

``` swift
public struct CreateDocumentationPartInputBodyMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "CreateDocumentationPartInputBodyMiddleware"
```
