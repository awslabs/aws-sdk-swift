# GetDocumentationVersionsInputQueryItemMiddleware

``` swift
public struct GetDocumentationVersionsInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetDocumentationVersionsInputQueryItemMiddleware"
```
