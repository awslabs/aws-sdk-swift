# UpdateClientCertificateInputQueryItemMiddleware

``` swift
public struct UpdateClientCertificateInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateClientCertificateInputQueryItemMiddleware"
```
