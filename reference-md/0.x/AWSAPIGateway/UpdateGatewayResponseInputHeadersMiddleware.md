# UpdateGatewayResponseInputHeadersMiddleware

``` swift
public struct UpdateGatewayResponseInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "UpdateGatewayResponseInputHeadersMiddleware"
```
