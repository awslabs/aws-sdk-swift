# PutMethodResponseInputQueryItemMiddleware

``` swift
public struct PutMethodResponseInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "PutMethodResponseInputQueryItemMiddleware"
```
