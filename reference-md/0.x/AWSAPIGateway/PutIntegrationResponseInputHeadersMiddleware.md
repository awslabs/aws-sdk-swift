# PutIntegrationResponseInputHeadersMiddleware

``` swift
public struct PutIntegrationResponseInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "PutIntegrationResponseInputHeadersMiddleware"
```
