# DeleteRequestValidatorInputQueryItemMiddleware

``` swift
public struct DeleteRequestValidatorInputQueryItemMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "DeleteRequestValidatorInputQueryItemMiddleware"
```
