# GetSdkInputHeadersMiddleware

``` swift
public struct GetSdkInputHeadersMiddleware: ClientRuntime.Middleware 
```
...
``` swift
public let id: Swift.String = "GetSdkInputHeadersMiddleware"
```
