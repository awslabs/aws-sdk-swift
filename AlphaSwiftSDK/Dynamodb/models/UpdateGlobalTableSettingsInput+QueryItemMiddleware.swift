...
public struct UpdateGlobalTableSettingsInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<UpdateGlobalTableSettingsOutput, UpdateGlobalTableSettingsOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<UpdateGlobalTableSettingsOutput, UpdateGlobalTableSettingsOutputError>
