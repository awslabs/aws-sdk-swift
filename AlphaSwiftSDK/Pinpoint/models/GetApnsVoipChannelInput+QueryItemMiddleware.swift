...
public struct GetApnsVoipChannelInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetApnsVoipChannelOutput, GetApnsVoipChannelOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetApnsVoipChannelOutput, GetApnsVoipChannelOutputError>
