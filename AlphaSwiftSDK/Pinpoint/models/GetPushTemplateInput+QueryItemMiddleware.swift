...
public struct GetPushTemplateInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetPushTemplateOutput, GetPushTemplateOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetPushTemplateOutput, GetPushTemplateOutputError>
