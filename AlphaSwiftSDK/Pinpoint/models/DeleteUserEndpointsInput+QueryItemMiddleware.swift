...
public struct DeleteUserEndpointsInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DeleteUserEndpointsOutput, DeleteUserEndpointsOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteUserEndpointsOutput, DeleteUserEndpointsOutputError>
