...
public struct GetSegmentVersionInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetSegmentVersionOutput, GetSegmentVersionOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetSegmentVersionOutput, GetSegmentVersionOutputError>
