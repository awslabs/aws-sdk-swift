...
public struct DeleteApnsChannelInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<DeleteApnsChannelOutput, DeleteApnsChannelOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<DeleteApnsChannelOutput, DeleteApnsChannelOutputError>
