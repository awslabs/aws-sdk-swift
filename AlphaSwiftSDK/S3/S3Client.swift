...
public class S3Client {
    ...
    public init(config: S3ClientConfiguration) throws {
    ...
    public class S3ClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        public static func `default`() throws -> S3ClientConfiguration {
            let awsCredsProvider = try AWSCredentialsProvider.fromEnv()
            return S3ClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
...
extension S3Client: S3ClientProtocol {
     ...
     */
    public func abortMultipartUpload(input: AbortMultipartUploadInput, completion: @escaping (SdkResult<AbortMultipartUploadOutput, AbortMultipartUploadOutputError>) -> Void)
    {
        ...
        guard let key = input.key else {
            completion(.failure(.client(ClientError.serializationFailed("uri component key unexpectedly nil"))))
            return
        }
        let urlPath = "/\(bucket)/\(key)"
        let context = HttpContextBuilder()
                      ...
                      .withHost(value: "s3.\(config.region).amazonaws.com")
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<AbortMultipartUploadInput, AbortMultipartUploadOutput, AbortMultipartUploadOutputError>(id: "abortMultipartUpload")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: AbortMultipartUploadInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: AbortMultipartUploadInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<AbortMultipartUploadInput, AbortMultipartUploadOutput, AbortMultipartUploadOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
     ...
     */
    public func completeMultipartUpload(input: CompleteMultipartUploadInput, completion: @escaping (SdkResult<CompleteMultipartUploadOutput, CompleteMultipartUploadOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CompleteMultipartUploadInput, CompleteMultipartUploadOutput, CompleteMultipartUploadOutputError>(id: "completeMultipartUpload")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: CompleteMultipartUploadInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: CompleteMultipartUploadInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CompleteMultipartUploadInput, CompleteMultipartUploadOutput, CompleteMultipartUploadOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: CompleteMultipartUploadInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    /**
     <p>Creates a copy of an object that is already stored in Amazon S3.</p>
              ...
              <p>For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/CopyingObjectsExamples.html">Copying
                 Objects</a>.</p>
     */
    public func copyObject(input: CopyObjectInput, completion: @escaping (SdkResult<CopyObjectOutput, CopyObjectOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CopyObjectInput, CopyObjectOutput, CopyObjectOutputError>(id: "copyObject")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: CopyObjectInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: CopyObjectInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CopyObjectInput, CopyObjectOutput, CopyObjectOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func createMultipartUpload(input: CreateMultipartUploadInput, completion: @escaping (SdkResult<CreateMultipartUploadOutput, CreateMultipartUploadOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateMultipartUploadInput, CreateMultipartUploadOutput, CreateMultipartUploadOutputError>(id: "createMultipartUpload")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: CreateMultipartUploadInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: CreateMultipartUploadInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateMultipartUploadInput, CreateMultipartUploadOutput, CreateMultipartUploadOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketAnalyticsConfiguration(input: DeleteBucketAnalyticsConfigurationInput, completion: @escaping (SdkResult<DeleteBucketAnalyticsConfigurationOutput, DeleteBucketAnalyticsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketAnalyticsConfigurationInput, DeleteBucketAnalyticsConfigurationOutput, DeleteBucketAnalyticsConfigurationOutputError>(id: "deleteBucketAnalyticsConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketAnalyticsConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketAnalyticsConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketAnalyticsConfigurationInput, DeleteBucketAnalyticsConfigurationOutput, DeleteBucketAnalyticsConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketCors(input: DeleteBucketCorsInput, completion: @escaping (SdkResult<DeleteBucketCorsOutput, DeleteBucketCorsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketCorsInput, DeleteBucketCorsOutput, DeleteBucketCorsOutputError>(id: "deleteBucketCors")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketCorsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketCorsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketCorsInput, DeleteBucketCorsOutput, DeleteBucketCorsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketEncryption(input: DeleteBucketEncryptionInput, completion: @escaping (SdkResult<DeleteBucketEncryptionOutput, DeleteBucketEncryptionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketEncryptionInput, DeleteBucketEncryptionOutput, DeleteBucketEncryptionOutputError>(id: "deleteBucketEncryption")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketEncryptionInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketEncryptionInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketEncryptionInput, DeleteBucketEncryptionOutput, DeleteBucketEncryptionOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketIntelligentTieringConfiguration(input: DeleteBucketIntelligentTieringConfigurationInput, completion: @escaping (SdkResult<DeleteBucketIntelligentTieringConfigurationOutput, DeleteBucketIntelligentTieringConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketIntelligentTieringConfigurationInput, DeleteBucketIntelligentTieringConfigurationOutput, DeleteBucketIntelligentTieringConfigurationOutputError>(id: "deleteBucketIntelligentTieringConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketIntelligentTieringConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketIntelligentTieringConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketIntelligentTieringConfigurationInput, DeleteBucketIntelligentTieringConfigurationOutput, DeleteBucketIntelligentTieringConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketInventoryConfiguration(input: DeleteBucketInventoryConfigurationInput, completion: @escaping (SdkResult<DeleteBucketInventoryConfigurationOutput, DeleteBucketInventoryConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketInventoryConfigurationInput, DeleteBucketInventoryConfigurationOutput, DeleteBucketInventoryConfigurationOutputError>(id: "deleteBucketInventoryConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketInventoryConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketInventoryConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketInventoryConfigurationInput, DeleteBucketInventoryConfigurationOutput, DeleteBucketInventoryConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketLifecycle(input: DeleteBucketLifecycleInput, completion: @escaping (SdkResult<DeleteBucketLifecycleOutput, DeleteBucketLifecycleOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketLifecycleInput, DeleteBucketLifecycleOutput, DeleteBucketLifecycleOutputError>(id: "deleteBucketLifecycle")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketLifecycleInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketLifecycleInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketLifecycleInput, DeleteBucketLifecycleOutput, DeleteBucketLifecycleOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketMetricsConfiguration(input: DeleteBucketMetricsConfigurationInput, completion: @escaping (SdkResult<DeleteBucketMetricsConfigurationOutput, DeleteBucketMetricsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketMetricsConfigurationInput, DeleteBucketMetricsConfigurationOutput, DeleteBucketMetricsConfigurationOutputError>(id: "deleteBucketMetricsConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketMetricsConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketMetricsConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketMetricsConfigurationInput, DeleteBucketMetricsConfigurationOutput, DeleteBucketMetricsConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketOwnershipControls(input: DeleteBucketOwnershipControlsInput, completion: @escaping (SdkResult<DeleteBucketOwnershipControlsOutput, DeleteBucketOwnershipControlsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketOwnershipControlsInput, DeleteBucketOwnershipControlsOutput, DeleteBucketOwnershipControlsOutputError>(id: "deleteBucketOwnershipControls")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketOwnershipControlsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketOwnershipControlsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketOwnershipControlsInput, DeleteBucketOwnershipControlsOutput, DeleteBucketOwnershipControlsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketReplication(input: DeleteBucketReplicationInput, completion: @escaping (SdkResult<DeleteBucketReplicationOutput, DeleteBucketReplicationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketReplicationInput, DeleteBucketReplicationOutput, DeleteBucketReplicationOutputError>(id: "deleteBucketReplication")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketReplicationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketReplicationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketReplicationInput, DeleteBucketReplicationOutput, DeleteBucketReplicationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteBucketWebsite(input: DeleteBucketWebsiteInput, completion: @escaping (SdkResult<DeleteBucketWebsiteOutput, DeleteBucketWebsiteOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteBucketWebsiteInput, DeleteBucketWebsiteOutput, DeleteBucketWebsiteOutputError>(id: "deleteBucketWebsite")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketWebsiteInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteBucketWebsiteInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteBucketWebsiteInput, DeleteBucketWebsiteOutput, DeleteBucketWebsiteOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    public func deleteObject(input: DeleteObjectInput, completion: @escaping (SdkResult<DeleteObjectOutput, DeleteObjectOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteObjectInput, DeleteObjectOutput, DeleteObjectOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteObjectTagging(input: DeleteObjectTaggingInput, completion: @escaping (SdkResult<DeleteObjectTaggingOutput, DeleteObjectTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteObjectTaggingInput, DeleteObjectTaggingOutput, DeleteObjectTaggingOutputError>(id: "deleteObjectTagging")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteObjectTaggingInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteObjectTaggingInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteObjectTaggingInput, DeleteObjectTaggingOutput, DeleteObjectTaggingOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func deleteObjects(input: DeleteObjectsInput, completion: @escaping (SdkResult<DeleteObjectsOutput, DeleteObjectsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteObjectsInput, DeleteObjectsOutput, DeleteObjectsOutputError>(id: "deleteObjects")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: DeleteObjectsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: DeleteObjectsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteObjectsInput, DeleteObjectsOutput, DeleteObjectsOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: DeleteObjectsInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketAccelerateConfiguration(input: GetBucketAccelerateConfigurationInput, completion: @escaping (SdkResult<GetBucketAccelerateConfigurationOutput, GetBucketAccelerateConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketAccelerateConfigurationInput, GetBucketAccelerateConfigurationOutput, GetBucketAccelerateConfigurationOutputError>(id: "getBucketAccelerateConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketAccelerateConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketAccelerateConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketAccelerateConfigurationInput, GetBucketAccelerateConfigurationOutput, GetBucketAccelerateConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketAcl(input: GetBucketAclInput, completion: @escaping (SdkResult<GetBucketAclOutput, GetBucketAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketAclInput, GetBucketAclOutput, GetBucketAclOutputError>(id: "getBucketAcl")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketAclInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketAclInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketAclInput, GetBucketAclOutput, GetBucketAclOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketAnalyticsConfiguration(input: GetBucketAnalyticsConfigurationInput, completion: @escaping (SdkResult<GetBucketAnalyticsConfigurationOutput, GetBucketAnalyticsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketAnalyticsConfigurationInput, GetBucketAnalyticsConfigurationOutput, GetBucketAnalyticsConfigurationOutputError>(id: "getBucketAnalyticsConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketAnalyticsConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketAnalyticsConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketAnalyticsConfigurationInput, GetBucketAnalyticsConfigurationOutput, GetBucketAnalyticsConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketCors(input: GetBucketCorsInput, completion: @escaping (SdkResult<GetBucketCorsOutput, GetBucketCorsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketCorsInput, GetBucketCorsOutput, GetBucketCorsOutputError>(id: "getBucketCors")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketCorsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketCorsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketCorsInput, GetBucketCorsOutput, GetBucketCorsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketEncryption(input: GetBucketEncryptionInput, completion: @escaping (SdkResult<GetBucketEncryptionOutput, GetBucketEncryptionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketEncryptionInput, GetBucketEncryptionOutput, GetBucketEncryptionOutputError>(id: "getBucketEncryption")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketEncryptionInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketEncryptionInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketEncryptionInput, GetBucketEncryptionOutput, GetBucketEncryptionOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketIntelligentTieringConfiguration(input: GetBucketIntelligentTieringConfigurationInput, completion: @escaping (SdkResult<GetBucketIntelligentTieringConfigurationOutput, GetBucketIntelligentTieringConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketIntelligentTieringConfigurationInput, GetBucketIntelligentTieringConfigurationOutput, GetBucketIntelligentTieringConfigurationOutputError>(id: "getBucketIntelligentTieringConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketIntelligentTieringConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketIntelligentTieringConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketIntelligentTieringConfigurationInput, GetBucketIntelligentTieringConfigurationOutput, GetBucketIntelligentTieringConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketInventoryConfiguration(input: GetBucketInventoryConfigurationInput, completion: @escaping (SdkResult<GetBucketInventoryConfigurationOutput, GetBucketInventoryConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketInventoryConfigurationInput, GetBucketInventoryConfigurationOutput, GetBucketInventoryConfigurationOutputError>(id: "getBucketInventoryConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketInventoryConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketInventoryConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketInventoryConfigurationInput, GetBucketInventoryConfigurationOutput, GetBucketInventoryConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketLocation(input: GetBucketLocationInput, completion: @escaping (SdkResult<GetBucketLocationOutput, GetBucketLocationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketLocationInput, GetBucketLocationOutput, GetBucketLocationOutputError>(id: "getBucketLocation")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketLocationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketLocationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketLocationInput, GetBucketLocationOutput, GetBucketLocationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketLogging(input: GetBucketLoggingInput, completion: @escaping (SdkResult<GetBucketLoggingOutput, GetBucketLoggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketLoggingInput, GetBucketLoggingOutput, GetBucketLoggingOutputError>(id: "getBucketLogging")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketLoggingInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketLoggingInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketLoggingInput, GetBucketLoggingOutput, GetBucketLoggingOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketMetricsConfiguration(input: GetBucketMetricsConfigurationInput, completion: @escaping (SdkResult<GetBucketMetricsConfigurationOutput, GetBucketMetricsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketMetricsConfigurationInput, GetBucketMetricsConfigurationOutput, GetBucketMetricsConfigurationOutputError>(id: "getBucketMetricsConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketMetricsConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketMetricsConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketMetricsConfigurationInput, GetBucketMetricsConfigurationOutput, GetBucketMetricsConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketNotificationConfiguration(input: GetBucketNotificationConfigurationInput, completion: @escaping (SdkResult<GetBucketNotificationConfigurationOutput, GetBucketNotificationConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketNotificationConfigurationInput, GetBucketNotificationConfigurationOutput, GetBucketNotificationConfigurationOutputError>(id: "getBucketNotificationConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketNotificationConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketNotificationConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketNotificationConfigurationInput, GetBucketNotificationConfigurationOutput, GetBucketNotificationConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketOwnershipControls(input: GetBucketOwnershipControlsInput, completion: @escaping (SdkResult<GetBucketOwnershipControlsOutput, GetBucketOwnershipControlsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketOwnershipControlsInput, GetBucketOwnershipControlsOutput, GetBucketOwnershipControlsOutputError>(id: "getBucketOwnershipControls")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketOwnershipControlsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketOwnershipControlsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketOwnershipControlsInput, GetBucketOwnershipControlsOutput, GetBucketOwnershipControlsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketPolicyStatus(input: GetBucketPolicyStatusInput, completion: @escaping (SdkResult<GetBucketPolicyStatusOutput, GetBucketPolicyStatusOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketPolicyStatusInput, GetBucketPolicyStatusOutput, GetBucketPolicyStatusOutputError>(id: "getBucketPolicyStatus")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketPolicyStatusInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketPolicyStatusInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketPolicyStatusInput, GetBucketPolicyStatusOutput, GetBucketPolicyStatusOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketReplication(input: GetBucketReplicationInput, completion: @escaping (SdkResult<GetBucketReplicationOutput, GetBucketReplicationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketReplicationInput, GetBucketReplicationOutput, GetBucketReplicationOutputError>(id: "getBucketReplication")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketReplicationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketReplicationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketReplicationInput, GetBucketReplicationOutput, GetBucketReplicationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketRequestPayment(input: GetBucketRequestPaymentInput, completion: @escaping (SdkResult<GetBucketRequestPaymentOutput, GetBucketRequestPaymentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketRequestPaymentInput, GetBucketRequestPaymentOutput, GetBucketRequestPaymentOutputError>(id: "getBucketRequestPayment")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketRequestPaymentInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketRequestPaymentInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketRequestPaymentInput, GetBucketRequestPaymentOutput, GetBucketRequestPaymentOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketVersioning(input: GetBucketVersioningInput, completion: @escaping (SdkResult<GetBucketVersioningOutput, GetBucketVersioningOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketVersioningInput, GetBucketVersioningOutput, GetBucketVersioningOutputError>(id: "getBucketVersioning")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketVersioningInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketVersioningInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketVersioningInput, GetBucketVersioningOutput, GetBucketVersioningOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getBucketWebsite(input: GetBucketWebsiteInput, completion: @escaping (SdkResult<GetBucketWebsiteOutput, GetBucketWebsiteOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetBucketWebsiteInput, GetBucketWebsiteOutput, GetBucketWebsiteOutputError>(id: "getBucketWebsite")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetBucketWebsiteInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetBucketWebsiteInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetBucketWebsiteInput, GetBucketWebsiteOutput, GetBucketWebsiteOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    public func getObject(input: GetObjectInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetObjectOutput, GetObjectOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectInput, GetObjectOutput, GetObjectOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getObjectAcl(input: GetObjectAclInput, completion: @escaping (SdkResult<GetObjectAclOutput, GetObjectAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectAclInput, GetObjectAclOutput, GetObjectAclOutputError>(id: "getObjectAcl")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetObjectAclInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetObjectAclInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectAclInput, GetObjectAclOutput, GetObjectAclOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    /**
     <p>Gets an object's current Legal Hold status. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html">Locking Objects</a>.</p>
              <p>This action is not supported by Amazon S3 on Outposts.</p>
     */
    public func getObjectLegalHold(input: GetObjectLegalHoldInput, completion: @escaping (SdkResult<GetObjectLegalHoldOutput, GetObjectLegalHoldOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectLegalHoldInput, GetObjectLegalHoldOutput, GetObjectLegalHoldOutputError>(id: "getObjectLegalHold")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetObjectLegalHoldInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetObjectLegalHoldInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectLegalHoldInput, GetObjectLegalHoldOutput, GetObjectLegalHoldOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    /**
     <p>Gets the Object Lock configuration for a bucket. The rule specified in the Object Lock
              ...
              bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html">Locking
                 Objects</a>.</p>
     */
    public func getObjectLockConfiguration(input: GetObjectLockConfigurationInput, completion: @escaping (SdkResult<GetObjectLockConfigurationOutput, GetObjectLockConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectLockConfigurationInput, GetObjectLockConfigurationOutput, GetObjectLockConfigurationOutputError>(id: "getObjectLockConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetObjectLockConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetObjectLockConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectLockConfigurationInput, GetObjectLockConfigurationOutput, GetObjectLockConfigurationOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    /**
     <p>Retrieves an object's retention settings. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html">Locking Objects</a>.</p>
              <p>This action is not supported by Amazon S3 on Outposts.</p>
     */
    public func getObjectRetention(input: GetObjectRetentionInput, completion: @escaping (SdkResult<GetObjectRetentionOutput, GetObjectRetentionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectRetentionInput, GetObjectRetentionOutput, GetObjectRetentionOutputError>(id: "getObjectRetention")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetObjectRetentionInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetObjectRetentionInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectRetentionInput, GetObjectRetentionOutput, GetObjectRetentionOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getObjectTagging(input: GetObjectTaggingInput, completion: @escaping (SdkResult<GetObjectTaggingOutput, GetObjectTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectTaggingInput, GetObjectTaggingOutput, GetObjectTaggingOutputError>(id: "getObjectTagging")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetObjectTaggingInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetObjectTaggingInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectTaggingInput, GetObjectTaggingOutput, GetObjectTaggingOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func getObjectTorrent(input: GetObjectTorrentInput, streamSink: StreamSink, completion: @escaping (SdkResult<GetObjectTorrentOutput, GetObjectTorrentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetObjectTorrentInput, GetObjectTorrentOutput, GetObjectTorrentOutputError>(id: "getObjectTorrent")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: GetObjectTorrentInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: GetObjectTorrentInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetObjectTorrentInput, GetObjectTorrentOutput, GetObjectTorrentOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    /**
     <p>This operation is useful to determine if a bucket exists and you have permission to
              ...
              can grant this permission to others. For more information about permissions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html#using-with-s3-actions-related-to-bucket-subresources">Permissions Related to Bucket Subresource Operations</a> and <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-access-control.html">Managing Access Permissions to Your Amazon S3
                 Resources</a>.</p>
     */
    public func headBucket(input: HeadBucketInput, completion: @escaping (SdkResult<HeadBucketOutput, HeadBucketOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<HeadBucketInput, HeadBucketOutput, HeadBucketOutputError>(id: "headBucket")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: HeadBucketInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: HeadBucketInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<HeadBucketInput, HeadBucketOutput, HeadBucketOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func headObject(input: HeadObjectInput, completion: @escaping (SdkResult<HeadObjectOutput, HeadObjectOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<HeadObjectInput, HeadObjectOutput, HeadObjectOutputError>(id: "headObject")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: HeadObjectInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: HeadObjectInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<HeadObjectInput, HeadObjectOutput, HeadObjectOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listBucketAnalyticsConfigurations(input: ListBucketAnalyticsConfigurationsInput, completion: @escaping (SdkResult<ListBucketAnalyticsConfigurationsOutput, ListBucketAnalyticsConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketAnalyticsConfigurationsInput, ListBucketAnalyticsConfigurationsOutput, ListBucketAnalyticsConfigurationsOutputError>(id: "listBucketAnalyticsConfigurations")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListBucketAnalyticsConfigurationsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListBucketAnalyticsConfigurationsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketAnalyticsConfigurationsInput, ListBucketAnalyticsConfigurationsOutput, ListBucketAnalyticsConfigurationsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listBucketIntelligentTieringConfigurations(input: ListBucketIntelligentTieringConfigurationsInput, completion: @escaping (SdkResult<ListBucketIntelligentTieringConfigurationsOutput, ListBucketIntelligentTieringConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketIntelligentTieringConfigurationsInput, ListBucketIntelligentTieringConfigurationsOutput, ListBucketIntelligentTieringConfigurationsOutputError>(id: "listBucketIntelligentTieringConfigurations")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListBucketIntelligentTieringConfigurationsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListBucketIntelligentTieringConfigurationsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketIntelligentTieringConfigurationsInput, ListBucketIntelligentTieringConfigurationsOutput, ListBucketIntelligentTieringConfigurationsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listBucketInventoryConfigurations(input: ListBucketInventoryConfigurationsInput, completion: @escaping (SdkResult<ListBucketInventoryConfigurationsOutput, ListBucketInventoryConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketInventoryConfigurationsInput, ListBucketInventoryConfigurationsOutput, ListBucketInventoryConfigurationsOutputError>(id: "listBucketInventoryConfigurations")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListBucketInventoryConfigurationsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListBucketInventoryConfigurationsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketInventoryConfigurationsInput, ListBucketInventoryConfigurationsOutput, ListBucketInventoryConfigurationsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listBucketMetricsConfigurations(input: ListBucketMetricsConfigurationsInput, completion: @escaping (SdkResult<ListBucketMetricsConfigurationsOutput, ListBucketMetricsConfigurationsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketMetricsConfigurationsInput, ListBucketMetricsConfigurationsOutput, ListBucketMetricsConfigurationsOutputError>(id: "listBucketMetricsConfigurations")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListBucketMetricsConfigurationsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListBucketMetricsConfigurationsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketMetricsConfigurationsInput, ListBucketMetricsConfigurationsOutput, ListBucketMetricsConfigurationsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    public func listBuckets(input: ListBucketsInput, completion: @escaping (SdkResult<ListBucketsOutput, ListBucketsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListBucketsInput, ListBucketsOutput, ListBucketsOutputError>(id: "listBuckets")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListBucketsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListBucketsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListBucketsInput, ListBucketsOutput, ListBucketsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listMultipartUploads(input: ListMultipartUploadsInput, completion: @escaping (SdkResult<ListMultipartUploadsOutput, ListMultipartUploadsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListMultipartUploadsInput, ListMultipartUploadsOutput, ListMultipartUploadsOutputError>(id: "listMultipartUploads")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListMultipartUploadsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListMultipartUploadsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListMultipartUploadsInput, ListMultipartUploadsOutput, ListMultipartUploadsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listObjectVersions(input: ListObjectVersionsInput, completion: @escaping (SdkResult<ListObjectVersionsOutput, ListObjectVersionsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListObjectVersionsInput, ListObjectVersionsOutput, ListObjectVersionsOutputError>(id: "listObjectVersions")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListObjectVersionsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListObjectVersionsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListObjectVersionsInput, ListObjectVersionsOutput, ListObjectVersionsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listObjects(input: ListObjectsInput, completion: @escaping (SdkResult<ListObjectsOutput, ListObjectsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListObjectsInput, ListObjectsOutput, ListObjectsOutputError>(id: "listObjects")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListObjectsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListObjectsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListObjectsInput, ListObjectsOutput, ListObjectsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listObjectsV2(input: ListObjectsV2Input, completion: @escaping (SdkResult<ListObjectsV2Output, ListObjectsV2OutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListObjectsV2Input, ListObjectsV2Output, ListObjectsV2OutputError>(id: "listObjectsV2")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListObjectsV2InputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListObjectsV2InputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListObjectsV2Input, ListObjectsV2Output, ListObjectsV2OutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func listParts(input: ListPartsInput, completion: @escaping (SdkResult<ListPartsOutput, ListPartsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListPartsInput, ListPartsOutput, ListPartsOutputError>(id: "listParts")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: ListPartsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ListPartsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListPartsInput, ListPartsOutput, ListPartsOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketAccelerateConfiguration(input: PutBucketAccelerateConfigurationInput, completion: @escaping (SdkResult<PutBucketAccelerateConfigurationOutput, PutBucketAccelerateConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketAccelerateConfigurationInput, PutBucketAccelerateConfigurationOutput, PutBucketAccelerateConfigurationOutputError>(id: "putBucketAccelerateConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAccelerateConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAccelerateConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketAccelerateConfigurationInput, PutBucketAccelerateConfigurationOutput, PutBucketAccelerateConfigurationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAccelerateConfigurationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketAcl(input: PutBucketAclInput, completion: @escaping (SdkResult<PutBucketAclOutput, PutBucketAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketAclInput, PutBucketAclOutput, PutBucketAclOutputError>(id: "putBucketAcl")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAclInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAclInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketAclInput, PutBucketAclOutput, PutBucketAclOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAclInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketAnalyticsConfiguration(input: PutBucketAnalyticsConfigurationInput, completion: @escaping (SdkResult<PutBucketAnalyticsConfigurationOutput, PutBucketAnalyticsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketAnalyticsConfigurationInput, PutBucketAnalyticsConfigurationOutput, PutBucketAnalyticsConfigurationOutputError>(id: "putBucketAnalyticsConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAnalyticsConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAnalyticsConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketAnalyticsConfigurationInput, PutBucketAnalyticsConfigurationOutput, PutBucketAnalyticsConfigurationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketAnalyticsConfigurationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketCors(input: PutBucketCorsInput, completion: @escaping (SdkResult<PutBucketCorsOutput, PutBucketCorsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketCorsInput, PutBucketCorsOutput, PutBucketCorsOutputError>(id: "putBucketCors")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketCorsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketCorsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketCorsInput, PutBucketCorsOutput, PutBucketCorsOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketCorsInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketEncryption(input: PutBucketEncryptionInput, completion: @escaping (SdkResult<PutBucketEncryptionOutput, PutBucketEncryptionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketEncryptionInput, PutBucketEncryptionOutput, PutBucketEncryptionOutputError>(id: "putBucketEncryption")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketEncryptionInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketEncryptionInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketEncryptionInput, PutBucketEncryptionOutput, PutBucketEncryptionOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketEncryptionInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketIntelligentTieringConfiguration(input: PutBucketIntelligentTieringConfigurationInput, completion: @escaping (SdkResult<PutBucketIntelligentTieringConfigurationOutput, PutBucketIntelligentTieringConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketIntelligentTieringConfigurationInput, PutBucketIntelligentTieringConfigurationOutput, PutBucketIntelligentTieringConfigurationOutputError>(id: "putBucketIntelligentTieringConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketIntelligentTieringConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketIntelligentTieringConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketIntelligentTieringConfigurationInput, PutBucketIntelligentTieringConfigurationOutput, PutBucketIntelligentTieringConfigurationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketIntelligentTieringConfigurationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketInventoryConfiguration(input: PutBucketInventoryConfigurationInput, completion: @escaping (SdkResult<PutBucketInventoryConfigurationOutput, PutBucketInventoryConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketInventoryConfigurationInput, PutBucketInventoryConfigurationOutput, PutBucketInventoryConfigurationOutputError>(id: "putBucketInventoryConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketInventoryConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketInventoryConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketInventoryConfigurationInput, PutBucketInventoryConfigurationOutput, PutBucketInventoryConfigurationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketInventoryConfigurationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketLogging(input: PutBucketLoggingInput, completion: @escaping (SdkResult<PutBucketLoggingOutput, PutBucketLoggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketLoggingInput, PutBucketLoggingOutput, PutBucketLoggingOutputError>(id: "putBucketLogging")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketLoggingInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketLoggingInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketLoggingInput, PutBucketLoggingOutput, PutBucketLoggingOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketLoggingInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketMetricsConfiguration(input: PutBucketMetricsConfigurationInput, completion: @escaping (SdkResult<PutBucketMetricsConfigurationOutput, PutBucketMetricsConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketMetricsConfigurationInput, PutBucketMetricsConfigurationOutput, PutBucketMetricsConfigurationOutputError>(id: "putBucketMetricsConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketMetricsConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketMetricsConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketMetricsConfigurationInput, PutBucketMetricsConfigurationOutput, PutBucketMetricsConfigurationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketMetricsConfigurationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketNotificationConfiguration(input: PutBucketNotificationConfigurationInput, completion: @escaping (SdkResult<PutBucketNotificationConfigurationOutput, PutBucketNotificationConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketNotificationConfigurationInput, PutBucketNotificationConfigurationOutput, PutBucketNotificationConfigurationOutputError>(id: "putBucketNotificationConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketNotificationConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketNotificationConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketNotificationConfigurationInput, PutBucketNotificationConfigurationOutput, PutBucketNotificationConfigurationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketNotificationConfigurationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketOwnershipControls(input: PutBucketOwnershipControlsInput, completion: @escaping (SdkResult<PutBucketOwnershipControlsOutput, PutBucketOwnershipControlsOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketOwnershipControlsInput, PutBucketOwnershipControlsOutput, PutBucketOwnershipControlsOutputError>(id: "putBucketOwnershipControls")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketOwnershipControlsInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketOwnershipControlsInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketOwnershipControlsInput, PutBucketOwnershipControlsOutput, PutBucketOwnershipControlsOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketOwnershipControlsInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketReplication(input: PutBucketReplicationInput, completion: @escaping (SdkResult<PutBucketReplicationOutput, PutBucketReplicationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketReplicationInput, PutBucketReplicationOutput, PutBucketReplicationOutputError>(id: "putBucketReplication")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketReplicationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketReplicationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketReplicationInput, PutBucketReplicationOutput, PutBucketReplicationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketReplicationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketRequestPayment(input: PutBucketRequestPaymentInput, completion: @escaping (SdkResult<PutBucketRequestPaymentOutput, PutBucketRequestPaymentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketRequestPaymentInput, PutBucketRequestPaymentOutput, PutBucketRequestPaymentOutputError>(id: "putBucketRequestPayment")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketRequestPaymentInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketRequestPaymentInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketRequestPaymentInput, PutBucketRequestPaymentOutput, PutBucketRequestPaymentOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketRequestPaymentInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketVersioning(input: PutBucketVersioningInput, completion: @escaping (SdkResult<PutBucketVersioningOutput, PutBucketVersioningOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketVersioningInput, PutBucketVersioningOutput, PutBucketVersioningOutputError>(id: "putBucketVersioning")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketVersioningInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketVersioningInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketVersioningInput, PutBucketVersioningOutput, PutBucketVersioningOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketVersioningInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putBucketWebsite(input: PutBucketWebsiteInput, completion: @escaping (SdkResult<PutBucketWebsiteOutput, PutBucketWebsiteOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutBucketWebsiteInput, PutBucketWebsiteOutput, PutBucketWebsiteOutputError>(id: "putBucketWebsite")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutBucketWebsiteInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutBucketWebsiteInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutBucketWebsiteInput, PutBucketWebsiteOutput, PutBucketWebsiteOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutBucketWebsiteInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
    ...
    public func putObject(input: PutObjectInput, streamSource: StreamSource, completion: @escaping (SdkResult<PutObjectOutput, PutObjectOutputError>) -> Void)
    {
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectInput, PutObjectOutput, PutObjectOutputError>(contentType: "application/xml"))
     ...
     */
    public func putObjectAcl(input: PutObjectAclInput, completion: @escaping (SdkResult<PutObjectAclOutput, PutObjectAclOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectAclInput, PutObjectAclOutput, PutObjectAclOutputError>(id: "putObjectAcl")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutObjectAclInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutObjectAclInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectAclInput, PutObjectAclOutput, PutObjectAclOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutObjectAclInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putObjectLegalHold(input: PutObjectLegalHoldInput, completion: @escaping (SdkResult<PutObjectLegalHoldOutput, PutObjectLegalHoldOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectLegalHoldInput, PutObjectLegalHoldOutput, PutObjectLegalHoldOutputError>(id: "putObjectLegalHold")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutObjectLegalHoldInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutObjectLegalHoldInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectLegalHoldInput, PutObjectLegalHoldOutput, PutObjectLegalHoldOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutObjectLegalHoldInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putObjectLockConfiguration(input: PutObjectLockConfigurationInput, completion: @escaping (SdkResult<PutObjectLockConfigurationOutput, PutObjectLockConfigurationOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectLockConfigurationInput, PutObjectLockConfigurationOutput, PutObjectLockConfigurationOutputError>(id: "putObjectLockConfiguration")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutObjectLockConfigurationInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutObjectLockConfigurationInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectLockConfigurationInput, PutObjectLockConfigurationOutput, PutObjectLockConfigurationOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutObjectLockConfigurationInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putObjectRetention(input: PutObjectRetentionInput, completion: @escaping (SdkResult<PutObjectRetentionOutput, PutObjectRetentionOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectRetentionInput, PutObjectRetentionOutput, PutObjectRetentionOutputError>(id: "putObjectRetention")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutObjectRetentionInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutObjectRetentionInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectRetentionInput, PutObjectRetentionOutput, PutObjectRetentionOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutObjectRetentionInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func putObjectTagging(input: PutObjectTaggingInput, completion: @escaping (SdkResult<PutObjectTaggingOutput, PutObjectTaggingOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutObjectTaggingInput, PutObjectTaggingOutput, PutObjectTaggingOutputError>(id: "putObjectTagging")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: PutObjectTaggingInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: PutObjectTaggingInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutObjectTaggingInput, PutObjectTaggingOutput, PutObjectTaggingOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: PutObjectTaggingInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func restoreObject(input: RestoreObjectInput, completion: @escaping (SdkResult<RestoreObjectOutput, RestoreObjectOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RestoreObjectInput, RestoreObjectOutput, RestoreObjectOutputError>(id: "restoreObject")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: RestoreObjectInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: RestoreObjectInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RestoreObjectInput, RestoreObjectOutput, RestoreObjectOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: RestoreObjectInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func selectObjectContent(input: SelectObjectContentInput, streamSink: StreamSink, completion: @escaping (SdkResult<SelectObjectContentOutput, SelectObjectContentOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<SelectObjectContentInput, SelectObjectContentOutput, SelectObjectContentOutputError>(id: "selectObjectContent")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: SelectObjectContentInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: SelectObjectContentInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<SelectObjectContentInput, SelectObjectContentOutput, SelectObjectContentOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: SelectObjectContentInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func uploadPart(input: UploadPartInput, streamSource: StreamSource, completion: @escaping (SdkResult<UploadPartOutput, UploadPartOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UploadPartInput, UploadPartOutput, UploadPartOutputError>(id: "uploadPart")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: UploadPartInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: UploadPartInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UploadPartInput, UploadPartOutput, UploadPartOutputError>(contentType: "application/xml"))
        operation.serializeStep.intercept(position: .before, middleware: UploadPartInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
     ...
     */
    public func uploadPartCopy(input: UploadPartCopyInput, completion: @escaping (SdkResult<UploadPartCopyOutput, UploadPartCopyOutputError>) -> Void)
    {
        guard let bucket = input.bucket else {
            completion(.failure(.client(ClientError.serializationFailed("uri component bucket unexpectedly nil"))))
            return
        ...
        let context = HttpContextBuilder()
                      ...
                      .withSigningName(value: "s3")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UploadPartCopyInput, UploadPartCopyOutput, UploadPartCopyOutputError>(id: "uploadPartCopy")
        operation.addDefaultOperationMiddlewares()
        operation.serializeStep.intercept(position: .before, middleware: UploadPartCopyInputHeadersMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: UploadPartCopyInputQueryItemMiddleware())
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UploadPartCopyInput, UploadPartCopyOutput, UploadPartCopyOutputError>(contentType: "application/xml"))
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(signedBodyHeader: .contentSha256, unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
