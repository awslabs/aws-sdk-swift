...
public struct GetObjectLegalHoldInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetObjectLegalHoldOutput, GetObjectLegalHoldOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetObjectLegalHoldOutput, GetObjectLegalHoldOutputError>
