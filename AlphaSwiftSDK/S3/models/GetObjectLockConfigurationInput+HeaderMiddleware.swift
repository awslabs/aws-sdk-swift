...
public struct GetObjectLockConfigurationInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetObjectLockConfigurationOutput, GetObjectLockConfigurationOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetObjectLockConfigurationOutput, GetObjectLockConfigurationOutputError>
