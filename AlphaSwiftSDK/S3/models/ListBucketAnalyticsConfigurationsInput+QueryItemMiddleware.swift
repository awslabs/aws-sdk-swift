...
public struct ListBucketAnalyticsConfigurationsInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<ListBucketAnalyticsConfigurationsOutput, ListBucketAnalyticsConfigurationsOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<ListBucketAnalyticsConfigurationsOutput, ListBucketAnalyticsConfigurationsOutputError>
