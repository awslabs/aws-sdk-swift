...
public struct GetBucketInventoryConfigurationInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetBucketInventoryConfigurationOutput, GetBucketInventoryConfigurationOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetBucketInventoryConfigurationOutput, GetBucketInventoryConfigurationOutputError>
