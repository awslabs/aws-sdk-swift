...
public struct PutObjectLegalHoldInputHeadersMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<PutObjectLegalHoldOutput, PutObjectLegalHoldOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<PutObjectLegalHoldOutput, PutObjectLegalHoldOutputError>
