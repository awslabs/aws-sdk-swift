...
public struct AdminSetUserMFAPreferenceInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<AdminSetUserMFAPreferenceOutput, AdminSetUserMFAPreferenceOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<AdminSetUserMFAPreferenceOutput, AdminSetUserMFAPreferenceOutputError>
