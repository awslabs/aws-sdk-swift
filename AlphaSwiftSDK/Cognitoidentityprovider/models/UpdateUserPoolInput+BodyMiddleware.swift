...
public struct UpdateUserPoolInputBodyMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<UpdateUserPoolOutput, UpdateUserPoolOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<UpdateUserPoolOutput, UpdateUserPoolOutputError>
