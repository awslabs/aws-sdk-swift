...
public class SecretsmanagerClient {
    ...
    let serviceName = "Secretsmanager"
    let encoder: RequestEncoder
    let decoder: ResponseDecoder

    public init(config: SecretsmanagerClientConfiguration) throws {
    ...
    public class SecretsmanagerClientConfiguration: ClientRuntime.Configuration, AWSClientConfiguration {
        ...
        public static func `default`() throws -> SecretsmanagerClientConfiguration {
            ...
            return SecretsmanagerClientConfiguration(credentialsProvider: awsCredsProvider)
        }
    }
}
...
extension SecretsmanagerClient: SecretsmanagerClientProtocol {
     ...
     */
    public func cancelRotateSecret(input: CancelRotateSecretInput, completion: @escaping (SdkResult<CancelRotateSecretOutput, CancelRotateSecretOutputError>) -> Void)
    {
        let urlPath = "/"
        ...
        var operation = OperationStack<CancelRotateSecretInput, CancelRotateSecretOutput, CancelRotateSecretOutputError>(id: "cancelRotateSecret")
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CancelRotateSecretInput, CancelRotateSecretOutput, CancelRotateSecretOutputError>(contentType: "application/x-amz-json-1.1"))
        ...
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CancelRotateSecretInput, CancelRotateSecretOutput, CancelRotateSecretOutputError>(xAmzTarget: "secretsmanager.CancelRotateSecret"))
     ...
     */
    public func createSecret(input: CreateSecretInput, completion: @escaping (SdkResult<CreateSecretOutput, CreateSecretOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<CreateSecretInput, CreateSecretOutput, CreateSecretOutputError>(id: "createSecret")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<CreateSecretOutput, CreateSecretOutputError>, Error> in
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<CreateSecretInput, CreateSecretOutput, CreateSecretOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: CreateSecretInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<CreateSecretInput, CreateSecretOutput, CreateSecretOutputError>(xAmzTarget: "secretsmanager.CreateSecret"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func deleteResourcePolicy(input: DeleteResourcePolicyInput, completion: @escaping (SdkResult<DeleteResourcePolicyOutput, DeleteResourcePolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteResourcePolicyInput, DeleteResourcePolicyOutput, DeleteResourcePolicyOutputError>(xAmzTarget: "secretsmanager.DeleteResourcePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func deleteSecret(input: DeleteSecretInput, completion: @escaping (SdkResult<DeleteSecretOutput, DeleteSecretOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DeleteSecretInput, DeleteSecretOutput, DeleteSecretOutputError>(id: "deleteSecret")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DeleteSecretInput, DeleteSecretOutput, DeleteSecretOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: DeleteSecretInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DeleteSecretInput, DeleteSecretOutput, DeleteSecretOutputError>(xAmzTarget: "secretsmanager.DeleteSecret"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func describeSecret(input: DescribeSecretInput, completion: @escaping (SdkResult<DescribeSecretOutput, DescribeSecretOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<DescribeSecretInput, DescribeSecretOutput, DescribeSecretOutputError>(id: "describeSecret")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<DescribeSecretInput, DescribeSecretOutput, DescribeSecretOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: DescribeSecretInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<DescribeSecretInput, DescribeSecretOutput, DescribeSecretOutputError>(xAmzTarget: "secretsmanager.DescribeSecret"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func getRandomPassword(input: GetRandomPasswordInput, completion: @escaping (SdkResult<GetRandomPasswordOutput, GetRandomPasswordOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetRandomPasswordInput, GetRandomPasswordOutput, GetRandomPasswordOutputError>(id: "getRandomPassword")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetRandomPasswordInput, GetRandomPasswordOutput, GetRandomPasswordOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: GetRandomPasswordInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetRandomPasswordInput, GetRandomPasswordOutput, GetRandomPasswordOutputError>(xAmzTarget: "secretsmanager.GetRandomPassword"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func getResourcePolicy(input: GetResourcePolicyInput, completion: @escaping (SdkResult<GetResourcePolicyOutput, GetResourcePolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetResourcePolicyInput, GetResourcePolicyOutput, GetResourcePolicyOutputError>(xAmzTarget: "secretsmanager.GetResourcePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func getSecretValue(input: GetSecretValueInput, completion: @escaping (SdkResult<GetSecretValueOutput, GetSecretValueOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<GetSecretValueInput, GetSecretValueOutput, GetSecretValueOutputError>(id: "getSecretValue")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<GetSecretValueInput, GetSecretValueOutput, GetSecretValueOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: GetSecretValueInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<GetSecretValueInput, GetSecretValueOutput, GetSecretValueOutputError>(xAmzTarget: "secretsmanager.GetSecretValue"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func listSecretVersionIds(input: ListSecretVersionIdsInput, completion: @escaping (SdkResult<ListSecretVersionIdsOutput, ListSecretVersionIdsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSecretVersionIdsInput, ListSecretVersionIdsOutput, ListSecretVersionIdsOutputError>(id: "listSecretVersionIds")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSecretVersionIdsInput, ListSecretVersionIdsOutput, ListSecretVersionIdsOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: ListSecretVersionIdsInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListSecretVersionIdsInput, ListSecretVersionIdsOutput, ListSecretVersionIdsOutputError>(xAmzTarget: "secretsmanager.ListSecretVersionIds"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func listSecrets(input: ListSecretsInput, completion: @escaping (SdkResult<ListSecretsOutput, ListSecretsOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ListSecretsInput, ListSecretsOutput, ListSecretsOutputError>(id: "listSecrets")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ListSecretsInput, ListSecretsOutput, ListSecretsOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: ListSecretsInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ListSecretsInput, ListSecretsOutput, ListSecretsOutputError>(xAmzTarget: "secretsmanager.ListSecrets"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func putResourcePolicy(input: PutResourcePolicyInput, completion: @escaping (SdkResult<PutResourcePolicyOutput, PutResourcePolicyOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutResourcePolicyInput, PutResourcePolicyOutput, PutResourcePolicyOutputError>(xAmzTarget: "secretsmanager.PutResourcePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func putSecretValue(input: PutSecretValueInput, completion: @escaping (SdkResult<PutSecretValueOutput, PutSecretValueOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<PutSecretValueInput, PutSecretValueOutput, PutSecretValueOutputError>(id: "putSecretValue")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<PutSecretValueOutput, PutSecretValueOutputError>, Error> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<PutSecretValueInput, PutSecretValueOutput, PutSecretValueOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: PutSecretValueInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<PutSecretValueInput, PutSecretValueOutput, PutSecretValueOutputError>(xAmzTarget: "secretsmanager.PutSecretValue"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func restoreSecret(input: RestoreSecretInput, completion: @escaping (SdkResult<RestoreSecretOutput, RestoreSecretOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RestoreSecretInput, RestoreSecretOutput, RestoreSecretOutputError>(id: "restoreSecret")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RestoreSecretInput, RestoreSecretOutput, RestoreSecretOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: RestoreSecretInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RestoreSecretInput, RestoreSecretOutput, RestoreSecretOutputError>(xAmzTarget: "secretsmanager.RestoreSecret"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func rotateSecret(input: RotateSecretInput, completion: @escaping (SdkResult<RotateSecretOutput, RotateSecretOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<RotateSecretInput, RotateSecretOutput, RotateSecretOutputError>(id: "rotateSecret")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<RotateSecretOutput, RotateSecretOutputError>, Error> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<RotateSecretInput, RotateSecretOutput, RotateSecretOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: RotateSecretInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<RotateSecretInput, RotateSecretOutput, RotateSecretOutputError>(xAmzTarget: "secretsmanager.RotateSecret"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func tagResource(input: TagResourceInput, completion: @escaping (SdkResult<TagResourceOutput, TagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<TagResourceInput, TagResourceOutput, TagResourceOutputError>(xAmzTarget: "secretsmanager.TagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
    ...
    public func untagResource(input: UntagResourceInput, completion: @escaping (SdkResult<UntagResourceOutput, UntagResourceOutputError>) -> Void)
    {
        ...
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UntagResourceInput, UntagResourceOutput, UntagResourceOutputError>(xAmzTarget: "secretsmanager.UntagResource"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func updateSecret(input: UpdateSecretInput, completion: @escaping (SdkResult<UpdateSecretOutput, UpdateSecretOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateSecretInput, UpdateSecretOutput, UpdateSecretOutputError>(id: "updateSecret")
        operation.addDefaultOperationMiddlewares()
        operation.initializeStep.intercept(position: .before, id: "IdempotencyTokenMiddleware") { (context, input, next) -> Result<OperationOutput<UpdateSecretOutput, UpdateSecretOutputError>, Error> in
            let idempotencyTokenGenerator = context.getIdempotencyTokenGenerator()
            var copiedInput = input
            if input.clientRequestToken == nil {
                copiedInput.clientRequestToken = idempotencyTokenGenerator.generateToken()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateSecretInput, UpdateSecretOutput, UpdateSecretOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: UpdateSecretInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSecretInput, UpdateSecretOutput, UpdateSecretOutputError>(xAmzTarget: "secretsmanager.UpdateSecret"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func updateSecretVersionStage(input: UpdateSecretVersionStageInput, completion: @escaping (SdkResult<UpdateSecretVersionStageOutput, UpdateSecretVersionStageOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<UpdateSecretVersionStageInput, UpdateSecretVersionStageOutput, UpdateSecretVersionStageOutputError>(id: "updateSecretVersionStage")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<UpdateSecretVersionStageInput, UpdateSecretVersionStageOutput, UpdateSecretVersionStageOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: UpdateSecretVersionStageInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<UpdateSecretVersionStageInput, UpdateSecretVersionStageOutput, UpdateSecretVersionStageOutputError>(xAmzTarget: "secretsmanager.UpdateSecretVersionStage"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
     ...
     */
    public func validateResourcePolicy(input: ValidateResourcePolicyInput, completion: @escaping (SdkResult<ValidateResourcePolicyOutput, ValidateResourcePolicyOutputError>) -> Void)
    {
        let urlPath = "/"
        let context = HttpContextBuilder()
                      .withEncoder(value: encoder)
                      ...
                      .withSigningName(value: "secretsmanager")
                      .withSigningRegion(value: config.signingRegion)
        var operation = OperationStack<ValidateResourcePolicyInput, ValidateResourcePolicyOutput, ValidateResourcePolicyOutputError>(id: "validateResourcePolicy")
        operation.addDefaultOperationMiddlewares()
        ...
        operation.serializeStep.intercept(position: .before, middleware: ContentTypeMiddleware<ValidateResourcePolicyInput, ValidateResourcePolicyOutput, ValidateResourcePolicyOutputError>(contentType: "application/x-amz-json-1.1"))
        operation.serializeStep.intercept(position: .before, middleware: ValidateResourcePolicyInputBodyMiddleware())
        operation.buildStep.intercept(position: .before, middleware: EndpointResolverMiddleware(endpointResolver: config.endpointResolver, serviceId: serviceName))
        let config = SigV4Config(unsignedBody: false)
        operation.finalizeStep.intercept(position: .after,
                                                 middleware: SigV4Middleware(config: config))
        operation.serializeStep.intercept(position: .before, middleware: XAmzTargetMiddleware<ValidateResourcePolicyInput, ValidateResourcePolicyOutput, ValidateResourcePolicyOutputError>(xAmzTarget: "secretsmanager.ValidateResourcePolicy"))
        let result = operation.handleMiddleware(context: context.build(), input: input, next: client.getHandler())
        completion(result)
    }
