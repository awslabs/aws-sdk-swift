...
public struct GetFunctionConcurrencyInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetFunctionConcurrencyOutput, GetFunctionConcurrencyOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetFunctionConcurrencyOutput, GetFunctionConcurrencyOutputError>
