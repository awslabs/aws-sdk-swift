...
public struct GetFunctionEventInvokeConfigInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetFunctionEventInvokeConfigOutput, GetFunctionEventInvokeConfigOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetFunctionEventInvokeConfigOutput, GetFunctionEventInvokeConfigOutputError>
