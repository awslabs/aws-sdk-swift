...
public struct GetEventSourceMappingInputQueryItemMiddleware: Middleware {
    ...
    public func handle<H>(context: Context,
                  ...
                  next: H) -> Swift.Result<OperationOutput<GetEventSourceMappingOutput, GetEventSourceMappingOutputError>, Swift.Error>
    where H: Handler,
    Self.MInput == H.Input,
    ...
    public typealias MOutput = OperationOutput<GetEventSourceMappingOutput, GetEventSourceMappingOutputError>
